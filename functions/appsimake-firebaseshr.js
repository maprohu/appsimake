...
define(['exports', 'kotlin', 'appsimake-commonshr', 'kotlinx-coroutines-core'], function (_, Kotlin, $module$appsimake_commonshr, $module$kotlinx_coroutines_core) {
  ...
  var map_0 = $module$appsimake_commonshr.common.map_x7fpzi$;
  ...
  function get_ids$lambda$lambda(s) {
    return s.props.idOrFail;
  }
  function get_ids$lambda_0(m) {
    return m.map_2o04qz$(get_ids$lambda$lambda);
  }
  function get_ids_0($receiver) {
    return map_0(toMoves($receiver.diffsAll), get_ids$lambda_0);
  }
  ...
  package$firebaseshr.get_ids_ed8nim$ = get_ids_0;
