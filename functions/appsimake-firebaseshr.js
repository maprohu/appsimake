...
define(['exports', 'kotlin', 'appsimake-commonshr'], function (_, Kotlin, $module$appsimake_commonshr) {
  ...
  BaseRootCheck.prototype = Object.create(BaseRoot.prototype);
  ...
  Object.defineProperty(ScalarProp.prototype, 'iv', {
    get: function () {
      return get_0(this.initial);
    }
  });
  Object.defineProperty(ScalarProp.prototype, 'cv', {
    get: function () {
  ...
  function toSet_0($receiver) {
    ...
    return mapped.copy_sxzkdt$(void 0, void 0, void 0, void 0, toSet$lambda$lambda($receiver, mapped));
  }
  ...
  function BaseRootCheck() {
    BaseRoot.call(this);
    this.type_op8zbj$_0 = this.o.scalar_287e2$().prop_2nq2ks$().provideDelegate_n5byny$(this, BaseRootCheck$type_metadata);
  }
  var BaseRootCheck$type_metadata = new PropertyMetadata('type');
  Object.defineProperty(BaseRootCheck.prototype, 'type', {
    get: function () {
      return this.type_op8zbj$_0.getValue_lrcp0p$(this, BaseRootCheck$type_metadata);
    }
  });
  ...
  package$firebaseshr.initFrom_d5knkn$ = initFrom;
  package$firebaseshr.wrapper_3ib333$ = wrapper;
