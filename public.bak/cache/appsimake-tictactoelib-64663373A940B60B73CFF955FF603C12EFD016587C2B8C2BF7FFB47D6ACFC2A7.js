...
if (typeof this['appsimake-commonlib'] === 'undefined') {
  throw new Error("Error loading module 'appsimake-tictactoelib'. Its dependency 'appsimake-commonlib' was not found. Please, check whether 'appsimake-commonlib' is loaded prior to 'appsimake-tictactoelib'.");
}
...
this['appsimake-tictactoelib'] = function (_, Kotlin, $module$appsimake_commonlib, $module$appsimake_commonshr) {
  'use strict';
  ...
  return _;
}(typeof this['appsimake-tictactoelib'] === 'undefined' ? {} : this['appsimake-tictactoelib'], kotlin, this['appsimake-commonlib'], this['appsimake-commonshr']);
