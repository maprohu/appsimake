...
if (typeof domx === 'undefined') {
  throw new Error("Error loading module 'commonfb'. Its dependency 'domx' was not found. Please, check whether 'domx' is loaded prior to 'commonfb'.");
}
...
var commonfb = function (_, Kotlin, $module$firebase, $module$commonui, $module$bootstrap, $module$domx, $module$common) {
  'use strict';
  ...
  var btn = $module$bootstrap.bootstrap.btn_ejp6nk$;
  ...
  function FbCtx_init(name, title, $this) {
    $this = $this || Object.create(FbCtx.prototype);
    FbCtx.call($this, new AppCtx(title), name);
    return $this;
  }
  ...
  function LoggingInCtx_init(name, $this) {
    ...
    LoggingInCtx_init_0(name, name, $this);
    return $this;
  }
  function LoggingInCtx_init_0(name, title, $this) {
    $this = $this || Object.create(LoggingInCtx.prototype);
    LoggingInCtx.call($this, FbCtx_init(name, title));
    return $this;
  }
  ...
  package$commonfb.FbCtx_init_puj7f4$ = FbCtx_init;
  ...
  package$commonfb.LoggingInCtx_init_puj7f4$ = LoggingInCtx_init_0;
  ...
  return _;
}(typeof commonfb === 'undefined' ? {} : commonfb, kotlin, firebase, commonui, bootstrap, domx, common);
