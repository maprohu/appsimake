...
if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
  throw new Error("Error loading module 'commonui'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'commonui'.");
}
...
var commonui = function (_, Kotlin, $module$kotlinx_coroutines_core, $module$common, $module$bootstrap, $module$domx, $module$fontawesome) {
  'use strict';
  ...
  function AppCtx$notify$lambda() {
    return Unit;
  }
  function AppCtx$notify$lambda$lambda$lambda(closure$fn) {
    return function (it) {
      window.focus();
      closure$fn();
      return Unit;
  ...
  function AppCtx$notify$lambda_0(this$AppCtx_0, closure$msg_0, closure$fn_0) {
    return function ($receiver, continuation_0, suspended) {
      var instance = new Coroutine$AppCtx$notify$lambda(this$AppCtx_0, closure$msg_0, closure$fn_0, $receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
  ...
  function Coroutine$AppCtx$notify$lambda(this$AppCtx_0, closure$msg_0, closure$fn_0, $receiver, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$AppCtx = this$AppCtx_0;
    this.local$closure$msg = closure$msg_0;
    this.local$closure$fn = closure$fn_0;
  }
  Coroutine$AppCtx$notify$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$AppCtx$notify$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$AppCtx$notify$lambda.prototype.constructor = Coroutine$AppCtx$notify$lambda;
  Coroutine$AppCtx$notify$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (!this.local$this$AppCtx.windowActive.now) {
              this.state_0 = 2;
              this.result_0 = grant(Notification, this);
          ...
          case 2:
            if (this.result_0) {
              var tmp$ = this.local$this$AppCtx.title;
              var body = this.local$closure$msg;
              var dir;
              var lang;
              var tag;
              var image;
              ...
              o['data'] = data;
              o['actions'] = actions;
              var $receiver = new Notification(tmp$, o);
              $receiver.onclick = AppCtx$notify$lambda$lambda$lambda(this.local$closure$fn);
              return $receiver;
            }
             else {
              return Unit;
  ...
  AppCtx.prototype.notify_a4mwiz$ = function (msg, fn) {
    if (fn === void 0)
      fn = AppCtx$notify$lambda;
    return launch(coroutines.GlobalScope, void 0, void 0, AppCtx$notify$lambda_0(this, msg, fn));
  };
  ...
  function grant($receiver, continuation_0, suspended) {
    var instance = new Coroutine$grant($receiver, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$grant($receiver, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$tmp$_0 = void 0;
  }
  Coroutine$grant.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$grant.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$grant.prototype.constructor = Coroutine$grant;
  Coroutine$grant.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            tmp$ = Notification.permission;
            if (equals(tmp$, 'granted')) {
              this.local$tmp$_0 = true;
              this.state_0 = 4;
              continue;
            }
             else {
              if (equals(tmp$, 'denied')) {
          ...
          case 1:
            throw this.exception_0;
          case 2:
            this.local$tmp$_0 = equals(this.result_0, 'granted');
            this.state_0 = 3;
            continue;
          case 3:
            this.state_0 = 4;
  ...
  function ifGranted$lambda(this$ifGranted_0, closure$fn_0) {
    return function ($receiver, continuation_0, suspended) {
      var instance = new Coroutine$ifGranted$lambda(this$ifGranted_0, closure$fn_0, $receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$ifGranted$lambda(this$ifGranted_0, closure$fn_0, $receiver, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$ifGranted = this$ifGranted_0;
    this.local$closure$fn = closure$fn_0;
  }
  Coroutine$ifGranted$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$ifGranted$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$ifGranted$lambda.prototype.constructor = Coroutine$ifGranted$lambda;
  Coroutine$ifGranted$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = grant(this.local$this$ifGranted, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 2:
            if (this.result_0) {
              return this.local$closure$fn(), Unit;
            }
             else {
              this.state_0 = 3;
              continue;
  ...
  function ifGranted($receiver, fn) {
    launch(coroutines.GlobalScope, void 0, void 0, ifGranted$lambda($receiver, fn));
  }
  ...
  package$commonui.grant_iyaa7$ = grant;
  package$commonui.ifGranted_wxtrii$ = ifGranted;
  ...
  return _;
}(typeof commonui === 'undefined' ? {} : commonui, kotlin, this['kotlinx-coroutines-core'], common, bootstrap, domx, fontawesome);
