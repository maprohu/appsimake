...
var chat = function (_, Kotlin, $module$pullanappfb, $module$firebase, $module$kotlinx_html_js, $module$common) {
  ...
  function Chatting$start$lambda$lambda$lambda_0(this$, this$Chatting) {
    return function ($receiver) {
      ...
      button(this$, void 0, void 0, void 0, tmp$_0, 'btn input-group-append', Chatting$start$lambda$lambda$lambda$lambda);
  ...
  function Chatting$start$lambda$lambda$lambda_3(this$, this$Chatting) {
    return function ($receiver) {
      ...
      tmp$_0 = ButtonType.submit;
      button(this$, void 0, void 0, void 0, tmp$_0, 'btn input-group-append', Chatting$start$lambda$lambda$lambda$lambda_2);
  ...
  function Chatting$start$lambda$lambda(this$, this$Chatting) {
    return function ($receiver) {
      ...
      form(this$, void 0, void 0, void 0, 'd-flex flex-row flex-grow-0 flex-shrink-0 input-group', Chatting$start$lambda$lambda$lambda_0(this$, this$Chatting));
      var list = dl(this$, 'flex-grow-1 ' + styles.scrollVertical + ' my-2 border px-2', Chatting$start$lambda$lambda$lambda_1);
      var first = {v: true};
      this$Chatting.lastMessage.onSnapshot(Chatting$start$lambda$lambda$lambda_2(first, list, this$Chatting));
      form(this$, void 0, void 0, void 0, 'd-flex flex-row flex-grow-0 flex-shrink-0 input-group', Chatting$start$lambda$lambda$lambda_3(this$, this$Chatting));
      return Unit;
    };
  }
