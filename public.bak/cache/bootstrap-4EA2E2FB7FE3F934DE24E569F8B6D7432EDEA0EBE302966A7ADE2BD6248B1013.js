...
var bootstrap = function (_, Kotlin, $module$domx, $module$common) {
  ...
  function divCenter$lambda(closure$block) {
    return function ($receiver) {
      fullSize($receiver);
      flexCenter($receiver);
      closure$block($receiver);
  ...
  function divCenter($receiver, block) {
    return div($receiver, divCenter$lambda(block));
  }
  function flexCenter($receiver) {
    flex($receiver);
    get_classes($receiver).plusAssign_61zpoe$('align-items-center justify-content-center');
  }
  ...
  package$bootstrap.divCenter_gnmiz0$ = divCenter;
  ...
  package$bootstrap.bgLigth_ejp6nk$ = bgLigth;
