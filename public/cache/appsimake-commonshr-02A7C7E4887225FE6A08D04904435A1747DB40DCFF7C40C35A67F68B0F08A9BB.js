...
this['appsimake-commonshr'] = function (_, Kotlin) {
  ...
  Emitter.prototype.add_qlkmfe$ = function (listener) {
    var tmp$;
    tmp$ = this.first_n8p2fh$_0().iterator();
    while (tmp$.hasNext()) {
      var element = tmp$.next();
      listener(element);
    }
  ...
  function feedTo$lambda_0(closure$rxv) {
    return function (old, new_0) {
  ...
  function feedTo$lambda_1(closure$rxv, this$feedTo) {
    return function () {
      closure$rxv.transform_ru8m0w$(feedTo$lambda$lambda_0(this$feedTo));
      return Unit;
    };
  }
  function feedTo_0($receiver, rxv) {
    return $receiver.fold_b8xf17$(0, feedTo$lambda_0(rxv)).plus_wii6vi$(Killable$Companion_getInstance().once_o14v8n$(feedTo$lambda_1(rxv, $receiver)));
  }
  ...
  function feedTo_2($receiver, rxv) {
    return $receiver.fold_b8xf17$(L0, feedTo$lambda_4(rxv)).plus_wii6vi$(Killable$Companion_getInstance().once_o14v8n$(feedTo$lambda_5(rxv, $receiver)));
  }
  ...
  function feedTo_3($receiver, rxv) {
    return $receiver.fold_b8xf17$(0.0, feedTo$lambda_6(rxv)).plus_wii6vi$(Killable$Companion_getInstance().once_o14v8n$(feedTo$lambda_7(rxv, $receiver)));
  }
  ...
  package$rx.feedTo_s4tckn$ = feedTo_0;
  package$rx.feedTo_jq98q0$ = feedTo_1;
  package$rx.feedTo_ghlndt$ = feedTo_2;
  package$rx.feedTo_tqwc97$ = feedTo_3;
