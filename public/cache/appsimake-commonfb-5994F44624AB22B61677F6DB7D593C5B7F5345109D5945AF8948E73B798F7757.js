...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_commonui, $module$appsimake_firebase, $module$kotlinx_coroutines_core, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common, $module$appsimake_commonlib) {
  ...
  function build$lambda$lambda_3(closure$isSaving, closure$item, closure$back, this$build, closure$fc, closure$canSave, closure$save, closure$showDropDown, closure$showDelete, closure$canDelete, closure$delete) {
    return function ($receiver) {
      ...
      invoke($receiver.main, build$lambda$lambda$lambda_1(closure$fc));
      return Unit;
    };
  }
  ...
  function build$lambda$lambda_4(closure$isBusy, closure$close, this$build, closure$filterConfig, closure$killables, closure$panel, closure$displayList, closure$db) {
    return function ($receiver) {
      ...
      invoke($receiver.main, build$lambda$lambda$lambda_3(closure$filterConfig, filterOpen, closure$killables, closure$displayList, this$build, closure$db, closure$panel));
      return Unit;
    };
  }
  ...
  function ListUIConfig(root, query, create, hourglassDecor, emptyDivDecor, listDivDecor, ulDecor, itemFactory) {
    ...
    if (listDivDecor === void 0)
      listDivDecor = ListUIConfig_init$lambda_0;
    if (ulDecor === void 0)
      ulDecor = ListUIConfig_init$lambda_1;
    this.root = root;
    this.query = query;
    this.create = create;
  ...
  function listUI$lambda$lambda$lambda(this$, closure$list) {
    return function ($receiver) {
  ...
  function listUI$lambda$lambda$lambda_0(closure$ks, closure$list, closure$queryRoot, closure$emptyDiv, closure$listDiv) {
    return function () {
  ...
  function listUI$lambda$lambda_0(this$, closure$killables, closure$emptyDiv) {
    return function (old, q) {
      ...
      var listDiv = column(document, listUI$lambda$lambda$lambda(this$, list));
      listen_0(q.query, ks, ListenConfig.Companion.hasProps_5sp7du$(list, this$.create).copy_4cbyqc$(void 0, void 0, void 0, void 0, listUI$lambda$lambda$lambda_0(ks, list, queryRoot, closure$emptyDiv, listDiv)));
      return ks;
    };
  }
  ...
  ViewScreenConfig.prototype.copy_atz74u$ = function (title, edit, top, view) {
  ...
  function build$lambda$lambda$lambda_4(this$build, closure$state, closure$panel, closure$item, closure$displayViewer) {
    return function ($receiver) {
  ...
  function build$lambda$lambda$lambda_5(this$build, closure$state, closure$item) {
    return function ($receiver) {
      this$build.view($receiver, closure$state, closure$item);
      return Unit;
    };
  }
  function build$lambda$lambda_5(this$build, closure$state, closure$panel, closure$item, closure$displayViewer) {
    return function ($receiver) {
      $receiver.top_vesf63$(build$lambda$lambda$lambda_4(this$build, closure$state, closure$panel, closure$item, closure$displayViewer));
      invoke($receiver.main, build$lambda$lambda$lambda_5(this$build, closure$state, closure$item));
      return Unit;
    };
  }
  function build$lambda_8(closure$panel, closure$killables, closure$close, this$build, closure$item) {
    return function ($receiver) {
      ...
      screenLayout($receiver, closure$killables, build$lambda$lambda_5(this$build, state, closure$panel, closure$item, displayViewer));
      return Unit;
    };
  }
