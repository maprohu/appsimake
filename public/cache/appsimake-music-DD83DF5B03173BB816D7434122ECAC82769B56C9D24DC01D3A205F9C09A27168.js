...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_commonfb, $module$appsimake_firebase, $module$appsimake_indexeddb, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_musiclib, $module$appsimake_fontawesome, $module$appsimake_common, $module$appsimake_firebaseshr, $module$appsimake_commonlib) {
  ...
  function Boot_init$lambda$lambda$lambda(u) {
    if (u != null)
      console.dir(u);
    return Unit;
  }
  ...
  function Boot_init$lambda$lambda$lambda_0(this$Boot, this$) {
      ...
      try {
        switch (this.state_0) {
          ...
          case 3:
            ...
            continue;
          case 4:
            this.local$tmp$.app.auth().onIdTokenChanged(Boot_init$lambda$lambda$lambda);
            ...
            continue;
          case 5:
            this.local$this$Boot_0.forEach_5mel8p$(this.result_0, Boot_init$lambda$lambda$lambda_0(this.local$this$Boot_0, this.local$tmp$));
            return Unit;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
  ...
  function ui_3($receiver) {
    ...
    listenableList($receiver_9.pane, $receiver.kills, $receiver.loadList, ui$lambda$lambda_2);
  ...
  function ui$lambda_0(this$ui) {
    return function ($receiver) {
      ...
      get_dFlex($receiver_0);
      get_flexColumn($receiver_0);
      invoke(get_dl($receiver), ui$lambda$lambda_3(this$ui));
      invoke(get_div($receiver), ui$lambda$lambda_4(this$ui));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda_6(closure$totalDurationText) {
    return function ($receiver) {
      return closure$totalDurationText.invoke().length;
    };
  }
  function ui$lambda$lambda_7(this$ui, closure$totalDurationTextLength) {
    return function ($receiver) {
      return padStart(get_formatSecs(this$ui.currentPosition.invoke()), closure$totalDurationTextLength.invoke(), 32);
    };
  }
  function ui$lambda$lambda_8(this$ui) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda_10(closure$artistTitle) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda_12(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText, closure$likeButtonsDisabled, closure$state) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
  ...
  function ui_7($receiver) {
    ...
    var totalDurationText = $receiver.rx_pn7ch0$(ui$lambda$lambda_5($receiver));
    var totalDurationTextLength = $receiver.rx_pn7ch0$(ui$lambda$lambda_6(totalDurationText));
    var currentPositionText = $receiver.rx_pn7ch0$(ui$lambda$lambda_7($receiver, totalDurationTextLength));
    var likeButtonsDisabled = $receiver.rx_pn7ch0$(ui$lambda$lambda_8($receiver));
    var state = $receiver.userSong;
    var artistTitle = $receiver.rx_pn7ch0$(ui$lambda$lambda_9($receiver));
    var artist = $receiver.rx_pn7ch0$(ui$lambda$lambda_10(artistTitle));
    var title = $receiver.rx_pn7ch0$(ui$lambda$lambda_11(artistTitle));
    ...
    return $receiver_0.wraps.div_iw61es$(ui$lambda$lambda_12($receiver, artist, title, currentPositionText, totalDurationText, likeButtonsDisabled, state)).node;
  }
  var SeekSeconds;
  ...
  function ui$lambda$lambda_13(this$ui) {
    return function ($receiver) {
      get_p1(get_cls($receiver));
  ...
  function ui_8($receiver) {
    ...
    invoke($receiver_3.pane, ui$lambda$lambda_13($receiver));
