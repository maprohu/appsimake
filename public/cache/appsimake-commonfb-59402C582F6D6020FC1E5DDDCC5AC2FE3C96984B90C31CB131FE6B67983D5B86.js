...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_firebase, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_firebaseshr, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common) {
  ...
  var mapAsync = $module$appsimake_commonshr.rx.mapAsync_e87wto$;
  ...
  function runUserState$lambda_0(closure$rxv) {
    return function (u) {
      var tmp$, tmp$_0;
      tmp$_0 = closure$rxv;
      if (u == null) {
  ...
  function runUserState($receiver, app, fn, continuation) {
    ...
    plusAssign($receiver.kills, app.auth().onAuthStateChanged(runUserState$lambda_0(rxv), runUserState$lambda_1(rxv)));
    return mapAsync(rxv, $receiver.kills, fn, continuation);
  }
  ...
  package$commonfb.runUserState_4by09g$ = runUserState;
