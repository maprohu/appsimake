...
this['appsimake-commonui'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$kotlinx_coroutines_core, $module$appsimake_buildenv, $module$appsimake_bootstrap, $module$appsimake_common, $module$appsimake_fontawesome) {
  ...
  ViewImpl.prototype = Object.create(ExecImpl.prototype);
  ViewImpl.prototype.constructor = ViewImpl;
  ForwardImpl.prototype = Object.create(ViewImpl.prototype);
  ...
  ViewWithForwardImpl.prototype = Object.create(ExecImpl.prototype);
  ViewWithForwardImpl.prototype.constructor = ViewWithForwardImpl;
  ...
  var get_uiapi = defineInlineFunction('appsimake-commonui.commonui.get_uiapi_mighe9$', wrapFunction(function () {
    ...
    get_uiapi$ObjectLiteral.prototype.containsRx_t3ffic$ = function ($receiver, value) {
      return this.$delegate_w8povv$_0.containsRx_t3ffic$($receiver, value);
    };
  ...
  function ScreenWrap$visible$lambda$lambda$lambda$lambda(closure$fn, this$ScreenWrap) {
    return function () {
      return closure$fn() ? this$ScreenWrap.node : null;
    };
  }
  function ScreenWrap$visible$lambda(this$ScreenWrap, closure$fn) {
    return function ($receiver) {
      ...
      if ((tmp$ = this$ScreenWrap.target.invoke()) != null) {
        ...
        get_uiapi($receiver).remAssign_ah7wag$(tmp$, ScreenWrap$visible$lambda$lambda$lambda$lambda(closure$fn_0, this$ScreenWrap_0));
        tmp$_0 = Unit;
      }
       else
        tmp$_0 = null;
  ...
  ScreenWrap.prototype.visible_cskrne$ = function ($receiver, fn) {
  ...
  ViewWithForward.prototype.view_qlkmfe$ = function (prepare) {
    var tmp$, tmp$_0;
    return (tmp$_0 = (tmp$ = this.forward()) != null ? tmp$.view_qlkmfe$(prepare) : null) != null ? tmp$_0 : this.base.view_qlkmfe$(prepare);
  };
  ...
  function ForwardBase(factory) {
    ForwardImpl.call(this, factory);
  }
  ...
  function ForwardImpl(factory) {
    ViewImpl.call(this, factory.coroutineContext);
  ...
  function ViewWithForwardImpl(factory, base, forward) {
    ViewWithForwardImpl$Companion_getInstance();
    ExecImpl.call(this, factory.coroutineContext);
    this.base = base;
    this.forward = forward;
    this.forwardView_0 = ViewWithForward$Companion_getInstance().of_xdlxgs$(this.base, this.forward);
  }
  function ViewWithForwardImpl$Companion() {
    ViewWithForwardImpl$Companion_instance = this;
  }
  ViewWithForwardImpl$Companion.prototype.of_3sra6q$ = function (factory, forward) {
    return new ViewWithForwardImpl(factory, forward, forward.forward);
  };
  ViewWithForwardImpl$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var ViewWithForwardImpl$Companion_instance = null;
  function ViewWithForwardImpl$Companion_getInstance() {
    if (ViewWithForwardImpl$Companion_instance === null) {
      new ViewWithForwardImpl$Companion();
    }
    return ViewWithForwardImpl$Companion_instance;
  }
  ViewWithForwardImpl.prototype.view_qlkmfe$ = function (prepare) {
    return this.forwardView_0.view_qlkmfe$(prepare);
  };
  ViewWithForwardImpl.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ViewWithForwardImpl',
    interfaces: [JobScopeWithView, ExecImpl]
  };
  function Coroutine$fwd$lambda(closure$fn_0, this$fwd_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$fn = closure$fn_0;
    this.local$this$fwd = this$fwd_0;
    this.local$tmp$ = void 0;
    this.local$$receiver = $receiver_0;
  }
  Coroutine$fwd$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$fwd$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$fwd$lambda.prototype.constructor = Coroutine$fwd$lambda;
  Coroutine$fwd$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$tmp$ = ViewWithForwardImpl$Companion_getInstance();
            this.state_0 = 2;
            this.result_0 = this.local$closure$fn(this.local$$receiver, this.local$this$fwd, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            return this.local$tmp$.of_3sra6q$(this.local$$receiver, this.result_0);
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function fwd$lambda(closure$fn_0, this$fwd_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$fwd$lambda(closure$fn_0, this$fwd_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function fwd($receiver, fn, continuation) {
    return $receiver.withChild_p3so7j$(fwd$lambda(fn, $receiver), continuation);
  }
  function Coroutine$fwdc$lambda(closure$fn_0, this$fwdc_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$fn = closure$fn_0;
    this.local$this$fwdc = this$fwdc_0;
    this.local$$receiver = $receiver_0;
  }
  Coroutine$fwdc$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$fwdc$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$fwdc$lambda.prototype.constructor = Coroutine$fwdc$lambda;
  Coroutine$fwdc$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return ViewWithForwardImpl$Companion_getInstance().of_3sra6q$(this.local$$receiver, this.local$closure$fn(this.local$$receiver, this.local$this$fwdc));
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function fwdc$lambda(closure$fn_0, this$fwdc_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$fwdc$lambda(closure$fn_0, this$fwdc_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function fwdc($receiver, fn, continuation) {
    return $receiver.withChild_p3so7j$(fwdc$lambda(fn, $receiver), continuation);
  }
  function HasUIX() {
  }
  ...
  var of = defineInlineFunction('appsimake-commonui.commonui.widget.of_uujay0$', function ($receiver, initial, fn) {
    return $receiver.viewsOpt_3ys1gp$(initial, fn);
  });
  ...
  function ViewImpl(coroutineContext) {
    ...
    this.prepared_y04vf5$_0 = false;
  }
  ViewImpl.prototype.view_qlkmfe$ = function (prepare) {
    var v = this.rawView;
    if (!this.prepared_y04vf5$_0) {
      this.prepared_y04vf5$_0 = true;
      prepare(v);
    }
    return v;
  };
  ...
  JobSwitch.prototype.foldLater_h2yxzx$ = function (ks, z0, fn) {
    return this.current_0.foldLater_h2yxzx$(ks, z0, fn);
  };
  JobSwitch.prototype.forEach_yk5nc8$ = function (ks, fn) {
    return this.current_0.forEach_yk5nc8$(ks, fn);
  };
  JobSwitch.prototype.forEachLater_sysl1e$ = function (ks, fn) {
    return this.current_0.forEachLater_sysl1e$(ks, fn);
  };
  ...
  JobSwitch.prototype.onChange_4k9vs1$ = function (ks, fn) {
    return this.current_0.onChange_4k9vs1$(ks, fn);
  };
  ...
  function get_insert$lambda($receiver) {
    if ($receiver != null) {
      $receiver.appendChild($receiver);
    }
    return Unit;
  }
  function get_insert($receiver) {
    return (new Factory()).with_lx79ro$(get_insert$lambda);
  }
  ...
  Object.defineProperty(ViewWithForwardImpl, 'Companion', {
    get: ViewWithForwardImpl$Companion_getInstance
  });
  package$widget.ViewWithForwardImpl = ViewWithForwardImpl;
  package$widget.fwd_kg9inz$ = fwd;
  package$widget.fwdc_8pwk8e$ = fwdc;
  ...
  UiApi.prototype.containsRx_t3ffic$ = HasKillSet.prototype.containsRx_t3ffic$;
  ...
  JobKillsImpl.prototype.containsRx_t3ffic$ = HasKillSet.prototype.containsRx_t3ffic$;
