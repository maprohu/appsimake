...
this['appsimake-gymclock'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common, $module$kotlinx_coroutines_core) {
  ...
  function Coroutine$boot($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  ...
  Form$Companion.prototype.boot = function (continuation_0, suspended) {
    var instance = new Coroutine$boot(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
    ...
    do
      try {
        switch (this.state_0) {
          ...
          case 2:
            this.state_0 = 3;
            this.result_0 = Form$Companion_getInstance().boot(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
