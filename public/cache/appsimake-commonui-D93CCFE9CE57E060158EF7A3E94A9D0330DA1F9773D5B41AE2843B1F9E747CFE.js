...
this['appsimake-commonui'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_bootstrap, $module$appsimake_buildenv, $module$appsimake_domx, $module$appsimake_fontawesome, $module$kotlinx_coroutines_core, $module$appsimake_common) {
  'use strict';
  ...
  function showClosable$lambda(closure$back, closure$killables) {
    return function () {
      closure$back();
  ...
  function showClosable(page, back) {
    var killables = new Killables();
    killables.plusAssign_wii6vi$(page(showClosable$lambda(back, killables)));
    return killables;
  }
  ...
  function ToolBar$backButton$lambda$lambda$lambda(closure$fn) {
    return function (it) {
      closure$fn();
      return Unit;
    };
  }
  function ToolBar$backButton$lambda$lambda(closure$fn, this$) {
    return function ($receiver) {
      get_m1($receiver);
      get_chevronLeft(get_fa($receiver));
      clickEvent(this$, ToolBar$backButton$lambda$lambda$lambda(closure$fn));
      return Unit;
    };
  }
  function ToolBar$backButton$lambda(closure$fn) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(ToolBar$backButton$lambda$lambda(closure$fn, $receiver));
      return Unit;
    };
  }
  ...
  package$commonui.showClosable_nozcv4$ = showClosable;
  package$commonui.faButtonSpan_n55jy3$ = faButtonSpan;
  ...
  return _;
}(typeof this['appsimake-commonui'] === 'undefined' ? {} : this['appsimake-commonui'], kotlin, this['appsimake-commonshr'], this['appsimake-bootstrap'], this['appsimake-buildenv'], this['appsimake-domx'], this['appsimake-fontawesome'], this['kotlinx-coroutines-core'], this['appsimake-common']);
