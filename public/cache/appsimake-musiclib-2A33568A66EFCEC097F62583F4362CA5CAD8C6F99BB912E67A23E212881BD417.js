...
this['appsimake-musiclib'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_firebaseshr) {
  ...
  function StoreState() {
    Base.call(this);
    this.uploaded_yl0bsa$_0 = this.o.scalar_287e2$().prop_absfod$().provideDelegate_n5byny$(this, StoreState$uploaded_metadata);
    this.count_8lqj3v$_0 = this.o.scalar_287e2$().prop_absfod$().provideDelegate_n5byny$(this, StoreState$count_metadata);
  }
  ...
  function fixedArtist$lambda$lambda(this$fixedArtist) {
    return function () {
  ...
  function fixedArtist$lambda(this$fixedArtist) {
    return function () {
      return this$fixedArtist.artistfix.initial.invoke().orElse_isaiq7$(fixedArtist$lambda$lambda(this$fixedArtist));
    };
  }
  function fixedArtist($receiver) {
    return Rx_init(fixedArtist$lambda($receiver));
  }
  function fixedTitle$lambda$lambda(this$fixedTitle) {
    return function () {
  ...
  function fixedTitle$lambda(this$fixedTitle) {
    return function () {
      return this$fixedTitle.titlefix.initial.invoke().orElse_isaiq7$(fixedTitle$lambda$lambda(this$fixedTitle));
    };
  }
  function fixedTitle($receiver) {
    return Rx_init(fixedTitle$lambda($receiver));
  }
