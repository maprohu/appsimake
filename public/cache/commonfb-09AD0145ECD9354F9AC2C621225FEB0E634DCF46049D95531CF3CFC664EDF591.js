...
var commonfb = function (_, Kotlin, $module$firebase, $module$bootstrap, $module$common, $module$fontawesome) {
  ...
  function LoggedInBase(base, user) {
    this.base = base;
    this.user = user;
    this.privateRef = this.base.baseRef.collection('private').doc(this.user.uid);
  }
  LoggedInBase.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LoggedInBase',
    interfaces: []
  };
  ...
  package$commonui.LoggedInBase = LoggedInBase;
