...
this['appsimake-tictactoesw'] = function (_, Kotlin, $module$appsimake_tictactoelib, $module$appsimake_commonshr, $module$appsimake_fbmessagingsw) {
  ...
  var libMessageToClient = $module$appsimake_fbmessagingsw.fbmessagingsw.libMessageToClient_ycvucz$;
        ...
        switch (this.state_0) {
          case 0:
            ...
            if (equals(tmp$, '') || equals(tmp$, tictactoelib.GoOnline)) {
              this.state_0 = 4;
              this.result_0 = libMessageToClient(tictactoelib.tictactoeLib, tictactoelib.GoOnline, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
             else {
              if (equals(tmp$, tictactoelib.DisableNotifications)) {
                this.state_0 = 2;
                this.result_0 = libMessageToClient(tictactoelib.tictactoeLib, tictactoelib.DisableNotifications, this);
                if (this.result_0 === COROUTINE_SUSPENDED)
                  return COROUTINE_SUSPENDED;
                continue;
              }
               else {
                return console.dir(this.local$e), Unit;
              }
            }
