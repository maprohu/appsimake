...
this['appsimake-tasks'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_commonfb, $module$appsimake_taskslib, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_fontawesome, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_common, $module$appsimake_firebaseshr) {
  ...
  function viewTask$lambda$lambda$lambda$lambda(this$, closure$notesWrap, this$viewTask) {
    return function ($receiver) {
  ...
  function viewTask$lambda$lambda$lambda(this$, closure$notesWrap, this$viewTask) {
    return function ($receiver) {
      invoke(get_div($receiver), viewTask$lambda$lambda$lambda$lambda(this$, closure$notesWrap, this$viewTask));
      return Unit;
    };
  }
  function viewTask$lambda(closure$close, closure$notesWrap, this$viewTask) {
    return function ($receiver, cfg) {
      ...
      $receiver.right.invoke_gk6m2q$(viewTask$lambda$lambda$lambda(cfg, closure$notesWrap_0, this$viewTask_0));
      return Unit;
    };
  }
  ...
  function viewTask$lambda$lambda$lambda$lambda$lambda_1(it) {
    return it.name;
  }
  function viewTask$lambda$lambda$lambda$lambda_3(closure$item) {
    return function () {
      return closure$item.status.initial.invoke().map_2o04qz$(viewTask$lambda$lambda$lambda$lambda$lambda_1);
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_2(closure$notesList) {
    return function () {
  ...
  function viewTask$lambda$lambda$lambda$lambda_4(closure$notesList) {
    return function ($receiver) {
      rxDisplayed_0($receiver, viewTask$lambda$lambda$lambda$lambda$lambda_2(closure$notesList));
      get_m1(get_cls($receiver));
      $receiver.innerText = '<none>';
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_3(closure$notesList) {
    return function () {
      return !closure$notesList.isEmptyRx.invoke();
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_4(closure$notesList) {
    return function (diff) {
  ...
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$ks, closure$id, this$viewTask) {
    return function ($receiver) {
      tagBadge($receiver, closure$ks, closure$id, this$viewTask.tagSource);
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_5(this$, this$viewTask) {
    return function (id, ks) {
      return invoke(get_span(this$), viewTask$lambda$lambda$lambda$lambda$lambda$lambda_0(ks, id, this$viewTask));
    };
  }
  function viewTask$lambda$lambda$lambda$lambda_5(closure$notesList, this$, closure$item, this$viewTask) {
    return function ($receiver) {
      rxDisplayed_0($receiver, viewTask$lambda$lambda$lambda$lambda$lambda_3(closure$notesList));
      this$.killables.plusAssign_wii6vi$(diffs(closure$item.tags.initial, viewTask$lambda$lambda$lambda$lambda$lambda_4(closure$notesList)));
      listenableList($receiver, closure$notesList, this$.killables, viewTask$lambda$lambda$lambda$lambda$lambda_5($receiver, this$viewTask));
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_6(closure$st, this$viewTask) {
    return function (ks, item, close) {
      editNote(this$viewTask, ks, closure$st.panel.sub(), item, close);
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_1($receiver) {
    $receiver.desc_tixzdw$(Note.Companion.ts);
    return Unit;
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_2() {
    return new Note();
  }
  ...
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_4(it) {
    return orEmpty(it.text.initial.invoke());
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_7(closure$notesRoot, closure$notesWrap, this$viewTask) {
    return function (show) {
      return new ListUIConfig(closure$notesRoot, new Var(query(closure$notesWrap, this$viewTask.db, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_1)), closure$notesWrap, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_2, void 0, void 0, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_3, void 0, void 0, stringListClick(viewTask$lambda$lambda$lambda$lambda$lambda$lambda_4, show));
    };
  }
  function viewTask$lambda$lambda$lambda$lambda_6(this$, closure$st, this$viewTask, closure$notesWrap) {
    return function ($receiver) {
      ...
      showClosableList(this$.killables, this$.redisplay, viewTask$lambda$lambda$lambda$lambda$lambda_6(closure$st, this$viewTask), viewTask$lambda$lambda$lambda$lambda$lambda_7(notesRoot, closure$notesWrap, this$viewTask));
      return Unit;
    };
  }
  ...
  function viewTask($receiver, ks, panel, task, close) {
    ...
    build_1(new ViewScreenConfig('Task', getCallableRef('editTask', function ($receiver, killables, panel, task, close) {
      return editTask($receiver, killables, panel, task, close), Unit;
    }.bind(null, $receiver)), viewTask$lambda(close, notesWrap, $receiver), viewTask$lambda_0($receiver, notesWrap)), ks, panel, task, close);
  }
