...
this['appsimake-checklistlib'] = function (_, Kotlin, $module$appsimake_commonshr) {
  ...
  function Checklist() {
    ...
    RxBase.call(this);
    this.name_4e5ndt$_0 = this.o.string_61zpoe$().provideDelegate_n5byny$(this, Checklist$name_metadata);
  ...
  function ChecklistItem() {
    RxBase.call(this);
    this.name_6g0rzi$_0 = this.o.string_61zpoe$().provideDelegate_n5byny$(this, ChecklistItem$name_metadata);
    this.checked_cs55tc$_0 = this.o.boolean_6taknv$().provideDelegate_n5byny$(this, ChecklistItem$checked_metadata);
  }
  ...
  package$checklist.get_checklists_x4imip$ = get_checklists;
