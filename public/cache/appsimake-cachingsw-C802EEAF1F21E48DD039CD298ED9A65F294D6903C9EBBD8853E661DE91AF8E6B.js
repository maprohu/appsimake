...
this['appsimake-cachingsw'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_buildenv, $module$kotlinx_coroutines_core, $module$appsimake_indexeddb) {
  ...
  function Coroutine$main$lambda$lambda(closure$cc_0, $receiver_0, controller, continuation_0) {
  ...
  function main$lambda$lambda(closure$cc_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$main$lambda$lambda(closure$cc_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
  ...
  function Coroutine$main$lambda$lambda_0(closure$event_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
  ...
  function main$lambda$lambda_0(closure$event_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$main$lambda$lambda_0(closure$event_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$main$lambda$lambda_1(closure$cc_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$cc = closure$cc_0;
    ...
    do
      try {
        switch (this.state_0) {
          ...
          case 2:
            this.local$cache = this.result_0;
            var $receiver = get_indexedDB(self).open('appsimake-cache');
  ...
  function main$lambda$lambda_1(closure$cc_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$main$lambda$lambda_1(closure$cc_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  ReferenceCountStore = named(ReferenceCountStore$lambda).provideDelegate_n5byny$(this, ReferenceCountStore_metadata);
  ModuleResourcesStore = named(ModuleResourcesStore$lambda).provideDelegate_n5byny$(this, ModuleResourcesStore_metadata);
  main([]);
