...
this['appsimake-domx'] = function (_, Kotlin, $module$appsimake_common) {
  'use strict';
  ...
  var lazyNamed = $module$appsimake_common.common.lazyNamed_cq6yhu$;
  ...
  function checkbox($receiver, fn) {
    return input($receiver, checkbox$lambda(fn));
  }
  function pointerEventsNone($receiver) {
    get_classes($receiver).plusAssign_61zpoe$(get_pointerEventsNone());
  }
  ...
  function form($receiver, fn) {
    if (fn === void 0)
      fn = form$lambda;
    return tag($receiver, 'form', fn);
  }
  ...
  var pointerEventsNone_0;
  function get_pointerEventsNone() {
    return pointerEventsNone_0.value;
  }
  ...
  function cls(txt) {
    return lazyNamed(cls$lambda(txt));
  }
  var SvgNS;
  ...
  package$domx.pointerEventsNone_ejp6nk$ = pointerEventsNone;
  ...
  pointerEventsNone_0 = lazy(pointerEventsNone$lambda);
  ...
  return _;
}(typeof this['appsimake-domx'] === 'undefined' ? {} : this['appsimake-domx'], kotlin, this['appsimake-common']);
