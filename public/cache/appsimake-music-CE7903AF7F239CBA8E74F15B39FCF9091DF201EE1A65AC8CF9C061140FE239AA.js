...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_commonshr, $module$appsimake_indexeddb, $module$appsimake_musiclib, $module$appsimake_common, $module$appsimake_firebaseshr, $module$appsimake_commonlib, $module$appsimake_commonfb, $module$appsimake_firebase) {
  ...
  function main$lambda$ObjectLiteral$loggedIn$lambda$lambda() {
    return new UserSong();
  }
  function main$lambda$ObjectLiteral$loggedIn$lambda$lambda_0() {
    return new Mp3File();
  }
  function main$lambda$ObjectLiteral$loggedIn$lambda$lambda_1() {
    return new StoreState();
  }
  function Coroutine$main$lambda$ObjectLiteral$loggedIn$lambda(closure$user_0, closure$fbCtx_0, closure$ks_0, closure$idb_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 2;
            this.result_0 = toSetSource_0(get_usersongs(get_private(musiclib.music.app).doc_61zpoe$(uid)), this.local$closure$ks, this.local$db, main$lambda$ObjectLiteral$loggedIn$lambda$lambda, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 2:
            ...
            this.state_0 = 3;
            this.result_0 = toSetSource_0(get_songs(musiclib.music.app), this.local$closure$ks, this.local$db, main$lambda$ObjectLiteral$loggedIn$lambda$lambda_0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
            ...
            this.state_0 = 4;
            this.result_0 = toSetSource_0(get_storage(musiclib.music.app), this.local$closure$ks, this.local$db, main$lambda$ObjectLiteral$loggedIn$lambda$lambda_1, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
  ...
  function main$lambda$ObjectLiteral$loggedIn$lambda(closure$user_0, closure$fbCtx_0, closure$ks_0, closure$idb_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$main$lambda$ObjectLiteral$loggedIn$lambda(closure$user_0, closure$fbCtx_0, closure$ks_0, closure$idb_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  main$lambda$ObjectLiteral.prototype.loggedIn_v1eir6$ = function (user) {
    ...
    launch(coroutines.GlobalScope, void 0, void 0, main$lambda$ObjectLiteral$loggedIn$lambda(user, this.closure$fbCtx, ks, this.closure$idb));
    return ks;
  };
