...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_fontawesome, $module$appsimake_domx, $module$appsimake_bootstrap) {
  ...
  var updateNotificationState = $module$appsimake_commonui.commonui.updateNotificationState;
  ...
  var NotificationState = $module$appsimake_commonui.commonui.NotificationState;
  ...
  function MessagingControl(deps, fcm) {
    ...
    this.enabledNonLocalTokens = this.rx_y6x17j$(MessagingControl$enabledNonLocalTokens$lambda(this));
    this.isGranted = this.rx_y6x17j$(MessagingControl$isGranted$lambda);
    this.notificationsEnabled = this.rx_y6x17j$(MessagingControl$notificationsEnabled$lambda(this));
  ...
  function MessagingControl$enabledNonLocalTokens$lambda(this$MessagingControl) {
    return function ($receiver) {
      var $receiver_0 = this$MessagingControl.enabledTokens.invoke();
      var destination = ArrayList_init();
      var tmp$;
      tmp$ = $receiver_0.iterator();
      while (tmp$.hasNext()) {
        var element = tmp$.next();
        var this$MessagingControl_0 = this$MessagingControl;
        if (!equals(get_idOrFail(element), this$MessagingControl_0.deviceId))
          destination.add_11rb$(element);
      }
      return destination;
    };
  }
  function MessagingControl$isGranted$lambda($receiver) {
    return equals(commonui.notificationState.invoke(), NotificationState.Granted);
  }
  function MessagingControl$notificationsEnabled$lambda(this$MessagingControl) {
    return function ($receiver) {
      return this$MessagingControl.isGranted.invoke() && this$MessagingControl.enabledLocalToken.invoke();
    };
  }
  function MessagingControl$canEnable$lambda(this$MessagingControl) {
    return function ($receiver) {
      var tmp$ = this$MessagingControl.fcmSupported;
      if (tmp$) {
        var ns = commonui.notificationState.invoke();
        tmp$ = equals(ns, NotificationState.Supported) || equals(ns, NotificationState.Granted);
      }
      return tmp$ && !this$MessagingControl.enabledLocalToken.invoke();
    };
  }
  ...
  function Coroutine$MessagingControl_init$lambda$lambda(this$MessagingControl_0, this$_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$MessagingControl = this$MessagingControl_0;
    this.local$this$ = this$_0;
  ...
  function MessagingControl_init$lambda$lambda(this$MessagingControl_0, this$_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$MessagingControl_init$lambda$lambda(this$MessagingControl_0, this$_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function MessagingControl_init$lambda(this$MessagingControl) {
    return function ($receiver) {
      launchReport(CsKills_init($receiver), MessagingControl_init$lambda$lambda(this$MessagingControl, $receiver));
      return Unit;
    };
  }
  ...
  function messagingButton$lambda$lambda$unsupported$lambda($receiver) {
    var $receiver_0 = get_cls($receiver);
    get_m1($receiver_0);
  ...
  function messagingButton$lambda$lambda$unsupported() {
    return invoke(get_div(document), messagingButton$lambda$lambda$unsupported$lambda);
  }
  function messagingButton$lambda$lambda$lambda$lambda($receiver) {
    var $receiver_0 = get_cls($receiver);
    get_m1($receiver_0);
    get_textMuted($receiver_0);
    get_textJustify($receiver_0);
  ...
  function messagingButton$lambda$lambda$lambda$lambda$lambda$lambda(this$) {
    return function () {
      this$.messaging.disableNotifications();
      return Unit;
    };
  }
  function messagingButton$lambda$lambda$lambda$lambda$lambda$lambda_0(this$) {
    return function () {
      this$.messaging.enableNotifications();
      return Unit;
    };
  ...
  function messagingButton$lambda$lambda(this$, closure$deps) {
    return function () {
      var unsupported = messagingButton$lambda$lambda$unsupported;
      if (!this$.messaging.fcmSupported) {
        return unsupported();
      }
       else {
        var $receiver = commonui.notificationState.invoke();
        var this$_0 = this$;
        var closure$deps_0 = closure$deps;
        var block$result;
        if (equals($receiver, NotificationState.Unsupported)) {
          block$result = unsupported();
        }
         else if (equals($receiver, NotificationState.Denied)) {
          block$result = invoke(get_div(document), messagingButton$lambda$lambda$lambda$lambda);
        }
         else {
          var block$result_0;
          if (this$_0.messaging.notificationsEnabled.invoke()) {
            var $receiver_0 = widget.factory.button;
            $receiver_0.m1p2;
            $receiver_0.secondary;
            remAssign_0($receiver_0.text, 'Notifications Enabled');
            get_comment($receiver_0.icon.fa);
            $receiver_0.iconAndText;
            click_0($receiver_0, closure$deps_0, messagingButton$lambda$lambda$lambda$lambda$lambda$lambda(this$_0));
            block$result_0 = $receiver_0.node;
          }
           else {
            var $receiver_1 = widget.factory.button;
            $receiver_1.m1p2;
            $receiver_1.secondary;
            remAssign_0($receiver_1.text, 'Notifications Disabled');
            get_commentSlash($receiver_1.icon.fa);
            $receiver_1.iconAndText;
            click_0($receiver_1, closure$deps_0, messagingButton$lambda$lambda$lambda$lambda$lambda$lambda_0(this$_0));
            block$result_0 = $receiver_1.node;
          }
          block$result = block$result_0;
        }
        return block$result;
      }
    };
