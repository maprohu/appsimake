...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_firebaseshr, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common) {
  'use strict';
  ...
  var docRef_0 = $module$appsimake_firebase.firebase.firestore.docRef_ek09gi$;
  ...
  var collectionRef = $module$appsimake_firebase.firebase.firestore.collectionRef_h36x4c$;
  ...
  var rxClass = $module$appsimake_commonshr.rx.rxClass_6yki6o$;
  ...
  DbKillsApiCommonfb.prototype.rxEditing_pc5ddi$ = function (initial, preSave) {
    return rxEditing(this, initial, preSave);
  };
  ...
  function CsDbKillsApiCommonfb() {
  }
  CsDbKillsApiCommonfb.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'CsDbKillsApiCommonfb',
  ...
  function Coroutine$rxEditing$lambda(closure$preSave_0, closure$initial_0, closure$deps_0, current_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
  ...
  function rxEditing$lambda(closure$preSave_0, closure$initial_0, closure$deps_0) {
    return function (current_0, continuation_0, suspended) {
      var instance = new Coroutine$rxEditing$lambda(closure$preSave_0, closure$initial_0, closure$deps_0, current_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function rxEditing(deps, initial, preSave) {
    return new RxEditing(initial.doc, deps.kills, rxEditing$lambda(preSave, initial, deps));
  }
  ...
  function tabsConfig$lambda_0(closure$active, closure$ks, closure$nodes) {
    return function ($receiver) {
      ...
      closure$active.forEach_aaomyj$(closure$ks, tabsConfig$lambda$lambda_0(root, closure$nodes));
      return Unit;
    };
  }
  ...
  function build$lambda_3(closure$item, closure$db) {
    return function ($receiver) {
      ...
      return Kotlin.isType($receiver_0, IdState$Persisted) ? docRef_0($receiver_0.id, closure$db_0) : null;
    };
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = await_0(docRef_0(this.local$closure$item.props.docWrapOrFail, this.local$closure$db).delete(), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function build($receiver, ks, panel, item, close, db) {
    ...
    docRefOpt.forEach_aaomyj$(ks, build$lambda_4(idListenerSeq, isSaving));
  ...
  function listenToSnapshots($receiver, killables, db, onFirst) {
    ...
    listen(docRef_0($receiver.props.docWrapOrFail, new DbDeps(db)), $receiver, onFirst);
  }
  ...
  package$commonfb.CsDbKillsApiCommonfb = CsDbKillsApiCommonfb;
  ...
  package$editing.rxEditing_is85ku$ = rxEditing;
  ...
  package$commonfb.build_1ts7pv$ = build;
  ...
  DbKillsApiCommonfb.prototype.get_randomDoc_9jwep6$ = DbKillsApi.prototype.get_randomDoc_9jwep6$;
  DbKillsApiCommonfb.prototype.get_ref_9jwep6$ = DbKillsApi.prototype.get_ref_9jwep6$;
  DbKillsApiCommonfb.prototype.get_ref_lysoy0$ = DbKillsApi.prototype.get_ref_lysoy0$;
  ...
  DbKillsApiCommonfb.prototype.map_1mq1ue$ = DbKillsApi.prototype.map_1mq1ue$;
  ...
  DbKillsApiCommonfb.prototype.query_mixq7r$$default = DbKillsApi.prototype.query_mixq7r$$default;
  ...
  DbKillsApiCommonfb.prototype.toRandomFsDoc_t7liao$ = DbKillsApi.prototype.toRandomFsDoc_t7liao$;
  DbKillsApiCommonfb.prototype.toRxSet_jr4bl4$ = DbKillsApi.prototype.toRxSet_jr4bl4$;
  DbKillsApiCommonfb.prototype.query_mixq7r$ = DbKillsApi.prototype.query_mixq7r$;
  CsDbKillsApiCommonfb.prototype.get_live_73z9b6$ = CsDbKillsApi.prototype.get_live_73z9b6$;
  CsDbKillsApiCommonfb.prototype.get_randomDoc_9jwep6$ = CsDbKillsApi.prototype.get_randomDoc_9jwep6$;
  CsDbKillsApiCommonfb.prototype.get_ref_9jwep6$ = CsDbKillsApi.prototype.get_ref_9jwep6$;
  CsDbKillsApiCommonfb.prototype.get_ref_lysoy0$ = CsDbKillsApi.prototype.get_ref_lysoy0$;
  CsDbKillsApiCommonfb.prototype.get_snapshots_5bfeyi$ = CsDbKillsApi.prototype.get_snapshots_5bfeyi$;
  CsDbKillsApiCommonfb.prototype.rx_y6x17j$ = CsDbKillsApi.prototype.rx_y6x17j$;
  CsDbKillsApiCommonfb.prototype.rx_46ic4w$ = CsDbKillsApi.prototype.rx_46ic4w$;
  CsDbKillsApiCommonfb.prototype.containsRx_1w65cx$ = CsDbKillsApi.prototype.containsRx_1w65cx$;
  CsDbKillsApiCommonfb.prototype.delete_73z9b6$ = CsDbKillsApi.prototype.delete_73z9b6$;
  CsDbKillsApiCommonfb.prototype.docs_om34f8$ = CsDbKillsApi.prototype.docs_om34f8$;
  CsDbKillsApiCommonfb.prototype.documentChanges_z2kgpb$ = CsDbKillsApi.prototype.documentChanges_z2kgpb$;
  CsDbKillsApiCommonfb.prototype.events_9fvrrk$ = CsDbKillsApi.prototype.events_9fvrrk$;
  CsDbKillsApiCommonfb.prototype.filtered_tnde95$ = CsDbKillsApi.prototype.filtered_tnde95$;
  CsDbKillsApiCommonfb.prototype.forEach_xwzbbo$ = CsDbKillsApi.prototype.forEach_xwzbbo$;
  CsDbKillsApiCommonfb.prototype.forEach_35q7bt$ = CsDbKillsApi.prototype.forEach_35q7bt$;
  CsDbKillsApiCommonfb.prototype.listEvents_e847ux$$default = CsDbKillsApi.prototype.listEvents_e847ux$$default;
  CsDbKillsApiCommonfb.prototype.listEvents_ghesau$ = CsDbKillsApi.prototype.listEvents_ghesau$;
  CsDbKillsApiCommonfb.prototype.listEvents_1nmm22$ = CsDbKillsApi.prototype.listEvents_1nmm22$;
  CsDbKillsApiCommonfb.prototype.map_1mq1ue$ = CsDbKillsApi.prototype.map_1mq1ue$;
  CsDbKillsApiCommonfb.prototype.map_jtxi0h$ = CsDbKillsApi.prototype.map_jtxi0h$;
  CsDbKillsApiCommonfb.prototype.onChange_rlu5c6$ = CsDbKillsApi.prototype.onChange_rlu5c6$;
  CsDbKillsApiCommonfb.prototype.process_7xi3v7$ = CsDbKillsApi.prototype.process_7xi3v7$;
  CsDbKillsApiCommonfb.prototype.query_mixq7r$$default = CsDbKillsApi.prototype.query_mixq7r$$default;
  CsDbKillsApiCommonfb.prototype.remAssign_7fncnf$ = CsDbKillsApi.prototype.remAssign_7fncnf$;
  CsDbKillsApiCommonfb.prototype.remAssign_ah7wag$ = KillsApiCommonui.prototype.remAssign_ah7wag$;
  CsDbKillsApiCommonfb.prototype.rxClass_c5yvvx$ = CsDbKillsApi.prototype.rxClass_c5yvvx$;
  CsDbKillsApiCommonfb.prototype.rxClass_6sflyw$ = CsDbKillsApi.prototype.rxClass_6sflyw$;
  CsDbKillsApiCommonfb.prototype.rxClass_9npl0m$ = KillsApiCommonui.prototype.rxClass_9npl0m$;
  CsDbKillsApiCommonfb.prototype.save_73z9b6$ = CsDbKillsApi.prototype.save_73z9b6$;
  CsDbKillsApiCommonfb.prototype.toChannelLater_z5dyp2$ = CsDbKillsApi.prototype.toChannelLater_z5dyp2$;
  CsDbKillsApiCommonfb.prototype.toRandomFsDoc_t7liao$ = CsDbKillsApi.prototype.toRandomFsDoc_t7liao$;
  CsDbKillsApiCommonfb.prototype.toRx_on0lyu$ = CsDbKillsApi.prototype.toRx_on0lyu$;
  CsDbKillsApiCommonfb.prototype.toRxSet_jr4bl4$ = CsDbKillsApi.prototype.toRxSet_jr4bl4$;
  CsDbKillsApiCommonfb.prototype.toSnapshotEvents_ecp0ut$ = CsDbKillsApi.prototype.toSnapshotEvents_ecp0ut$;
  CsDbKillsApiCommonfb.prototype.rxEditing_pc5ddi$ = DbKillsApiCommonfb.prototype.rxEditing_pc5ddi$;
  CsDbKillsApiCommonfb.prototype.click_3xepc3$ = UixApi.prototype.click_3xepc3$;
  CsDbKillsApiCommonfb.prototype.click_ka8ib0$ = UixApi.prototype.click_ka8ib0$;
  CsDbKillsApiCommonfb.prototype.click_b0jn9q$ = UixApi.prototype.click_b0jn9q$;
  CsDbKillsApiCommonfb.prototype.click_htd9kn$ = UixApi.prototype.click_htd9kn$;
  CsDbKillsApiCommonfb.prototype.signOut_7wq8x$ = UixApi.prototype.signOut_7wq8x$;
  CsDbKillsApiCommonfb.prototype.list_u1uvxv$ = CsApiCommonui.prototype.list_u1uvxv$;
  CsDbKillsApiCommonfb.prototype.enabled_y5ufnr$ = KillsApiCommonui.prototype.enabled_y5ufnr$;
  CsDbKillsApiCommonfb.prototype.on_2stdkb$ = KillsApiCommonui.prototype.on_2stdkb$;
  CsDbKillsApiCommonfb.prototype.on_hgi4ad$ = KillsApiCommonui.prototype.on_hgi4ad$;
  CsDbKillsApiCommonfb.prototype.visibility_dakdiv$ = KillsApiCommonui.prototype.visibility_dakdiv$;
  CsDbKillsApiCommonfb.prototype.listEvents_e847ux$ = CsDbKillsApi.prototype.listEvents_e847ux$;
  CsDbKillsApiCommonfb.prototype.query_mixq7r$ = CsDbKillsApi.prototype.query_mixq7r$;
  Kotlin.defineModule('appsimake-commonfb', _);
  return _;
}(typeof this['appsimake-commonfb'] === 'undefined' ? {} : this['appsimake-commonfb'], kotlin, this['appsimake-commonshr'], this['appsimake-firebase'], this['appsimake-commonui'], this['kotlinx-coroutines-core'], this['appsimake-firebaseshr'], this['appsimake-domx'], this['appsimake-bootstrap'], this['appsimake-fontawesome'], this['appsimake-common']);
