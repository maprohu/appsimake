...
if (typeof this['appsimake-commonlib'] === 'undefined') {
  throw new Error("Error loading module 'appsimake-taskslib'. Its dependency 'appsimake-commonlib' was not found. Please, check whether 'appsimake-commonlib' is loaded prior to 'appsimake-taskslib'.");
}
...
this['appsimake-taskslib'] = function (_, Kotlin, $module$appsimake_commonlib, $module$appsimake_commonshr, $module$appsimake_firebaseshr) {
  'use strict';
  ...
  var coll = $module$appsimake_commonlib.commonlib.coll_287e2$;
  ...
  function Task() {
    ...
    this.status_xo655i$_0 = this.o.scalar_287e2$().map_4zme6a$(PropFactory$enum$lambda_0(TaskStatus, Kotlin.isInstanceOf(TaskStatus)), PropFactory$enum$lambda).withDefault_11rc$(TaskStatus$New_getInstance()).mandatory().prop_2nq2ks$().provideDelegate_n5byny$(this, Task$status_metadata);
    ...
    this.tagsx_f0qbpp$_0 = toSet(this.o.array_287e2$()).calculated_bc07mh$(Task$tagsx$lambda$lambda(this)).prop_2nq2ks$().provideDelegate_n5byny$(this, Task$tagsx_metadata);
  }
  ...
  function Task$completed$lambda(this$Task) {
    return function (it) {
      return lazyOf(this$Task.status.current.now.map_2o04qz$(Task$completed$lambda$lambda));
    };
  }
  var collectionSizeOrDefault = Kotlin.kotlin.collections.collectionSizeOrDefault_ba2ldo$;
  var ArrayList_init_0 = Kotlin.kotlin.collections.ArrayList_init_ww73n8$;
  function Task$tagsx$lambda$lambda$lambda$lambda(ts) {
  ...
  function Task$tagsx$lambda$lambda$lambda(closure$t) {
    return function () {
      return closure$t.map_2o04qz$(Task$tagsx$lambda$lambda$lambda$lambda);
    };
  }
  function Task$tagsx$lambda$lambda(this$) {
    return function (it) {
      var t = this$.tags.current.invoke();
      return lazy(Task$tagsx$lambda$lambda$lambda(t));
    };
  }
  Task.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function Note() {
    ...
    this.ts_etvhbe$_0 = this.o.scalar_287e2$().withDefault_skz6mo$(Note$ts$lambda).prop_2nq2ks$().provideDelegate_n5byny$(this, Note$ts_metadata);
  }
  ...
  function Note$ts$lambda() {
    return firebaseshr.ops.serverTimestamp();
  }
  Note.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Note',
  ...
  package$taskslib.get_tasks_kpytd$ = get_tasks_0;
  package$taskslib.get_usertags_kpytd$ = get_usertags;
  package$taskslib.get_notes_ycv2h8$ = get_notes;
  ...
  return _;
}(typeof this['appsimake-taskslib'] === 'undefined' ? {} : this['appsimake-taskslib'], kotlin, this['appsimake-commonlib'], this['appsimake-commonshr'], this['appsimake-firebaseshr']);
