...
var tictactoe = function (_, Kotlin, $module$bootstrap, $module$domx, $module$common, $module$firebase, $module$kotlinx_coroutines_core, $module$commonfb, $module$commonui) {
  ...
  function playfieldUI$lambda_2(closure$killables, closure$tableRatio, closure$board, closure$turn) {
    return function ($receiver) {
  ...
  function playfieldUI$lambda_3(closure$gameOverStates, closure$turn) {
    return function () {
  ...
  function playfieldUI$lambda_4(closure$process) {
    return function (qs) {
      var $receiver = qs.docChanges();
      var destination = ArrayList_init_0();
      var tmp$;
  ...
  function playfieldUI$lambda_5(closure$killables, closure$stopListening, this$playfieldUI) {
    return function () {
      closure$killables.kill();
  ...
  function playfieldUI($receiver) {
    ...
    $receiver.root.newRoot_iw61es$(playfieldUI$lambda_2(killables, tableRatio, board, turn));
    var gameOverStates = setOf([Turn$Won_getInstance(), Turn$Lost_getInstance(), Turn$Draw_getInstance(), Turn$Alone_getInstance()]);
    var isOver = Rx_init(playfieldUI$lambda_3(gameOverStates, turn));
    ...
    })), playfieldUI$lambda_4(process));
    return playfieldUI$lambda_5(killables, stopListening, $receiver);
  }
