...
this['appsimake-commonui'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$kotlinx_coroutines_core, $module$appsimake_buildenv, $module$appsimake_bootstrap, $module$appsimake_common, $module$appsimake_fontawesome) {
  ...
  var get_uiapi = defineInlineFunction('appsimake-commonui.commonui.get_uiapi_mighe9$', wrapFunction(function () {
    ...
    var UiKillsApi = _.commonui.UiKillsApi;
    get_uiapi$ObjectLiteral.prototype.remAssign_ah7wag$ = UiKillsApi.prototype.remAssign_ah7wag$;
    get_uiapi$ObjectLiteral.prototype.visibility_dakdiv$ = UiKillsApi.prototype.visibility_dakdiv$;
    get_uiapi$ObjectLiteral.prototype.rxEnabled_y5ufnr$ = UiKillsApi.prototype.rxEnabled_y5ufnr$;
    ...
    get_uiapi$ObjectLiteral.prototype.toChannelLater_z5dyp2$ = function ($receiver) {
      return this.$delegate_w8povv$_0.toChannelLater_z5dyp2$($receiver);
    };
    ...
    get_uiapi$ObjectLiteral.$metadata$ = {
      kind: Kind_CLASS,
      interfaces: [UiKillsApi, HasKillSet]
    };
  ...
  UiKillsApi.prototype.visibility_dakdiv$ = function ($receiver, fn) {
    return visibility($receiver, this.kills, fn);
  };
  UiKillsApi.prototype.rxEnabled_y5ufnr$ = function ($receiver, fn) {
    rxEnabled($receiver.node, this.kills, fn);
  };
  function UiKillsApi$remAssign$lambda(closure$fn) {
    return function ($receiver) {
      return closure$fn();
    };
  }
  function UiKillsApi$remAssign$lambda_0(this$remAssign) {
    return function ($receiver, it) {
      this$remAssign(it);
      return Unit;
    };
  }
  UiKillsApi.prototype.remAssign_ah7wag$ = function ($receiver, fn) {
    this.forEach_5mel8p$(this.rx_pn7ch0$(UiKillsApi$remAssign$lambda(fn)), UiKillsApi$remAssign$lambda_0($receiver));
  };
  UiKillsApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'UiKillsApi',
    interfaces: [InvokeWith, HasKillSet]
  };
  function UiCoroutinesApi() {
  }
  UiCoroutinesApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'UiCoroutinesApi',
    interfaces: [NodeListApi]
  };
  function UiApi() {
  }
  UiApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'UiApi',
    interfaces: [UiCoroutinesApi, UiKillsApi]
  };
  ...
  NodeListApi.prototype.list_u1uvxv$ = function ($receiver, nodes) {
    nodeList(this, $receiver, nodes);
  };
  NodeListApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'NodeListApi',
    interfaces: [CoroutineScope]
  };
  function Coroutine$nodeList$lambda(closure$nodes_0, closure$target_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
        ...
        switch (this.state_0) {
          ...
          case 5:
            ...
            if (Kotlin.isType(e_0, ListEvent$Add))
              insertAt(this.local$closure$target, e_0.index, e_0.item);
            else if (Kotlin.isType(e_0, ListEvent$Move))
              insertAt(this.local$closure$target, e_0.to, removeAt(this.local$closure$target, e_0.from));
            else if (Kotlin.isType(e_0, ListEvent$Remove))
              removeAt(this.local$closure$target, e_0.index);
            else
  ...
  function nodeList$lambda(closure$nodes_0, closure$target_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$nodeList$lambda(closure$nodes_0, closure$target_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function nodeList($receiver, target, nodes) {
    if (!!target.hasChildNodes()) {
      var message = 'List container node must be empty!';
      throw IllegalArgumentException_init(message.toString());
    }
    launch($receiver, void 0, void 0, nodeList$lambda(nodes, target));
  }
  ...
  function ui$lambda$lambda$lambda() {
  ...
  function ui$lambda$lambda_0(this$ui) {
    return function ($receiver) {
      ...
      this$ui.remAssign_7fncnf$($receiver, ui$lambda$lambda$lambda);
      return Unit;
    };
  }
  function ui$lambda(this$ui) {
    return function ($receiver) {
      ...
      invoke(get_div(get_insert($receiver).wraps.div_iw61es$(ui$lambda$lambda).node), ui$lambda$lambda_0(this$ui));
      return Unit;
    };
  }
  function ui($receiver) {
    return factory.wraps.div_iw61es$(ui$lambda($receiver)).node;
  }
  ...
  function Body(slot) {
    ...
    this.content = JobSwitch$Companion_getInstance().jobWithView_x14k2b$(ItemWithViewRx$Companion_getInstance().hasView_tmlb55$(new Progress(this)));
  ...
  DropdownMenu.prototype.signOut_vzdl2z$ = function ($receiver, action) {
    var $receiver_0 = this.item;
    $receiver_0.text.remAssign_61zpoe$('Sign Out');
    get_signOutAlt($receiver_0.fa);
    $receiver.click_ka8ib0$($receiver_0, action);
    return $receiver_0;
  };
  ...
  ForwardImpl.$metadata$ = {
    ...
    interfaces: [HasKillSetAndUIX, ViewImplBase]
  };
  ...
  function HasKillSetAndUIX() {
  }
  HasKillSetAndUIX.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasKillSetAndUIX',
    interfaces: [HasKillSet, HasUIX]
  };
  function plus$ObjectLiteral(this$plus, closure$ks) {
    this.uix_vtss6a$_0 = this$plus.uix;
    this.kills_wkubov$_0 = closure$ks.kills;
  }
  Object.defineProperty(plus$ObjectLiteral.prototype, 'uix', {
    get: function () {
      return this.uix_vtss6a$_0;
    }
  });
  Object.defineProperty(plus$ObjectLiteral.prototype, 'kills', {
    get: function () {
      return this.kills_wkubov$_0;
    }
  });
  plus$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [HasKillSetAndUIX]
  };
  function plus_0($receiver, ks) {
    return new plus$ObjectLiteral($receiver, ks);
  }
  function Hourglass() {
    ScreenWrap.call(this);
  ...
  function Coroutine$mapAsync_qco7w4$($this, $receiver_0, fn_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  ...
  Coroutine$mapAsync_qco7w4$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$mapAsync_qco7w4$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$mapAsync_qco7w4$.prototype.constructor = Coroutine$mapAsync_qco7w4$;
  Coroutine$mapAsync_qco7w4$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  JobKillsApi.prototype.mapAsync_qco7w4$ = function ($receiver_0, fn_0, continuation_0, suspended) {
    var instance = new Coroutine$mapAsync_qco7w4$(this, $receiver_0, fn_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  function Loading() {
    ...
    setupFullScreen();
    globalStatus.forEach_yk5nc8$(this.ks.killSet, Loading_init$lambda(this));
  }
  ...
  JobScope.prototype.get_childUIWrap_irb06o$ = function ($receiver) {
  ...
  JobKillsImpl.$metadata$ = {
    ...
    interfaces: [JobKillsApi, UiApi, HasKillSet, JobScopeImpl]
  };
  ...
  Status.prototype.get_global_mighe9$ = function ($receiver) {
  ...
  package$commonui.UiKillsApi = UiKillsApi;
  package$commonui.get_uiapi_mighe9$ = get_uiapi;
  package$commonui.UiCoroutinesApi = UiCoroutinesApi;
  ...
  package$commonui.keepScreenAwake_mighe9$ = keepScreenAwake;
  ...
  package$commonui.NodeListApi = NodeListApi;
  package$commonui.nodeList_eb6zt3$ = nodeList;
  ...
  package$widget.HasKillSetAndUIX = HasKillSetAndUIX;
  package$widget.plus_7510hi$ = plus_0;
  ...
  package$widget.UIWrap_init_i8ai6l$ = UIWrap_init;
  package$widget.UIWrap = UIWrap;
  package$widget.childUIWrap_wilzf4$ = childUIWrap;
  ...
  package$widget.switchToView_t9xs9u$ = switchToView;
  ...
  UiKillsApi.prototype.remAssign_7fncnf$ = HasKillSet.prototype.remAssign_7fncnf$;
  UiKillsApi.prototype.rx_pn7ch0$ = HasKillSet.prototype.rx_pn7ch0$;
  UiKillsApi.prototype.rx_rf89m5$ = HasKillSet.prototype.rx_rf89m5$;
  UiKillsApi.prototype.containsRx_1w65cx$ = HasKillSet.prototype.containsRx_1w65cx$;
  UiKillsApi.prototype.filtered_49l5s4$ = HasKillSet.prototype.filtered_49l5s4$;
  UiKillsApi.prototype.forEach_5mel8p$ = HasKillSet.prototype.forEach_5mel8p$;
  UiKillsApi.prototype.forEach_igkruk$ = HasKillSet.prototype.forEach_igkruk$;
  UiKillsApi.prototype.map_i8ud5a$ = HasKillSet.prototype.map_i8ud5a$;
  UiKillsApi.prototype.onChange_ocsf2x$ = HasKillSet.prototype.onChange_ocsf2x$;
  UiKillsApi.prototype.process_ttzep4$ = HasKillSet.prototype.process_ttzep4$;
  UiKillsApi.prototype.rxClass_wqb4ha$ = HasKillSet.prototype.rxClass_wqb4ha$;
  UiKillsApi.prototype.rxClass_mjd6u9$ = HasKillSet.prototype.rxClass_mjd6u9$;
  UiKillsApi.prototype.toChannelLater_z5dyp2$ = HasKillSet.prototype.toChannelLater_z5dyp2$;
  UiKillsApi.prototype.toRxSet_jr4bl4$ = HasKillSet.prototype.toRxSet_jr4bl4$;
  UiCoroutinesApi.prototype.list_u1uvxv$ = NodeListApi.prototype.list_u1uvxv$;
  UiApi.prototype.visibility_dakdiv$ = UiKillsApi.prototype.visibility_dakdiv$;
  UiApi.prototype.rxEnabled_y5ufnr$ = UiKillsApi.prototype.rxEnabled_y5ufnr$;
  UiApi.prototype.remAssign_ah7wag$ = UiKillsApi.prototype.remAssign_ah7wag$;
  UiApi.prototype.remAssign_7fncnf$ = UiKillsApi.prototype.remAssign_7fncnf$;
  UiApi.prototype.rx_pn7ch0$ = UiKillsApi.prototype.rx_pn7ch0$;
  UiApi.prototype.rx_rf89m5$ = UiKillsApi.prototype.rx_rf89m5$;
  UiApi.prototype.containsRx_1w65cx$ = UiKillsApi.prototype.containsRx_1w65cx$;
  UiApi.prototype.filtered_49l5s4$ = UiKillsApi.prototype.filtered_49l5s4$;
  UiApi.prototype.forEach_5mel8p$ = UiKillsApi.prototype.forEach_5mel8p$;
  UiApi.prototype.forEach_igkruk$ = UiKillsApi.prototype.forEach_igkruk$;
  UiApi.prototype.map_i8ud5a$ = UiKillsApi.prototype.map_i8ud5a$;
  UiApi.prototype.onChange_ocsf2x$ = UiKillsApi.prototype.onChange_ocsf2x$;
  UiApi.prototype.process_ttzep4$ = UiKillsApi.prototype.process_ttzep4$;
  UiApi.prototype.rxClass_wqb4ha$ = UiKillsApi.prototype.rxClass_wqb4ha$;
  UiApi.prototype.rxClass_mjd6u9$ = UiKillsApi.prototype.rxClass_mjd6u9$;
  UiApi.prototype.toChannelLater_z5dyp2$ = UiKillsApi.prototype.toChannelLater_z5dyp2$;
  UiApi.prototype.toRxSet_jr4bl4$ = UiKillsApi.prototype.toRxSet_jr4bl4$;
  UiApi.prototype.list_u1uvxv$ = UiCoroutinesApi.prototype.list_u1uvxv$;
  ...
  JobScopeImpl.prototype.get_childUIWrap_irb06o$ = JobScope.prototype.get_childUIWrap_irb06o$;
  JobKillsApi.prototype.rx_pn7ch0$ = HasKillSet.prototype.rx_pn7ch0$;
  JobKillsApi.prototype.rx_rf89m5$ = HasKillSet.prototype.rx_rf89m5$;
  JobKillsApi.prototype.containsRx_1w65cx$ = HasKillSet.prototype.containsRx_1w65cx$;
  JobKillsApi.prototype.filtered_49l5s4$ = HasKillSet.prototype.filtered_49l5s4$;
  JobKillsApi.prototype.forEach_5mel8p$ = HasKillSet.prototype.forEach_5mel8p$;
  JobKillsApi.prototype.forEach_igkruk$ = HasKillSet.prototype.forEach_igkruk$;
  JobKillsApi.prototype.map_i8ud5a$ = HasKillSet.prototype.map_i8ud5a$;
  JobKillsApi.prototype.onChange_ocsf2x$ = HasKillSet.prototype.onChange_ocsf2x$;
  JobKillsApi.prototype.process_ttzep4$ = HasKillSet.prototype.process_ttzep4$;
  JobKillsApi.prototype.remAssign_7fncnf$ = HasKillSet.prototype.remAssign_7fncnf$;
  JobKillsApi.prototype.rxClass_wqb4ha$ = HasKillSet.prototype.rxClass_wqb4ha$;
  JobKillsApi.prototype.rxClass_mjd6u9$ = HasKillSet.prototype.rxClass_mjd6u9$;
  JobKillsApi.prototype.toChannelLater_z5dyp2$ = HasKillSet.prototype.toChannelLater_z5dyp2$;
  JobKillsApi.prototype.toRxSet_jr4bl4$ = HasKillSet.prototype.toRxSet_jr4bl4$;
  ...
  JobKillsImpl.prototype.toChannelLater_z5dyp2$ = HasKillSet.prototype.toChannelLater_z5dyp2$;
  ...
  JobKillsImpl.prototype.list_u1uvxv$ = UiApi.prototype.list_u1uvxv$;
  JobKillsImpl.prototype.mapAsync_qco7w4$ = JobKillsApi.prototype.mapAsync_qco7w4$;
  ...
  JobScopeWithView.prototype.get_childUIWrap_irb06o$ = JobScope.prototype.get_childUIWrap_irb06o$;
  ...
  HasKillSetAndUIX.prototype.click_htd9kn$ = HasUIX.prototype.click_htd9kn$;
  HasKillSetAndUIX.prototype.click_ka8ib0$ = HasUIX.prototype.click_ka8ib0$;
  HasKillSetAndUIX.prototype.click_3xepc3$ = HasUIX.prototype.click_3xepc3$;
  HasKillSetAndUIX.prototype.rx_pn7ch0$ = HasKillSet.prototype.rx_pn7ch0$;
  HasKillSetAndUIX.prototype.rx_rf89m5$ = HasKillSet.prototype.rx_rf89m5$;
  HasKillSetAndUIX.prototype.containsRx_1w65cx$ = HasKillSet.prototype.containsRx_1w65cx$;
  HasKillSetAndUIX.prototype.filtered_49l5s4$ = HasKillSet.prototype.filtered_49l5s4$;
  HasKillSetAndUIX.prototype.forEach_5mel8p$ = HasKillSet.prototype.forEach_5mel8p$;
  HasKillSetAndUIX.prototype.forEach_igkruk$ = HasKillSet.prototype.forEach_igkruk$;
  HasKillSetAndUIX.prototype.map_i8ud5a$ = HasKillSet.prototype.map_i8ud5a$;
  HasKillSetAndUIX.prototype.onChange_ocsf2x$ = HasKillSet.prototype.onChange_ocsf2x$;
  HasKillSetAndUIX.prototype.process_ttzep4$ = HasKillSet.prototype.process_ttzep4$;
  HasKillSetAndUIX.prototype.remAssign_7fncnf$ = HasKillSet.prototype.remAssign_7fncnf$;
  HasKillSetAndUIX.prototype.rxClass_wqb4ha$ = HasKillSet.prototype.rxClass_wqb4ha$;
  HasKillSetAndUIX.prototype.rxClass_mjd6u9$ = HasKillSet.prototype.rxClass_mjd6u9$;
  HasKillSetAndUIX.prototype.toChannelLater_z5dyp2$ = HasKillSet.prototype.toChannelLater_z5dyp2$;
  HasKillSetAndUIX.prototype.toRxSet_jr4bl4$ = HasKillSet.prototype.toRxSet_jr4bl4$;
  ForwardImpl.prototype.click_htd9kn$ = HasKillSetAndUIX.prototype.click_htd9kn$;
  ForwardImpl.prototype.click_ka8ib0$ = HasKillSetAndUIX.prototype.click_ka8ib0$;
  ForwardImpl.prototype.click_3xepc3$ = HasKillSetAndUIX.prototype.click_3xepc3$;
  plus$ObjectLiteral.prototype.click_htd9kn$ = HasKillSetAndUIX.prototype.click_htd9kn$;
  plus$ObjectLiteral.prototype.click_ka8ib0$ = HasKillSetAndUIX.prototype.click_ka8ib0$;
  plus$ObjectLiteral.prototype.click_3xepc3$ = HasKillSetAndUIX.prototype.click_3xepc3$;
  plus$ObjectLiteral.prototype.rx_pn7ch0$ = HasKillSetAndUIX.prototype.rx_pn7ch0$;
  plus$ObjectLiteral.prototype.rx_rf89m5$ = HasKillSetAndUIX.prototype.rx_rf89m5$;
  plus$ObjectLiteral.prototype.containsRx_1w65cx$ = HasKillSetAndUIX.prototype.containsRx_1w65cx$;
  plus$ObjectLiteral.prototype.filtered_49l5s4$ = HasKillSetAndUIX.prototype.filtered_49l5s4$;
  plus$ObjectLiteral.prototype.forEach_5mel8p$ = HasKillSetAndUIX.prototype.forEach_5mel8p$;
  plus$ObjectLiteral.prototype.forEach_igkruk$ = HasKillSetAndUIX.prototype.forEach_igkruk$;
  plus$ObjectLiteral.prototype.map_i8ud5a$ = HasKillSetAndUIX.prototype.map_i8ud5a$;
  plus$ObjectLiteral.prototype.onChange_ocsf2x$ = HasKillSetAndUIX.prototype.onChange_ocsf2x$;
  plus$ObjectLiteral.prototype.process_ttzep4$ = HasKillSetAndUIX.prototype.process_ttzep4$;
  plus$ObjectLiteral.prototype.remAssign_7fncnf$ = HasKillSetAndUIX.prototype.remAssign_7fncnf$;
  plus$ObjectLiteral.prototype.rxClass_wqb4ha$ = HasKillSetAndUIX.prototype.rxClass_wqb4ha$;
  plus$ObjectLiteral.prototype.rxClass_mjd6u9$ = HasKillSetAndUIX.prototype.rxClass_mjd6u9$;
  plus$ObjectLiteral.prototype.toChannelLater_z5dyp2$ = HasKillSetAndUIX.prototype.toChannelLater_z5dyp2$;
  plus$ObjectLiteral.prototype.toRxSet_jr4bl4$ = HasKillSetAndUIX.prototype.toRxSet_jr4bl4$;
  ...
  $receiver.forEach_yk5nc8$(killable.NoKill, globalStatus$lambda$lambda);
