...
this['appsimake-tictactoe'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_commonui, $module$appsimake_common, $module$kotlinx_coroutines_core, $module$appsimake_tictactoelib, $module$appsimake_commonfb, $module$appsimake_fontawesome) {
  ...
  var RollbackException = $module$appsimake_firebase.firebase.firestore.RollbackException;
  ...
  function PlayerActiveWaiting$enter$lambda$lambda$lambda(closure$players) {
    return function ($receiver) {
      ...
      $receiver.originalPlayers = $receiver.players.slice();
      return Unit;
    };
  }
        ...
        switch (this.state_0) {
          ...
          case 6:
            if (this.local$playersFree) {
              ...
              var seq = 0;
              var moveRef = this.local$closure$ownGameRef.collection(tictactoelib.firestoreMovesCollectionName).doc(seq.toString());
              var $receiver_0 = new Start();
              $receiver_0.sequence = seq;
              $receiver_0.player = Random.Default.nextInt_za3lpa$(2);
              this.local$tx.set(moveRef, $receiver_0.wrapped);
              return true;
            }
             else {
              return rollback();
  ...
  function playfieldUI$fieldUI$lambda$lambda$lambda_1(closure$canClick, closure$turn, closure$state, closure$expectingSequence, closure$x, closure$y, this$playfieldUI) {
    return function (it) {
      if (closure$canClick.now) {
        closure$turn.now = Turn$Check_getInstance();
  ...
  function playfieldUI$lambda_4(closure$killables, closure$board) {
    return function ($receiver) {
      padding1($receiver);
  ...
  function playfieldUI$lambda$lambda$lambda(closure$theirMark, closure$drawMark, closure$ourMark) {
    return function (it) {
      switch (it.name) {
        ...
        case 'Check':
          return get_textNode('Please wait...');
        case 'There':
  ...
  function playfieldUI$lambda$lambda$lambda$lambda_2(closure$killables, this$playfieldUI) {
    return function ($receiver) {
      toggleNotificationButton($receiver, closure$killables, this$playfieldUI.loggedInCtx.fcmControl);
      return Unit;
    };
  }
  function playfieldUI$lambda$lambda$lambda_2(closure$theirMark, closure$drawMark, closure$ourMark, closure$killables, this$playfieldUI) {
    return function ($receiver) {
      ...
      dropdownItemAnchor($receiver, playfieldUI$lambda$lambda$lambda$lambda_2(closure$killables, this$playfieldUI));
      return Unit;
    };
  }
  function playfieldUI$lambda$lambda_1(closure$theirMark, closure$drawMark, closure$ourMark, closure$killables, this$playfieldUI) {
    return function ($receiver) {
      invoke($receiver.element, playfieldUI$lambda$lambda$lambda_0);
      $receiver.button_3uqggf$(playfieldUI$lambda$lambda$lambda_1);
      invoke($receiver.menu, playfieldUI$lambda$lambda$lambda_2(closure$theirMark, closure$drawMark, closure$ourMark, closure$killables, this$playfieldUI));
      return Unit;
    };
  }
  function playfieldUI$lambda_6(closure$theirMark, closure$drawMark, closure$ourMark, closure$killables, this$playfieldUI) {
    return function ($receiver) {
      dropdown($receiver, playfieldUI$lambda$lambda_1(closure$theirMark, closure$drawMark, closure$ourMark, closure$killables, this$playfieldUI));
      return Unit;
    };
  }
  ...
  function playfieldUI$process$lambda($receiver) {
  ...
  function playfieldUI$process(closure$expectingSequence, closure$isOver, this$playfieldUI, closure$turn, closure$state, closure$party, closure$checkGameOver, closure$isDraw) {
    return function ($receiver) {
      ...
      if (closure$isOver.now) {
        this$playfieldUI.gameRef.set(obj(playfieldUI$process$lambda), setOptionsMerge());
      }
    };
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = leaveGameMove(this.local$this$playfieldUI, playfieldUI$lambda$lambda$lambda_3(this.local$closure$expectingSequence), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function playfieldUI($receiver) {
    ...
    $receiver.ui.root.newRoot_iw61es$(playfieldUI$lambda_4(killables, board));
    ...
    $receiver.ui.layout.top.right_iw61es$(playfieldUI$lambda_6(theirMark, drawMark, ourMark, killables, $receiver));
        ...
        switch (this.state_0) {
          ...
          case 3:
            ...
            if (!currentMove.exists) {
              ...
              this.local$tx.set(this.local$this$move.gameRef, obj_0(), setOptionsMerge());
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            if (!Kotlin.isType(_, RollbackException))
              throw _;
            this.state_0 = 3;
            continue;
          case 3:
  ...
  function leaveGameMove($receiver_0, seq_0, continuation_0, suspended) {
    var instance = new Coroutine$leaveGameMove($receiver_0, seq_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$leaveGameMove($receiver_0, seq_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
    this.local$seq = seq_0;
  }
  Coroutine$leaveGameMove.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$leaveGameMove.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$leaveGameMove.prototype.constructor = Coroutine$leaveGameMove;
  Coroutine$leaveGameMove.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function toggleNotificationButton$lambda(closure$fcmControl) {
    return function () {
      return closure$fcmControl.enabled.invoke();
    };
  }
  function toggleNotificationButton$lambda$lambda(this$) {
    return function (it) {
      this$.checked = it === true;
      return Unit;
    };
  }
  function toggleNotificationButton$lambda$lambda_0(closure$fcmState) {
    return function () {
      return closure$fcmState.invoke() != null;
    };
  }
  function toggleNotificationButton$lambda_0(closure$fcmState) {
    return function ($receiver) {
      get_classes($receiver).plusAssign_61zpoe$(styles.pointerEventsNone);
      margin1($receiver);
      $receiver.type = 'checkbox';
      closure$fcmState.forEach_qlkmfe$(toggleNotificationButton$lambda$lambda($receiver));
      rxDisplay_0($receiver, toggleNotificationButton$lambda$lambda_0(closure$fcmState));
      return Unit;
    };
  }
  function toggleNotificationButton$lambda$lambda_1(closure$fcmState) {
    return function () {
      return closure$fcmState.invoke() == null;
    };
  }
  function toggleNotificationButton$lambda_1(closure$fcmState) {
    return function ($receiver) {
      spinnerBorderSm($receiver);
      rxDisplay_0($receiver, toggleNotificationButton$lambda$lambda_1(closure$fcmState));
      return Unit;
    };
  }
  function toggleNotificationButton$lambda_2($receiver) {
    margin1($receiver);
    $receiver.innerText = 'Send me notifications';
    return Unit;
  }
  function toggleNotificationButton$lambda$lambda_2(it) {
    console.log(it);
    return Unit;
  }
  function toggleNotificationButton$lambda_3(closure$fcmControl) {
    return function (it) {
      closure$fcmControl.toggle_ep0k5p$(toggleNotificationButton$lambda$lambda_2);
      return Unit;
    };
  }
  function toggleNotificationButton($receiver, killables, fcmControl) {
    flexRow($receiver);
    var fcmState = Rx_init(toggleNotificationButton$lambda(fcmControl));
    killables.plusAssign_wii6vi$(fcmState);
    flexAlignItemsCenter($receiver);
    input($receiver, toggleNotificationButton$lambda_0(fcmState));
    div($receiver, toggleNotificationButton$lambda_1(fcmState));
    div($receiver, toggleNotificationButton$lambda_2);
    clickEvent($receiver, toggleNotificationButton$lambda_3(fcmControl));
  }
  ...
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$killables, this$waitingUI) {
    return function ($receiver) {
      padding1($receiver);
      btn($receiver);
      btnPrimary($receiver);
      toggleNotificationButton($receiver, closure$killables, this$waitingUI.control.loggedInCtx.fcmControl);
      return Unit;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda_0(closure$killables, this$waitingUI) {
    return function ($receiver) {
      flexAlignItemsCenter($receiver);
      span($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda_0);
      div($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$killables, this$waitingUI));
      return Unit;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda_0(closure$killables, this$waitingUI) {
    return function ($receiver) {
      padding2($receiver);
      flex($receiver);
      flexGrow1($receiver);
      flexCenter($receiver);
      column($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda_0(closure$killables, this$waitingUI));
      return Unit;
    };
  }
  ...
  function waitingUI$lambda$lambda$lambda_0(closure$killables, this$waitingUI) {
    return function ($receiver) {
      flexColumn($receiver);
      div($receiver, waitingUI$lambda$lambda$lambda$lambda_0(closure$killables, this$waitingUI));
  ...
  function waitingUI$lambda$lambda(this$waitingUI, closure$killables) {
    return function ($receiver) {
      ...
      $receiver.main_iw61es$(waitingUI$lambda$lambda$lambda_0(closure$killables, this$waitingUI));
      return Unit;
    };
  }
  ...
  package$tictactoe.leaveGameMove_li81mw$ = leaveGameMove;
  ...
  package$tictactoe.toggleNotificationButton_lz3kk8$ = toggleNotificationButton;
