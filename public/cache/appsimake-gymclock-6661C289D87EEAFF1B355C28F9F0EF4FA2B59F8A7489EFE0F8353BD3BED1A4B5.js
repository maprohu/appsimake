...
this['appsimake-gymclock'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_commonui, $module$appsimake_common) {
  ...
  function Clock$show$lambda$lambda$lambda$lambda$lambda(closure$ks) {
    return function ($receiver) {
  ...
  function Clock$show$lambda$lambda$lambda$lambda_1(closure$ks) {
    return function ($receiver) {
      btnButton($receiver, Clock$show$lambda$lambda$lambda$lambda$lambda(closure$ks));
      return Unit;
    };
  }
  function Clock$show$lambda$lambda$lambda(closure$ks) {
    return function ($receiver) {
      $receiver.backButton_o14v8n$(Clock$show$lambda$lambda$lambda$lambda(closure$ks));
  ...
  function Clock$show$lambda$lambda(closure$ks, this$Clock) {
    return function ($receiver) {
      ...
      $receiver.main_iw61es$(Clock$show$lambda$lambda$lambda_0(closure$ks, this$Clock));
      return Unit;
    };
  }
  ...
  function Clock$timer$lambda$lambda_2(closure$counter) {
    return function ($receiver) {
  ...
  function Clock$timer$lambda_0(closure$counter) {
    return function ($receiver) {
      ...
      invoke(get_span($receiver), Clock$timer$lambda$lambda_2(closure$counter));
      return Unit;
    };
  }
  ...
  Clock.prototype.timer_e0t6x9$ = function (timerDiv) {
    ...
    invoke(get_div(timerDiv), Clock$timer$lambda_0(counter));
  ...
  function Form$root$lambda$lambda$lambda_0(closure$ks) {
    return function ($receiver) {
      ...
      $receiver.main_iw61es$(Form$root$lambda$lambda$lambda$lambda_0(closure$ks));
      return Unit;
    };
  }
