...
this['appsimake-gymclock'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common, $module$kotlinx_coroutines_core) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_0(this$ui) {
    return function () {
      this$ui.model.sounds.rxv.transform_ru8m0w$(ui$lambda$lambda$lambda$lambda$lambda$lambda);
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda_1(this$ui, closure$timerDiv) {
    return function ($receiver) {
      ...
      this$ui.forEach_xwzbbo$(this$ui.counter, ui$lambda$lambda$lambda$lambda$lambda_2($receiver));
      return Unit;
    };
  }
  ...
  function ui($receiver) {
    ...
    get_x3($receiver.get_backButton_tdhe4g$($receiver_1.left).fa);
    remAssign($receiver_1.title, 'Workout');
    var $receiver_2 = $receiver_1.right.button;
    $receiver_2.m1p2;
    $receiver_2.secondary;
    get_x3($receiver_2.fa);
    $receiver.rxClass_c5yvvx$($receiver_2.icon, ui$lambda$lambda$lambda$lambda$lambda($receiver));
    $receiver.click_9375ex$($receiver_2, ui$lambda$lambda$lambda$lambda$lambda_0($receiver));
  ...
  Form.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Form',
    interfaces: [LinkApi, BindKillsApi, FormPath, LinksPath, ForwardBase, KillsUixApi]
  };
  ...
  function ui$lambda$lambda$lambda$lambda_3(this$ui) {
    return function () {
      this$ui.model.sounds.rxv.transform_ru8m0w$(ui$lambda$lambda$lambda$lambda$lambda_3);
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda_2(this$ui) {
    return function ($receiver) {
      ...
      get_p1($receiver_0);
      invoke(get_form($receiver), ui$lambda$lambda$lambda$lambda_4(this$ui));
      ...
      this$ui_0.enabled_hlnvpg$($receiver_1, ui$lambda$lambda$lambda$lambda$lambda_4(this$ui_0));
      this$ui_0.click_9375ex$($receiver_1, ui$lambda$lambda$lambda$lambda$lambda_5(this$ui_0));
      return Unit;
    };
  }
  function ui_0($receiver) {
    ...
    $receiver_2.fa;
    $receiver_2.secondary;
    $receiver.rxClass_c5yvvx$($receiver_2.icon, ui$lambda$lambda$lambda$lambda_2($receiver));
    $receiver.click_9375ex$($receiver_2, ui$lambda$lambda$lambda$lambda_3($receiver));
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.local$closure$deps.body.hole.remAssign_looze4$($receiver);
            return $receiver;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
