...
this['appsimake-taskslib'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_firebaseshr) {
  ...
  HiddenTask.prototype = Object.create(Base.prototype);
  ...
  function Task$ts$lambda(it) {
    return toLazy(toOptional(firebaseshr.binderOps.serverTimestamp()));
  }
  ...
  function Task_init$lambda$lambda(this$) {
    return function () {
      firebaseshr.binderOps.deleteCollection(get_notes(this$.docWrapOrFail));
      return Unit;
    };
  }
  Task.$metadata$ = {
  ...
  package$taskslib.get_hiddenTasks_13xn5r$ = get_hiddenTasks;
