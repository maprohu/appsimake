...
if (typeof this['appsimake-common'] === 'undefined') {
  throw new Error("Error loading module 'appsimake-tictactoe'. Its dependency 'appsimake-common' was not found. Please, check whether 'appsimake-common' is loaded prior to 'appsimake-tictactoe'.");
}
...
this['appsimake-tictactoe'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_commonui, $module$appsimake_common, $module$kotlinx_coroutines_core, $module$appsimake_tictactoelib, $module$appsimake_commonfb, $module$appsimake_fontawesome) {
  'use strict';
  ...
  var get_typeEnum = $module$appsimake_firebase.firebase.firestore.get_typeEnum_samrru$;
  var DocumentChangeType = $module$appsimake_firebase.firebase.firestore.DocumentChangeType;
  var equals = Kotlin.equals;
  var onSnapshotNext = $module$appsimake_firebase.firebase.firestore.onSnapshotNext_o3477o$;
  var shouldRequest = $module$appsimake_commonui.commonui.shouldRequest_iyaa7$;
  ...
  var alertWarning = $module$appsimake_bootstrap.bootstrap.alertWarning_ejp6nk$;
  ...
  var obj_0 = $module$appsimake_commonshr.common.obj_287e2$;
  var launch_0 = $module$appsimake_firebase.firebase.firestore.launch_g2bo5h$;
  var txDefer = $module$appsimake_firebase.firebase.firestore.txDefer_81x6o2$;
  var Killables = $module$appsimake_common.killable.Killables;
  var indexOf = Kotlin.kotlin.collections.indexOf_mjy6jw$;
  var tx = $module$appsimake_firebase.firebase.firestore.tx_81x6o2$;
  var LoggedInCtx = $module$appsimake_commonfb.commonfb.LoggedInCtx;
  var Enum = Kotlin.kotlin.Enum;
  var throwISE = Kotlin.throwISE;
  var until = Kotlin.kotlin.ranges.until_dqglrj$;
  var Emitter = $module$appsimake_common.common.Emitter;
  var Rx_init = $module$appsimake_common.rx.Rx_init_klfg04$;
  var rxDisplay = $module$appsimake_bootstrap.bootstrap.rxDisplay_86pnez$;
  var line = $module$appsimake_domx.svgx.line_lr0x44$;
  var g = $module$appsimake_domx.svgx.g_5dzvjl$;
  var circle = $module$appsimake_domx.svgx.circle_nmh8i0$;
  ...
  var rxHover = $module$appsimake_common.rx.rxHover_st2z1u$;
  var rect = $module$appsimake_domx.svgx.rect_bfker8$;
  var a = $module$appsimake_domx.svgx.a_lzuxbr$;
  var set = $module$appsimake_domx.domx.set_56wq3j$;
  var svg = $module$appsimake_domx.svgx.svg_veu7ak$;
  var padding1 = $module$appsimake_bootstrap.bootstrap.padding1_ejp6nk$;
  var aspectRatio = $module$appsimake_commonui.commonui.aspectRatio_ahwbu2$;
  var viewBox = $module$appsimake_domx.svgx.viewBox_wedmho$;
  var rxVisible = $module$appsimake_domx.domx.rxVisible_i505hf$;
  var get_textNode = $module$appsimake_domx.domx.get_textNode_pdl1vz$;
  var plus = $module$appsimake_domx.domx.plus_uy78um$;
  var rxPanel = $module$appsimake_commonui.commonui.rxPanel_83qqjo$;
  var span = $module$appsimake_domx.domx.span_c7xqcp$;
  var invoke = $module$appsimake_bootstrap.bootstrap.invoke_inodcj$;
  var chevronDown = $module$appsimake_fontawesome.fontawesome.chevronDown_asww5s$;
  var dropdownMenuRight = $module$appsimake_bootstrap.bootstrap.dropdownMenuRight_ejp6nk$;
  var dropdownItemAnchor = $module$appsimake_bootstrap.bootstrap.dropdownItemAnchor_6t02fy$;
  var dropdown = $module$appsimake_bootstrap.bootstrap.dropdown_dz5l3e$;
  ...
  var orderBy = $module$appsimake_firebase.firebase.firestore.orderBy_pn31r1$;
  ...
  var rxDisplay_0 = $module$appsimake_bootstrap.bootstrap.rxDisplay_dw434i$;
  var input = $module$appsimake_domx.domx.input_xh1a31$;
  var spinnerBorderSm = $module$appsimake_bootstrap.bootstrap.spinnerBorderSm_ejp6nk$;
  ...
  var fas = $module$appsimake_fontawesome.fontawesome.fas_46n0ku$;
  ...
  function PlayerActiveWaiting$enter$lambda$lambda$lambda(closure$players) {
    return function ($receiver) {
      var $receiver_0 = closure$players.v;
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.local$players = {v: [this.local$this$PlayerActiveWaiting.control.playerRef, this.local$closure$otherPlayerChange.doc.ref]};
            this.local$tmp$ = this.local$players.v;
            this.local$tmp$_0 = 0;
            this.state_0 = 2;
            continue;
          case 1:
          ...
          case 2:
            ...
            var player = this.local$tmp$[this.local$tmp$_0];
            this.state_0 = 3;
          ...
          case 6:
            if (this.local$playersFree) {
              var $receiver = this.local$players.v;
              var tmp$_0;
              ...
              var game = obj(PlayerActiveWaiting$enter$lambda$lambda$lambda(this.local$players));
              this.local$tx.set(this.local$closure$ownGameRef, game, setOptionsMerge());
              return true;
            }
             else {
              return rollback();
  ...
  function Coroutine$PlayerActiveWaiting$enter$lambda(this$PlayerActiveWaiting_0, closure$channel_0, $receiver, controller, continuation_0) {
    ...
    this.local$firstPlayerIndex = void 0;
  }
      ...
      try {
        switch (this.state_0) {
          ...
          case 6:
            ...
            this.local$firstPlayerIndex = Random.Default.nextInt_za3lpa$(2);
            this.state_0 = 7;
          ...
          case 7:
            ...
            if (started) {
              var seq = 0;
              var tmp$ = this.local$ownGameRef.collection(tictactoelib.firestoreMovesCollectionName).doc(seq.toString());
              var $receiver = new Start();
              $receiver.sequence = 0;
              $receiver.player = 1 - this.local$firstPlayerIndex | 0;
              tmp$.set($receiver.wrapped);
              this.state_0 = 9;
              continue;
            }
             else {
  ...
  function PlayerActiveWaiting$enter$lambda_1(closure$killUI, closure$stopQuerying, closure$processingJob) {
    return function () {
      closure$killUI();
  ...
  PlayerActiveWaiting.prototype.enter = function () {
    ...
    return PlayerActiveWaiting$enter$lambda_1(killUI, stopQuerying, processingJob);
  };
  ...
  function MainCtx(fbCtx) {
    this.fbCtx = fbCtx;
    this.playersRef = this.fbCtx.db.collection(tictactoelib.firestorePlayersPath);
    this.gamesRef = this.fbCtx.db.collection(tictactoelib.firestoreGamesPath);
  }
  MainCtx.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'MainCtx',
  ...
  function notificationUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda(closure$askDiv) {
    return function (it) {
      removeFromParent(closure$askDiv);
      common.onResize.fire();
      return Unit;
    };
  }
  function notificationUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda(closure$askDiv) {
    return function ($receiver) {
      get_classes($receiver).plusAssign_61zpoe$('close');
      $receiver.innerHTML = '&times;';
      clickEvent($receiver, notificationUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda(closure$askDiv));
      return Unit;
    };
  }
  function notificationUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda(closure$e, closure$askDiv) {
    return function ($receiver) {
      var tmp$, tmp$_0;
      padding2($receiver);
      alertWarning($receiver);
      $receiver.innerText = (tmp$_0 = typeof (tmp$ = closure$e.message) === 'string' ? tmp$ : null) != null ? tmp$_0 : 'Permission for sending notifications has been denied.';
      button($receiver, notificationUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda(closure$askDiv));
      return Unit;
    };
  }
  function notificationUI$lambda$lambda$lambda$lambda$lambda$lambda(closure$askDiv_0, closure$askButton_0) {
    return function ($receiver, continuation_0, suspended) {
      var instance = new Coroutine$notificationUI$lambda$lambda$lambda$lambda$lambda$lambda(closure$askDiv_0, closure$askButton_0, $receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$notificationUI$lambda$lambda$lambda$lambda$lambda$lambda(closure$askDiv_0, closure$askButton_0, $receiver, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$askDiv = closure$askDiv_0;
    this.local$closure$askButton = closure$askButton_0;
  }
  Coroutine$notificationUI$lambda$lambda$lambda$lambda$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$notificationUI$lambda$lambda$lambda$lambda$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$notificationUI$lambda$lambda$lambda$lambda$lambda$lambda.prototype.constructor = Coroutine$notificationUI$lambda$lambda$lambda$lambda$lambda$lambda;
  Coroutine$notificationUI$lambda$lambda$lambda$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            try {
              removeFromParent(this.local$closure$askDiv);
              return common.onResize.fire(), Unit;
            }
             catch (e) {
              removeFromParent(this.local$closure$askButton);
              div(this.local$closure$askDiv, notificationUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda(e, this.local$closure$askDiv));
              return common.onResize.fire(), Unit;
            }
  ...
  function notificationUI$lambda$lambda$lambda$lambda$lambda(closure$canClick, closure$askDiv, closure$askButton) {
    return function (it) {
      if (closure$canClick.now) {
        closure$canClick.now = false;
        launch(coroutines.GlobalScope, void 0, void 0, notificationUI$lambda$lambda$lambda$lambda$lambda$lambda(closure$askDiv, closure$askButton));
      }
      return Unit;
    };
  }
  function notificationUI$lambda$lambda$lambda$lambda(closure$askDiv) {
    return function ($receiver) {
      var askButton = $receiver;
      btnPrimary($receiver);
      $receiver.innerText = 'Turn on Game Notifications';
      var canClick = new Var(true);
      rxEnabled($receiver, canClick);
      clickEvent($receiver, notificationUI$lambda$lambda$lambda$lambda$lambda(canClick, closure$askDiv, askButton));
      return Unit;
    };
  }
  function notificationUI$lambda$lambda$lambda($receiver) {
    var askDiv = $receiver;
    margin1($receiver);
    flexFixedSize($receiver);
    btnButton($receiver, notificationUI$lambda$lambda$lambda$lambda(askDiv));
    return Unit;
  }
  function notificationUI$lambda$lambda(this$_0) {
    return function ($receiver, continuation_0, suspended) {
      var instance = new Coroutine$notificationUI$lambda$lambda(this$_0, $receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$notificationUI$lambda$lambda(this$_0, $receiver, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$ = this$_0;
  }
  Coroutine$notificationUI$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$notificationUI$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$notificationUI$lambda$lambda.prototype.constructor = Coroutine$notificationUI$lambda$lambda;
  Coroutine$notificationUI$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (shouldRequest(Notification)) {
              return column(this.local$this$, notificationUI$lambda$lambda$lambda), Unit;
            }
  ...
  function notificationUI($receiver, f) {
    launch(coroutines.GlobalScope, void 0, void 0, notificationUI$lambda$lambda(f));
  }
  ...
  function PlayerCtx$startPlaying$lambda(closure$gameId, this$PlayerCtx, closure$ui, closure$killables) {
    return function (it) {
      if (!it.exists) {
        ...
        var playingCtx = new PlayingCtx(this$PlayerCtx, closure$gameId, playerIndex, closure$ui);
  ...
  function playfieldUI$lambda_1(closure$turn) {
    return function () {
  ...
  function playfieldUI$lambda_2(closure$state) {
    return function () {
  ...
  function playfieldUI$lambda_3(closure$freeLeft) {
    return function () {
  ...
  function playfieldUI$lambda_4(closure$killables, closure$board, this$playfieldUI) {
    return function ($receiver) {
      padding1($receiver);
      aspectRatio($receiver, closure$killables, void 0, playfieldUI$lambda$lambda(closure$board));
      notificationUI(this$playfieldUI, $receiver);
      return Unit;
    };
  }
  ...
  function playfieldUI$lambda_5(closure$turn, closure$theirMark, closure$drawMark, closure$ourMark) {
    return function ($receiver) {
      flexCenter($receiver);
  ...
  function playfieldUI$lambda_6(closure$theirMark, closure$drawMark, closure$ourMark) {
    return function ($receiver) {
      dropdown($receiver, playfieldUI$lambda$lambda_1(closure$theirMark, closure$drawMark, closure$ourMark));
      return Unit;
    };
  }
  function playfieldUI$lambda_7(closure$gameOverStates, closure$turn) {
    return function () {
  ...
  function playfieldUI$process(closure$expectingSequence, closure$isOver, this$playfieldUI, closure$turn, closure$state, closure$party, closure$checkGameOver, closure$isDraw) {
    return function ($receiver) {
      var tmp$, tmp$_0;
      ...
      if (Kotlin.isType($receiver, Start))
        closure$turn.now = $receiver.player === this$playfieldUI.playerIndex ? Turn$There_getInstance() : Turn$Here_getInstance();
      else if (Kotlin.isType($receiver, Placement)) {
  ...
  function playfieldUI$lambda_8(closure$process) {
    return function (qs) {
      var $receiver = qs.docChanges();
      var destination = ArrayList_init_0();
      var tmp$;
      ...
      while (tmp$_0.hasNext()) {
        var element_0 = tmp$_0.next();
        closure$process(Move.Companion.of(element_0.doc.data()));
      }
      return Unit;
    };
  }
  ...
  function playfieldUI$lambda_9(closure$expectingSequence, this$playfieldUI, closure$killables, closure$stopListening) {
    return function () {
  ...
  function playfieldUI($receiver) {
    ...
    var turn = new Var(Turn$Check_getInstance());
    var isWaiting = Rx_init(playfieldUI$lambda_0(turn));
    rxDisplay($receiver.ui.spinner, isWaiting);
    var ourTurn = Rx_init(playfieldUI$lambda_1(turn));
    var freeLeft = Rx_init(playfieldUI$lambda_2(state));
    var isDraw = Rx_init(playfieldUI$lambda_3(freeLeft));
    ...
    $receiver.ui.root.newRoot_iw61es$(playfieldUI$lambda_4(killables, board, $receiver));
    var markSvg = playfieldUI$markSvg;
    var drawMark = playfieldUI$drawMark(markSvg, drawO, drawX);
    $receiver.ui.layout.top.middle_iw61es$(playfieldUI$lambda_5(turn, theirMark, drawMark, ourMark));
    $receiver.ui.layout.top.right_iw61es$(playfieldUI$lambda_6(theirMark, drawMark, ourMark));
    var gameOverStates = setOf([Turn$Won_getInstance(), Turn$Lost_getInstance(), Turn$Draw_getInstance(), Turn$Alone_getInstance()]);
    var isOver = Rx_init(playfieldUI$lambda_7(gameOverStates, turn));
    ...
    var process = playfieldUI$process(expectingSequence, isOver, $receiver, turn, state, party, checkGameOver, isDraw);
    ...
    })), playfieldUI$lambda_8(process));
    return playfieldUI$lambda_9(expectingSequence, $receiver, killables, stopListening);
  }
  function PlayingCtx(playerCtx, gameId, playerIndex, ui) {
    this.playerCtx = playerCtx;
    this.gameId = gameId;
    this.playerIndex = playerIndex;
    this.ui = ui;
    this.loggedInCtx = this.playerCtx.loggedInCtx;
  ...
  function TicTacToeLoggedOutControl() {
    LoggingInCtx_init(tictactoelib.tictactoe, 'Tic Tac Toe', this);
  }
  function TicTacToeLoggedOutControl$loggedIn$lambda(closure$killables) {
    return function () {
      closure$killables.kill();
      return Unit;
    };
  ...
  TicTacToeLoggedOutControl.prototype.loggedIn_v1eir6$ = function (user) {
    var loggedInCtx = new LoggedInCtx(this.fbCtx, user);
    var killables = new Killables();
    killables.plusAssign_o14v8n$(this.startStateMachine_18d6m1$(loggedInCtx));
    return TicTacToeLoggedOutControl$loggedIn$lambda(killables);
  };
  function TicTacToeLoggedOutControl$startStateMachine$lambda(closure$stateMachine) {
    return function (ds) {
      closure$stateMachine.update_11rb$(ds.exists ? ds.data() : null);
      return Unit;
    };
  }
  function TicTacToeLoggedOutControl$startStateMachine$lambda_0(closure$control, closure$stopQuerying, closure$stateMachine) {
    return function () {
      closure$control.loggedInCtx.killables.kill();
      closure$stopQuerying();
      closure$stateMachine.shutdown();
      return Unit;
    };
  }
  TicTacToeLoggedOutControl.prototype.startStateMachine_18d6m1$ = function (user) {
    var control = new PlayerCtx(new MainCtx(this.fbCtx), user);
    var stateMachine = new StateMachine(new PlayerStateUnknown(control));
    var stopQuerying = control.playerRef.onSnapshot(TicTacToeLoggedOutControl$startStateMachine$lambda(stateMachine));
    return TicTacToeLoggedOutControl$startStateMachine$lambda_0(control, stopQuerying, stateMachine);
  };
  ...
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda_0($receiver) {
    margin1($receiver);
    $receiver.innerText = 'Waiting for opponent...';
    return Unit;
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda(this$waitingUI) {
    return function () {
      return this$waitingUI.control.loggedInCtx.fcmControl.enabled.invoke();
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda(this$) {
    return function (it) {
      this$.checked = it === true;
      return Unit;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$fcmState) {
    return function () {
      return closure$fcmState.invoke() != null;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$fcmState) {
    return function ($receiver) {
      get_classes($receiver).plusAssign_61zpoe$(styles.pointerEventsNone);
      margin1($receiver);
      $receiver.type = 'checkbox';
      closure$fcmState.forEach_qlkmfe$(waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda($receiver));
      rxDisplay_0($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$fcmState));
      return Unit;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$fcmState) {
    return function () {
      return closure$fcmState.invoke() == null;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$fcmState) {
    return function ($receiver) {
      spinnerBorderSm($receiver);
      rxDisplay_0($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$fcmState));
      return Unit;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda_2($receiver) {
    margin1($receiver);
    $receiver.innerText = 'Send me notifications';
    return Unit;
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_2(it) {
    console.log(it);
    return Unit;
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda_3(this$waitingUI) {
    return function (it) {
      this$waitingUI.control.loggedInCtx.fcmControl.toggle_ep0k5p$(waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_2);
      return Unit;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda_1(this$waitingUI, closure$killables) {
    return function ($receiver) {
      var fcmState = Rx_init(waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda(this$waitingUI));
      closure$killables.plusAssign_wii6vi$(fcmState);
      padding1($receiver);
      btn($receiver);
      btnPrimary($receiver);
      flexAlignItemsCenter($receiver);
      input($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0(fcmState));
      div($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda_1(fcmState));
      div($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda_2);
      clickEvent($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda$lambda_3(this$waitingUI));
      return Unit;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda$lambda_0(this$waitingUI, closure$killables) {
    return function ($receiver) {
      flexAlignItemsCenter($receiver);
      span($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda_0);
      row($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda_1(this$waitingUI, closure$killables));
      return Unit;
    };
  }
  function waitingUI$lambda$lambda$lambda$lambda_0(this$waitingUI, closure$killables) {
    return function ($receiver) {
      padding2($receiver);
      flex($receiver);
      flexGrow1($receiver);
      flexCenter($receiver);
      column($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda_0(this$waitingUI, closure$killables));
      return Unit;
    };
  }
  ...
  function waitingUI$lambda$lambda$lambda$lambda$lambda$lambda_2(it) {
  ...
  function waitingUI$lambda$lambda$lambda$lambda$lambda_2($receiver) {
    ...
    margin1($receiver);
    fas($receiver, 'copy');
    clickEvent($receiver, waitingUI$lambda$lambda$lambda$lambda$lambda$lambda_2);
    return Unit;
  }
  ...
  function waitingUI$lambda$lambda$lambda_0(this$waitingUI, closure$killables) {
    return function ($receiver) {
      flexColumn($receiver);
      div($receiver, waitingUI$lambda$lambda$lambda$lambda_0(this$waitingUI, closure$killables));
      row($receiver, waitingUI$lambda$lambda$lambda$lambda_1);
      return Unit;
    };
  }
  function waitingUI$lambda$lambda(this$waitingUI, closure$killables) {
    return function ($receiver) {
      $receiver.top_vesf63$(waitingUI$lambda$lambda$lambda(this$waitingUI));
      $receiver.main_iw61es$(waitingUI$lambda$lambda$lambda_0(this$waitingUI, closure$killables));
      return Unit;
    };
  }
  function waitingUI$lambda(this$waitingUI, closure$killables) {
    return function ($receiver) {
      screenLayout($receiver, waitingUI$lambda$lambda(this$waitingUI, closure$killables));
      return Unit;
    };
  }
  function waitingUI$lambda_0(closure$killables) {
    return function () {
      closure$killables.kill();
      return Unit;
    };
  ...
  function waitingUI($receiver) {
    var killables = new Killables();
    $receiver.control.appCtx.root.newRoot_iw61es$(waitingUI$lambda($receiver, killables));
    return waitingUI$lambda_0(killables);
  }
  ...
  package$tictactoe.notificationUI_9838t9$ = notificationUI;
  ...
  package$tictactoe.move_jed1wk$ = move;
  ...
  return _;
}(typeof this['appsimake-tictactoe'] === 'undefined' ? {} : this['appsimake-tictactoe'], kotlin, this['appsimake-domx'], this['appsimake-bootstrap'], this['appsimake-commonshr'], this['appsimake-firebase'], this['appsimake-commonui'], this['appsimake-common'], this['kotlinx-coroutines-core'], this['appsimake-tictactoelib'], this['appsimake-commonfb'], this['appsimake-fontawesome']);
