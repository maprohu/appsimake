...
this['appsimake-domx'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_common) {
  ...
  function rxEnabled($receiver, ks, rx) {
    rx.forEach_yk5nc8$(ks, rxEnabled$lambda($receiver));
  }
  ...
  function rxEnabled_0($receiver, ks, fn) {
    rxEnabled($receiver, ks, Rx_init(ks, rxEnabled$lambda_0(fn)));
  }
  ...
  function rxVisible($receiver, ks, rxv) {
    rxv.forEach_yk5nc8$(ks, rxVisible$lambda($receiver));
  }
  ...
  function rxDisplayed_0($receiver, ks, rxv) {
    ...
    rxv.forEach_yk5nc8$(ks, rxDisplayed$lambda_0($receiver, childRole, parent));
  }
  ...
  var domx = defineInlineFunction('appsimake-domx.domx.domx_uh63sd$', wrapFunction(function () {
  ...
  package$domx.rxEnabled_gjielg$ = rxEnabled_0;
  package$domx.rxVisible_so0w3s$ = rxVisible;
  package$domx.rxVisible_3jexjz$ = rxVisible_0;
  ...
  DomxHasKillSet.prototype.rx_pn7ch0$ = HasKillSet.prototype.rx_pn7ch0$;
  DomxHasKillSet.prototype.rx_rf89m5$ = HasKillSet.prototype.rx_rf89m5$;
  DomxHasKillSet.prototype.containsRx_1w65cx$ = HasKillSet.prototype.containsRx_1w65cx$;
  DomxHasKillSet.prototype.filtered_49l5s4$ = HasKillSet.prototype.filtered_49l5s4$;
  DomxHasKillSet.prototype.forEach_5mel8p$ = HasKillSet.prototype.forEach_5mel8p$;
  DomxHasKillSet.prototype.forEach_igkruk$ = HasKillSet.prototype.forEach_igkruk$;
  DomxHasKillSet.prototype.map_i8ud5a$ = HasKillSet.prototype.map_i8ud5a$;
  DomxHasKillSet.prototype.onChange_ocsf2x$ = HasKillSet.prototype.onChange_ocsf2x$;
  DomxHasKillSet.prototype.process_ttzep4$ = HasKillSet.prototype.process_ttzep4$;
  DomxHasKillSet.prototype.remAssign_7fncnf$ = HasKillSet.prototype.remAssign_7fncnf$;
  DomxHasKillSet.prototype.rxClass_wqb4ha$ = HasKillSet.prototype.rxClass_wqb4ha$;
  DomxHasKillSet.prototype.rxClass_mjd6u9$ = HasKillSet.prototype.rxClass_mjd6u9$;
  DomxHasKillSet.prototype.toChannelLater_z5dyp2$ = HasKillSet.prototype.toChannelLater_z5dyp2$;
  DomxHasKillSet.prototype.toRxSet_jr4bl4$ = HasKillSet.prototype.toRxSet_jr4bl4$;
  nextId = 0;
