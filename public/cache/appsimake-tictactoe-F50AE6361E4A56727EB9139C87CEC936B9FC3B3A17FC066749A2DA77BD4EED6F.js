...
this['appsimake-tictactoe'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_tictactoelib, $module$kotlinx_coroutines_core, $module$appsimake_firebase, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_fontawesome, $module$appsimake_commonfb, $module$appsimake_bootstrap) {
  'use strict';
  ...
  var libMessages = $module$appsimake_commonfb.commonfb.messaging.libMessages_ixqyx1$;
  ...
  Object.defineProperty(OnlineBoardControl.prototype, 'kills', {
    get: function () {
      return this.board.kills;
    }
  });
  Object.defineProperty(OnlineBoardControl.prototype, 'uix', {
    get: function () {
      return this.board.uix;
    }
  });
  ...
  function OnlineBoardControl$topbar$lambda(this$OnlineBoardControl) {
    return function ($receiver) {
      ...
      this$OnlineBoardControl_0.get_messagingMenu_rp0x24$($receiver_2);
      return Unit;
    };
  }
  ...
  OnlineBoardControl.$metadata$ = {
    ...
    interfaces: [KillsMessagingUixApi, HasKillsUix, LoggedInPath, BoardControlBase]
  };
  ...
  function Links(deps) {
    ...
    this.messages_zfo42b$_0 = lazy(Links$messages$lambda(this));
  ...
  Object.defineProperty(Links.prototype, 'messages', {
    get: function () {
      return this.messages_zfo42b$_0.value;
    }
  });
  ...
  function Coroutine$Links$messages$lambda$lambda(this$Links_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$Links = this$Links_0;
  }
  Coroutine$Links$messages$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Links$messages$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Links$messages$lambda$lambda.prototype.constructor = Coroutine$Links$messages$lambda$lambda;
  Coroutine$Links$messages$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
          ...
          case 2:
            tmp$ = this.result_0;
            return libMessages(this.local$this$Links, tmp$);
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function Links$messages$lambda$lambda(this$Links_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$Links$messages$lambda$lambda(this$Links_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Links$messages$lambda(this$Links) {
    return function () {
      return async(this$Links, void 0, void 0, Links$messages$lambda$lambda(this$Links));
    };
  }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            continue;
          case 1:
            this.local$$receiver = new Killables();
  ...
  function LoggedIn(links, linkage, hole, user, fcm) {
    ...
    if (this.messaging.fcmSupported) {
      this.register_3ijkb1$(links.signOutListeners, LoggedIn_init$lambda(this));
      launchReport(this, LoggedIn_init$lambda_0(links, this));
    }
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$LoggedIn.messaging.removeTokenAndWait(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function Coroutine$LoggedIn_init$lambda_0(closure$links_0, this$LoggedIn_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$closure$links = closure$links_0;
    this.local$this$LoggedIn = this$LoggedIn_0;
    this.local$tmp$ = void 0;
  }
  Coroutine$LoggedIn_init$lambda_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$LoggedIn_init$lambda_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$LoggedIn_init$lambda_0.prototype.constructor = Coroutine$LoggedIn_init$lambda_0;
  Coroutine$LoggedIn_init$lambda_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$closure$links.messages.await(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 6:
            var e_0 = this.result_0;
            if (equals(e_0, tictactoelib.GoOnline))
              window.location.hash = '#' + this.local$closure$links.online.name;
            else if (equals(e_0, tictactoelib.DisableNotifications))
              this.local$this$LoggedIn.messaging.disableNotifications();
            this.state_0 = 3;
            continue;
          case 7:
            return Unit;
  ...
  function LoggedIn_init$lambda_0(closure$links_0, this$LoggedIn_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$LoggedIn_init$lambda_0(closure$links_0, this$LoggedIn_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function main() {
    commonui.APP.serviceWorkerMessages;
    FbLinksFactory.Companion.start_gwo7fm$(tictactoelib.tictactoeLib, void 0, void 0, main$lambda);
  }
  ...
  OnlineBoardControl.prototype.click_4eku4n$ = KillsMessagingUixApi.prototype.click_4eku4n$;
  OnlineBoardControl.prototype.click_9375ex$ = KillsMessagingUixApi.prototype.click_9375ex$;
  OnlineBoardControl.prototype.click_512jbc$ = KillsMessagingUixApi.prototype.click_512jbc$;
  OnlineBoardControl.prototype.click_3zaxtq$ = KillsMessagingUixApi.prototype.click_3zaxtq$;
  OnlineBoardControl.prototype.click_ts68bh$ = KillsMessagingUixApi.prototype.click_ts68bh$;
  OnlineBoardControl.prototype.get_clickActivate_tvm2vp$ = KillsMessagingUixApi.prototype.get_clickActivate_tvm2vp$;
  OnlineBoardControl.prototype.get_clickToggle_tvm2vp$ = KillsMessagingUixApi.prototype.get_clickToggle_tvm2vp$;
  OnlineBoardControl.prototype.get_messagingButton_asww5s$ = KillsMessagingUixApi.prototype.get_messagingButton_asww5s$;
  OnlineBoardControl.prototype.get_messagingMenu_rp0x24$ = KillsMessagingUixApi.prototype.get_messagingMenu_rp0x24$;
  OnlineBoardControl.prototype.get_oldKilled_vsdo34$ = KillsMessagingUixApi.prototype.get_oldKilled_vsdo34$;
  OnlineBoardControl.prototype.get_oldKilledOpt_vsdo34$ = KillsMessagingUixApi.prototype.get_oldKilledOpt_vsdo34$;
  OnlineBoardControl.prototype.get_routing_lqv1tx$ = KillsMessagingUixApi.prototype.get_routing_lqv1tx$;
  OnlineBoardControl.prototype.rx_y6x17j$ = KillsMessagingUixApi.prototype.rx_y6x17j$;
  OnlineBoardControl.prototype.rx_46ic4w$ = KillsMessagingUixApi.prototype.rx_46ic4w$;
  OnlineBoardControl.prototype.rx_wgabca$ = KillsMessagingUixApi.prototype.rx_wgabca$;
  OnlineBoardControl.prototype.rx_djv61p$ = KillsMessagingUixApi.prototype.rx_djv61p$;
  OnlineBoardControl.prototype.addDirty_3529di$ = KillsMessagingUixApi.prototype.addDirty_3529di$;
  OnlineBoardControl.prototype.anyRx_tnde95$ = KillsMessagingUixApi.prototype.anyRx_tnde95$;
  OnlineBoardControl.prototype.attached_ux9tev$ = KillsMessagingUixApi.prototype.attached_ux9tev$;
  OnlineBoardControl.prototype.bind_zfaq6f$ = KillsMessagingUixApi.prototype.bind_zfaq6f$;
  OnlineBoardControl.prototype.bindValue_xy1r9h$ = KillsMessagingUixApi.prototype.bindValue_xy1r9h$;
  OnlineBoardControl.prototype.containsRx_1w65cx$ = KillsMessagingUixApi.prototype.containsRx_1w65cx$;
  OnlineBoardControl.prototype.enabled_hlnvpg$ = KillsMessagingUixApi.prototype.enabled_hlnvpg$;
  OnlineBoardControl.prototype.feedTo_9o5f67$ = KillsMessagingUixApi.prototype.feedTo_9o5f67$;
  OnlineBoardControl.prototype.filtered_tnde95$ = KillsMessagingUixApi.prototype.filtered_tnde95$;
  OnlineBoardControl.prototype.forEach_xwzbbo$ = KillsMessagingUixApi.prototype.forEach_xwzbbo$;
  OnlineBoardControl.prototype.forEach_35q7bt$ = KillsMessagingUixApi.prototype.forEach_35q7bt$;
  OnlineBoardControl.prototype.forEachLater_xwzbbo$ = KillsMessagingUixApi.prototype.forEachLater_xwzbbo$;
  OnlineBoardControl.prototype.forEachNonNull_cjboeh$ = KillsMessagingUixApi.prototype.forEachNonNull_cjboeh$;
  OnlineBoardControl.prototype.forEachTrue_aq5y71$ = KillsMessagingUixApi.prototype.forEachTrue_aq5y71$;
  OnlineBoardControl.prototype.incremented_eoy9qo$ = KillsMessagingUixApi.prototype.incremented_eoy9qo$;
  OnlineBoardControl.prototype.keepScreenAwake_ipfk82$ = KillsMessagingUixApi.prototype.keepScreenAwake_ipfk82$;
  OnlineBoardControl.prototype.linked_n1nom7$ = KillsMessagingUixApi.prototype.linked_n1nom7$;
  OnlineBoardControl.prototype.listen_ubid8w$ = KillsMessagingUixApi.prototype.listen_ubid8w$;
  OnlineBoardControl.prototype.map_jtxi0h$ = KillsMessagingUixApi.prototype.map_jtxi0h$;
  OnlineBoardControl.prototype.mapLive_1mq1ue$ = KillsMessagingUixApi.prototype.mapLive_1mq1ue$;
  OnlineBoardControl.prototype.on_2stdkb$ = KillsMessagingUixApi.prototype.on_2stdkb$;
  OnlineBoardControl.prototype.on_hgi4ad$ = KillsMessagingUixApi.prototype.on_hgi4ad$;
  OnlineBoardControl.prototype.onChange_oeam7t$ = KillsMessagingUixApi.prototype.onChange_oeam7t$;
  OnlineBoardControl.prototype.onChange_rlu5c6$ = KillsMessagingUixApi.prototype.onChange_rlu5c6$;
  OnlineBoardControl.prototype.onClick_pofl4w$ = KillsMessagingUixApi.prototype.onClick_pofl4w$;
  OnlineBoardControl.prototype.onInput_clfw57$ = KillsMessagingUixApi.prototype.onInput_clfw57$;
  OnlineBoardControl.prototype.onSnapshotNext_po64up$ = KillsMessagingUixApi.prototype.onSnapshotNext_po64up$;
  OnlineBoardControl.prototype.plusAssign_ubid8w$ = KillsMessagingUixApi.prototype.plusAssign_ubid8w$;
  OnlineBoardControl.prototype.process_7xi3v7$ = KillsMessagingUixApi.prototype.process_7xi3v7$;
  OnlineBoardControl.prototype.register_3ijkb1$ = KillsMessagingUixApi.prototype.register_3ijkb1$;
  OnlineBoardControl.prototype.remAssign_wgabca$ = KillsMessagingUixApi.prototype.remAssign_wgabca$;
  OnlineBoardControl.prototype.remAssign_djv61p$ = KillsMessagingUixApi.prototype.remAssign_djv61p$;
  OnlineBoardControl.prototype.remAssign_7fncnf$ = KillsMessagingUixApi.prototype.remAssign_7fncnf$;
  OnlineBoardControl.prototype.runView_n76bhm$ = KillsMessagingUixApi.prototype.runView_n76bhm$;
  OnlineBoardControl.prototype.rxClass_9npl0m$ = KillsMessagingUixApi.prototype.rxClass_9npl0m$;
  OnlineBoardControl.prototype.rxClass_62ldac$ = KillsMessagingUixApi.prototype.rxClass_62ldac$;
  OnlineBoardControl.prototype.rxClass_c5yvvx$ = KillsMessagingUixApi.prototype.rxClass_c5yvvx$;
  OnlineBoardControl.prototype.rxClass_6sflyw$ = KillsMessagingUixApi.prototype.rxClass_6sflyw$;
  OnlineBoardControl.prototype.signIn_tstgz9$ = KillsMessagingUixApi.prototype.signIn_tstgz9$;
  OnlineBoardControl.prototype.signOut_tstgz9$ = KillsMessagingUixApi.prototype.signOut_tstgz9$;
  OnlineBoardControl.prototype.toChannel_z5dyp2$ = KillsMessagingUixApi.prototype.toChannel_z5dyp2$;
  OnlineBoardControl.prototype.toChannelLater_z5dyp2$ = KillsMessagingUixApi.prototype.toChannelLater_z5dyp2$;
  OnlineBoardControl.prototype.toRxSet_jr4bl4$ = KillsMessagingUixApi.prototype.toRxSet_jr4bl4$;
  OnlineBoardControl.prototype.visibility_12lt6u$ = KillsMessagingUixApi.prototype.visibility_12lt6u$;
  OnlineBoardControl.prototype.visible_od9jl4$ = KillsMessagingUixApi.prototype.visible_od9jl4$;
  ...
  return _;
}(typeof this['appsimake-tictactoe'] === 'undefined' ? {} : this['appsimake-tictactoe'], kotlin, this['appsimake-commonui'], this['appsimake-tictactoelib'], this['kotlinx-coroutines-core'], this['appsimake-firebase'], this['appsimake-commonshr'], this['appsimake-domx'], this['appsimake-fontawesome'], this['appsimake-commonfb'], this['appsimake-bootstrap']);
