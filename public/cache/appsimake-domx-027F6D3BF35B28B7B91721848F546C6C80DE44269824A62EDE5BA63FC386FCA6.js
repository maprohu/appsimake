...
this['appsimake-domx'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_common) {
  ...
  var RxList$Listener = $module$appsimake_commonshr.rx.RxList.Listener;
  ...
  function clickEvent($receiver, fn) {
    $receiver.addEventListener('click', clickEvent$lambda(fn));
  }
  ...
  function clickEventSeq$lambda(closure$fn, closure$seq) {
    return function (it) {
      it.preventDefault();
      closure$fn(closure$seq.killSet(), it);
      return Unit;
    };
  }
  function clickEventSeq($receiver, ks, fn) {
    var seq_0 = seq(ks);
    $receiver.onclick = clickEventSeq$lambda(fn, seq_0);
  }
  ...
  function rxEnabled($receiver, ks, rx) {
    rx.forEach_aaomyj$(ks, rxEnabled$lambda($receiver));
  }
  ...
  function rxEnabled_0($receiver, deps, fn) {
    ...
    rxEnabled($receiver, deps.kills, $receiver_0);
  }
  ...
  function rxVisible($receiver, deps, rxv) {
    rxv.forEach_aaomyj$(deps.kills, rxVisible$lambda($receiver));
  }
  function rxVisible_0($receiver, deps, fn) {
    var $receiver_0 = Rx_init(deps.kills, fn);
    rxVisible($receiver, killable.HasNoKill, $receiver_0);
    return $receiver_0;
  }
  ...
  function rxDisplayed($receiver, ks, fn) {
    var rxv = Rx_init(ks, rxDisplayed$lambda(fn));
    rxDisplayed_0($receiver, ks, rxv);
  }
    ...
    return function ($receiver, v) {
      ...
      if (v) {
        if (!get_isDisplayed(this$rxDisplayed)) {
          var $receiver_0 = drop(previousChain(closure$childRole), 1);
          var firstOrNull$result;
          firstOrNull$break: do {
            var tmp$_0;
  ...
  function rxDisplayed_0($receiver, ks, rxv) {
    ...
    rxv.forEach_aaomyj$(ks, rxDisplayed$lambda_0($receiver, childRole, parent));
  }
  ...
  function listenableList($receiver, ks, list, create) {
    plusAssign(ks, list.addListener_6zudpe$(new RxList$Listener(listenableList$lambda(create, $receiver), listenableList$lambda_0($receiver), listenableList$lambda_1($receiver))));
  }
  function listenableList$lambda_2(closure$ks, closure$create, this$listenableList, closure$kills) {
    return function (index, element) {
      var iks = killables(closure$ks);
      var node = closure$create(element, iks.killSet);
      insertAt(this$listenableList, index, node);
      closure$kills.add_wxm5ur$(index, iks.kill);
      return Unit;
    };
  }
  function listenableList$lambda_3(this$listenableList, closure$kills) {
    return function (index, f) {
      removeAt(this$listenableList, index);
      closure$kills.removeAt_za3lpa$(index)();
      return Unit;
    };
  }
  ...
  function listenableList_0($receiver, ks, list, create) {
    var kills = ArrayList_init();
    plusAssign(ks, list.addListener_6zudpe$(new RxList$Listener(listenableList$lambda_2(ks, create, $receiver, kills), listenableList$lambda_3($receiver, kills), listenableList$lambda_4($receiver, kills))));
  }
  var domx = defineInlineFunction('appsimake-domx.domx.domx_yl91pu$', wrapFunction(function () {
    return function ($receiver, fn) {
      return fn($receiver);
    };
  }));
  function DomxHasKillSet() {
  }
  DomxHasKillSet.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DomxHasKillSet',
    interfaces: [KillsApi]
  };
  ...
  function defParam$ObjectLiteral$getValue$lambda$lambda$lambda(this$) {
    return function ($receiver) {
      get_classes($receiver).plusAssign_pdl1vj$(this$);
      return Unit;
    };
  }
  ...
  package$domx.clickEvent_pofl4w$ = clickEvent;
  package$domx.longClick_j9bshf$ = longClick;
  package$domx.clickEventSeq_af1ohy$ = clickEventSeq;
  ...
  package$domx.rxEnabled_biqke9$ = rxEnabled;
  package$domx.rxEnabled_3afqaq$ = rxEnabled_0;
  package$domx.rxVisible_agztjd$ = rxVisible;
  package$domx.rxVisible_8fv2i1$ = rxVisible_0;
  ...
  package$domx.rxDisplayed_y8cljz$ = rxDisplayed;
  package$domx.rxDisplayed_4g3vmm$ = rxDisplayed_0;
  ...
  package$domx.listenableList_sgm3r2$ = listenableList;
  package$domx.listenableList_11j6pq$ = listenableList_0;
  $$importsForInline$$['appsimake-domx'] = _;
  package$domx.domx_yl91pu$ = domx;
  package$domx.DomxHasKillSet = DomxHasKillSet;
  ...
  DomxHasKillSet.prototype.rx_y6x17j$ = KillsApi.prototype.rx_y6x17j$;
  DomxHasKillSet.prototype.rx_46ic4w$ = KillsApi.prototype.rx_46ic4w$;
  DomxHasKillSet.prototype.rx_wgabca$ = KillsApi.prototype.rx_wgabca$;
  DomxHasKillSet.prototype.rx_djv61p$ = KillsApi.prototype.rx_djv61p$;
  DomxHasKillSet.prototype.containsRx_1w65cx$ = KillsApi.prototype.containsRx_1w65cx$;
  DomxHasKillSet.prototype.feedTo_9o5f67$ = KillsApi.prototype.feedTo_9o5f67$;
  DomxHasKillSet.prototype.filtered_tnde95$ = KillsApi.prototype.filtered_tnde95$;
  DomxHasKillSet.prototype.forEach_xwzbbo$ = KillsApi.prototype.forEach_xwzbbo$;
  DomxHasKillSet.prototype.forEach_35q7bt$ = KillsApi.prototype.forEach_35q7bt$;
  DomxHasKillSet.prototype.forEachLater_xwzbbo$ = KillsApi.prototype.forEachLater_xwzbbo$;
  DomxHasKillSet.prototype.incremented_eoy9qo$ = KillsApi.prototype.incremented_eoy9qo$;
  DomxHasKillSet.prototype.linked_n1nom7$ = KillsApi.prototype.linked_n1nom7$;
  DomxHasKillSet.prototype.listen_ubid8w$ = KillsApi.prototype.listen_ubid8w$;
  DomxHasKillSet.prototype.map_jtxi0h$ = KillsApi.prototype.map_jtxi0h$;
  DomxHasKillSet.prototype.mapLive_1mq1ue$ = KillsApi.prototype.mapLive_1mq1ue$;
  DomxHasKillSet.prototype.onChange_rlu5c6$ = KillsApi.prototype.onChange_rlu5c6$;
  DomxHasKillSet.prototype.plusAssign_ubid8w$ = KillsApi.prototype.plusAssign_ubid8w$;
  DomxHasKillSet.prototype.process_7xi3v7$ = KillsApi.prototype.process_7xi3v7$;
  DomxHasKillSet.prototype.remAssign_wgabca$ = KillsApi.prototype.remAssign_wgabca$;
  DomxHasKillSet.prototype.remAssign_djv61p$ = KillsApi.prototype.remAssign_djv61p$;
  DomxHasKillSet.prototype.remAssign_7fncnf$ = KillsApi.prototype.remAssign_7fncnf$;
  DomxHasKillSet.prototype.rxClass_c5yvvx$ = KillsApi.prototype.rxClass_c5yvvx$;
  DomxHasKillSet.prototype.rxClass_6sflyw$ = KillsApi.prototype.rxClass_6sflyw$;
  DomxHasKillSet.prototype.toChannelLater_z5dyp2$ = KillsApi.prototype.toChannelLater_z5dyp2$;
  DomxHasKillSet.prototype.toRxSet_jr4bl4$ = KillsApi.prototype.toRxSet_jr4bl4$;
  nextId = 0;
