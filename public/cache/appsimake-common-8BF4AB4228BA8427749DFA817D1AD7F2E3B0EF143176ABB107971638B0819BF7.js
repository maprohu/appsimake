...
this['appsimake-common'] = function (_, Kotlin, $module$appsimake_commonshr, $module$kotlinx_coroutines_core) {
  ...
  function attachEnabler($receiver, ks, enabled) {
    enabled.forEach_yk5nc8$(ks, attachEnabler$lambda($receiver));
  }
  ...
  function SortedListenableListConfig$build$Holder(closure$result, this$SortedListenableListConfig, holders, sorted, item, holdersIndex) {
    ...
    this.krx.forEachLater_z9f4ga$(this.ks.killSet, void 0, void 0, SortedListenableListConfig$build$SortedListenableListConfig$build$Holder_init$lambda(this, closure$result));
  }
  ...
  SortedListenableListConfig.prototype.build = function () {
    ...
    this.killables.plusAssign_o14v8n$(this.list.addListener_ednqrc$(new ListenableList$Listener(SortedListenableListConfig$build$lambda(holders, sorted, result, this), SortedListenableListConfig$build$lambda_0(holders), SortedListenableListConfig$build$lambda_1(holders))));
    return result;
  };
  ...
  function FilteredListenableListConfig$build$Holder(closure$result, this$FilteredListenableListConfig, holders, item, holdersIndex) {
    ...
    this.key.forEach_yk5nc8$(this.ks.killSet, FilteredListenableListConfig$build$FilteredListenableListConfig$build$Holder_init$lambda(this));
  }
  ...
  FilteredListenableListConfig.prototype.build = function () {
    var result = new ListenableMutableList();
    var holders = ArrayList_init();
    this.input.forEachLater_z9f4ga$(this.killables, void 0, void 0, FilteredListenableListConfig$build$lambda(holders));
