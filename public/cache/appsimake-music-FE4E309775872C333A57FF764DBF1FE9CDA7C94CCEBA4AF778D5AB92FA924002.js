...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonshr, $module$appsimake_commonfb, $module$kotlinx_coroutines_core, $module$appsimake_firebase, $module$appsimake_indexeddb, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_musiclib, $module$appsimake_fontawesome, $module$appsimake_common, $module$appsimake_firebaseshr, $module$appsimake_commonlib) {
  ...
  function Database(from) {
    ...
    this.rawView_vrycfe$_0 = ui_1(this);
  }
  ...
  function Details(from) {
    ...
    this.rawView_ndpus1$_0 = ui_0(this);
  }
  ...
  function ui$lambda$lambda(this$ui) {
    return function ($receiver) {
      ...
      statusPanel(this$ui.cloud, 'Cloud', ui$lambda$lambda$lambda_0(this$ui));
  ...
  function ui$lambda$lambda_0(this$ui) {
    return function ($receiver) {
      ...
      statusPanel(this$ui.toBeDownloaded, 'To Be Downloaded', ui$lambda$lambda$lambda_2(this$ui));
      statusPanel(this$ui.toBeUploaded, 'To Be Uploaded', ui$lambda$lambda$lambda_3(this$ui));
      statusPanel(this$ui.toBeDeleted, 'To Be Deleted', ui$lambda$lambda$lambda_4(this$ui));
  ...
  function ui_1($receiver) {
    ...
    invoke($receiver_7.pane, ui$lambda$lambda_0($receiver));
  ...
  function Import(from) {
    ...
    this.rawView_xbdjti$_0 = ui_2(this);
  ...
  function ImportFile(import_0, file, playable) {
    ...
    this.rawView_2r18my$_0 = ui_3(this);
  ...
  function ui$lambda$lambda$lambda_5(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui_2($receiver) {
    ...
    var $receiver_1 = $receiver_0.left.button;
    $receiver_1.back;
    $receiver.click_3xepc3$($receiver_1, ui$lambda$lambda$lambda_5($receiver));
    ...
    if (commonui.webkitdirectorySupported) {
      var $receiver_3 = invoke(get_input(inputContainer), ui$lambda$lambda$lambda_6($receiver));
      invoke(get_label($receiver_2.node), ui$lambda$lambda$lambda$lambda_1($receiver_3));
    }
    var $receiver_4 = invoke(get_input(inputContainer), ui$lambda$lambda$lambda_7($receiver));
    ...
    listenableList($receiver_9.pane, $receiver.kills, $receiver.loadList, ui$lambda$lambda_1);
  ...
  function ui$lambda(this$ui) {
    return function ($receiver) {
      ...
      get_dFlex($receiver_0);
      get_flexColumn($receiver_0);
      invoke(get_dl($receiver), ui$lambda$lambda_2(this$ui));
      invoke(get_div($receiver), ui$lambda$lambda_3(this$ui));
      return Unit;
    };
  }
  ...
  function LoggedIn(from, user, app, db, functions, storage, songInfoSource, userSongs) {
    ...
    this.rawView_mrgtfa$_0 = ui_4(this);
  }
  ...
  function ui_4($receiver) {
    ...
    invoke($receiver_6.node, ui$lambda$lambda$lambda_11($receiver_6));
  ...
  function NotLoggedIn(boot, app) {
    ...
    this.rawView_sonhr6$_0 = ui_5(this);
  }
  ...
  function ui_5($receiver) {
    ...
    invoke($receiver_4.node, ui$lambda$lambda$lambda_12($receiver_4));
    return new TopAndContent($receiver_0.node, null);
  }
  ...
  function ui$lambda$lambda_5(closure$totalDurationText) {
    return function ($receiver) {
      return closure$totalDurationText.invoke().length;
    };
  }
  function ui$lambda$lambda_6(this$ui, closure$totalDurationTextLength) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda_20(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda_21(this$ui, closure$mediaButton, closure$likeButtonsDisabled, closure$state) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
  ...
  function ui$lambda$lambda_11(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText, closure$likeButtonsDisabled, closure$state) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      ...
      row_0($receiver, ui$lambda$lambda$lambda_20(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText));
      row_0($receiver, ui$lambda$lambda$lambda_21(this$ui, mediaButton, closure$likeButtonsDisabled, closure$state));
      return Unit;
    };
  }
  function ui_6($receiver) {
    var $receiver_0 = new Factory();
    var totalDurationText = $receiver.rx_pn7ch0$(ui$lambda$lambda_4($receiver));
    var totalDurationTextLength = $receiver.rx_pn7ch0$(ui$lambda$lambda_5(totalDurationText));
    var currentPositionText = $receiver.rx_pn7ch0$(ui$lambda$lambda_6($receiver, totalDurationTextLength));
    var likeButtonsDisabled = $receiver.rx_pn7ch0$(ui$lambda$lambda_7($receiver));
    var state = $receiver.userSong;
    var artistTitle = $receiver.rx_pn7ch0$(ui$lambda$lambda_8($receiver));
    var artist = $receiver.rx_pn7ch0$(ui$lambda$lambda_9(artistTitle));
    var title = $receiver.rx_pn7ch0$(ui$lambda$lambda_10(artistTitle));
    if (mediasession.mediaSessionSupported) {
      var $receiver_1 = window.navigator.mediaSession;
      $receiver.forEach_5mel8p$(artistTitle, ui$lambda$lambda$lambda_13($receiver_1));
      $receiver_1.setActionHandler('play', ui$lambda$lambda$lambda_14($receiver));
      $receiver_1.setActionHandler('pause', ui$lambda$lambda$lambda_15($receiver));
      $receiver_1.setActionHandler('seekbackward', ui$lambda$lambda$lambda_16($receiver));
      $receiver_1.setActionHandler('seekforward', ui$lambda$lambda$lambda_17($receiver));
      $receiver_1.setActionHandler('previoustrack', ui$lambda$lambda$lambda_18($receiver));
      $receiver_1.setActionHandler('nexttrack', ui$lambda$lambda$lambda_19($receiver));
    }
    return $receiver_0.wraps.div_iw61es$(ui$lambda$lambda_11($receiver, artist, title, currentPositionText, totalDurationText, likeButtonsDisabled, state)).node;
  }
  var SeekSeconds;
  ...
  function Visible(boot) {
    ...
    this.rawView_13lnzh$_0 = ui_6(this);
  }
  ...
  function Status(from, database, status, title, bgfn) {
    ...
    this.rawView_avgzzq$_0 = ui_7(this);
  }
  ...
  function ui$lambda$lambda$lambda_22(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda$lambda_23(this$ui_0, this$_0) {
    return function ($receiver_0, continuation_0, suspended) {
  ...
  function ui$lambda$lambda_12(this$ui) {
    return function ($receiver) {
      get_p1(get_cls($receiver));
      launch(this$ui, void 0, void 0, ui$lambda$lambda$lambda_23(this$ui, $receiver));
      return Unit;
    };
  }
  function ui_7($receiver) {
    ...
    var $receiver_1 = $receiver_0.left.button;
    $receiver_1.back;
    $receiver.click_3xepc3$($receiver_1, ui$lambda$lambda$lambda_22($receiver));
    $receiver.tasksUi_tdhe4g$($receiver_0.right);
    $receiver.syncUi_e1rmy3$($receiver_0.slots.right.slots);
    var $receiver_2 = $receiver_0.right.buttonGroup;
    $receiver_2.m1;
    ...
    invoke($receiver_3.pane, ui$lambda$lambda_12($receiver));
  ...
  package$details.ui_nf38ql$ = ui_0;
  package$database.ui_ihgqlm$ = ui_1;
  ...
  package$import.ui_1redzq$ = ui_2;
  package$import.ui_jya5ma$ = ui_3;
  ...
  package$loggedin.ui_yshx4m$ = ui_4;
  ...
  package$notloggedin.ui_njwtce$ = ui_5;
