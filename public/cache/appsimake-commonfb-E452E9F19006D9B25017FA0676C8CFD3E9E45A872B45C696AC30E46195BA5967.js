...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_commonui, $module$appsimake_firebaseshr, $module$appsimake_firebase, $module$kotlinx_coroutines_core, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common) {
  ...
  var addedTo_0 = $module$appsimake_commonshr.killable.addedTo_wvpfik$;
  ...
  function FbCtx(appCtx, lib) {
    this.appCtx = appCtx;
    this.lib = lib;
    this.app = FB_getInstance().app;
    this.name = this.lib.name;
    this.db_qixv9q$_0 = FB_getInstance().db;
  ...
  var SignOut_instance = null;
  function SignOut_getInstance() {
    if (SignOut_instance === null) {
      new SignOut();
    }
    return SignOut_instance;
  }
  function SignIn() {
    SignIn_instance = this;
  }
  SignIn.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'SignIn',
  ...
  var SignIn_instance = null;
  function SignIn_getInstance() {
    if (SignIn_instance === null) {
      new SignIn();
    }
    return SignIn_instance;
  }
  function Coroutine$signOut$lambda(continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
  }
  Coroutine$signOut$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$signOut$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$signOut$lambda.prototype.constructor = Coroutine$signOut$lambda;
  Coroutine$signOut$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function signOut$lambda(continuation_0, suspended) {
    var instance = new Coroutine$signOut$lambda(continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$signOut$lambda_0(closure$app_0, closure$fn_0, e_0, els_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
  ...
  Coroutine$signOut$lambda_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$signOut$lambda_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$signOut$lambda_0.prototype.constructor = Coroutine$signOut$lambda_0;
  Coroutine$signOut$lambda_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (equals(this.local$e, SignOut_getInstance())) {
              this.local$closure$app.auth().signOut();
              this.state_0 = 3;
  ...
  function signOut$lambda_0(closure$app_0, closure$fn_0) {
    return function (e_0, els_0, continuation_0, suspended) {
      var instance = new Coroutine$signOut$lambda_0(closure$app_0, closure$fn_0, e_0, els_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function signOut(app, fn) {
    if (app === void 0)
      app = FB_getInstance().app;
    if (fn === void 0)
      fn = signOut$lambda;
    return signOut$lambda_0(app, fn);
  }
  function NotLoggedIn() {
    NotLoggedIn_instance = this;
  }
  ...
  var NotLoggedIn_instance = null;
  function NotLoggedIn_getInstance() {
    if (NotLoggedIn_instance === null) {
      new NotLoggedIn();
    }
    return NotLoggedIn_instance;
  }
  ...
  function runLoginEvents$lambda(this$runLoginEvents) {
    return function (user) {
      var tmp$;
      tmp$ = this$runLoginEvents;
      var tmp$_0;
      if (user == null) {
        tmp$_0 = NotLoggedIn_getInstance();
      }
       else {
        tmp$_0 = new LoggedIn(user);
      }
      plusAssign(tmp$, tmp$_0);
      return Unit;
    };
  }
  function runLoginEvents($receiver, kills, app) {
    if (app === void 0)
      app = FB_getInstance().app;
    addedTo_0(app.auth().onAuthStateChanged(runLoginEvents$lambda($receiver)), kills);
  }
  ...
  Object.defineProperty(package$commonfb, 'SignOut', {
    get: SignOut_getInstance
  });
  Object.defineProperty(package$commonfb, 'SignIn', {
    get: SignIn_getInstance
  });
  package$commonfb.signOut_uctwgq$ = signOut;
  Object.defineProperty(package$commonfb, 'NotLoggedIn', {
    get: NotLoggedIn_getInstance
  });
  package$commonfb.LoggedIn = LoggedIn;
  package$commonfb.runLoginEvents_50sxdr$ = runLoginEvents;
