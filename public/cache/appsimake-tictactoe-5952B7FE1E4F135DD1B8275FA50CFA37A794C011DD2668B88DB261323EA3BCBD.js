...
this['appsimake-tictactoe'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_tictactoelib, $module$kotlinx_coroutines_core, $module$appsimake_firebase, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_fontawesome, $module$appsimake_bootstrap, $module$appsimake_commonfb) {
  ...
  var HasUser = $module$appsimake_firebase.firebase.HasUser;
  ...
  function Active(from, linkage) {
    ...
    this.forEach_xwzbbo$(this.gState, Active_init$lambda(this));
    launchReport(this, Active_init$lambda_0(this));
  }
    ...
    do
      try {
        switch (this.state_0) {
          ...
          case 2:
            if (!this.local$closure$andWait) {
              return this.local$this$Active.back(), Unit;
            }
             else {
              this.state_0 = 3;
              continue;
  ...
  function Active$gState$lambda(this$Active) {
    return function ($receiver) {
      var gs = this$Active.loggedIn.gameStatus.invoke();
      var block$result;
  ...
  Coroutine$Active_init$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$tmp$ = this.local$this$Active.toChannel_z5dyp2$(this.local$this$Active.loggedIn.gameStatus).iterator();
            this.state_0 = 2;
            continue;
          case 1:
            throw this.exception_0;
  ...
  function Active_init$lambda_0(this$Active_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda($receiver) {
    ...
    invoke(get_div($receiver), ui$lambda$lambda$lambda_0);
    return Unit;
  }
  ...
  function ui$lambda$lambda$lambda$lambda(closure$url) {
    return function () {
  ...
  function ui$lambda$lambda_0(this$ui) {
    return function ($receiver) {
      ...
      var url = invoke(get_input($receiver), ui$lambda$lambda$lambda_1);
      ...
      this$ui_0.click_9375ex$($receiver_0, ui$lambda$lambda$lambda$lambda(url));
      return Unit;
    };
  }
  ...
  Waiting.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Waiting',
    interfaces: [BackCsDbKillsUixApi, HasBack, WaitingPath, ActivePath, CsKillsView, HasKillKillsView]
  };
  function BoardPath() {
  }
  BoardPath.$metadata$ = {
  ...
  function ui$lambda_1(this$ui) {
    return function ($receiver) {
      ...
      var this$ui_0 = this$ui;
      $receiver_1.primary;
      this$ui_0.remAssign_7fncnf$($receiver_1.text, ui$lambda$lambda$lambda_2(this$ui_0));
      this$ui_0.click_9375ex$($receiver_1, ui$lambda$lambda$lambda_3(this$ui_0));
      return Unit;
    };
  }
  function ui_1($receiver) {
    ...
    $receiver.signOut_tstgz9$($receiver_2, ui$lambda$lambda$lambda$lambda_0($receiver));
  ...
  package$active.flow_n185ym$ = flow;
