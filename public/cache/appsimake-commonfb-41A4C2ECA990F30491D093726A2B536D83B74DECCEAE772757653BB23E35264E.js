...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_firebase, $module$kotlinx_coroutines_core, $module$appsimake_firebaseshr, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_commonui, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common) {
  'use strict';
  ...
  function Login(parent, app, back, loggingIn, loginFailed) {
  ...
  function Coroutine$tryLogin_g2bo5h$($this, fn_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 6;
    this.$this = $this;
    this.local$fn = fn_0;
  }
  Coroutine$tryLogin_g2bo5h$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$tryLogin_g2bo5h$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$tryLogin_g2bo5h$.prototype.constructor = Coroutine$tryLogin_g2bo5h$;
  Coroutine$tryLogin_g2bo5h$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  Login.prototype.tryLogin_g2bo5h$ = function (fn_0, continuation_0, suspended) {
    var instance = new Coroutine$tryLogin_g2bo5h$(this, fn_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 2;
            this.result_0 = this.local$this$Login.tryLogin_g2bo5h$(Login$google$lambda$lambda(this.local$this$Login, provider), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Login.prototype.google = function (continuation) {
    launch(coroutines.GlobalScope, void 0, void 0, Login$google$lambda(this));
  };
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$Login.tryLogin_g2bo5h$(Login$guest$lambda$lambda(this.local$this$Login), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Login.prototype.guest = function (continuation) {
    launch(coroutines.GlobalScope, void 0, void 0, Login$guest$lambda(this));
  };
  Login.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Login',
  ...
  Coroutine$ui$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$ui.back();
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui$lambda$lambda($receiver) {
    invoke(get_h5($receiver), ui$lambda$lambda$lambda_0);
    return Unit;
  }
  ...
  function ui$lambda$lambda$lambda_3($receiver) {
    get_user($receiver);
    return Unit;
  }
  ...
  function ui$lambda$lambda$lambda_4(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda_0(this$ui) {
    return function ($receiver) {
      ...
      butt(FaIcon.Companion.faBrands_xqq80m$(ui$lambda$lambda$lambda_1), 'Sign in with Google', ui$lambda$lambda$lambda_2(this$ui));
      butt(FaIcon.Companion.fa_k1ws5a$(ui$lambda$lambda$lambda_3), 'Continue as guest', ui$lambda$lambda$lambda_4(this$ui));
      return Unit;
    };
  }
  ...
  function Coroutine$runUserState$lambda(it_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$it = it_0;
  }
  ...
  function runUserState$lambda(it_0, continuation_0, suspended) {
    var instance = new Coroutine$runUserState$lambda(it_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function runUserState$lambda_0(closure$ch) {
    return function () {
      closure$ch.close_dbl4no$();
      return Unit;
    };
  }
  function Coroutine$runUserState$lambda_0(closure$ch_0, closure$fn_0, closure$rxv_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
      ...
      try {
        switch (this.state_0) {
          ...
          case 5:
            ...
            this.state_0 = 6;
            this.result_0 = this.local$closure$fn(u, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 6:
  ...
  function runUserState$lambda_1(closure$ch_0, closure$fn_0, closure$rxv_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$runUserState$lambda_0(closure$ch_0, closure$fn_0, closure$rxv_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function runUserState$lambda_2(closure$ch) {
    return function (u) {
      var tmp$;
      tmp$ = closure$ch;
      var tmp$_0;
      if (u == null) {
        tmp$_0 = UserState$NotLoggedIn_getInstance();
      }
       else {
        tmp$_0 = new UserState$LoggedIn(u);
      }
      plusAssign_0(tmp$, tmp$_0);
      return Unit;
    };
  }
  function runUserState$lambda_3(closure$ch) {
    return function (e) {
      report(e);
      plusAssign_0(closure$ch, UserState$NotLoggedIn_getInstance());
      return Unit;
    };
  }
  function runUserState($receiver, app, fn) {
    if (app === void 0)
    ...
    var ch = Channel();
    plusAssign($receiver.kills, runUserState$lambda_0(ch));
    launch(coroutines.GlobalScope, void 0, void 0, runUserState$lambda_1(ch, fn, rxv));
    plusAssign($receiver.kills, app.auth().onAuthStateChanged(runUserState$lambda_2(ch), runUserState$lambda_3(ch)));
    return rxv;
  }
  ...
  package$commonfb.runUserState_g2eoyy$ = runUserState;
  ...
  return _;
}(typeof this['appsimake-commonfb'] === 'undefined' ? {} : this['appsimake-commonfb'], kotlin, this['appsimake-firebase'], this['kotlinx-coroutines-core'], this['appsimake-firebaseshr'], this['appsimake-commonshr'], this['appsimake-domx'], this['appsimake-commonui'], this['appsimake-bootstrap'], this['appsimake-fontawesome'], this['appsimake-common']);
