...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_commonui, $module$appsimake_firebase, $module$kotlinx_coroutines_core, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common, $module$appsimake_commonlib) {
  ...
  FilterConfig.prototype.component1 = function () {
    return this.panel;
  };
  FilterConfig.prototype.copy_iw61es$ = function (panel) {
    return new FilterConfig(panel === void 0 ? this.panel : panel);
  };
  FilterConfig.prototype.toString = function () {
    return 'FilterConfig(panel=' + Kotlin.toString(this.panel) + ')';
  };
  FilterConfig.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.panel) | 0;
    return result;
  };
  FilterConfig.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && Kotlin.equals(this.panel, other.panel))));
  };
  function ListScreenConfig(title, create, view, edit, query, itemText, filter) {
    if (filter === void 0)
      filter = null;
    this.title = title;
    this.create = create;
  ...
  ListScreenConfig.prototype.copy_5lnwop$ = function (title, create, view, edit, query, itemText, filter) {
    return new ListScreenConfig(title === void 0 ? this.title : title, create === void 0 ? this.create : create, view === void 0 ? this.view : view, edit === void 0 ? this.edit : edit, query === void 0 ? this.query : query, itemText === void 0 ? this.itemText : itemText, filter === void 0 ? this.filter : filter);
  };
  ListScreenConfig.prototype.toString = function () {
    return 'ListScreenConfig(title=' + Kotlin.toString(this.title) + (', create=' + Kotlin.toString(this.create)) + (', view=' + Kotlin.toString(this.view)) + (', edit=' + Kotlin.toString(this.edit)) + (', query=' + Kotlin.toString(this.query)) + (', itemText=' + Kotlin.toString(this.itemText)) + (', filter=' + Kotlin.toString(this.filter)) + ')';
  };
  ...
  ListScreenConfig.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.title, other.title) && Kotlin.equals(this.create, other.create) && Kotlin.equals(this.view, other.view) && Kotlin.equals(this.edit, other.edit) && Kotlin.equals(this.query, other.query) && Kotlin.equals(this.itemText, other.itemText) && Kotlin.equals(this.filter, other.filter)))));
  };
  ...
  function build$lambda$lambda$lambda_2(closure$isBusy, closure$close, this$build, closure$filterOpen, closure$killables, closure$panel, closure$displayList) {
    return function ($receiver) {
  ...
  function build$lambda$lambda$lambda$lambda$lambda_8(this$build) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(build$lambda$lambda$lambda$lambda$lambda$lambda_8);
      this$build.filter.panel($receiver);
      return Unit;
    };
  }
  function build$lambda$lambda$lambda$lambda_4(closure$filterOpen, this$build) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(build$lambda$lambda$lambda$lambda$lambda_7);
      rxDisplayed($receiver, closure$filterOpen);
      invoke(get_div($receiver), build$lambda$lambda$lambda$lambda$lambda_8(this$build));
      return Unit;
    };
  }
  ...
  function build$lambda$lambda$lambda$lambda$lambda$lambda_9(this$build, closure$panel, closure$item) {
    return function (close) {
      return this$build.view(closure$panel.sub(), closure$item, close);
    };
  }
  function build$lambda$lambda$lambda$lambda$lambda_11(this$build, closure$panel) {
    return function (item) {
      return build$lambda$lambda$lambda$lambda$lambda$lambda_9(this$build, closure$panel, item);
    };
  }
  ...
  function build$lambda$lambda$lambda$lambda$lambda_12(closure$listRoot, this$build) {
    return function (show) {
      return new ListUIConfig(closure$listRoot, this$build.create, void 0, void 0, void 0, build$lambda$lambda$lambda$lambda$lambda$lambda_10, stringListClick(this$build.itemText, show));
    };
  }
  function build$lambda$lambda$lambda$lambda_5(closure$killables, this$build, closure$displayList, closure$panel) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(build$lambda$lambda$lambda$lambda$lambda_9);
      var listRoot = new RootPanel($receiver);
      closure$killables.plusAssign_o14v8n$(showClosableList(this$build.query, build$lambda$lambda$lambda$lambda$lambda_10(closure$displayList), build$lambda$lambda$lambda$lambda$lambda_11(this$build, closure$panel), build$lambda$lambda$lambda$lambda$lambda_12(listRoot, this$build)));
      return Unit;
    };
  }
  function build$lambda$lambda$lambda_3(this$build, closure$filterOpen, closure$killables, closure$displayList, closure$panel) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(build$lambda$lambda$lambda$lambda_3);
      if (this$build.filter != null) {
        invoke(get_div($receiver), build$lambda$lambda$lambda$lambda_4(closure$filterOpen, this$build));
      }
      invoke(get_div($receiver), build$lambda$lambda$lambda$lambda_5(closure$killables, this$build, closure$displayList, closure$panel));
      return Unit;
    };
  }
  function build$lambda$lambda_4(closure$isBusy, closure$close, this$build, closure$killables, closure$panel, closure$displayList) {
    return function ($receiver) {
      var filterOpen = new Var(false);
      $receiver.top_vesf63$(build$lambda$lambda$lambda_2(closure$isBusy, closure$close, this$build, filterOpen, closure$killables, closure$panel, closure$displayList));
      $receiver.main_iw61es$(build$lambda$lambda$lambda_3(this$build, filterOpen, closure$killables, closure$displayList, closure$panel));
      return Unit;
    };
  }
  function build$lambda_7(closure$panel, closure$killables, closure$isBusy, closure$close, this$build) {
    return function ($receiver) {
      var displayList = build$lambda$displayList(closure$panel, $receiver);
      screenLayout($receiver, closure$killables, build$lambda$lambda_4(closure$isBusy, closure$close, this$build, closure$killables, closure$panel, displayList));
      return Unit;
    };
  }
  function build_0($receiver, panel, close) {
    ...
    var killables = new Killables();
    panel.newRoot_iw61es$(build$lambda_7(panel, killables, isBusy, close, $receiver));
    return killables;
  }
  ...
  function build$lambda$lambda$lambda_5(closure$killables, this$build, closure$item) {
    return function ($receiver) {
  ...
  function build$lambda$lambda_5(closure$close, this$build, closure$panel, closure$item, closure$displayViewer, closure$killables) {
    return function ($receiver) {
      ...
      $receiver.main_iw61es$(build$lambda$lambda$lambda_5(closure$killables, this$build, closure$item));
      return Unit;
    };
  }
