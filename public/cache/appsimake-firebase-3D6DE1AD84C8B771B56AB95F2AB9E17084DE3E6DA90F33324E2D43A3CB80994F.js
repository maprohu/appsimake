...
this['appsimake-firebase'] = function (_, Kotlin, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_common, $module$appsimake_firebaseshr) {
  ...
  var CoroutineWithKills = $module$appsimake_commonshr.commonshr.CoroutineWithKills;
  ...
  get_fbapi$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [FirebaseApi, HasKillSet]
  };
  ...
  function documentChanges$lambda(closure$channel) {
    return function (qs) {
      var $receiver = qs.docChanges();
      var tmp$;
      for (tmp$ = 0; tmp$ !== $receiver.length; ++tmp$) {
        var element = $receiver[tmp$];
        closure$channel.offer_11rb$(element);
      }
      return Unit;
    };
  }
  function documentChanges$lambda_0(closure$channel) {
    return function (it) {
      closure$channel.close_dbl4no$(it);
      return Unit;
    };
  }
  function documentChanges($receiver, kills) {
    var $receiver_0 = Channel(2147483647);
    plusAssign(kills, documentChanges$lambda$lambda($receiver_0));
    var channel = $receiver_0;
    plusAssign(kills, $receiver.onSnapshot(documentChanges$lambda(channel), documentChanges$lambda_0(channel)));
    return channel;
  }
  function Coroutine$toSnapshotEvents$lambda(closure$dcs_0, closure$channel_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$dcs = closure$dcs_0;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            this.local$tmp$ = this.local$closure$dcs.iterator();
            this.state_0 = 2;
            continue;
          case 1:
            throw this.exception_0;
          ...
          case 4:
            ...
            continue;
          case 5:
            var dc = this.result_0;
            tmp$ = dc.type;
            if (equals(tmp$, 'added'))
              plusAssign_0(this.local$closure$channel, new SnapshotEvent$Added(dc.doc.id, dc.newIndex, dc.doc.data()));
            else {
              if (equals(tmp$, 'removed'))
                plusAssign_0(this.local$closure$channel, new SnapshotEvent$Removed(dc.oldIndex));
              else {
                if (equals(tmp$, 'modified')) {
                  plusAssign_0(this.local$closure$channel, new SnapshotEvent$Modified(dc.oldIndex, dc.doc.data()));
                  if (dc.newIndex !== dc.oldIndex) {
                    plusAssign_0(this.local$closure$channel, new SnapshotEvent$Moved(dc.oldIndex, dc.newIndex));
                  }
                }
                 else
                  throw Error_init('Unkown type: ' + dc.type);
              }
            }
  ...
  function toSnapshotEvents$lambda(closure$dcs_0, closure$channel_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$toSnapshotEvents$lambda(closure$dcs_0, closure$channel_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function toSnapshotEvents($receiver, dcs) {
    var channel = Channel(2147483647);
    launch($receiver, void 0, void 0, toSnapshotEvents$lambda(dcs, channel));
    return channel;
  }
        ...
        switch (this.state_0) {
          ...
          case 5:
            ...
            if (Kotlin.isType(e_0, SnapshotEvent$Added)) {
              ...
              plusAssign_0(this.local$closure$channel, new ListEvent$Add(e_0.index, item));
            }
              ...
              plusAssign_0(this.local$closure$channel, new ListEvent$Move(e_0.from, e_0.to));
            }
             else if (Kotlin.isType(e_0, SnapshotEvent$Removed))
              plusAssign_0(this.local$closure$channel, new ListEvent$Remove(e_0.index));
            this.state_0 = 2;
            continue;
          case 6:
            return Unit;
  ...
  function wrapSnapshotEvents$createPersisted(closure$create, closure$collectionWrap) {
    return function (id) {
      var $receiver = closure$create();
      var closure$collectionWrap_0 = closure$collectionWrap;
      $receiver.props.persisted_11rd$(closure$collectionWrap_0.doc_61zpoe$(id));
  ...
  function wrapSnapshotEvents$lambda_0(closure$createPersisted) {
    return function (id, data) {
      var $receiver = closure$createPersisted(id);
      initFrom($receiver, data);
      return $receiver;
  ...
  function wrapSnapshotEvents$lambda_1($receiver, data) {
    initFrom($receiver, data);
    return Unit;
  }
  function wrapSnapshotEvents_0($receiver, ses, collectionWrap, create) {
    var createPersisted = wrapSnapshotEvents$createPersisted(create, collectionWrap);
    return wrapSnapshotEvents($receiver, ses, wrapSnapshotEvents$lambda_0(createPersisted), wrapSnapshotEvents$lambda_1);
  }
  function FirestoreApi() {
  }
  FirestoreApi.prototype.documentChanges_z2kgpb$ = function ($receiver) {
    return documentChanges($receiver, this.kills);
  };
  FirestoreApi.prototype.toSnapshotEvents_ecp0ut$ = function ($receiver) {
    return toSnapshotEvents(this, $receiver);
  };
  FirestoreApi.prototype.wrap_b39p79$ = function ($receiver, collectionWrap, create) {
    return wrapSnapshotEvents_0(this, $receiver, collectionWrap, create);
  };
  FirestoreApi.prototype.wrap_ghesau$ = function ($receiver, create) {
    return this.wrap_b39p79$(this.toSnapshotEvents_ecp0ut$(this.documentChanges_z2kgpb$($receiver.query)), $receiver.collectionWrap, create);
  };
  FirestoreApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'FirestoreApi',
    interfaces: [CoroutineWithKills]
  };
  ...
  package$firestore.SnapshotEvent = SnapshotEvent;
  package$firestore.documentChanges_z0g61p$ = documentChanges;
  package$firestore.toSnapshotEvents_5sd8zz$ = toSnapshotEvents;
  package$firestore.wrapSnapshotEvents_s8v3cp$ = wrapSnapshotEvents;
  package$firestore.wrapSnapshotEvents_vn1wn5$ = wrapSnapshotEvents_0;
  package$firestore.FirestoreApi = FirestoreApi;
  ...
  FirebaseApi.prototype.rx_pn7ch0$ = HasKillSet.prototype.rx_pn7ch0$;
  FirebaseApi.prototype.rx_rf89m5$ = HasKillSet.prototype.rx_rf89m5$;
  FirebaseApi.prototype.containsRx_1w65cx$ = HasKillSet.prototype.containsRx_1w65cx$;
  FirebaseApi.prototype.filtered_49l5s4$ = HasKillSet.prototype.filtered_49l5s4$;
  FirebaseApi.prototype.forEach_5mel8p$ = HasKillSet.prototype.forEach_5mel8p$;
  FirebaseApi.prototype.forEach_igkruk$ = HasKillSet.prototype.forEach_igkruk$;
  FirebaseApi.prototype.map_i8ud5a$ = HasKillSet.prototype.map_i8ud5a$;
  FirebaseApi.prototype.onChange_ocsf2x$ = HasKillSet.prototype.onChange_ocsf2x$;
  FirebaseApi.prototype.process_ttzep4$ = HasKillSet.prototype.process_ttzep4$;
  FirebaseApi.prototype.remAssign_7fncnf$ = HasKillSet.prototype.remAssign_7fncnf$;
  FirebaseApi.prototype.rxClass_wqb4ha$ = HasKillSet.prototype.rxClass_wqb4ha$;
  FirebaseApi.prototype.rxClass_mjd6u9$ = HasKillSet.prototype.rxClass_mjd6u9$;
  FirebaseApi.prototype.toChannelLater_z5dyp2$ = HasKillSet.prototype.toChannelLater_z5dyp2$;
  FirebaseApi.prototype.toRxSet_jr4bl4$ = HasKillSet.prototype.toRxSet_jr4bl4$;
  get_fbapi$ObjectLiteral.prototype.get_ids_wjz35z$ = FirebaseApi.prototype.get_ids_wjz35z$;
  FirestoreApi.prototype.rx_pn7ch0$ = CoroutineWithKills.prototype.rx_pn7ch0$;
  FirestoreApi.prototype.rx_rf89m5$ = CoroutineWithKills.prototype.rx_rf89m5$;
  FirestoreApi.prototype.containsRx_1w65cx$ = CoroutineWithKills.prototype.containsRx_1w65cx$;
  FirestoreApi.prototype.filtered_49l5s4$ = CoroutineWithKills.prototype.filtered_49l5s4$;
  FirestoreApi.prototype.forEach_5mel8p$ = CoroutineWithKills.prototype.forEach_5mel8p$;
  FirestoreApi.prototype.forEach_igkruk$ = CoroutineWithKills.prototype.forEach_igkruk$;
  FirestoreApi.prototype.map_i8ud5a$ = CoroutineWithKills.prototype.map_i8ud5a$;
  FirestoreApi.prototype.onChange_ocsf2x$ = CoroutineWithKills.prototype.onChange_ocsf2x$;
  FirestoreApi.prototype.process_ttzep4$ = CoroutineWithKills.prototype.process_ttzep4$;
  FirestoreApi.prototype.remAssign_7fncnf$ = CoroutineWithKills.prototype.remAssign_7fncnf$;
  FirestoreApi.prototype.rxClass_wqb4ha$ = CoroutineWithKills.prototype.rxClass_wqb4ha$;
  FirestoreApi.prototype.rxClass_mjd6u9$ = CoroutineWithKills.prototype.rxClass_mjd6u9$;
  FirestoreApi.prototype.toChannelLater_z5dyp2$ = CoroutineWithKills.prototype.toChannelLater_z5dyp2$;
  FirestoreApi.prototype.toRxSet_jr4bl4$ = CoroutineWithKills.prototype.toRxSet_jr4bl4$;
  MaxBatchSize = 500;
