...
this['appsimake-domx'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_common) {
  ...
  function rxVisible($receiver, ks, rxv) {
    rxv.forEach_aaomyj$(ks, rxVisible$lambda($receiver));
  }
  function rxVisible_0($receiver, ks, fn) {
    var $receiver_0 = Rx_init(ks, fn);
    rxVisible($receiver, ks, $receiver_0);
    return $receiver_0;
  }
  ...
  function listenableList($receiver, ks, list, create) {
    plusAssign(ks, list.addListener_ednqrc$(new ListenableList$Listener(listenableList$lambda(create, $receiver), listenableList$lambda_0($receiver), listenableList$lambda_1($receiver))));
  }
  ...
  function listenableList_0($receiver, ks, list, create) {
    ...
    plusAssign(ks, list.addListener_ednqrc$(new ListenableList$Listener(listenableList$lambda_2(ks, create, $receiver, kills), listenableList$lambda_3($receiver, kills), listenableList$lambda_4($receiver, kills))));
  }
  ...
  package$domx.rxEnabled_n1x8kh$ = rxEnabled_0;
  package$domx.rxVisible_so0w3s$ = rxVisible;
  package$domx.rxVisible_upne14$ = rxVisible_0;
  ...
  package$domx.listenableList_hqlnvw$ = listenableList;
  package$domx.listenableList_6zj3dg$ = listenableList_0;
  ...
  KillsApiDomx.prototype.map_1mq1ue$ = KillsApi.prototype.map_1mq1ue$;
  ...
  DomxHasKillSet.prototype.map_1mq1ue$ = KillsApi.prototype.map_1mq1ue$;
