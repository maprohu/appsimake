...
this['appsimake-common'] = function (_, Kotlin, $module$appsimake_commonshr) {
  ...
  function ListenableMutableList() {
    ...
    this.isEmptyRx = Rx_init(ListenableMutableList$isEmptyRx$lambda(this));
  ...
  function MappedListenableListConfig$build$Holder(killable) {
    this.killable = killable;
  }
  MappedListenableListConfig$build$Holder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Holder',
    interfaces: []
  };
  function MappedListenableListConfig$build$lambda(this$MappedListenableListConfig, closure$result, closure$holders) {
    return function (index, element) {
      var ks = this$MappedListenableListConfig.killables.killables();
      var node = this$MappedListenableListConfig.mapper(element, ks);
      closure$result.add_wxm5ur$(index, node);
      closure$holders.add_wxm5ur$(index, new MappedListenableListConfig$build$Holder(ks));
      return Unit;
    };
  }
  function MappedListenableListConfig$build$lambda_0(closure$result, closure$holders) {
  ...
  function MappedListenableListConfig$build$lambda_1(closure$result, closure$holders) {
    return function (from, to) {
      closure$result.move_vux9f0$(from, to);
  ...
  MappedListenableListConfig.prototype.build = function () {
    var result = new ListenableMutableList();
    var holders = ArrayList_init();
    this.killables.plusAssign_wii6vi$(this.list.addListener_ednqrc$(new ListenableList$Listener(MappedListenableListConfig$build$lambda(this, result, holders), MappedListenableListConfig$build$lambda_0(result, holders), MappedListenableListConfig$build$lambda_1(result, holders))));
    return result;
  };
