...
this['appsimake-fontawesome'] = function (_, Kotlin, $module$appsimake_domx, $module$kotlinx_coroutines_core, $module$appsimake_commonshr) {
  ...
  var edit_metadata = new PropertyMetadata('edit');
  var edit;
  function get_edit($receiver) {
    return edit.getValue_lrcp0p$($receiver, edit_metadata);
  }
  var code_metadata = new PropertyMetadata('code');
  var code;
  function get_code($receiver) {
    return code.getValue_lrcp0p$($receiver, code_metadata);
  }
  ...
  package$fontawesome.get_edit_xml72e$ = get_edit;
  package$fontawesome.get_code_xml72e$ = get_code;
  ...
  edit = facss().provideDelegate_d6mtq7$(this, edit_metadata);
  code = facss().provideDelegate_d6mtq7$(this, code_metadata);
