...
this['appsimake-firebase'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_common, $module$kotlinx_coroutines_core, $module$appsimake_firebaseshr) {
  ...
  DbApi.prototype.query_wzkv1r$$default = function ($receiver, query) {
  ...
  CsApiFirebase.prototype.listEvents_f2awki$ = function ($receiver, collectionWrap, create) {
  ...
  CsDbKillsApi.prototype.listEvents_pujjsl$$default = function ($receiver, query) {
    return listEvents_2($receiver, this, query);
  };
  ...
  get_fbapi$ObjectLiteral.prototype.feedTo_9o5f67$ = function ($receiver, target) {
    return this.$delegate_elvtu3$_0.feedTo_9o5f67$($receiver, target);
  };
  ...
  get_fbapi$ObjectLiteral.prototype.forEachLater_xwzbbo$ = function ($receiver, fn) {
    return this.$delegate_elvtu3$_0.forEachLater_xwzbbo$($receiver, fn);
  };
  get_fbapi$ObjectLiteral.prototype.incremented_eoy9qo$ = function ($receiver) {
    return this.$delegate_elvtu3$_0.incremented_eoy9qo$($receiver);
  };
  get_fbapi$ObjectLiteral.prototype.linked_n1nom7$ = function ($receiver, read, write) {
    return this.$delegate_elvtu3$_0.linked_n1nom7$($receiver, read, write);
  };
  get_fbapi$ObjectLiteral.prototype.listen_ubid8w$ = function ($receiver, callback) {
    return this.$delegate_elvtu3$_0.listen_ubid8w$($receiver, callback);
  };
  get_fbapi$ObjectLiteral.prototype.map_jtxi0h$ = function ($receiver, fn) {
    return this.$delegate_elvtu3$_0.map_jtxi0h$($receiver, fn);
  };
  get_fbapi$ObjectLiteral.prototype.mapLive_1mq1ue$ = function ($receiver, fn) {
    return this.$delegate_elvtu3$_0.mapLive_1mq1ue$($receiver, fn);
  };
  ...
  get_fbapi$ObjectLiteral.prototype.plusAssign_ubid8w$ = function ($receiver, fn) {
    return this.$delegate_elvtu3$_0.plusAssign_ubid8w$($receiver, fn);
  };
  ...
  get_fbapi$ObjectLiteral.prototype.remAssign_wgabca$ = function ($receiver, fn) {
    return this.$delegate_elvtu3$_0.remAssign_wgabca$($receiver, fn);
  };
  get_fbapi$ObjectLiteral.prototype.remAssign_djv61p$ = function ($receiver, fn) {
    return this.$delegate_elvtu3$_0.remAssign_djv61p$($receiver, fn);
  };
  ...
  get_fbapi$ObjectLiteral.prototype.rx_wgabca$ = function ($receiver, fn) {
    return this.$delegate_elvtu3$_0.rx_wgabca$($receiver, fn);
  };
  get_fbapi$ObjectLiteral.prototype.rx_djv61p$ = function ($receiver, fn) {
    return this.$delegate_elvtu3$_0.rx_djv61p$($receiver, fn);
  };
  ...
  ListenConfig$Companion.prototype.hasProps_25iuj1$ = function (list, collectionWrap, create) {
  ...
  ListenConfig.prototype.copy_7je87j$ = function (list, create, update, remove, onFirst, onError) {
  ...
  function updateFrom($receiver, ds) {
    ...
    if (ds.exists) {
      $receiver.rxv.now = $receiver.id.coll.factory(ds.data(), FsDynamicOps_getInstance());
    }
  }
  ...
  Coroutine$fsLookup$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$tmp$ = listEvents_2(this.local$closure$coll, this.local$closure$deps).iterator();
            this.state_0 = 2;
            continue;
          case 1:
            throw this.exception_0;
  ...
  function fsCache($receiver, deps, query, factory) {
    ...
    return fsCache_0(listEvents_2($receiver, deps, query), deps, factory);
  }
  ...
  function QuerySettings(order, where) {
    if (order === void 0)
      order = emptyList();
    if (where === void 0)
      where = emptyList();
  ...
  QuerySettings.prototype.asc_61zpoe$ = function (path) {
    return this.copy_nka3l6$(plus_0(this.order, new QuerySettings$OrderBy(path)));
  };
  QuerySettings.prototype.desc_61zpoe$ = function (path) {
    return this.copy_nka3l6$(plus_0(this.order, new QuerySettings$OrderBy(path, QuerySettings$OrderDirection$Desc_getInstance())));
  };
  QuerySettings.prototype.where_iwz0pm$ = function (wh) {
    return this.copy_nka3l6$(void 0, plus_0(this.where, wh));
  };
  ...
  QuerySettings.prototype.copy_nka3l6$ = function (order, where) {
    return new QuerySettings(order === void 0 ? this.order : order, where === void 0 ? this.where : where);
  };
  QuerySettings.prototype.toString = function () {
    return 'QuerySettings(order=' + Kotlin.toString(this.order) + (', where=' + Kotlin.toString(this.where)) + ')';
  };
  ...
  QuerySettings.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.order, other.order) && Kotlin.equals(this.where, other.where)))));
  };
  ...
  function apply_1($receiver, settings) {
    var tmp$;
  ...
  function query_0($receiver, deps, query) {
    ...
    return apply_1(collectionRef($receiver, deps), querySettings(query));
  }
  ...
  function listEvents_2($receiver, deps, query) {
    if (query === void 0)
      query = listEvents$lambda_1;
    return listEvents(toSnapshotEvents(documentChanges(query_0($receiver, deps, query), deps), deps), deps, $receiver, FsDynamicOps_getInstance());
  }
  ...
  function toList($receiver, deps, query) {
    if (query === void 0)
      query = toList$lambda;
    var list = RxMutableList_init();
    applyTo_0(listEvents_2($receiver, deps, query), deps, list);
    return list;
  }
  ...
  package$firestore.query_vrjdf1$ = query;
  package$firestore.wrap_aaxyke$ = wrap;
  package$firestore.wrap_d1t8e0$ = wrap_0;
  ...
  package$firestore.toSetSource_udcr7m$ = toSetSource_0;
  package$firestore.toSetSource_wb9rsq$ = toSetSource_1;
  ...
  package$firestore.toRxSetWithLookup_wb9rsq$ = toRxSetWithLookup_1;
  ...
  package$firestore.listEvents_m9r3f2$ = listEvents_0;
  ...
  package$firestore.apply_tgjpyq$ = apply_1;
  package$firestore.query_th3nra$ = query_0;
  ...
  package$firestore.snapshots_jlz3we$ = snapshots_1;
  package$firestore.listEvents_wamwi5$ = listEvents_2;
  ...
  CsKillsApiFirebase.prototype.listEvents_f2awki$ = CsApiFirebase.prototype.listEvents_f2awki$;
  CsKillsApiFirebase.prototype.get_ids_qko62t$ = CsKillsApiCommon.prototype.get_ids_qko62t$;
  ...
  CsKillsApiFirebase.prototype.rx_wgabca$ = CsKillsApiCommon.prototype.rx_wgabca$;
  CsKillsApiFirebase.prototype.rx_djv61p$ = CsKillsApiCommon.prototype.rx_djv61p$;
  CsKillsApiFirebase.prototype.containsRx_1w65cx$ = CsKillsApiCommon.prototype.containsRx_1w65cx$;
  CsKillsApiFirebase.prototype.events_9k4h2$ = CsKillsApiCommon.prototype.events_9k4h2$;
  CsKillsApiFirebase.prototype.feedTo_9o5f67$ = CsKillsApiCommon.prototype.feedTo_9o5f67$;
  CsKillsApiFirebase.prototype.filter_hu0si9$ = CsKillsApiCommon.prototype.filter_hu0si9$;
  ...
  CsKillsApiFirebase.prototype.forEachLater_xwzbbo$ = CsKillsApiCommon.prototype.forEachLater_xwzbbo$;
  CsKillsApiFirebase.prototype.incremented_eoy9qo$ = CsKillsApiCommon.prototype.incremented_eoy9qo$;
  CsKillsApiFirebase.prototype.linked_n1nom7$ = CsKillsApiCommon.prototype.linked_n1nom7$;
  CsKillsApiFirebase.prototype.listen_ubid8w$ = CsKillsApiCommon.prototype.listen_ubid8w$;
  CsKillsApiFirebase.prototype.map_jtxi0h$ = CsKillsApiCommon.prototype.map_jtxi0h$;
  CsKillsApiFirebase.prototype.mapLive_1mq1ue$ = CsKillsApiCommon.prototype.mapLive_1mq1ue$;
  CsKillsApiFirebase.prototype.onChange_rlu5c6$ = CsKillsApiCommon.prototype.onChange_rlu5c6$;
  CsKillsApiFirebase.prototype.plusAssign_ubid8w$ = CsKillsApiCommon.prototype.plusAssign_ubid8w$;
  CsKillsApiFirebase.prototype.process_y3juat$ = CsKillsApiCommon.prototype.process_y3juat$;
  CsKillsApiFirebase.prototype.process_7xi3v7$ = CsKillsApiCommon.prototype.process_7xi3v7$;
  CsKillsApiFirebase.prototype.remAssign_wgabca$ = CsKillsApiCommon.prototype.remAssign_wgabca$;
  CsKillsApiFirebase.prototype.remAssign_djv61p$ = CsKillsApiCommon.prototype.remAssign_djv61p$;
  ...
  CsDbKillsApi.prototype.listEvents_f2awki$ = CsKillsApiFirebase.prototype.listEvents_f2awki$;
  ...
  FirebaseApi.prototype.rx_wgabca$ = KillsApi.prototype.rx_wgabca$;
  FirebaseApi.prototype.rx_djv61p$ = KillsApi.prototype.rx_djv61p$;
  FirebaseApi.prototype.containsRx_1w65cx$ = KillsApi.prototype.containsRx_1w65cx$;
  FirebaseApi.prototype.feedTo_9o5f67$ = KillsApi.prototype.feedTo_9o5f67$;
  ...
  FirebaseApi.prototype.forEachLater_xwzbbo$ = KillsApi.prototype.forEachLater_xwzbbo$;
  FirebaseApi.prototype.incremented_eoy9qo$ = KillsApi.prototype.incremented_eoy9qo$;
  FirebaseApi.prototype.linked_n1nom7$ = KillsApi.prototype.linked_n1nom7$;
  FirebaseApi.prototype.listen_ubid8w$ = KillsApi.prototype.listen_ubid8w$;
  FirebaseApi.prototype.map_jtxi0h$ = KillsApi.prototype.map_jtxi0h$;
  FirebaseApi.prototype.mapLive_1mq1ue$ = KillsApi.prototype.mapLive_1mq1ue$;
  FirebaseApi.prototype.onChange_rlu5c6$ = KillsApi.prototype.onChange_rlu5c6$;
  FirebaseApi.prototype.plusAssign_ubid8w$ = KillsApi.prototype.plusAssign_ubid8w$;
  FirebaseApi.prototype.process_7xi3v7$ = KillsApi.prototype.process_7xi3v7$;
  FirebaseApi.prototype.remAssign_wgabca$ = KillsApi.prototype.remAssign_wgabca$;
  FirebaseApi.prototype.remAssign_djv61p$ = KillsApi.prototype.remAssign_djv61p$;
