...
if (typeof this['appsimake-common'] === 'undefined') {
  throw new Error("Error loading module 'appsimake-fontawesome'. Its dependency 'appsimake-common' was not found. Please, check whether 'appsimake-common' is loaded prior to 'appsimake-fontawesome'.");
}
...
this['appsimake-fontawesome'] = function (_, Kotlin, $module$appsimake_domx, $module$kotlinx_coroutines_core, $module$appsimake_common, $module$appsimake_commonshr) {
  'use strict';
  ...
  return _;
}(typeof this['appsimake-fontawesome'] === 'undefined' ? {} : this['appsimake-fontawesome'], kotlin, this['appsimake-domx'], this['kotlinx-coroutines-core'], this['appsimake-common'], this['appsimake-commonshr']);
