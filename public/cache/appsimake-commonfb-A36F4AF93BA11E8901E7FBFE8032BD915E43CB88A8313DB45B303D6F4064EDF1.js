...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_commonui, $module$appsimake_firebaseshr, $module$appsimake_firebase, $module$kotlinx_coroutines_core, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common) {
  ...
  var initBinder = $module$appsimake_firebase.firebase.initBinder_8mbn6p$;
  ...
  function build$save(closure$canSave, closure$isSaving, closure$docRefOpt, closure$item, closure$db, closure$killables, closure$close, this$build) {
    return function () {
      var tmp$;
      if (closure$canSave.now) {
        ...
        if (tmp$_0 == null) {
          ...
          closure$killables_0.plusAssign_o14v8n$(closure$item_0.props.onDeleted.add_o14v8n$(closure$close_0));
        }
      }
    };
  }
  ...
  function build$delete$lambda(closure$item_0, closure$db_0, closure$isSaving_0) {
    return function ($receiver, continuation_0, suspended) {
      var instance = new Coroutine$build$delete$lambda(closure$item_0, closure$db_0, closure$isSaving_0, $receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
  ...
  function Coroutine$build$delete$lambda(closure$item_0, closure$db_0, closure$isSaving_0, $receiver, controller, continuation_0) {
  ...
  function build$lambda$lambda_0(closure$isSaving, closure$item, closure$back, this$build, closure$fc, closure$canSave, closure$save, closure$showDropDown, closure$showDelete, closure$canDelete, closure$delete) {
    return function ($receiver) {
  ...
  function build$lambda_5(closure$killables, closure$isSaving, closure$item, closure$back, this$build, closure$fc, closure$canSave, closure$save, closure$showDropDown, closure$showDelete, closure$canDelete, closure$delete) {
    return function ($receiver) {
      screenLayout($receiver, closure$killables, build$lambda$lambda_0(closure$isSaving, closure$item, closure$back, this$build, closure$fc, closure$canSave, closure$save, closure$showDropDown, closure$showDelete, closure$canDelete, closure$delete));
      return Unit;
    };
  }
  function build($receiver, killables, panel, item, close, db) {
    ...
    var save = build$save(canSave, isSaving, docRefOpt, item, db, killables, close, $receiver);
    var back = build$back(close);
    var delete_0 = build$delete(isSaving, item, db);
    var fc = $receiver.form(item, killables);
    panel.newRoot_iw61es$(build$lambda_5(killables, isSaving, item, back, $receiver, fc, canSave, save, showDropDown, showDelete, canDelete, delete_0));
  }
  ...
  function build$lambda$lambda$lambda$lambda$lambda_12(closure$listRoot, closure$filterConfig, this$build) {
    return function (show) {
      return new ListUIConfig(closure$listRoot, closure$filterConfig.query, this$build.collectionWrap, this$build.create, void 0, void 0, build$lambda$lambda$lambda$lambda$lambda$lambda_9, build$lambda$lambda$lambda$lambda$lambda$lambda_10, stringListClick(this$build.itemText, show));
    };
  }
  ...
  function ListUIConfig(root, query, collectionWrap, create, hourglassDecor, emptyDivDecor, listDivDecor, ulDecor, itemFactory) {
  ...
  ListUIConfig.prototype.copy_mmakvg$ = function (root, query, collectionWrap, create, hourglassDecor, emptyDivDecor, listDivDecor, ulDecor, itemFactory) {
    return new ListUIConfig(root === void 0 ? this.root : root, query === void 0 ? this.query : query, collectionWrap === void 0 ? this.collectionWrap : collectionWrap, create === void 0 ? this.create : create, hourglassDecor === void 0 ? this.hourglassDecor : hourglassDecor, emptyDivDecor === void 0 ? this.emptyDivDecor : emptyDivDecor, listDivDecor === void 0 ? this.listDivDecor : listDivDecor, ulDecor === void 0 ? this.ulDecor : ulDecor, itemFactory === void 0 ? this.itemFactory : itemFactory);
  };
  ListUIConfig.prototype.toString = function () {
    return 'ListUIConfig(root=' + Kotlin.toString(this.root) + (', query=' + Kotlin.toString(this.query)) + (', collectionWrap=' + Kotlin.toString(this.collectionWrap)) + (', create=' + Kotlin.toString(this.create)) + (', hourglassDecor=' + Kotlin.toString(this.hourglassDecor)) + (', emptyDivDecor=' + Kotlin.toString(this.emptyDivDecor)) + (', listDivDecor=' + Kotlin.toString(this.listDivDecor)) + (', ulDecor=' + Kotlin.toString(this.ulDecor)) + (', itemFactory=' + Kotlin.toString(this.itemFactory)) + ')';
  };
  ...
  ListUIConfig.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.root, other.root) && Kotlin.equals(this.query, other.query) && Kotlin.equals(this.collectionWrap, other.collectionWrap) && Kotlin.equals(this.create, other.create) && Kotlin.equals(this.hourglassDecor, other.hourglassDecor) && Kotlin.equals(this.emptyDivDecor, other.emptyDivDecor) && Kotlin.equals(this.listDivDecor, other.listDivDecor) && Kotlin.equals(this.ulDecor, other.ulDecor) && Kotlin.equals(this.itemFactory, other.itemFactory)))));
  };
  ...
  function listUI$lambda$lambda_0(this$, closure$killables, closure$emptyDiv) {
    return function (old, q) {
      ...
      listen_0(q.query, ks, ListenConfig.Companion.hasProps_4r7uln$(list, this$.collectionWrap, this$.create).copy_4cbyqc$(void 0, void 0, void 0, void 0, listUI$lambda$lambda$lambda_0(ks, list, queryRoot, closure$emptyDiv, listDiv)));
      return ks;
    };
  }
