...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_commonui, $module$appsimake_firebase, $module$kotlinx_coroutines_core, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common, $module$appsimake_commonlib) {
  'use strict';
  ...
  function build$lambda$lambda(it) {
    return it.id;
  }
  function build$lambda_3(closure$item) {
    return function () {
      return closure$item.props.id.invoke().map_2o04qz$(build$lambda$lambda);
    };
  }
  function build$lambda$lambda_0(closure$wrap, closure$db) {
    return function (id) {
      return docRef(closure$wrap.doc_61zpoe$(id), closure$db);
    };
  }
  function build$lambda_4(closure$idOpt, closure$wrap, closure$db) {
    return function () {
      return closure$idOpt.invoke().map_2o04qz$(build$lambda$lambda_0(closure$wrap, closure$db));
    };
  }
  function build$lambda$lambda$lambda(closure$isSaving) {
    return function (it) {
      closure$isSaving.now = false;
      return Unit;
    };
  }
  function build$lambda$lambda_1(closure$isSaving) {
    return function (dr) {
      return dr.onSnapshot(build$lambda$lambda$lambda(closure$isSaving));
    };
  }
  function build$lambda$lambda_2() {
    return Unit;
  }
  function build$lambda_5(closure$idListenerSeq, closure$isSaving) {
    return function (dro) {
      closure$idListenerSeq.plusAssign_o14v8n$(dro.map_2o04qz$(build$lambda$lambda_1(closure$isSaving)).getOrDefault_11rb$(build$lambda$lambda_2));
      return Unit;
    };
  }
  function build$save$lambda(closure$item) {
    return function (dr) {
      dr.set(closure$item.props.merge(), setOptionsMerge());
      return Unit;
    };
  }
  function build$save$lambda_0(closure$wrap, closure$db, closure$item, closure$killables, closure$close) {
    return function () {
      var ref = collectionRef(closure$wrap, closure$db).doc();
      closure$item.props.persisted_11rc$(ref.id);
      ref.set(closure$item.props.write());
      closure$killables.plusAssign_wii6vi$(listen(ref, closure$item));
      closure$killables.plusAssign_o14v8n$(closure$item.props.onDeleted.add_o14v8n$(closure$close));
      return Unit;
    };
  }
  function build$save(closure$canSave, closure$isSaving, closure$docRef, closure$item, closure$wrap, closure$db, closure$killables, closure$close) {
    return function () {
      if (closure$canSave.now) {
        closure$isSaving.now = true;
        closure$docRef.now.map_2o04qz$(build$save$lambda(closure$item)).getOrElse_skz6lt$(build$save$lambda_0(closure$wrap, closure$db, closure$item, closure$killables, closure$close));
      }
    };
  }
  ...
  function build$lambda$lambda$lambda_0(closure$isSaving, closure$item, closure$back, this$build, closure$fc, closure$canSave, closure$save, closure$showDropDown, closure$showDelete, closure$canDelete, closure$delete) {
    return function ($receiver) {
  ...
  function build$lambda$lambda$lambda_1(closure$fc) {
    return function ($receiver) {
      closure$fc.form($receiver);
      return Unit;
    };
  }
  function build$lambda$lambda_3(closure$isSaving, closure$item, closure$back, this$build, closure$fc, closure$canSave, closure$save, closure$showDropDown, closure$showDelete, closure$canDelete, closure$delete) {
    return function ($receiver) {
      $receiver.top_vesf63$(build$lambda$lambda$lambda_0(closure$isSaving, closure$item, closure$back, this$build, closure$fc, closure$canSave, closure$save, closure$showDropDown, closure$showDelete, closure$canDelete, closure$delete));
      $receiver.main_iw61es$(build$lambda$lambda$lambda_1(closure$fc));
      return Unit;
    };
  }
  function build$lambda_6(closure$killables, closure$isSaving, closure$item, closure$back, this$build, closure$fc, closure$canSave, closure$save, closure$showDropDown, closure$showDelete, closure$canDelete, closure$delete) {
    return function ($receiver) {
      screenLayout($receiver, closure$killables, build$lambda$lambda_3(closure$isSaving, closure$item, closure$back, this$build, closure$fc, closure$canSave, closure$save, closure$showDropDown, closure$showDelete, closure$canDelete, closure$delete));
      return Unit;
    };
  }
  function build($receiver, killables, panel, item, close, wrap, db) {
    item.props.rollback();
    ...
    var idOpt = addedTo(Rx_init(build$lambda_3(item)), killables);
    var docRef = Rx_init(build$lambda_4(idOpt, wrap, db));
    docRef.forEach_qlkmfe$(build$lambda_5(idListenerSeq, isSaving));
    var save = build$save(canSave, isSaving, docRef, item, wrap, db, killables, close);
    var back = build$back(close);
    var delete_0 = build$delete(isSaving, wrap, item, db);
    var fc = $receiver.form(item, killables);
    panel.newRoot_iw61es$(build$lambda_6(killables, isSaving, item, back, $receiver, fc, canSave, save, showDropDown, showDelete, canDelete, delete_0));
  }
  ...
  function ListScreenConfig(title, create, collection, view, edit, itemText, filter) {
    this.title = title;
    this.create = create;
  ...
  ListScreenConfig.prototype.copy_wqzddz$ = function (title, create, collection, view, edit, itemText, filter) {
    return new ListScreenConfig(title === void 0 ? this.title : title, create === void 0 ? this.create : create, collection === void 0 ? this.collection : collection, view === void 0 ? this.view : view, edit === void 0 ? this.edit : edit, itemText === void 0 ? this.itemText : itemText, filter === void 0 ? this.filter : filter);
  };
  ListScreenConfig.prototype.toString = function () {
    return 'ListScreenConfig(title=' + Kotlin.toString(this.title) + (', create=' + Kotlin.toString(this.create)) + (', collection=' + Kotlin.toString(this.collection)) + (', view=' + Kotlin.toString(this.view)) + (', edit=' + Kotlin.toString(this.edit)) + (', itemText=' + Kotlin.toString(this.itemText)) + (', filter=' + Kotlin.toString(this.filter)) + ')';
  };
  ListScreenConfig.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.title) | 0;
    result = result * 31 + Kotlin.hashCode(this.create) | 0;
    result = result * 31 + Kotlin.hashCode(this.collection) | 0;
  ...
  ListScreenConfig.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.title, other.title) && Kotlin.equals(this.create, other.create) && Kotlin.equals(this.collection, other.collection) && Kotlin.equals(this.view, other.view) && Kotlin.equals(this.edit, other.edit) && Kotlin.equals(this.itemText, other.itemText) && Kotlin.equals(this.filter, other.filter)))));
  };
  ...
  function build$lambda$lambda$lambda$lambda$lambda$lambda$lambda_3(act) {
    return !act;
  }
  function build$lambda$lambda$lambda$lambda$lambda$lambda_5(closure$filterOpen) {
    return function (it) {
      closure$filterOpen.transform_ru8m0w$(build$lambda$lambda$lambda$lambda$lambda$lambda$lambda_3);
      return Unit;
    };
  }
  ...
  function build$lambda$lambda$lambda$lambda$lambda$lambda_6($receiver) {
    get_m1($receiver);
    get_btnPrimary($receiver);
    return Unit;
  }
  function build$lambda$lambda$lambda$lambda$lambda$lambda_7(this$build, closure$panel, closure$displayList) {
  ...
  function build$lambda$lambda$lambda$lambda$lambda_6(closure$killables, this$build, closure$panel, closure$displayList) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(build$lambda$lambda$lambda$lambda$lambda$lambda_6);
      closure$killables.plusAssign_wii6vi$(clickEventSeq($receiver, build$lambda$lambda$lambda$lambda$lambda$lambda_7(this$build, closure$panel, closure$displayList)));
      return Unit;
    };
  }
  ...
  function build$lambda$lambda$lambda_2(closure$isBusy, closure$close, this$build, closure$filterConfig, closure$filterOpen, closure$killables, closure$panel, closure$displayList) {
    return function ($receiver) {
  ...
  function build$lambda$lambda$lambda$lambda_4(closure$filterOpen, closure$filterConfig) {
    return function ($receiver) {
      ...
      rxDisplayed($receiver, closure$filterOpen);
  ...
  function build$lambda$lambda$lambda$lambda$lambda_11(this$build, closure$db, closure$panel) {
    return function (ks, item, close) {
      keepAlive(item, ks, this$build.collection, closure$db);
      this$build.view(ks, closure$panel.sub(), item, close);
      return Unit;
    };
  }
  function build$lambda$lambda$lambda$lambda$lambda$lambda$lambda_4($receiver) {
    get_scrollVertical($receiver);
    return Unit;
  }
  function build$lambda$lambda$lambda$lambda$lambda$lambda_9($receiver) {
    get_cls($receiver).invoke_cr52h1$(build$lambda$lambda$lambda$lambda$lambda$lambda$lambda_4);
    return Unit;
  }
  function build$lambda$lambda$lambda$lambda$lambda$lambda$lambda_5($receiver) {
    get_m2($receiver);
    get_dBlock($receiver);
    return Unit;
  }
  function build$lambda$lambda$lambda$lambda$lambda$lambda_10($receiver) {
    get_cls($receiver).invoke_cr52h1$(build$lambda$lambda$lambda$lambda$lambda$lambda$lambda_5);
    return Unit;
  }
  function build$lambda$lambda$lambda$lambda$lambda_12(closure$listRoot, closure$filterConfig, this$build) {
    return function (show) {
      return new ListUIConfig(closure$listRoot, closure$filterConfig.query, this$build.create, void 0, void 0, build$lambda$lambda$lambda$lambda$lambda$lambda_9, build$lambda$lambda$lambda$lambda$lambda$lambda_10, stringListClick(this$build.itemText, show));
    };
  }
  function build$lambda$lambda$lambda$lambda_5(closure$killables, closure$displayList, this$build, closure$db, closure$panel, closure$filterConfig) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(build$lambda$lambda$lambda$lambda$lambda_9);
      var listRoot = new RootPanel($receiver);
      showClosableList(closure$killables, build$lambda$lambda$lambda$lambda$lambda_10(closure$displayList), build$lambda$lambda$lambda$lambda$lambda_11(this$build, closure$db, closure$panel), build$lambda$lambda$lambda$lambda$lambda_12(listRoot, closure$filterConfig, this$build));
      return Unit;
    };
  }
  function build$lambda$lambda$lambda_3(closure$filterConfig, closure$filterOpen, closure$killables, closure$displayList, this$build, closure$db, closure$panel) {
    return function ($receiver) {
      ...
      invoke(get_div($receiver), build$lambda$lambda$lambda$lambda_5(closure$killables, closure$displayList, this$build, closure$db, closure$panel, closure$filterConfig));
      return Unit;
    };
  }
  function build$lambda$lambda_4(closure$isBusy, closure$close, this$build, closure$filterConfig, closure$killables, closure$panel, closure$displayList, closure$db) {
    return function ($receiver) {
      var filterOpen = new Var(false);
      $receiver.top_vesf63$(build$lambda$lambda$lambda_2(closure$isBusy, closure$close, this$build, closure$filterConfig, filterOpen, closure$killables, closure$panel, closure$displayList));
      $receiver.main_iw61es$(build$lambda$lambda$lambda_3(closure$filterConfig, filterOpen, closure$killables, closure$displayList, this$build, closure$db, closure$panel));
      return Unit;
    };
  }
  function build$lambda_7(closure$panel, this$build, closure$killables, closure$isBusy, closure$close, closure$db) {
    return function ($receiver) {
      ...
      screenLayout($receiver, closure$killables, build$lambda$lambda_4(closure$isBusy, closure$close, this$build, filterConfig, closure$killables, closure$panel, displayList, closure$db));
      return Unit;
    };
  }
  function build_0($receiver, killables, panel, db, close) {
    var isBusy = new Var(false);
    panel.newRoot_iw61es$(build$lambda_7(panel, $receiver, killables, isBusy, close, db));
  }
  ...
  function ListUIConfig(root, query, create, hourglassDecor, emptyDivDecor, listDivDecor, ulDecor, itemFactory) {
  ...
  ListUIConfig.prototype.copy_ec9scu$ = function (root, query, create, hourglassDecor, emptyDivDecor, listDivDecor, ulDecor, itemFactory) {
    return new ListUIConfig(root === void 0 ? this.root : root, query === void 0 ? this.query : query, create === void 0 ? this.create : create, hourglassDecor === void 0 ? this.hourglassDecor : hourglassDecor, emptyDivDecor === void 0 ? this.emptyDivDecor : emptyDivDecor, listDivDecor === void 0 ? this.listDivDecor : listDivDecor, ulDecor === void 0 ? this.ulDecor : ulDecor, itemFactory === void 0 ? this.itemFactory : itemFactory);
  };
  ListUIConfig.prototype.toString = function () {
    return 'ListUIConfig(root=' + Kotlin.toString(this.root) + (', query=' + Kotlin.toString(this.query)) + (', create=' + Kotlin.toString(this.create)) + (', hourglassDecor=' + Kotlin.toString(this.hourglassDecor)) + (', emptyDivDecor=' + Kotlin.toString(this.emptyDivDecor)) + (', listDivDecor=' + Kotlin.toString(this.listDivDecor)) + (', ulDecor=' + Kotlin.toString(this.ulDecor)) + (', itemFactory=' + Kotlin.toString(this.itemFactory)) + ')';
  };
  ...
  ListUIConfig.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.root, other.root) && Kotlin.equals(this.query, other.query) && Kotlin.equals(this.create, other.create) && Kotlin.equals(this.hourglassDecor, other.hourglassDecor) && Kotlin.equals(this.emptyDivDecor, other.emptyDivDecor) && Kotlin.equals(this.listDivDecor, other.listDivDecor) && Kotlin.equals(this.ulDecor, other.ulDecor) && Kotlin.equals(this.itemFactory, other.itemFactory)))));
  };
  ...
  function listUI$lambda$lambda$lambda$lambda(this$, closure$list) {
    return function ($receiver) {
  ...
  function listUI$lambda$lambda$lambda_1(this$, closure$list) {
    return function ($receiver) {
      ...
      listGroup($receiver, listUI$lambda$lambda$lambda$lambda(this$, closure$list));
      return Unit;
    };
  }
  ...
  function listUI$lambda$lambda$lambda_2(closure$ks, closure$list, closure$queryRoot, closure$emptyDiv, closure$listDiv) {
    return function () {
      closure$ks.plusAssign_wii6vi$(closure$list.isEmptyRx.forEach_qlkmfe$(listUI$lambda$lambda$lambda$lambda_0(closure$queryRoot, closure$emptyDiv, closure$listDiv)));
      return Unit;
    };
  }
  function listUI$lambda$lambda_0(this$, closure$killables, closure$emptyDiv) {
    return function (old, q) {
      ...
      var listDiv = column(document, listUI$lambda$lambda$lambda_1(this$, list));
      listen_0(q.query, ks, ListenConfig.Companion.hasProps_5sp7du$(list, this$.create).copy_4cbyqc$(void 0, void 0, void 0, void 0, listUI$lambda$lambda$lambda_2(ks, list, queryRoot, closure$emptyDiv, listDiv)));
      return ks;
    };
  }
  ...
  function keepAlive$lambda(closure$killListen, closure$coll, this$keepAlive, closure$db) {
    return function (alive) {
      if (!alive) {
        closure$killListen.plusAssign_wii6vi$(listen(docRef(closure$coll.doc_61zpoe$(this$keepAlive.props.idOrFail), closure$db), this$keepAlive));
      }
      return Unit;
    };
  }
  ...
  function keepAlive($receiver, killables, coll, db) {
    var killListen = new Killables();
    var killForeach = $receiver.props.live.forEach_qlkmfe$(keepAlive$lambda(killListen, coll, $receiver, db));
  ...
  ViewScreenConfig.prototype.copy_elfipm$ = function (title, edit, view) {
  ...
  function build$lambda$lambda$lambda$lambda_6(this$build) {
    return function ($receiver) {
      $receiver.innerText = this$build.title;
      return Unit;
    };
  ...
  function build$lambda$lambda$lambda$lambda$lambda$lambda_12(this$build, closure$panel, closure$item, closure$displayViewer) {
    return function (ks, f) {
      this$build.edit(ks, closure$panel.sub(), closure$item, getCallableRef('displayViewer', function () {
        return closure$displayViewer(), Unit;
      }));
      return Unit;
    };
  }
  function build$lambda$lambda$lambda$lambda$lambda_13(this$build, closure$panel, closure$item, closure$displayViewer) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(build$lambda$lambda$lambda$lambda$lambda$lambda_11);
      clickEventSeq($receiver, build$lambda$lambda$lambda$lambda$lambda$lambda_12(this$build, closure$panel, closure$item, closure$displayViewer));
      return Unit;
    };
  }
  function build$lambda$lambda$lambda$lambda_7(this$build, closure$panel, closure$item, closure$displayViewer) {
    return function ($receiver) {
      faButton($receiver, get_pen(Fa.Companion), build$lambda$lambda$lambda$lambda$lambda_13(this$build, closure$panel, closure$item, closure$displayViewer));
      return Unit;
    };
  }
  function build$lambda$lambda$lambda_4(closure$close, this$build, closure$panel, closure$item, closure$displayViewer) {
    return function ($receiver) {
      $receiver.backButton_o14v8n$(closure$close);
      $receiver.middleTitle_9f50g3$(build$lambda$lambda$lambda$lambda_6(this$build));
      $receiver.right.invoke_gk6m2q$(build$lambda$lambda$lambda$lambda_7(this$build, closure$panel, closure$item, closure$displayViewer));
      return Unit;
    };
  }
  function build$lambda$lambda$lambda_5(this$build, closure$killables, closure$item) {
    return function ($receiver) {
      this$build.view($receiver, closure$killables, closure$item);
      return Unit;
    };
  }
  function build$lambda$lambda_5(closure$close, this$build, closure$panel, closure$item, closure$displayViewer, closure$killables) {
    return function ($receiver) {
      $receiver.top_vesf63$(build$lambda$lambda$lambda_4(closure$close, this$build, closure$panel, closure$item, closure$displayViewer));
      $receiver.main_iw61es$(build$lambda$lambda$lambda_5(this$build, closure$killables, closure$item));
      return Unit;
    };
  }
  function build$lambda_8(closure$panel, closure$killables, closure$close, this$build, closure$item) {
    return function ($receiver) {
      var displayViewer = build$lambda$displayViewer(closure$panel, $receiver);
      screenLayout($receiver, closure$killables, build$lambda$lambda_5(closure$close, this$build, closure$panel, closure$item, displayViewer, closure$killables));
      return Unit;
    };
  }
  function build_1($receiver, killables, panel, item, close) {
    panel.newRoot_iw61es$(build$lambda_8(panel, killables, close, $receiver, item));
  }
  ...
  package$commonfb.build_mgj0h9$ = build;
  ...
  package$commonfb.build_f01wra$ = build_0;
  package$commonfb.stringListClick_cvv88r$ = stringListClick;
  package$commonfb.ListUIConfig = ListUIConfig;
  package$commonfb.listUI_ywoyug$ = listUI;
  package$commonfb.showClosableList_uv07cr$ = showClosableList;
  package$commonfb.keepAlive_r9y676$ = keepAlive;
  ...
  package$commonfb.build_8wja18$ = build_1;
  ...
  return _;
}(typeof this['appsimake-commonfb'] === 'undefined' ? {} : this['appsimake-commonfb'], kotlin, this['appsimake-commonshr'], this['appsimake-domx'], this['appsimake-commonui'], this['appsimake-firebase'], this['kotlinx-coroutines-core'], this['appsimake-bootstrap'], this['appsimake-fontawesome'], this['appsimake-common'], this['appsimake-commonlib']);
