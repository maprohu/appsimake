...
this['appsimake-gymclock'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_commonui, $module$appsimake_common) {
  ...
  var Math_0 = Math;
  function Clock$timer$lambda$lambda$lambda(closure$timerDiv, this$) {
    return function () {
  ...
  function Clock$timer$lambda$lambda_2(closure$killables, closure$timerDiv, closure$counter) {
    return function ($receiver) {
      closure$killables.plusAssign_o14v8n$(resizeEvent(window, Clock$timer$lambda$lambda$lambda(closure$timerDiv, $receiver)));
  ...
  function Form$root$lambda$lambda$lambda$lambda$lambda$lambda_1($receiver) {
    get_x3(get_fa(get_cls($receiver)));
    return Unit;
  }
  var Collection = Kotlin.kotlin.collections.Collection;
  function Form$root$lambda$lambda$lambda$lambda$lambda$lambda_2(closure$valids) {
    return function () {
  ...
  function Form$root$lambda$lambda$lambda$lambda$lambda$lambda_3(closure$canSubmit, closure$submit) {
    return function (it) {
  ...
  function Form$root$lambda$lambda$lambda$lambda$lambda_2(closure$valids, closure$submit) {
    return function ($receiver) {
      ...
      faButtonSpan($receiver, get_running(Fa.Companion), Form$root$lambda$lambda$lambda$lambda$lambda$lambda_1);
      var canSubmit = Rx_init(Form$root$lambda$lambda$lambda$lambda$lambda$lambda_2(closure$valids));
      rxEnabled($receiver, canSubmit);
      clickEvent($receiver, Form$root$lambda$lambda$lambda$lambda$lambda$lambda_3(canSubmit, closure$submit));
      return Unit;
    };
  }
