...
var chat = function (_, Kotlin, $module$pullanappfb, $module$firebase, $module$kotlinx_html_js, $module$common) {
  ...
  function Chatting$start$lambda$lambda(this$, this$Chatting) {
    return function ($receiver) {
      span(this$, void 0, Chatting$start$lambda$lambda$lambda(this$, this$Chatting));
      form(this$, void 0, void 0, void 0, 'd-flex flex-row', Chatting$start$lambda$lambda$lambda_0(this$, this$Chatting));
      var list = dl(this$, 'flex-grow-1 ' + styles.scrollVertical, Chatting$start$lambda$lambda$lambda_1);
      var first = {v: true};
      this$Chatting.lastMessage.onSnapshot(Chatting$start$lambda$lambda$lambda_2(first, list, this$Chatting));
      form(this$, void 0, void 0, void 0, 'd-flex flex-row', Chatting$start$lambda$lambda$lambda_3(this$, this$Chatting));
      return Unit;
    };
  }
