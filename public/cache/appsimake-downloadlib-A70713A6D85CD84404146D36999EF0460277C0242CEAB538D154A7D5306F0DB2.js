...
this['appsimake-downloadlib'] = function (_, Kotlin, $module$appsimake_commonshr) {
  ...
  function DownloadItem() {
    ...
    RxBase.call(this);
    this.url_yn8lc8$_0 = this.o.string().provideDelegate_n5byny$(this, DownloadItem$url_metadata);
    this.name_8nux0e$_0 = this.o.string().provideDelegate_n5byny$(this, DownloadItem$name_metadata);
  ...
  function DownloadProcess() {
    ...
    RxBase.call(this);
    this.url_3vbyns$_0 = this.o.string().provideDelegate_n5byny$(this, DownloadProcess$url_metadata);
    this.title_p6ntpr$_0 = this.o.string().provideDelegate_n5byny$(this, DownloadProcess$title_metadata);
