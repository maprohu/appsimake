...
this['appsimake-tasks'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_commonfb, $module$appsimake_taskslib, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_fontawesome, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_common, $module$appsimake_firebaseshr) {
  ...
  function LoggedIn$main$lambda$lambda(this$LoggedIn, closure$showHome, closure$homeActive) {
    return function ($receiver) {
      ...
      invoke($receiver.main, LoggedIn$main$lambda$lambda$lambda_0(this$LoggedIn, closure$homeActive, closure$showHome));
      return Unit;
    };
  }
  ...
  function recent$lambda$lambda_2($receiver) {
    ListUIConfig.Companion.standardEmptyDiv($receiver);
    get_cardBody(get_cls($receiver));
    return Unit;
  }
  ...
  function recent$lambda_0(closure$panel, this$recent) {
    return function (onClick) {
      return new ListUIConfig(closure$panel, new Var(query(this$recent.userTasks, this$recent.db, recent$lambda$lambda)), this$recent.userTasks, recent$lambda$lambda_0, recent$lambda$lambda_1, recent$lambda$lambda_2, recent$lambda$lambda_3, recent$lambda$lambda_4, stringListClick(recent$lambda$lambda_5, onClick));
    };
  }
  ...
  function viewTask$lambda$lambda$lambda$lambda$lambda_7(closure$notesRoot, closure$notesWrap, this$viewTask) {
    return function (show) {
      return new ListUIConfig(closure$notesRoot, new Var(query(closure$notesWrap, this$viewTask.db, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_1)), closure$notesWrap, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_2, void 0, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_3, void 0, void 0, stringListClick(viewTask$lambda$lambda$lambda$lambda$lambda$lambda_4, show));
    };
  }
