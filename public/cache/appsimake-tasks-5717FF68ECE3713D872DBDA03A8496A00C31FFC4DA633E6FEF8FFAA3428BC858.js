...
this['appsimake-tasks'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_commonfb, $module$appsimake_taskslib, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_fontawesome, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_common, $module$appsimake_commonlib) {
  ...
  var get_notes = $module$appsimake_taskslib.taskslib.get_notes_ycv2h8$;
  ...
  function editNote($receiver, killables, panel, coll, note, close) {
    return build(new EditScreenConfig('Note', editNote$lambda), killables, panel, note, close, coll, $receiver.db);
  }
  ...
  function listTasks($receiver, killables, panel, after) {
    build_0(new ListScreenConfig('Task List', listTasks$lambda, $receiver.userTasks, getCallableRef('viewTask', function ($receiver, ks, panel, task, close) {
  ...
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda(this$, closure$notesWrap, this$viewTask) {
    return function (it) {
      editNote(this$viewTask, this$.state.killables, this$.state.panel.sub(), closure$notesWrap, new Note(), this$.state.redisplay);
      return Unit;
    };
  }
  ...
  function viewTask$lambda$lambda$lambda$lambda$lambda_6(closure$st, closure$notesWrap, this$viewTask) {
    return function (ks, item, close) {
      editNote(this$viewTask, ks, closure$st.panel.sub(), closure$notesWrap, item, close);
      return Unit;
    };
  }
  ...
  function viewTask$lambda$lambda$lambda$lambda$lambda_7(closure$notesRoot, closure$notesWrap, this$viewTask) {
    return function (show) {
      return new ListUIConfig(closure$notesRoot, new Var(query(closure$notesWrap, this$viewTask.db, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_1)), viewTask$lambda$lambda$lambda$lambda$lambda$lambda_2, void 0, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_3, void 0, void 0, stringListClick(viewTask$lambda$lambda$lambda$lambda$lambda$lambda_4, show));
    };
  }
  function viewTask$lambda$lambda$lambda$lambda_6(this$, closure$st, closure$notesWrap, this$viewTask) {
    return function ($receiver) {
      var notesRoot = new RootPanel($receiver);
      showClosableList(this$.killables, this$.redisplay, viewTask$lambda$lambda$lambda$lambda$lambda_6(closure$st, closure$notesWrap, this$viewTask), viewTask$lambda$lambda$lambda$lambda$lambda_7(notesRoot, closure$notesWrap, this$viewTask));
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda_1(this$, closure$item, this$viewTask, closure$st, closure$notesWrap) {
    return function ($receiver) {
      ...
      invoke(get_div($receiver), viewTask$lambda$lambda$lambda$lambda_6(this$, closure$st, closure$notesWrap, this$viewTask));
      return Unit;
    };
  }
  ...
  function viewTask($receiver, ks, panel, task, close) {
    var notesWrap = get_notes($receiver.userTasks.doc_61zpoe$(task.props.idOrFail));
  ...
  package$tasks.editNote_9fizmu$ = editNote;
