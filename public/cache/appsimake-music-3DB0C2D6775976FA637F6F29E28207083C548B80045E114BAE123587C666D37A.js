...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_commonshr, $module$appsimake_indexeddb, $module$appsimake_musiclib, $module$appsimake_common, $module$appsimake_firebaseshr, $module$appsimake_commonlib, $module$appsimake_commonfb, $module$appsimake_firebase) {
  ...
  var call = $module$appsimake_commonfb.commonfb.call_wyg8o4$;
  ...
  function Coroutine$runApp$lambda$ObjectLiteral$loggedIn$lambda(this$_0, closure$user_0, closure$fbCtx_0, closure$ks_0, closure$idb_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 1;
            this.result_0 = call(commonlib.customToken, this.local$this$.app, Unit, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            if ((tmp$ = this.result_0) != null) {
              this.state_0 = 2;
              this.result_0 = await_1(this.local$this$.app.auth().signInWithCustomToken(tmp$), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  function runApp$lambda$ObjectLiteral$loggedIn$lambda(this$_0, closure$user_0, closure$fbCtx_0, closure$ks_0, closure$idb_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$runApp$lambda$ObjectLiteral$loggedIn$lambda(this$_0, closure$user_0, closure$fbCtx_0, closure$ks_0, closure$idb_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  runApp$lambda$ObjectLiteral.prototype.loggedIn_v1eir6$ = function (user) {
    ...
    launch(coroutines.GlobalScope, void 0, void 0, runApp$lambda$ObjectLiteral$loggedIn$lambda(this, user, this.closure$fbCtx, ks, this.closure$idb));
    return ks;
  };
