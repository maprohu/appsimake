...
this['appsimake-firebase'] = function (_, Kotlin, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_common, $module$appsimake_firebaseshr) {
  ...
  function RxSetWithLookup(set, lookup) {
    this.set = set;
    this.lookup = lookup;
  }
  ...
  function Coroutine$toRxSetWithLookup($receiver_0, killables_0, create_0, update_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$set = void 0;
  ...
  Coroutine$toRxSetWithLookup.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$toRxSetWithLookup.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$toRxSetWithLookup.prototype.constructor = Coroutine$toRxSetWithLookup;
  Coroutine$toRxSetWithLookup.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$set = new RxMutableSet();
            this.local$map = LinkedHashMap_init();
            this.local$addOrUpdate = toRxSetWithLookup$addOrUpdate(this.local$map, this.local$create, this.local$set, this.local$update);
            plusAssign(this.local$killables, onSnapshotNext(this.local$$receiver.query, toRxSetWithLookup$lambda(this.local$addOrUpdate, this.local$map, this.local$set)));
            this.state_0 = 2;
            this.result_0 = await_0(this.local$$receiver.query.get(), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
          ...
          case 2:
            ...
            return new RxSetWithLookup(this.local$set, toRxSetWithLookup$lambda_0(this.local$map));
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function toRxSetWithLookup($receiver_0, killables_0, create_0, update_0, continuation_0, suspended) {
    var instance = new Coroutine$toRxSetWithLookup($receiver_0, killables_0, create_0, update_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function toRxSetWithLookup$createPersisted(closure$create, closure$collectionWrap) {
    return function (id) {
      var $receiver = closure$create();
      var closure$collectionWrap_0 = closure$collectionWrap;
      $receiver.props.persisted_11rd$(closure$collectionWrap_0.doc_61zpoe$(id));
  ...
  function toRxSetWithLookup$lambda_1(closure$createPersisted) {
    return function (id, data) {
      var $receiver = closure$createPersisted(id);
      initFrom($receiver, data);
      return $receiver;
  ...
  function toRxSetWithLookup$lambda_2(t, data) {
    initFrom(t, data);
    return Unit;
  }
  function toRxSetWithLookup_0($receiver, killables, collectionWrap, create, continuation) {
    var createPersisted = toRxSetWithLookup$createPersisted(create, collectionWrap);
    return toRxSetWithLookup($receiver, killables, toRxSetWithLookup$lambda_1(createPersisted), toRxSetWithLookup$lambda_2, continuation);
  }
  function toRxSetWithLookup_1($receiver, killables, db, create, continuation) {
    return toRxSetWithLookup_0(query($receiver, db), killables, $receiver, create, continuation);
  }
  ...
  package$firestore.toRxSetWithLookup_ade12y$ = toRxSetWithLookup_0;
