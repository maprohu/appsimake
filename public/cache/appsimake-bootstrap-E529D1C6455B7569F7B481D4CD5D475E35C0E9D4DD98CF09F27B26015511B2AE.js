...
this['appsimake-bootstrap'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_commonshr, $module$appsimake_common) {
  ...
  function dropdownDiv$lambda_0(closure$block) {
    return function ($receiver) {
      ...
      invoke(get_div($receiver), dropdownDiv$lambda$lambda(closure$block));
      return Unit;
    };
  }
  function dropdownDiv($receiver, block) {
    ...
    return invoke(get_div($receiver), dropdownDiv$lambda_0(block));
  }
  ...
  function btnGroup($receiver) {
    get_classes($receiver).plusAssign_pdl1vj$('btn-group');
  }
  ...
  function get_btnGroup($receiver) {
    return btnGroup_0.getValue_lrcp0p$($receiver, btnGroup_metadata);
  }
  ...
  btnGroup_0 = css().provideDelegate_d6mtq7$(this, btnGroup_metadata);
