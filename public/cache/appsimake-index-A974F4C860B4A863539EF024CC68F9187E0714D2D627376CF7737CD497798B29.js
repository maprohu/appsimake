...
if (typeof this['appsimake-indexlib'] === 'undefined') {
  throw new Error("Error loading module 'appsimake-index'. Its dependency 'appsimake-indexlib' was not found. Please, check whether 'appsimake-indexlib' is loaded prior to 'appsimake-index'.");
}
...
if (typeof this['appsimake-commonlib'] === 'undefined') {
  throw new Error("Error loading module 'appsimake-index'. Its dependency 'appsimake-commonlib' was not found. Please, check whether 'appsimake-commonlib' is loaded prior to 'appsimake-index'.");
}
if (typeof this['appsimake-firebase'] === 'undefined') {
  throw new Error("Error loading module 'appsimake-index'. Its dependency 'appsimake-firebase' was not found. Please, check whether 'appsimake-firebase' is loaded prior to 'appsimake-index'.");
}
...
this['appsimake-index'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_indexlib, $module$appsimake_commonshr, $module$appsimake_commonlib, $module$appsimake_firebase, $module$appsimake_commonfb, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome) {
  'use strict';
  ...
  var wrapFsDoc = $module$appsimake_firebase.firebase.firestore.wrapFsDoc_fuxh7m$;
  ...
  function About(parent, linkage) {
    ...
    this.html = this.get_live_73z9b6$(wrapFsDoc(get_about(get_meta(index.indexLib.app)), new HtmlPage()));
  ...
  About.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_rz6dv4$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  About.prototype.getOrDefault_bo0woj$$default = function ($receiver, source, fn, continuation) {
    return this.$delegate_rz6dv4$_0.getOrDefault_bo0woj$$default($receiver, source, fn, continuation);
  };
  ...
  About.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_rz6dv4$_0.set_o9yh22$$default($receiver, data, options);
  };
  About.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_rz6dv4$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  function ui$lambda$lambda$lambda$lambda(this$ui) {
    return function ($receiver) {
      return this$ui.html.invoke().html.invoke();
    };
  }
  ...
  function ui$lambda$lambda$lambda(this$ui) {
    return function ($receiver) {
      this$ui.forEach_xwzbbo$(this$ui.rx_y6x17j$(ui$lambda$lambda$lambda$lambda(this$ui)), ui$lambda$lambda$lambda$lambda_0($receiver));
      return Unit;
    };
  }
  ...
  Home.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_k3lhg2$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  Home.prototype.getOrDefault_bo0woj$$default = function ($receiver, source, fn, continuation) {
    return this.$delegate_k3lhg2$_0.getOrDefault_bo0woj$$default($receiver, source, fn, continuation);
  };
  ...
  Home.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_k3lhg2$_0.set_o9yh22$$default($receiver, data, options);
  };
  Home.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_k3lhg2$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  LoggedIn.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_4vwecb$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  LoggedIn.prototype.getOrDefault_bo0woj$$default = function ($receiver, source, fn, continuation) {
    return this.$delegate_4vwecb$_0.getOrDefault_bo0woj$$default($receiver, source, fn, continuation);
  };
  ...
  LoggedIn.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_4vwecb$_0.set_o9yh22$$default($receiver, data, options);
  };
  LoggedIn.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_4vwecb$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  NotLoggedIn.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_aqqi0j$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  NotLoggedIn.prototype.getOrDefault_bo0woj$$default = function ($receiver, source, fn, continuation) {
    return this.$delegate_aqqi0j$_0.getOrDefault_bo0woj$$default($receiver, source, fn, continuation);
  };
  ...
  NotLoggedIn.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_aqqi0j$_0.set_o9yh22$$default($receiver, data, options);
  };
  NotLoggedIn.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_aqqi0j$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  function appListUi$lambda$lambda($receiver) {
    ...
    app($receiver_1, 'tictactoe', 'Tic Tac Toe');
    ...
    app($receiver_3, 'store', 'Store');
    app($receiver_3, 'eventlog', 'Event Log');
  ...
  function main() {
    FbLinksFactory.Companion.start_gwo7fm$(new Lib('index'), false, void 0, main$lambda);
  }
  function LinksPath() {
  }
  LinksPath.$metadata$ = {
  ...
  LinksPath.prototype.get_randomDoc_lsue4w$ = FbLinksApi.prototype.get_randomDoc_lsue4w$;
  ...
  LinksPath.prototype.getOrDefault_bo0woj$$default = FbLinksApi.prototype.getOrDefault_bo0woj$$default;
  ...
  LinksPath.prototype.set_o9yh22$$default = FbLinksApi.prototype.set_o9yh22$$default;
  LinksPath.prototype.toFsDoc_bo0woj$$default = FbLinksApi.prototype.toFsDoc_bo0woj$$default;
  LinksPath.prototype.toRandomFsDoc_xc7wmg$ = FbLinksApi.prototype.toRandomFsDoc_xc7wmg$;
  LinksPath.prototype.getOrDefault_bo0woj$ = FbLinksApi.prototype.getOrDefault_bo0woj$;
  ...
  LinksPath.prototype.set_o9yh22$ = FbLinksApi.prototype.set_o9yh22$;
  LinksPath.prototype.toFsDoc_bo0woj$ = FbLinksApi.prototype.toFsDoc_bo0woj$;
  HomePath.prototype.get_randomDoc_lsue4w$ = LinksPath.prototype.get_randomDoc_lsue4w$;
  ...
  HomePath.prototype.getOrDefault_bo0woj$$default = LinksPath.prototype.getOrDefault_bo0woj$$default;
  ...
  HomePath.prototype.set_o9yh22$$default = LinksPath.prototype.set_o9yh22$$default;
  HomePath.prototype.toFsDoc_bo0woj$$default = LinksPath.prototype.toFsDoc_bo0woj$$default;
  HomePath.prototype.toRandomFsDoc_xc7wmg$ = LinksPath.prototype.toRandomFsDoc_xc7wmg$;
  HomePath.prototype.getOrDefault_bo0woj$ = LinksPath.prototype.getOrDefault_bo0woj$;
  ...
  HomePath.prototype.set_o9yh22$ = LinksPath.prototype.set_o9yh22$;
  HomePath.prototype.toFsDoc_bo0woj$ = LinksPath.prototype.toFsDoc_bo0woj$;
  AboutPath.prototype.get_randomDoc_lsue4w$ = HomePath.prototype.get_randomDoc_lsue4w$;
  ...
  AboutPath.prototype.getOrDefault_bo0woj$$default = HomePath.prototype.getOrDefault_bo0woj$$default;
  ...
  AboutPath.prototype.set_o9yh22$$default = HomePath.prototype.set_o9yh22$$default;
  AboutPath.prototype.toFsDoc_bo0woj$$default = HomePath.prototype.toFsDoc_bo0woj$$default;
  AboutPath.prototype.toRandomFsDoc_xc7wmg$ = HomePath.prototype.toRandomFsDoc_xc7wmg$;
  AboutPath.prototype.getOrDefault_bo0woj$ = HomePath.prototype.getOrDefault_bo0woj$;
  ...
  AboutPath.prototype.set_o9yh22$ = HomePath.prototype.set_o9yh22$;
  AboutPath.prototype.toFsDoc_bo0woj$ = HomePath.prototype.toFsDoc_bo0woj$;
  ...
  About.prototype.get_docsOrNull_g2zw3r$ = FBBackApi.prototype.get_docsOrNull_g2zw3r$;
  ...
  About.prototype.documentChanges_pujjsl$$default = FBBackApi.prototype.documentChanges_pujjsl$$default;
  ...
  About.prototype.getOrDefault_bo0woj$ = AboutPath.prototype.getOrDefault_bo0woj$;
  ...
  About.prototype.set_o9yh22$ = AboutPath.prototype.set_o9yh22$;
  About.prototype.toFsDoc_bo0woj$ = AboutPath.prototype.toFsDoc_bo0woj$;
  ...
  About.prototype.documentChanges_pujjsl$ = FBBackApi.prototype.documentChanges_pujjsl$;
  ...
  Home.prototype.getOrDefault_bo0woj$ = HomePath.prototype.getOrDefault_bo0woj$;
  ...
  Home.prototype.set_o9yh22$ = HomePath.prototype.set_o9yh22$;
  Home.prototype.toFsDoc_bo0woj$ = HomePath.prototype.toFsDoc_bo0woj$;
  Home.prototype.fwd_e1fa5e$ = LinkApi.prototype.fwd_e1fa5e$;
  Home.prototype.fwd_nnhkmr$ = LinkApi.prototype.fwd_nnhkmr$;
  LoggedInPath.prototype.get_randomDoc_lsue4w$ = HomePath.prototype.get_randomDoc_lsue4w$;
  ...
  LoggedInPath.prototype.getOrDefault_bo0woj$$default = HomePath.prototype.getOrDefault_bo0woj$$default;
  ...
  LoggedInPath.prototype.set_o9yh22$$default = HomePath.prototype.set_o9yh22$$default;
  LoggedInPath.prototype.toFsDoc_bo0woj$$default = HomePath.prototype.toFsDoc_bo0woj$$default;
  LoggedInPath.prototype.toRandomFsDoc_xc7wmg$ = HomePath.prototype.toRandomFsDoc_xc7wmg$;
  LoggedInPath.prototype.getOrDefault_bo0woj$ = HomePath.prototype.getOrDefault_bo0woj$;
  ...
  LoggedInPath.prototype.set_o9yh22$ = HomePath.prototype.set_o9yh22$;
  LoggedInPath.prototype.toFsDoc_bo0woj$ = HomePath.prototype.toFsDoc_bo0woj$;
  HomeApi.prototype.get_randomDoc_lsue4w$ = HomePath.prototype.get_randomDoc_lsue4w$;
  ...
  HomeApi.prototype.getOrDefault_bo0woj$$default = HomePath.prototype.getOrDefault_bo0woj$$default;
  ...
  HomeApi.prototype.set_o9yh22$$default = HomePath.prototype.set_o9yh22$$default;
  HomeApi.prototype.toFsDoc_bo0woj$$default = HomePath.prototype.toFsDoc_bo0woj$$default;
  ...
  HomeApi.prototype.anyRx_tnde95$ = KillsLoginUixApi.prototype.anyRx_tnde95$;
  HomeApi.prototype.attached_ux9tev$ = KillsLoginUixApi.prototype.attached_ux9tev$;
  ...
  HomeApi.prototype.forEachNonNull_cjboeh$ = KillsLoginUixApi.prototype.forEachNonNull_cjboeh$;
  HomeApi.prototype.forEachTrue_aq5y71$ = KillsLoginUixApi.prototype.forEachTrue_aq5y71$;
  ...
  HomeApi.prototype.register_3ijkb1$ = KillsLoginUixApi.prototype.register_3ijkb1$;
  ...
  HomeApi.prototype.toChannel_z5dyp2$ = KillsLoginUixApi.prototype.toChannel_z5dyp2$;
  ...
  HomeApi.prototype.getOrDefault_bo0woj$ = HomePath.prototype.getOrDefault_bo0woj$;
  ...
  HomeApi.prototype.set_o9yh22$ = HomePath.prototype.set_o9yh22$;
  HomeApi.prototype.toFsDoc_bo0woj$ = HomePath.prototype.toFsDoc_bo0woj$;
  ...
  LoggedIn.prototype.getOrDefault_bo0woj$ = LoggedInPath.prototype.getOrDefault_bo0woj$;
  ...
  LoggedIn.prototype.set_o9yh22$ = LoggedInPath.prototype.set_o9yh22$;
  LoggedIn.prototype.toFsDoc_bo0woj$ = LoggedInPath.prototype.toFsDoc_bo0woj$;
  NotLoggedInPath.prototype.get_randomDoc_lsue4w$ = HomePath.prototype.get_randomDoc_lsue4w$;
  ...
  NotLoggedInPath.prototype.getOrDefault_bo0woj$$default = HomePath.prototype.getOrDefault_bo0woj$$default;
  ...
  NotLoggedInPath.prototype.set_o9yh22$$default = HomePath.prototype.set_o9yh22$$default;
  NotLoggedInPath.prototype.toFsDoc_bo0woj$$default = HomePath.prototype.toFsDoc_bo0woj$$default;
  NotLoggedInPath.prototype.toRandomFsDoc_xc7wmg$ = HomePath.prototype.toRandomFsDoc_xc7wmg$;
  NotLoggedInPath.prototype.getOrDefault_bo0woj$ = HomePath.prototype.getOrDefault_bo0woj$;
  ...
  NotLoggedInPath.prototype.set_o9yh22$ = HomePath.prototype.set_o9yh22$;
  NotLoggedInPath.prototype.toFsDoc_bo0woj$ = HomePath.prototype.toFsDoc_bo0woj$;
  ...
  NotLoggedIn.prototype.getOrDefault_bo0woj$ = NotLoggedInPath.prototype.getOrDefault_bo0woj$;
  ...
  NotLoggedIn.prototype.set_o9yh22$ = NotLoggedInPath.prototype.set_o9yh22$;
  NotLoggedIn.prototype.toFsDoc_bo0woj$ = NotLoggedInPath.prototype.toFsDoc_bo0woj$;
  ...
  return _;
}(typeof this['appsimake-index'] === 'undefined' ? {} : this['appsimake-index'], kotlin, this['appsimake-commonui'], this['appsimake-indexlib'], this['appsimake-commonshr'], this['appsimake-commonlib'], this['appsimake-firebase'], this['appsimake-commonfb'], this['appsimake-domx'], this['appsimake-bootstrap'], this['appsimake-fontawesome']);
