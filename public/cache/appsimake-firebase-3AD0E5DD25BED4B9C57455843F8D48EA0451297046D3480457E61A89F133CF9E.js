...
this['appsimake-firebase'] = function (_, Kotlin, $module$appsimake_commonshr, $module$kotlinx_coroutines_core) {
  ...
  DbTxApi.prototype.getOrDefault_we3fe6$ = function ($receiver, fn, continuation) {
    return getOrDefault($receiver, this, fn, continuation);
  };
  ...
  function Coroutine$getOrDefault($receiver_0, deps_0, fn_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
    this.local$deps = deps_0;
  ...
  function getOrDefault($receiver_0, deps_0, fn_0, continuation_0, suspended) {
    var instance = new Coroutine$getOrDefault($receiver_0, deps_0, fn_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  package$firestore.getOrDefault_z9h41t$ = getOrDefault;
