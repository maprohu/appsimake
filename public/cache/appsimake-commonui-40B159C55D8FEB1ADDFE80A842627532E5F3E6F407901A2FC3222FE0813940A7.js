...
this['appsimake-commonui'] = function (_, Kotlin, $module$appsimake_common, $module$appsimake_commonshr, $module$appsimake_bootstrap, $module$appsimake_buildenv, $module$appsimake_domx, $module$appsimake_fontawesome, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  function AppCtx$visible$lambda(this$AppCtx) {
    return function () {
      var hidden = named(AppCtx$visible$lambda$lambda).provideDelegate_d6mtq7$(this, AppCtx$visible$lambda$hidden_metadata);
      var visible = named(AppCtx$visible$lambda$lambda_0).provideDelegate_d6mtq7$(this, AppCtx$visible$lambda$visible_metadata);
      var visibilitychange = named(AppCtx$visible$lambda$lambda_1).provideDelegate_d6mtq7$(this, AppCtx$visible$lambda$visibilitychange_metadata);
      var visibilityState = named(AppCtx$visible$lambda$lambda_2).provideDelegate_d6mtq7$(this, AppCtx$visible$lambda$visibilityState_metadata);
  ...
  return _;
}(typeof this['appsimake-commonui'] === 'undefined' ? {} : this['appsimake-commonui'], kotlin, this['appsimake-common'], this['appsimake-commonshr'], this['appsimake-bootstrap'], this['appsimake-buildenv'], this['appsimake-domx'], this['appsimake-fontawesome'], this['kotlinx-coroutines-core']);
