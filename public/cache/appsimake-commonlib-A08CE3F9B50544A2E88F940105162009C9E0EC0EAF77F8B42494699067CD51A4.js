...
this['appsimake-commonlib'] = function (_, Kotlin, $module$kotlinx_coroutines_core, $module$appsimake_commonshr) {
  ...
  function RandomChooser(emitters, recentSize, cacheSize, fn) {
    ...
    addedTo(launch(coroutines.GlobalScope, void 0, void 0, RandomChooser_init$lambda(this)), this.ks);
  }
  ...
  function RandomChooser$Source($outer, s) {
    ...
    this.sourceChannel = toChannel_0(s, this.$outer.ks);
    this.items = LinkedHashSet_init();
    addedTo(launch(coroutines.GlobalScope, void 0, void 0, RandomChooser$RandomChooser$Source_init$lambda(this, this.$outer)), this.$outer.ks);
  }
  ...
  function Coroutine$RandomChooser$RandomChooser$Source_init$lambda(this$Source_0, this$RandomChooser_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$Source = this$Source_0;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = toChannel(map(this.local$this$Source.sourceChannel, void 0, RandomChooser$RandomChooser$Source_init$lambda$lambda(this.local$this$Source, this.local$this$RandomChooser)), this.local$this$RandomChooser.eventChannel, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function RandomChooser$RandomChooser$Source_init$lambda(this$Source_0, this$RandomChooser_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$RandomChooser$RandomChooser$Source_init$lambda(this$Source_0, this$RandomChooser_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  package$commonlib.toRx_txiss2$ = toRx;
