...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_commonfb, $module$appsimake_firebase, $module$appsimake_indexeddb, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_musiclib, $module$appsimake_fontawesome, $module$appsimake_common, $module$appsimake_firebaseshr, $module$appsimake_commonlib) {
  'use strict';
  ...
  DetailsPath.prototype = Object.create(DatabasePath.prototype);
  DetailsPath.prototype.constructor = DetailsPath;
  ...
  MusicApi.prototype.status_b5mdq1$ = function (items) {
    return new Database$Status(items, this.path, this.kills);
  };
  ...
  function Database(from) {
    ...
    this.toBeDownloaded = this.status_um4tjc$(this.filtered_49l5s4$(this.get_ids_wjz35z$(this.path.loggedIn.uploadedSet), Database$toBeDownloaded$lambda(this)));
    this.toBeUploaded = this.status_um4tjc$(this.filtered_49l5s4$(this.path.boot.localSongs.set, Database$toBeUploaded$lambda(this)));
    this.toBeDeleted = this.status_um4tjc$(this.filtered_49l5s4$(this.path.boot.localSongs.set, Database$toBeDeleted$lambda(this)));
    this.newInCloud = this.status_um4tjc$(this.filtered_49l5s4$(this.get_ids_wjz35z$(this.filtered_49l5s4$(this.path.loggedIn.storageSet.set, Database$newInCloud$lambda)), Database$newInCloud$lambda_0(this)));
  ...
  function DetailsPath(details) {
    DatabasePath.call(this, details.from);
  ...
  function Details(from) {
    ForwardBase_init(from, this);
    this.from = from;
    this.path_xp4c99$_0 = new DetailsPath(this);
    this.localSongIds = this.status_um4tjc$(this.path.boot.localSongs.set);
    this.new = this.status_um4tjc$(this.filtered_49l5s4$(this.path.boot.localSongs.set, Details$new$lambda(this)));
    this.like = this.status_um4tjc$(this.get_ids_wjz35z$(this.filtered_49l5s4$(this.path.loggedIn.userSongSet.set, Details$like$lambda)));
    this.dontLike = this.status_um4tjc$(this.get_ids_wjz35z$(this.filtered_49l5s4$(this.path.loggedIn.userSongSet.set, Details$dontLike$lambda)));
    this.cloud = this.status_um4tjc$(this.get_ids_wjz35z$(this.filtered_49l5s4$(this.path.loggedIn.storageSet.set, Details$cloud$lambda)));
    this.uploading = this.status_um4tjc$(this.path.loggedIn.uploadingIds);
    this.rawView_ndpus1$_0 = ui_1(this);
  }
  Object.defineProperty(Details.prototype, 'path', {
    get: function () {
      return this.path_xp4c99$_0;
    }
  });
  ...
  function Details$new$lambda(this$Details) {
    return function ($receiver, id) {
      return this$Details.path.loggedIn.userSongs.get(id).invoke() === UserSongState.New;
    };
  }
  ...
  function ui$lambda$lambda$statusPanel(this$, this$ui) {
    return function (st, title, bgfn) {
      ...
      statusPanel(this$ui, get_insert_0(this$), this$ui.path.database, st, title, bgfn);
    };
  }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            while (tmp$.hasNext()) {
              var element = tmp$.next();
              checkStorage(this.local$this$ui.path.loggedIn, element);
            }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_9(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda$lambda_5(this$ui) {
    return function ($receiver, bg) {
      ...
      this$ui_0.rxEnabled_y5ufnr$($receiver_0, ui$lambda$lambda$lambda$lambda$lambda_8(this$ui_0));
      $receiver.click_3xepc3$($receiver_0, ui$lambda$lambda$lambda$lambda$lambda_9(this$ui_0));
      return Unit;
    };
  }
  ...
  function ui_2($receiver) {
    ...
    invoke($receiver_7.pane, ui$lambda$lambda_1($receiver));
  ...
  function Import(from) {
    ...
    this.rawView_xbdjti$_0 = ui_3(this);
  }
  ...
  function ImportFile(import_0, file, playable) {
    ...
    this.rawView_2r18my$_0 = ui_4(this);
  ...
  function ui$lambda$lambda_2(this$ui) {
    return function () {
      return this$ui.path.boot.tasks.pending.invoke() + this$ui.loader.pending.invoke() | 0;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda_1(closure$inp) {
    return function ($receiver) {
      ...
      faButtonSpan($receiver, void 0, ui$lambda$lambda$lambda$lambda$lambda_10);
      var $receiver_0 = get_cls($receiver);
      get_btn($receiver_0);
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_11($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda_3(closure$inp) {
    return function ($receiver) {
      $receiver.htmlFor = get_ref(closure$inp);
      faButtonSpan($receiver, void 0, ui$lambda$lambda$lambda$lambda$lambda_11);
      var $receiver_0 = get_cls($receiver);
      get_btn($receiver_0);
      get_btnPrimary($receiver_0);
      get_m0($receiver_0);
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_15(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui_3($receiver) {
    ...
    $receiver.tasksUi_55raw2$($receiver_0.right, ui$lambda$lambda_2($receiver));
    var $receiver_2 = $receiver_0.right.buttonGroup;
    $receiver_2.m1;
    if (commonui.webkitdirectorySupported) {
      var $receiver_3 = invoke(get_input(inputContainer), ui$lambda$lambda$lambda_7($receiver));
      invoke(get_label($receiver_2.node), ui$lambda$lambda$lambda$lambda_1($receiver_3));
    }
    var $receiver_4 = invoke(get_input(inputContainer), ui$lambda$lambda$lambda_8($receiver));
    ...
    $receiver.rxClass_mjd6u9$($receiver_7.node, get_disabled(Cls.Companion), ui$lambda$lambda$lambda$lambda$lambda_12($receiver));
    get_fileImport($receiver_7.fa);
    $receiver_7.text.remAssign_61zpoe$('Start Importing');
    $receiver.click_ka8ib0$($receiver_7, ui$lambda$lambda$lambda$lambda$lambda_13($receiver));
    var $receiver_8 = $receiver_6.item;
    $receiver.rxClass_mjd6u9$($receiver_8.node, get_disabled(Cls.Companion), ui$lambda$lambda$lambda$lambda$lambda_14($receiver));
    get_trashAlt($receiver_8.fa);
    $receiver_8.text.remAssign_61zpoe$('Clear List');
    $receiver.click_ka8ib0$($receiver_8, ui$lambda$lambda$lambda$lambda$lambda_15($receiver));
    var tmp$ = $receiver_0.node;
    var $receiver_9 = widget.factory.scrollPane;
    var $receiver_10 = $receiver_9.cls;
    get_p1($receiver_10);
    get_flexColumn($receiver_10);
    listenableList($receiver_9.pane, $receiver.kills, $receiver.loadList, ui$lambda$lambda_3);
  ...
  function ui$lambda$lambda_4(this$ui) {
    return function ($receiver) {
      ...
      remAssign(get_dt($receiver), 'Artist');
      this$ui.remAssign_7fncnf$(get_dd($receiver), ui$lambda$lambda$lambda_9(this$ui));
      remAssign(get_dt($receiver), 'Title');
      this$ui.remAssign_7fncnf$(get_dd($receiver), ui$lambda$lambda$lambda_10(this$ui));
      remAssign(get_dt($receiver), 'Size');
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_17(this$ui) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_18(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_20(this$ui) {
    return function () {
  ...
  function ui$lambda$lambda_5(this$ui) {
    return function ($receiver) {
      ...
      $receiver_2.secondary;
      get_play($receiver_2.fa);
      this$ui_0.click_3xepc3$($receiver_2, ui$lambda$lambda$lambda$lambda$lambda_16(this$ui_0));
      var $receiver_3 = $receiver_1.button;
      $receiver_3.p2;
      get_thumbsUp($receiver_3.fa);
      this$ui_0.rxClass_wqb4ha$($receiver_3.node, ui$lambda$lambda$lambda$lambda$lambda_17(this$ui_0));
      this$ui_0.click_3xepc3$($receiver_3, ui$lambda$lambda$lambda$lambda$lambda_18(this$ui_0));
      var $receiver_4 = $receiver_1.button;
      $receiver_4.p2;
      $receiver_4.secondary;
      get_thumbsDown($receiver_4.fa);
      this$ui_0.click_3xepc3$($receiver_4, ui$lambda$lambda$lambda$lambda$lambda_19(this$ui_0));
      var $receiver_5 = $receiver_1.button;
      $receiver_5.p2;
      $receiver_5.secondary;
      get_fileImport($receiver_5.fa);
      this$ui_0.rxEnabled_y5ufnr$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_20(this$ui_0));
      this$ui_0.click_3xepc3$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_21(this$ui_0));
      var $receiver_6 = $receiver_1.button;
      $receiver_6.p2;
      $receiver_6.secondary;
      get_ban($receiver_6.fa);
      this$ui_0.click_3xepc3$($receiver_6, ui$lambda$lambda$lambda$lambda$lambda_22(this$ui_0));
      return Unit;
    };
  }
  function ui$lambda_0(this$ui) {
    return function ($receiver) {
      ...
      get_dFlex($receiver_0);
      get_flexColumn($receiver_0);
      invoke(get_dl($receiver), ui$lambda$lambda_4(this$ui));
      invoke(get_div($receiver), ui$lambda$lambda_5(this$ui));
      return Unit;
    };
  }
  ...
  function task($receiver, id, pr, fn) {
    $receiver.path.boot.task_1lt98f$(pr($receiver.path.boot.processOf_61zpoe$(id)), fn);
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$checkStorage.path.boot.localSongs.load_61zpoe$(this.local$closure$id, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
      ...
      try {
        switch (this.state_0) {
          ...
          case 4:
            ...
            return this.local$this$checkStorage.path.boot.slots.toasts(checkStorage$lambda$lambda$lambda_0(e));
          case 5:
            return Unit;
          case 6:
            throw this.exception_0;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$checkStorage.path.loggedIn.privileged_lnyleu$(checkStorage$lambda$lambda(this.local$this$checkStorage, this.local$closure$id), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function LoggedInPath(loggedIn) {
    ...
    this.$delegate_6aqe8a$_0 = loggedIn.from;
  }
  Object.defineProperty(LoggedInPath.prototype, 'body', {
    get: function () {
      return this.$delegate_6aqe8a$_0.body;
    }
  });
  Object.defineProperty(LoggedInPath.prototype, 'boot', {
    get: function () {
      return this.$delegate_6aqe8a$_0.boot;
    }
  });
  ...
  function LoggedIn(from, user, app, db, functions, storage, songInfoSource, userSongs) {
    ...
    this.rawView_mrgtfa$_0 = ui_5(this);
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.path.boot.customTokenReady.await(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$LoggedIn.path.boot.customTokenReady.await(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_24(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda$lambda_12(this$) {
    return function ($receiver) {
      get_m1(this$.cls);
      return Unit;
    };
  ...
  function ui_5($receiver) {
    ...
    $receiver.click_ka8ib0$($receiver_4, ui$lambda$lambda$lambda$lambda$lambda_23($receiver));
    $receiver_3.divider;
    var $receiver_5 = $receiver_3.item;
    get_signOutAlt($receiver_5.fa);
    $receiver_5.text.remAssign_61zpoe$('Sign Out');
    $receiver.click_ka8ib0$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_24($receiver));
    remAssign($receiver_0.title, 'Music');
    $receiver.syncUi_e1rmy3$($receiver_0.slots.right.slots);
    var $receiver_6 = userIcon($receiver_0.right, $receiver.kills, $receiver.path.boot.userIcon);
    invoke($receiver_6.node, ui$lambda$lambda$lambda_12($receiver_6));
    var tmp$ = $receiver_0.node;
  ...
  function NotLoggedIn(boot, app) {
    ...
    this.rawView_sonhr6$_0 = ui_6(this);
  }
  ...
  function ui$lambda$lambda$lambda_13(this$) {
    return function ($receiver) {
      get_m1(this$.cls);
      return Unit;
    };
  ...
  function ui_6($receiver) {
    ...
    $receiver.click_ka8ib0$($receiver_3, ui$lambda$lambda$lambda$lambda$lambda_25($receiver));
    remAssign($receiver_0.title, 'Music');
    var $receiver_4 = userIcon($receiver_0.right, $receiver.kills, $receiver.path.boot.userIcon);
    invoke($receiver_4.node, ui$lambda$lambda$lambda_13($receiver_4));
  ...
  function ui$lambda$lambda_7(closure$totalDurationText) {
    return function ($receiver) {
      return closure$totalDurationText.invoke().length;
    };
  }
  function ui$lambda$lambda_8(this$ui, closure$totalDurationTextLength) {
    return function ($receiver) {
      return padStart(get_formatSecs(this$ui.currentPosition.invoke()), closure$totalDurationTextLength.invoke(), 32);
    };
  }
  function ui$lambda$lambda_9(this$ui) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda_11(closure$artistTitle) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_26(this$ui, closure$artist, closure$title) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda_11(this$ui, closure$artist, closure$title) {
    return function ($receiver) {
      ...
      invoke(get_span($receiver), ui$lambda$lambda$lambda$lambda$lambda_26(this$ui, closure$artist, closure$title));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_27(this$ui, closure$currentPositionText, closure$totalDurationText) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_m0($receiver_0);
      get_textPrimary($receiver_0);
  ...
  function ui$lambda$lambda$lambda$lambda_12(this$ui, closure$currentPositionText, closure$totalDurationText) {
    return function ($receiver) {
      ...
      get_p2($receiver_0);
      flexCenter($receiver_0);
      invoke(get_pre($receiver), ui$lambda$lambda$lambda$lambda$lambda_27(this$ui, closure$currentPositionText, closure$totalDurationText));
      return Unit;
    };
  }
  function ui$lambda$lambda$lambda_21(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda_13(this$ui) {
    return function ($receiver) {
      ...
      invoke(get_button($receiver), ui$lambda$lambda$lambda$lambda$lambda_28(this$ui));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_31(this$ui) {
    return function ($receiver) {
      get_btnOutlinePrimary(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda_14(this$ui, closure$mediaButton) {
    return function ($receiver) {
      ...
      get_m1($receiver_0);
      get_btnGroup($receiver_0);
      closure$mediaButton($receiver, get_stepBackward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_29(this$ui));
      closure$mediaButton($receiver, get_backward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_30(this$ui));
      closure$mediaButton($receiver, get_forward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_31(this$ui));
      closure$mediaButton($receiver, get_stepForward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_32(this$ui));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_33(closure$likeButtonsDisabled, this$ui, closure$state) {
    return function ($receiver) {
      get_btn(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_34(closure$likeButtonsDisabled, this$ui, closure$state) {
    return function ($receiver) {
      get_btn(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda_15(closure$likeButtonsDisabled, this$ui, closure$state) {
    return function ($receiver) {
      ...
      get_m1($receiver_0);
      get_btnGroup($receiver_0);
      invoke(get_button($receiver), ui$lambda$lambda$lambda$lambda$lambda_33(closure$likeButtonsDisabled, this$ui, closure$state));
      invoke(get_button($receiver), ui$lambda$lambda$lambda$lambda$lambda_34(closure$likeButtonsDisabled, this$ui, closure$state));
      return Unit;
    };
  }
  function ui$lambda$lambda$lambda_22(this$ui, closure$mediaButton, closure$likeButtonsDisabled, closure$state) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
  ...
  function ui$lambda$lambda_13(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText, closure$likeButtonsDisabled, closure$state) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      ...
      row_0($receiver, ui$lambda$lambda$lambda_21(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText));
      row_0($receiver, ui$lambda$lambda$lambda_22(this$ui, mediaButton, closure$likeButtonsDisabled, closure$state));
      return Unit;
    };
  }
  function ui_7($receiver) {
    var $receiver_0 = new Factory();
    var totalDurationText = $receiver.rx_pn7ch0$(ui$lambda$lambda_6($receiver));
    var totalDurationTextLength = $receiver.rx_pn7ch0$(ui$lambda$lambda_7(totalDurationText));
    var currentPositionText = $receiver.rx_pn7ch0$(ui$lambda$lambda_8($receiver, totalDurationTextLength));
    var likeButtonsDisabled = $receiver.rx_pn7ch0$(ui$lambda$lambda_9($receiver));
    var state = $receiver.userSong;
    var artistTitle = $receiver.rx_pn7ch0$(ui$lambda$lambda_10($receiver));
    var artist = $receiver.rx_pn7ch0$(ui$lambda$lambda_11(artistTitle));
    var title = $receiver.rx_pn7ch0$(ui$lambda$lambda_12(artistTitle));
    if (mediasession.mediaSessionSupported) {
      var $receiver_1 = window.navigator.mediaSession;
      $receiver.forEach_5mel8p$(artistTitle, ui$lambda$lambda$lambda_14($receiver_1));
      $receiver_1.setActionHandler('play', ui$lambda$lambda$lambda_15($receiver));
      $receiver_1.setActionHandler('pause', ui$lambda$lambda$lambda_16($receiver));
      $receiver_1.setActionHandler('seekbackward', ui$lambda$lambda$lambda_17($receiver));
      $receiver_1.setActionHandler('seekforward', ui$lambda$lambda$lambda_18($receiver));
      $receiver_1.setActionHandler('previoustrack', ui$lambda$lambda$lambda_19($receiver));
      $receiver_1.setActionHandler('nexttrack', ui$lambda$lambda$lambda_20($receiver));
    }
    return $receiver_0.wraps.div_iw61es$(ui$lambda$lambda_13($receiver, artist, title, currentPositionText, totalDurationText, likeButtonsDisabled, state)).node;
  }
  var SeekSeconds;
  ...
  function Visible(boot) {
    ...
    this.rawView_13lnzh$_0 = ui_7(this);
  }
  ...
  function StatusPath(status) {
    DatabasePath.call(this, status.database);
    this.status = status;
  }
  StatusPath.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function Status(from, database, status, title, bgfn) {
    UIBase_init(from, this);
    this.from = from;
    this.database = database;
    this.status = status;
    ...
    this.rawView_avgzzq$_0 = ui_8(this);
  }
  ...
  function ui$lambda$lambda$lambda_23(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function Coroutine$ui$lambda$lambda$lambda$lambda$lambda_17(this$ui_0, this$_1, closure$id_0, this$_2, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$ui = this$ui_0;
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_35(this$ui_0, this$_1, closure$id_0, this$_2) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$ui$lambda$lambda$lambda$lambda$lambda_17(this$ui_0, this$_1, closure$id_0, this$_2, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function ui$lambda$lambda$lambda$lambda_16(this$ui, this$, this$_0) {
    return function ($receiver, id) {
      launch(this$_0, this$ui.coroutineContext, void 0, ui$lambda$lambda$lambda$lambda$lambda_35(this$ui, $receiver, id, this$));
      return Unit;
    };
  }
  function Coroutine$ui$lambda$lambda$lambda_3(this$ui_0, this$_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$ui = this$ui_0;
  ...
  function ui$lambda$lambda$lambda_24(this$ui_0, this$_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$ui$lambda$lambda$lambda_3(this$ui_0, this$_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function ui$lambda$lambda_14(this$ui) {
    return function ($receiver) {
      get_p1(get_cls($receiver));
      launch(this$ui, void 0, void 0, ui$lambda$lambda$lambda_24(this$ui, $receiver));
      return Unit;
    };
  }
  function ui_8($receiver) {
    ...
    var $receiver_1 = $receiver_0.left.button;
    $receiver_1.back;
    $receiver.click_3xepc3$($receiver_1, ui$lambda$lambda$lambda_23($receiver));
    $receiver.tasksUi_tdhe4g$($receiver_0.right);
    $receiver.syncUi_e1rmy3$($receiver_0.slots.right.slots);
    var $receiver_2 = $receiver_0.right.buttonGroup;
    $receiver_2.m1;
    ...
    invoke($receiver_3.pane, ui$lambda$lambda_14($receiver));
  ...
  package$import.ui_1redzq$ = ui_3;
  package$import.ui_jya5ma$ = ui_4;
  ...
  package$loggedin.ui_yshx4m$ = ui_5;
  ...
  package$notloggedin.ui_njwtce$ = ui_6;
  ...
  return _;
}(typeof this['appsimake-music'] === 'undefined' ? {} : this['appsimake-music'], kotlin, this['appsimake-commonui'], this['appsimake-commonshr'], this['kotlinx-coroutines-core'], this['appsimake-commonfb'], this['appsimake-firebase'], this['appsimake-indexeddb'], this['appsimake-domx'], this['appsimake-bootstrap'], this['appsimake-musiclib'], this['appsimake-fontawesome'], this['appsimake-common'], this['appsimake-firebaseshr'], this['appsimake-commonlib']);
