...
this['appsimake-domx'] = function (_, Kotlin, $module$kotlinx_coroutines_core, $module$appsimake_commonshr) {
  ...
  var forEachLater = $module$appsimake_commonshr.rx.forEachLater_yaias7$;
  ...
  function LocalStorageValue(key, encode, decode) {
    LocalStorageValue$Companion_getInstance();
    this.key_0 = key;
    this.encode_0 = encode;
    this.decode_0 = decode;
    var $receiver = new Var(this.value);
    forEachLater($receiver, killable.HasNoKill, LocalStorageValue$rxv$lambda$lambda(this));
    this.rxv = $receiver;
  }
  Object.defineProperty(LocalStorageValue.prototype, 'value', {
    get: function () {
      return this.decode_0.call(this, localStorage[this.key_0]);
    },
    set: function (v) {
      var e = this.encode_0(v);
      if (e == null) {
        localStorage.removeItem(this.key_0);
      }
       else {
        localStorage[this.key_0] = e;
      }
    }
  });
  function LocalStorageValue$Companion() {
    LocalStorageValue$Companion_instance = this;
  }
  function LocalStorageValue$Companion$boolean$lambda(it) {
    return it.toString();
  }
  function LocalStorageValue$Companion$boolean$lambda_0(closure$default) {
    return function (it) {
      var tmp$;
      return (tmp$ = it != null ? toBoolean(it) : null) != null ? tmp$ : closure$default;
    };
  }
  LocalStorageValue$Companion.prototype.boolean_ivxn3r$ = function (key, default_0) {
    if (default_0 === void 0)
      default_0 = false;
    return new LocalStorageValue(key, LocalStorageValue$Companion$boolean$lambda, LocalStorageValue$Companion$boolean$lambda_0(default_0));
  };
  LocalStorageValue$Companion.prototype.stringOpt_61zpoe$ = function (key) {
    return new LocalStorageValue(key, commonshr.Identity, commonshr.Identity);
  };
  LocalStorageValue$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var LocalStorageValue$Companion_instance = null;
  function LocalStorageValue$Companion_getInstance() {
    if (LocalStorageValue$Companion_instance === null) {
      new LocalStorageValue$Companion();
    }
    return LocalStorageValue$Companion_instance;
  }
  function LocalStorageValue$rxv$lambda$lambda(this$LocalStorageValue) {
    return function ($receiver, it) {
      this$LocalStorageValue.value = it;
      return Unit;
    };
  }
  LocalStorageValue.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LocalStorageValue',
    interfaces: []
  };
  ...
  var resizeNone;
  var resizeNone_metadata = new PropertyMetadata('resizeNone');
  function get_resizeNone($receiver) {
    return resizeNone.getValue_lrcp0p$($receiver, resizeNone_metadata);
  }
  var scrollVertical;
  ...
  Object.defineProperty(LocalStorageValue, 'Companion', {
    get: LocalStorageValue$Companion_getInstance
  });
  package$domx.LocalStorageValue = LocalStorageValue;
  ...
  package$styles.get_resizeNone_kre7dp$ = get_resizeNone;
  ...
  KillsApiDomx.prototype.anyRx_tnde95$ = KillsApi.prototype.anyRx_tnde95$;
  ...
  KillsApiDomx.prototype.forEachNonNull_cjboeh$ = KillsApi.prototype.forEachNonNull_cjboeh$;
  KillsApiDomx.prototype.forEachTrue_aq5y71$ = KillsApi.prototype.forEachTrue_aq5y71$;
  ...
  KillsApiDomx.prototype.register_3ijkb1$ = KillsApi.prototype.register_3ijkb1$;
