...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonshr, $module$appsimake_commonfb, $module$kotlinx_coroutines_core, $module$appsimake_firebase, $module$appsimake_indexeddb, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_musiclib, $module$appsimake_fontawesome, $module$appsimake_common, $module$appsimake_firebaseshr, $module$appsimake_commonlib) {
  ...
  function Boot(parent, from, localSongs) {
    ...
    var statusMessage = commonui.globalStatus;
    launch(coroutines.GlobalScope, void 0, void 0, Boot_init$lambda(statusMessage, this));
  ...
  function Coroutine$Boot_init$lambda$lambda$lambda(closure$st_0, this$Boot_0, closure$statusMessage_0, closure$app_0, closure$db_0, closure$functions_0, closure$storage_0, this$_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$closure$st = closure$st_0;
    this.local$this$Boot = this$Boot_0;
    this.local$closure$statusMessage = closure$statusMessage_0;
    this.local$closure$app = closure$app_0;
    this.local$closure$db = closure$db_0;
    this.local$closure$functions = closure$functions_0;
    this.local$closure$storage = closure$storage_0;
        ...
        switch (this.state_0) {
          case 0:
            ...
            if (Kotlin.isType(tmp$, UserState$LoggedIn)) {
              this.local$closure$statusMessage.remAssign_11rb$('Logging in...');
              this.state_0 = 5;
              ...
              if (Kotlin.isType(tmp$, Object.getPrototypeOf(UserState.NotLoggedIn).constructor)) {
                this.local$closure$statusMessage.remAssign_11rb$('Logging out...');
                this.state_0 = 3;
  ...
  function Boot_init$lambda$lambda$lambda(closure$st_0, this$Boot_0, closure$statusMessage_0, closure$app_0, closure$db_0, closure$functions_0, closure$storage_0, this$_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda(closure$st_0, this$Boot_0, closure$statusMessage_0, closure$app_0, closure$db_0, closure$functions_0, closure$storage_0, this$_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Boot_init$lambda$lambda(this$Boot, closure$statusMessage, closure$app, closure$db, closure$functions, closure$storage) {
    return function ($receiver, st) {
      this$Boot.exec(Boot_init$lambda$lambda$lambda(st, this$Boot, closure$statusMessage, closure$app, closure$db, closure$functions, closure$storage, $receiver));
      return Unit;
    };
  }
  function Coroutine$Boot_init$lambda(closure$statusMessage_0, this$Boot_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$statusMessage = closure$statusMessage_0;
  ...
  Coroutine$Boot_init$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$closure$statusMessage.remAssign_11rb$('Initializing Firebase...');
          ...
          case 2:
            ...
            this.local$closure$statusMessage.remAssign_11rb$('Enabling persistence...');
            var $receiver = {};
            ...
            continue;
          case 3:
            this.local$closure$statusMessage.remAssign_11rb$('Switching to offline data...');
            this.state_0 = 4;
            ...
            continue;
          case 4:
            this.local$closure$statusMessage.remAssign_11rb$('Checking user...');
            this.state_0 = 5;
            ...
            continue;
          case 5:
            return this.local$this$Boot.forEach_5mel8p$(this.result_0, Boot_init$lambda$lambda(this.local$this$Boot, this.local$closure$statusMessage, this.local$app, this.local$db, this.local$functions, this.local$storage)), Unit;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function Boot_init$lambda(closure$statusMessage_0, this$Boot_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda(closure$statusMessage_0, this$Boot_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
        ...
        switch (this.state_0) {
          case 0:
            ...
            if (!this.local$closure$signedIn.v) {
              ...
              this.state_0 = 2;
              this.result_0 = callable(commonlib.customToken, this.local$closure$functions).call_11rb$(Unit, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
          ...
          case 2:
            if ((tmp$ = this.result_0) != null) {
              ...
              this.state_0 = 3;
              this.result_0 = await_0(this$.app.auth().signInWithCustomToken(tmp$), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  function Sync_init$lambda$lambda(this$, this$Sync) {
    return function ($receiver, s) {
      if (s) {
        commonui.globalStatus.remAssign_11rb$('Starting syncing...');
