...
var tictactoe = function (_, Kotlin, $module$domx, $module$bootstrap, $module$common, $module$firebase, $module$commonui, $module$kotlinx_coroutines_core, $module$commonfb, $module$fontawesome) {
  ...
  function playfieldUI$lambda_1(closure$state) {
    return function () {
  ...
  function playfieldUI$lambda_2(closure$freeLeft) {
    return function () {
  ...
  function playfieldUI$fieldUI$lambda_10(closure$x, closure$y, closure$drawX, closure$xState, closure$drawO, closure$oState, closure$canClick, closure$turn, closure$state, this$playfieldUI, closure$hover) {
    return function ($receiver) {
  ...
  function playfieldUI$fieldUI(closure$state, closure$ourTurn, closure$ourMark, closure$drawX, closure$drawO, closure$turn, this$playfieldUI) {
    return function ($receiver, x, y) {
      ...
      g($receiver, playfieldUI$fieldUI$lambda_10(x, y, closure$drawX, xState, closure$drawO, oState, canClick, closure$turn, state, this$playfieldUI, hover));
    };
  }
  ...
  function playfieldUI$lambda_3(closure$killables, closure$board) {
    return function ($receiver) {
      padding2($receiver);
  ...
  function playfieldUI$lambda_4(closure$turn, closure$theirMark, closure$drawMark, closure$ourMark) {
    return function ($receiver) {
      flexCenter($receiver);
  ...
  function playfieldUI$lambda$lambda$lambda_1(closure$theirMark, closure$drawMark, closure$ourMark) {
    return function ($receiver) {
  ...
  function playfieldUI$lambda$lambda_1(closure$theirMark, closure$drawMark, closure$ourMark) {
    return function ($receiver) {
      $receiver.button_3uqggf$(playfieldUI$lambda$lambda$lambda_0);
      invoke($receiver.menu, playfieldUI$lambda$lambda$lambda_1(closure$theirMark, closure$drawMark, closure$ourMark));
      return Unit;
    };
  }
  function playfieldUI$lambda_5(closure$theirMark, closure$drawMark, closure$ourMark) {
    return function ($receiver) {
      dropdown($receiver, playfieldUI$lambda$lambda_1(closure$theirMark, closure$drawMark, closure$ourMark));
      return Unit;
    };
  }
  function playfieldUI$lambda_6(closure$gameOverStates, closure$turn) {
    return function () {
  ...
  function playfieldUI$lambda_7(closure$process) {
    return function (qs) {
      var $receiver = qs.docChanges();
      var destination = ArrayList_init_0();
      var tmp$;
  ...
  function playfieldUI$lambda_8(closure$killables, closure$stopListening, this$playfieldUI) {
    return function () {
      closure$killables.kill();
  ...
  function playfieldUI($receiver) {
    ...
    var ourTurn = Rx_init(playfieldUI$lambda_0(turn));
    var freeLeft = Rx_init(playfieldUI$lambda_1(state));
    var isDraw = Rx_init(playfieldUI$lambda_2(freeLeft));
    var markStyle = playfieldUI$markStyle;
    var drawX = playfieldUI$drawX(markStyle);
    var drawO = playfieldUI$drawO(markStyle);
    var fieldUI = playfieldUI$fieldUI(state_0, ourTurn, ourMark, drawX, drawO, turn, $receiver);
    var board = playfieldUI$board(fieldUI, highlights);
    $receiver.ui.root.newRoot_iw61es$(playfieldUI$lambda_3(killables, board));
    var markSvg = playfieldUI$markSvg;
    var drawMark = playfieldUI$drawMark(markSvg, drawO, drawX);
    $receiver.ui.layout.top.middle_iw61es$(playfieldUI$lambda_4(turn, theirMark, drawMark, ourMark));
    $receiver.ui.layout.top.right_iw61es$(playfieldUI$lambda_5(theirMark, drawMark, ourMark));
    var gameOverStates = setOf([Turn$Won_getInstance(), Turn$Lost_getInstance(), Turn$Draw_getInstance(), Turn$Alone_getInstance()]);
    var isOver = Rx_init(playfieldUI$lambda_6(gameOverStates, turn));
    ...
    })), playfieldUI$lambda_7(process));
    return playfieldUI$lambda_8(killables, stopListening, $receiver);
  }
  ...
  function PlayingUI$layout$lambda$lambda$lambda(closure$playerCtx) {
    return function ($receiver) {
      $receiver.button_3uqggf$(PlayingUI$layout$lambda$lambda$lambda$lambda);
      invoke($receiver.menu, PlayingUI$layout$lambda$lambda$lambda$lambda_0(closure$playerCtx));
      return Unit;
    };
  }
