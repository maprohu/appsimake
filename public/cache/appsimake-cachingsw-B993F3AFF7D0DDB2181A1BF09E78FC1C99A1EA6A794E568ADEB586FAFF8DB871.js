...
this['appsimake-cachingsw'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_buildenv, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  function main$lambda$lambda$inc$lambda$lambda(closure$toAdd, closure$file, closure$counts, closure$next) {
    return function (c) {
      ...
      then(closure$counts.put(count + 1 | 0, closure$file), main$lambda$lambda$inc$lambda$lambda$lambda(closure$next));
      return Unit;
    };
  }
  function main$lambda$lambda$inc$lambda(closure$counts, closure$toAdd) {
    return function (file, next) {
      then(closure$counts.get(file), main$lambda$lambda$inc$lambda$lambda(closure$toAdd, file, closure$counts, next));
      return Unit;
    };
  }
  function main$lambda$lambda$inc(closure$counts, closure$toAdd, closure$chain) {
    return function (files, then) {
      closure$chain(files, then, main$lambda$lambda$inc$lambda(closure$counts, closure$toAdd));
    };
  }
  ...
  function main$lambda$lambda$dec$lambda$lambda(closure$toRemove, closure$file, closure$next, closure$counts) {
    return function (count) {
      if (count == null) {
        ...
        if (newCount <= 0) {
          ...
          then(closure$counts.delete(closure$file), main$lambda$lambda$dec$lambda$lambda$lambda(closure$next));
        }
         else {
          then(closure$counts.put(newCount, closure$file), main$lambda$lambda$dec$lambda$lambda$lambda_0(closure$next));
        }
      }
      return Unit;
    };
  }
  function main$lambda$lambda$dec$lambda(closure$counts, closure$toRemove) {
    return function (file, next) {
      then(closure$counts.get(file), main$lambda$lambda$dec$lambda$lambda(closure$toRemove, file, next, closure$counts));
      return Unit;
    };
  }
  function main$lambda$lambda$dec(closure$counts, closure$toRemove, closure$chain) {
    return function (files, then) {
      closure$chain(files, then, main$lambda$lambda$dec$lambda(closure$counts, closure$toRemove));
    };
  }
  ...
  function main$lambda$lambda$lambda$lambda$lambda(closure$modules, closure$cc, closure$cd) {
    return function () {
      then(closure$modules.put(closure$cc.files, closure$cc.name), main$lambda$lambda$lambda$lambda$lambda$lambda(closure$cd));
      return Unit;
    };
  }
  function main$lambda$lambda$lambda$lambda_0(closure$modules, closure$cc, closure$cd, closure$dec) {
    return function (a) {
      var oldFiles = a != null ? a : [];
      closure$dec(toList(oldFiles), main$lambda$lambda$lambda$lambda$lambda(closure$modules, closure$cc, closure$cd));
      return Unit;
    };
  }
  function main$lambda$lambda$lambda(closure$modules, closure$cc, closure$cd, closure$dec) {
    return function () {
      then(closure$modules.get(closure$cc.name), main$lambda$lambda$lambda$lambda_0(closure$modules, closure$cc, closure$cd, closure$dec));
      return Unit;
    };
  }
      ...
      try {
        switch (this.state_0) {
          ...
          case 3:
            ...
            var inc = main$lambda$lambda$inc(counts, this.local$toAdd, chain);
            this.local$toRemove = ArrayList_init();
            var dec = main$lambda$lambda$dec(counts, this.local$toRemove, chain);
            var cd = CompletableDeferred();
            inc(toList(this.local$closure$cc.files), main$lambda$lambda$lambda(modules, this.local$closure$cc, cd, dec));
            this.state_0 = 4;
  ...
  var get_readonly = defineInlineFunction('appsimake-cachingsw.indexeddb.get_readonly_7jucnl$', function ($receiver) {
    return 'readonly';
  });
  var get_readwrite = defineInlineFunction('appsimake-cachingsw.indexeddb.get_readwrite_7jucnl$', function ($receiver) {
    return 'readwrite';
  });
  ...
  $$importsForInline$$['appsimake-cachingsw'] = _;
  ...
  package$indexeddb.await_cgxnqj$ = await_1;
  ...
  return _;
}(typeof this['appsimake-cachingsw'] === 'undefined' ? {} : this['appsimake-cachingsw'], kotlin, this['appsimake-commonshr'], this['appsimake-buildenv'], this['kotlinx-coroutines-core']);
