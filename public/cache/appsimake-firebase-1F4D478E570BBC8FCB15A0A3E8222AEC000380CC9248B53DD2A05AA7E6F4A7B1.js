...
this['appsimake-firebase'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_common, $module$kotlinx_coroutines_core, $module$appsimake_firebaseshr) {
  ...
  function QueryCache$listen$lambda(closure$fn) {
    return function (f, item) {
      closure$fn(new SetDiff(void 0, setOf(item)));
      return Unit;
    };
  }
  function QueryCache$listen$lambda_0(closure$fn) {
    return function (f, item) {
      closure$fn(new SetDiff(setOf(item)));
      return Unit;
    };
  }
  QueryCache.prototype.listen_bpy6tt$ = function (fn) {
    return this.list_0.addListener_ednqrc$(new ListenableList$Listener(QueryCache$listen$lambda(fn), QueryCache$listen$lambda_0(fn)));
  };
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            this.local$tmp$_0 = this.local$def;
            this.state_0 = 3;
            continue;
          case 3:
            this.state_0 = 4;
            this.result_0 = this.local$tmp$_0.await(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
