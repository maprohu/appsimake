  ...
  Coroutine$NotLoggedIn$signIn$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return new Login(this.local$this$NotLoggedIn, this.local$this$NotLoggedIn, this.local$this$NotLoggedIn.app, this.local$this$NotLoggedIn.back, NotLoggedIn$signIn$lambda$lambda(this.local$this$NotLoggedIn), NotLoggedIn$signIn$lambda$lambda_0(this.local$this$NotLoggedIn), NotLoggedIn$signIn$lambda$lambda_1(this.local$this$NotLoggedIn, this.local$closure$customTokenReady));
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
