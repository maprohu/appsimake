...
this['appsimake-commonshr'] = function (_, Kotlin, $module$kotlinx_coroutines_core) {
  ...
  Listeners.prototype = Object.create(AddRemoveImpl.prototype);
  Listeners.prototype.constructor = Listeners;
  AsyncListeners.prototype = Object.create(AddRemoveImpl.prototype);
  AsyncListeners.prototype.constructor = AsyncListeners;
  ...
  TS$Null.prototype = Object.create(TS.prototype);
  TS$Null.prototype.constructor = TS$Null;
  ...
  Object.defineProperty(Listeners.prototype, 'first', {
    get: function () {
      ...
      ks.plusAssign_o14v8n$(this.add(Listeners$get_Listeners$first$lambda(cd, ks)));
      return cd;
    }
  });
  ...
  function AddRemoveImpl() {
    this.mutableItems_s5xc24$_0 = ArrayList_init_0();
    this.items = this.mutableItems_s5xc24$_0;
    this.add = AddRemoveImpl$add$lambda(this);
  }
  AddRemoveImpl.prototype.plusAssign_11rb$ = function (item) {
    this.add(item);
  };
  AddRemoveImpl.prototype.invoke_11rb$ = function (item) {
    this.add(item);
  };
  function AddRemoveImpl$add$lambda$lambda(this$AddRemoveImpl, closure$item) {
    return function () {
      var $receiver = this$AddRemoveImpl.mutableItems_s5xc24$_0;
      var element = closure$item;
      $receiver.remove_11rb$(element);
      return Unit;
    };
  }
  function AddRemoveImpl$add$lambda(this$AddRemoveImpl) {
    return function (item) {
      this$AddRemoveImpl.mutableItems_s5xc24$_0.add_11rb$(item);
      return AddRemoveImpl$add$lambda$lambda(this$AddRemoveImpl, item);
    };
  }
  AddRemoveImpl.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AddRemoveImpl',
    interfaces: []
  };
  function register($receiver, deps, item) {
    plusAssign_0(deps.kills, $receiver.add(item));
  }
  function AsyncListeners() {
    AddRemoveImpl.call(this);
  }
  function Coroutine$AsyncListeners$fire$lambda$lambda(closure$action_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$action = closure$action_0;
  }
  Coroutine$AsyncListeners$fire$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$AsyncListeners$fire$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$AsyncListeners$fire$lambda$lambda.prototype.constructor = Coroutine$AsyncListeners$fire$lambda$lambda;
  Coroutine$AsyncListeners$fire$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function AsyncListeners$fire$lambda$lambda(closure$action_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$AsyncListeners$fire$lambda$lambda(closure$action_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$AsyncListeners$fire$lambda(this$AsyncListeners_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$AsyncListeners = this$AsyncListeners_0;
    this.local$$receiver = $receiver_0;
  }
  Coroutine$AsyncListeners$fire$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$AsyncListeners$fire$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$AsyncListeners$fire$lambda.prototype.constructor = Coroutine$AsyncListeners$fire$lambda;
  Coroutine$AsyncListeners$fire$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            tmp$ = this.local$this$AsyncListeners.items.iterator();
            while (tmp$.hasNext()) {
              var action = tmp$.next();
              launch(this.local$$receiver, void 0, void 0, AsyncListeners$fire$lambda$lambda(action));
            }
  ...
  function AsyncListeners$fire$lambda(this$AsyncListeners_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$AsyncListeners$fire$lambda(this$AsyncListeners_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$fire($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$fire.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$fire.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$fire.prototype.constructor = Coroutine$fire;
  Coroutine$fire.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = coroutineScope(AsyncListeners$fire$lambda(this.$this), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  AsyncListeners.prototype.fire = function (continuation_0, suspended) {
    var instance = new Coroutine$fire(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  AsyncListeners.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AsyncListeners',
    interfaces: [AddRemoveImpl]
  };
  function Try() {
  ...
  KillsApi.prototype.register_3ijkb1$ = function ($receiver, item) {
    register($receiver, this, item);
  };
  KillsApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'KillsApi',
  ...
  function HasKillsLib() {
  }
  HasKillsLib.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasKillsLib',
    interfaces: [HasLib, HasKills]
  };
  function HasCsKillsLib() {
  }
  HasCsKillsLib.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasCsKillsLib',
    interfaces: [HasKillsLib, HasCsKills]
  };
  ...
  function ServerTimestampPropertyType$lambda_1(d, ops) {
    return ops.readTimestamp_za3rmp$(d);
  }
  ...
  var TS$Null_instance = null;
  function TS$Null_getInstance() {
    if (TS$Null_instance === null) {
      new TS$Null();
    }
    return TS$Null_instance;
  }
  TS.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'TS',
  ...
  var DaysInYear;
  function ago$lambda$out(this$) {
    return function (unit, sn) {
      if (unit > 0) {
        this$.append_gw00v9$(unit.toString() + ' ' + sn);
        if (unit > 1)
          this$.append_s8itvh$(115);
        this$.append_s8itvh$(32);
      }
    };
  }
  function ago$lambda$unit(closure$units, closure$out) {
    return function closure$unit(idx, count, sn) {
      var tmp$ = closure$units.get_za3lpa$(idx);
      var mul = tmp$.component1()
      , sn2 = tmp$.component2();
      var x = count / mul;
      var divCount = Math_0.floor(x);
      var rem = round(count - divCount * mul);
      if (divCount > 0.0) {
        if (idx === get_lastIndex(closure$units)) {
          closure$out(divCount, sn2);
        }
         else {
          closure$unit(idx + 1 | 0, divCount, sn2);
        }
      }
      closure$out(rem, sn);
    };
  }
  function ago($receiver, ref, def) {
    if (ref === void 0)
      ref = new Date(Date.now());
    if (def === void 0)
      def = new Ago();
    var $receiver_0 = StringBuilder_init();
    if (Kotlin.isType($receiver, TS$Value)) {
      var diff = ref.getTime() - $receiver.date.getTime();
      var x = diff / 1000.0;
      var seconds = Math_0.floor(x);
      var units = listOf([to(60.0, 'minute'), to(60.0, 'hour'), to(24.0, 'day'), to(DaysInYear / 12.0, 'month'), to(12.0, 'year')]);
      var out = ago$lambda$out($receiver_0);
      var unit = ago$lambda$unit(units, out);
      if (seconds < 1.0) {
        $receiver_0.append_gw00v9$('just now');
      }
       else {
        unit(0, seconds, 'second');
        $receiver_0.append_gw00v9$('ago');
      }
    }
     else {
      $receiver_0.append_gw00v9$('<none>');
    }
  ...
  RxMutableSet.prototype.rxProperty_0 = function (fn) {
    var rxv = new Var(fn());
    this.updated_0.add(RxMutableSet$rxProperty$lambda(fn, rxv));
    return rxv;
  };
  ...
  package$common.AddRemoveImpl = AddRemoveImpl;
  package$common.register_xj2j54$ = register;
  package$common.AsyncListeners = AsyncListeners;
  ...
  Object.defineProperty(package$commonshr, 'MessageUrlParameter', {
    get: function () {
      return MessageUrlParameter;
    }
  });
  ...
  package$commonshr.HasKillsLib = HasKillsLib;
  package$commonshr.HasCsKillsLib = HasCsKillsLib;
  ...
  Object.defineProperty(TS, 'Null', {
    get: TS$Null_getInstance
  });
  package$properties.TS = TS;
  package$properties.Ago = Ago;
  Object.defineProperty(package$properties, 'DaysInYear', {
    get: function () {
      return DaysInYear;
    }
  });
  package$properties.ago_troxq7$ = ago;
  ...
  CsKillsApi.prototype.register_3ijkb1$ = KillsApi.prototype.register_3ijkb1$;
  ...
  CsKills.prototype.register_3ijkb1$ = CsKillsApi.prototype.register_3ijkb1$;
  ...
  filter$lambda$Item.prototype.register_3ijkb1$ = KillsApi.prototype.register_3ijkb1$;
  ...
  HasNoKill.prototype.register_3ijkb1$ = KillsApi.prototype.register_3ijkb1$;
  ...
  Killables.prototype.register_3ijkb1$ = KillsApi.prototype.register_3ijkb1$;
  ...
  sorted$Holder.prototype.register_3ijkb1$ = KillsApi.prototype.register_3ijkb1$;
  ...
  ServerTimestampPropertyType = new PropertyType(void 0, ServerTimestampPropertyType$lambda, ServerTimestampPropertyType$lambda_0, ServerTimestampPropertyType$lambda_1);
  DaysInYear = 365.25;
  Noop = Noop$lambda;
