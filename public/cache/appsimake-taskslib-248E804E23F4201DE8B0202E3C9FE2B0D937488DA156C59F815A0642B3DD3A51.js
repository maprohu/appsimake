...
this['appsimake-taskslib'] = function (_, Kotlin, $module$appsimake_commonshr) {
  ...
  var PropertyList$enum$lambda = wrapFunction(function () {
    ...
    var Var_init = $module$appsimake_commonshr.rx.Var;
    ...
    return function (typeClosure$E, isE, closure$v, this$PropertyList) {
      return function (name) {
        ...
        return new EnumProp_init(name, rxv, tmp$, $receiver, toList_0(typeClosure$E.values()));
      };
    };
  });
  function Task() {
    ...
    RxBase.call(this);
    this.title_f5ctn8$_0 = this.o.string().provideDelegate_n5byny$(this, Task$title_metadata);
    this.text_d9eg91$_0 = this.o.string().provideDelegate_n5byny$(this, Task$text_metadata);
    var $this = this.o;
  ...
  function Tag() {
    ...
    RxBase.call(this);
    this.name_k2q0f8$_0 = this.o.string().provideDelegate_n5byny$(this, Tag$name_metadata);
  }
  ...
  function Note() {
    ...
    RxBase.call(this);
    this.text_pq26zs$_0 = this.o.string().provideDelegate_n5byny$(this, Note$text_metadata);
