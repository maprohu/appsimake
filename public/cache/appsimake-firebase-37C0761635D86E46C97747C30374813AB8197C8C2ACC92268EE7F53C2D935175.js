...
this['appsimake-firebase'] = function (_, Kotlin, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_firebaseshr, $module$appsimake_common) {
  'use strict';
  ...
  function initBinder$lambda$lambda$step(closure$cw_0, closure$db_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$initBinder$lambda$lambda$step(closure$cw_0, closure$db_0, continuation_0);
      if (suspended)
        return instance;
      else
  ...
  function Coroutine$initBinder$lambda$lambda$step(closure$cw_0, closure$db_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$closure$cw = closure$cw_0;
    this.local$closure$db = closure$db_0;
    this.local$qs = void 0;
  }
  Coroutine$initBinder$lambda$lambda$step.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$initBinder$lambda$lambda$step.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$initBinder$lambda$lambda$step.prototype.constructor = Coroutine$initBinder$lambda$lambda$step;
  Coroutine$initBinder$lambda$lambda$step.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$, tmp$_0;
            this.state_0 = 2;
            this.result_0 = await_0(collectionRef(this.local$closure$cw, this.local$closure$db).limit(500).get(), this);
          ...
          case 2:
            this.local$qs = this.result_0;
            var batch = this.local$closure$db.batch();
            tmp$ = this.local$qs.docs;
            ...
            this.state_0 = 3;
            this.result_0 = await_0(batch.commit(), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
            return this.local$qs.size === 500;
  ...
  function initBinder$lambda$lambda(closure$cw_0, closure$db_0) {
    return function ($receiver, continuation_0, suspended) {
      var instance = new Coroutine$initBinder$lambda$lambda(closure$cw_0, closure$db_0, $receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$initBinder$lambda$lambda(closure$cw_0, closure$db_0, $receiver, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
  ...
  Coroutine$initBinder$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$initBinder$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$initBinder$lambda$lambda.prototype.constructor = Coroutine$initBinder$lambda$lambda;
  Coroutine$initBinder$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$step = initBinder$lambda$lambda$step(this.local$closure$cw, this.local$closure$db);
            this.state_0 = 2;
            continue;
          case 1:
            throw this.exception_0;
  ...
  function initBinder$lambda_1(closure$db) {
    return function (cw) {
      return async(coroutines.GlobalScope, void 0, void 0, initBinder$lambda$lambda(cw, closure$db));
    };
  }
  function initBinder_0(db) {
    initBinder(new PropOps(initBinder$lambda, initBinder$lambda_0, initBinder$lambda_1(db)));
  }
  ...
  Object.defineProperty(package$firebase, 'MaxBatchSize', {
    get: function () {
      return MaxBatchSize;
    }
  });
  package$firebase.initBinder_8mbn6p$ = initBinder_0;
  ...
  package$firestore.listen_wkiigx$ = listen_0;
  ...
  package$firestore.listen_p3kk2v$ = listen_1;
  ...
  return _;
}(typeof this['appsimake-firebase'] === 'undefined' ? {} : this['appsimake-firebase'], kotlin, this['appsimake-commonshr'], this['kotlinx-coroutines-core'], this['appsimake-firebaseshr'], this['appsimake-common']);
