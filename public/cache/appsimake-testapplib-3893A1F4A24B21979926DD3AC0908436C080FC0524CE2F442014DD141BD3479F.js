...
if (typeof this['appsimake-commonlib'] === 'undefined') {
  throw new Error("Error loading module 'appsimake-testapplib'. Its dependency 'appsimake-commonlib' was not found. Please, check whether 'appsimake-commonlib' is loaded prior to 'appsimake-testapplib'.");
}
...
this['appsimake-testapplib'] = function (_, Kotlin, $module$appsimake_commonlib, $module$appsimake_commonshr) {
  'use strict';
  ...
  return _;
}(typeof this['appsimake-testapplib'] === 'undefined' ? {} : this['appsimake-testapplib'], kotlin, this['appsimake-commonlib'], this['appsimake-commonshr']);
