...
this['appsimake-tasks'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_commonfb, $module$appsimake_taskslib, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_fontawesome, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_common, $module$appsimake_firebaseshr) {
  ...
  var textProp = $module$appsimake_commonfb.commonfb.textProp_7aqtlq$;
  ...
  var build = $module$appsimake_commonfb.commonfb.build_54sbj2$;
  var get_input = $module$appsimake_domx.domx.get_input_asww5s$;
  var textProp_0 = $module$appsimake_commonfb.commonfb.textProp_kk2tdu$;
  ...
  var build_0 = $module$appsimake_commonfb.commonfb.build_u50ezg$;
  ...
  var withCollection = $module$appsimake_firebaseshr.firebaseshr.withCollection_qmn23v$;
  ...
  var build_1 = $module$appsimake_commonfb.commonfb.build_tsg3i$;
  ...
  var deleteCollection = $module$appsimake_firebase.firebase.firestore.deleteCollection_whao2e$;
  ...
  var get_tasks = $module$appsimake_taskslib.taskslib.get_tasks_13xn5r$;
  var get_usertags = $module$appsimake_taskslib.taskslib.get_usertags_13xn5r$;
  var get_hiddenTasks = $module$appsimake_taskslib.taskslib.get_hiddenTasks_13xn5r$;
  var HasDB = $module$appsimake_commonfb.commonfb.HasDB;
  var keepAlive = $module$appsimake_commonfb.commonfb.keepAlive_so67rd$;
  ...
  var HiddenTask = $module$appsimake_taskslib.taskslib.HiddenTask;
  var ListUIConfig = $module$appsimake_commonfb.commonfb.ListUIConfig;
  var showClosableList = $module$appsimake_commonfb.commonfb.showClosableList_y6f49f$;
  var get_notes = $module$appsimake_taskslib.taskslib.get_notes_x7uku$;
  ...
  function editNote$lambda$lambda$lambda($receiver) {
    get_dFlex($receiver);
    get_flexColumn($receiver);
    return Unit;
  }
  function editNote$lambda$lambda$lambda$lambda($receiver) {
  ...
  function editNote$lambda$lambda$lambda_0(closure$eks, closure$item) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(editNote$lambda$lambda$lambda$lambda);
      closure$eks.plusAssign_wii6vi$(textProp($receiver, closure$item.text));
      return Unit;
    };
  }
  function editNote$lambda$lambda(closure$eks, closure$item) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(editNote$lambda$lambda$lambda);
      invoke(get_textarea($receiver), editNote$lambda$lambda$lambda_0(closure$eks, closure$item));
      return Unit;
    };
  }
  function editNote$lambda(item, eks) {
    return new FormConfig(void 0, editNote$lambda$lambda(eks, item));
  }
  function editNote($receiver, killables, panel, note, close) {
    return build(new EditScreenConfig('Note', editNote$lambda), killables, panel, note, close, $receiver.db);
  }
  ...
  function editTag$lambda$lambda$lambda$lambda$lambda(closure$lbl, closure$eks, closure$item) {
    return function ($receiver) {
      ...
      $receiver.type = 'text';
      closure$eks.plusAssign_wii6vi$(textProp_0($receiver, closure$item.name));
      return Unit;
    };
  }
  ...
  function editTag($receiver, killables, panel, tag, close) {
    return build(new EditScreenConfig('Tag', editTag$lambda), killables, panel, tag, close, $receiver.db);
  }
  ...
  function listTags($receiver, killables, panel, after) {
    build_0(new ListScreenConfig('Tags', $receiver.userTags, listTags$lambda, getCallableRef('editTag', function ($receiver, killables, panel, tag, close) {
  ...
  function selectTags$lambda$lambda$lambda$lambda$lambda(closure$close) {
    return function ($receiver) {
  ...
  function selectTags$lambda$lambda$lambda$lambda(closure$close) {
    return function ($receiver) {
      faButton($receiver, get_times(Fa.Companion), selectTags$lambda$lambda$lambda$lambda$lambda(closure$close));
      return Unit;
    };
  }
  ...
  function selectTags$lambda$lambda$lambda$lambda_1(closure$close) {
    return function ($receiver) {
  ...
  function selectTags$lambda$lambda$lambda(closure$close) {
    return function ($receiver) {
      ...
      $receiver.right.invoke_gk6m2q$(selectTags$lambda$lambda$lambda$lambda_1(closure$close));
      return Unit;
    };
  }
  ...
  function selectTags$lambda$lambda(closure$close, closure$killables, closure$tags, this$selectTags) {
    return function ($receiver) {
      ...
      invoke($receiver.main, selectTags$lambda$lambda$lambda_0(closure$killables, closure$tags, this$selectTags));
      return Unit;
    };
  }
  ...
  function TagSource(wrap, db) {
    this.wrap_0 = wrap;
    this.tagsRef_0 = collectionRef(this.wrap_0, db);
    ...
    var c = ListenConfig.Companion.hasProps_4r7uln$(this.list_0, this.wrap_0, TagSource_init$lambda_1);
    listen(query(this.wrap_0, db).query, this.killables_0, c);
  ...
  TagSource.prototype.tagv_0 = function (id) {
    ...
    if (value == null) {
      var $receiver_0 = withCollection(new Tag(), this.wrap_0);
      $receiver_0.props.persistedFB_61zpoe$(id);
  ...
  function viewTag$lambda$lambda$lambda$lambda_1(closure$state, closure$item) {
    return function ($receiver) {
      closure$state.killables.plusAssign_wii6vi$(rxTextOrEmpty($receiver, viewTag$lambda$lambda$lambda$lambda$lambda(closure$item)));
      return Unit;
    };
  }
  function viewTag$lambda$lambda$lambda_0(closure$state, closure$item) {
    return function ($receiver) {
      ...
      invoke(get_dd($receiver), viewTag$lambda$lambda$lambda$lambda_1(closure$state, closure$item));
      return Unit;
    };
  }
  function viewTag$lambda$lambda_0(closure$state, closure$item) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(viewTag$lambda$lambda$lambda);
      invoke(get_dl($receiver), viewTag$lambda$lambda$lambda_0(closure$state, closure$item));
      return Unit;
    };
  }
  function viewTag$lambda($receiver, state, item) {
    get_cls($receiver).invoke_cr52h1$(viewTag$lambda$lambda);
    invoke(get_div($receiver), viewTag$lambda$lambda_0(state, item));
    return Unit;
  }
  function viewTag($receiver, killables, panel, tag, close) {
    build_1(new ViewScreenConfig('Tag', getCallableRef('editTag', function ($receiver, killables, panel, tag, close) {
      return editTag($receiver, killables, panel, tag, close), Unit;
    }.bind(null, $receiver)), void 0, viewTag$lambda), killables, panel, tag, close);
  }
  ...
  function editTask$lambda$lambda$lambda$lambda$lambda$lambda(closure$labelFor, closure$eks, closure$item) {
    return function ($receiver) {
      ...
      $receiver.type = 'text';
      closure$eks.plusAssign_wii6vi$(textProp_0($receiver, closure$item.title));
      return Unit;
    };
  }
  ...
  function editTask$lambda(this$editTask) {
    return function (item, eks) {
      return tabsConfig(eks, listOf([new TabConfig(get_list(Fa.Companion), editTask$lambda$lambda(eks, item)), new TabConfig(get_tags(Fa.Companion), editTask$lambda$lambda_0(item, this$editTask))]));
    };
  }
  function editTask($receiver, killables, panel, task, close) {
    build(new EditScreenConfig('Task', editTask$lambda($receiver)), killables, panel, task, close, $receiver.db);
  }
  ...
  function listTasks($receiver, killables, panel, after) {
    build_0(new ListScreenConfig('Task List', $receiver.userTasks, listTasks$lambda, getCallableRef('viewTask', function ($receiver, ks, panel, task, close) {
      return viewTask($receiver, ks, panel, task, close), Unit;
  ...
  function LoggedIn(base, user) {
    ...
    this.userHiddenTasks = get_hiddenTasks(this.userPrivate);
  ...
  function LoggedIn$main$lambda$lambda(closure$hiddenTaskIds) {
    return function () {
      return closure$hiddenTaskIds.invoke().size;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda(closure$d) {
    return function (h) {
      return plus_0(minus_0(h, closure$d.removed), closure$d.added);
    };
  }
  function LoggedIn$main$lambda$lambda_0(closure$hiddenTaskIds) {
    return function (d) {
      closure$hiddenTaskIds.transform_ru8m0w$(LoggedIn$main$lambda$lambda$lambda(d));
      return Unit;
    };
  }
  ...
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda($receiver) {
    get_dFlex($receiver);
    get_flexRow($receiver);
    get_alignItemsCenter($receiver);
    return Unit;
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda($receiver) {
    get_btnInfo($receiver);
    get_m1($receiver);
    return Unit;
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda($receiver) {
    get_ml1($receiver);
    get_badgePill($receiver);
    get_badgeWarning($receiver);
    return Unit;
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$hiddenCount) {
    return function () {
      return closure$hiddenCount.invoke().toString();
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$hiddenCount) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda);
      rxText_0($receiver, LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$hiddenCount));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$hiddenTaskIds) {
    return function () {
      return !closure$hiddenTaskIds.invoke().isEmpty();
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_2(this$LoggedIn, closure$hiddenTaskIds) {
    return function (it) {
      deleteCollection(collectionRef(this$LoggedIn.userHiddenTasks, this$LoggedIn.db), this$LoggedIn.db);
      closure$hiddenTaskIds.now = emptySet();
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda(closure$hiddenCount, closure$hiddenTaskIds, this$LoggedIn) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda);
      invoke(get_span($receiver), LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$hiddenCount));
      rxDisplayed_0($receiver, LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$hiddenTaskIds));
      clickEvent($receiver, LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_2(this$LoggedIn, closure$hiddenTaskIds));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda_0(closure$hiddenCount, closure$hiddenTaskIds, this$LoggedIn) {
    return function ($receiver) {
      faButton($receiver, get_eye(Fa.Companion), LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda(closure$hiddenCount, closure$hiddenTaskIds, this$LoggedIn));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_0($receiver) {
    get_m1($receiver);
    get_btnGroup($receiver);
    return Unit;
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_1(this$LoggedIn) {
    return function (pks, close) {
      editTask(this$LoggedIn, pks, this$LoggedIn.root.sub(), withCollection(new Task(), this$LoggedIn.userTasks), close);
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_3(this$LoggedIn, closure$showHome) {
    return function (ks, f) {
      showClosable(ks, LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_1(this$LoggedIn), getCallableRef('showHome', function () {
        return closure$showHome(), Unit;
      }));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_1(this$LoggedIn, closure$showHome) {
    return function ($receiver) {
      get_btnPrimary(get_cls($receiver));
      this$LoggedIn.killables.plusAssign_wii6vi$(clickEventSeq($receiver, LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_3(this$LoggedIn, closure$showHome)));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_2(this$LoggedIn) {
    return function (pks, close) {
      listTasks(this$LoggedIn, pks, this$LoggedIn.root.sub(), close);
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_4(closure$homeActive, this$LoggedIn, closure$showHome) {
    return function (ks, f) {
      closure$homeActive.now = false;
      showClosable(ks, LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_2(this$LoggedIn), getCallableRef('showHome', function () {
        return closure$showHome(), Unit;
      }));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_2(this$LoggedIn, closure$homeActive, closure$showHome) {
    return function ($receiver) {
      get_btnPrimary(get_cls($receiver));
      this$LoggedIn.killables.plusAssign_wii6vi$(clickEventSeq($receiver, LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_4(closure$homeActive, this$LoggedIn, closure$showHome)));
      return Unit;
    };
  }
  ...
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_3(this$LoggedIn, closure$showHome) {
    return function ($receiver) {
  ...
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_5(this$LoggedIn, closure$showHome) {
    return function ($receiver) {
      get_dropdownMenuRight(get_cls($receiver));
      dropdownItemAnchor($receiver, LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_3(this$LoggedIn, closure$showHome));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_3(this$LoggedIn, closure$showHome) {
    return function ($receiver) {
      invoke($receiver.menu, LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda$lambda_5(this$LoggedIn, closure$showHome));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda_1(this$LoggedIn, closure$showHome, closure$homeActive) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_0);
      faButton($receiver, get_plus(Fa.Companion), LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_1(this$LoggedIn, closure$showHome));
      faButton($receiver, get_search(Fa.Companion), LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_2(this$LoggedIn, closure$homeActive, closure$showHome));
      dropdownGroup($receiver, get_btnPrimary(Cls.Companion), LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_3(this$LoggedIn, closure$showHome));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda_0(closure$hiddenCount, closure$hiddenTaskIds, this$LoggedIn, closure$showHome, closure$homeActive) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(LoggedIn$main$lambda$lambda$lambda$lambda$lambda);
      invoke(get_div($receiver), LoggedIn$main$lambda$lambda$lambda$lambda$lambda_0(closure$hiddenCount, closure$hiddenTaskIds, this$LoggedIn));
      invoke(get_div($receiver), LoggedIn$main$lambda$lambda$lambda$lambda$lambda_1(this$LoggedIn, closure$showHome, closure$homeActive));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda_0(this$LoggedIn, closure$hiddenCount, closure$hiddenTaskIds, closure$showHome, closure$homeActive) {
    return function ($receiver) {
      $receiver.middleTitle_9f50g3$(LoggedIn$main$lambda$lambda$lambda$lambda(this$LoggedIn));
      $receiver.right.invoke_gk6m2q$(LoggedIn$main$lambda$lambda$lambda$lambda_0(closure$hiddenCount, closure$hiddenTaskIds, this$LoggedIn, closure$showHome, closure$homeActive));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda$lambda$lambda_1(closure$recentSeq, closure$root, closure$hiddenTaskIds, closure$showHome, this$LoggedIn) {
    return function (ha) {
      if (ha) {
        recent(this$LoggedIn, closure$recentSeq.killables(), closure$root, closure$hiddenTaskIds, getCallableRef('showHome', function () {
          return closure$showHome(), Unit;
        }));
      }
       else {
  ...
  function LoggedIn$main$lambda$lambda$lambda_1(this$LoggedIn, closure$homeActive, closure$hiddenTaskIds, closure$showHome) {
    return function ($receiver) {
      get_dFlex(get_cls($receiver));
      var root = new RootPanel($receiver);
      var recentSeq = this$LoggedIn.killables.seq();
      closure$homeActive.forEach_qlkmfe$(LoggedIn$main$lambda$lambda$lambda$lambda_1(recentSeq, root, closure$hiddenTaskIds, closure$showHome, this$LoggedIn));
      return Unit;
    };
  }
  function LoggedIn$main$lambda$lambda_1(this$LoggedIn, closure$hiddenCount, closure$hiddenTaskIds, closure$showHome, closure$homeActive) {
    return function ($receiver) {
      $receiver.top_vesf63$(LoggedIn$main$lambda$lambda$lambda_0(this$LoggedIn, closure$hiddenCount, closure$hiddenTaskIds, closure$showHome, closure$homeActive));
      invoke($receiver.main, LoggedIn$main$lambda$lambda$lambda_1(this$LoggedIn, closure$homeActive, closure$hiddenTaskIds, closure$showHome));
      return Unit;
    };
  }
  function LoggedIn$main$lambda(this$LoggedIn) {
    return function ($receiver) {
      ...
      var hiddenTaskIds = new Var(emptySet());
      var hiddenCount = Rx_init(LoggedIn$main$lambda$lambda(hiddenTaskIds));
      this$LoggedIn.killables.plusAssign_o14v8n$(idDiffs(query(this$LoggedIn.userHiddenTasks, this$LoggedIn.db).query, LoggedIn$main$lambda$lambda_0(hiddenTaskIds)));
      screenLayout($receiver, this$LoggedIn.killables, LoggedIn$main$lambda$lambda_1(this$LoggedIn, hiddenCount, hiddenTaskIds, showHome, homeActive));
      return Unit;
    };
  }
  ...
  LoggedIn.prototype.get_ref_3a60a5$ = function ($receiver) {
    return this.$delegate_jgd70n$_0.get_ref_3a60a5$($receiver);
  };
  LoggedIn.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LoggedIn',
  ...
  function recent$lambda(this$recent) {
    return function (ks, dit, close) {
      keepAlive(dit, ks, this$recent.db);
  ...
  function recent$lambda$lambda$lambda($receiver) {
    get_m1($receiver);
    flexFixedSize($receiver);
    return Unit;
  }
  function recent$lambda$lambda_1($receiver) {
    get_cls($receiver).invoke_cr52h1$(recent$lambda$lambda$lambda);
    return Unit;
  }
  function recent$lambda$lambda$lambda$lambda(closure$task) {
    return function () {
      return closure$task.props.idOrFail;
    };
  }
  function recent$lambda$lambda$lambda_0(task, f) {
    return Rx_init(recent$lambda$lambda$lambda$lambda(task));
  }
  function recent$lambda$lambda$lambda_1(id, ids) {
    return !ids.contains_11rb$(id);
  }
  function recent$lambda$lambda_2(closure$killables, closure$filter) {
    return function (list) {
      return (new FilteredListenableListConfig(list, closure$killables, recent$lambda$lambda$lambda_0, closure$filter, recent$lambda$lambda$lambda_1)).build();
    };
  }
  function recent$lambda$lambda$lambda$lambda_0($receiver) {
    get_listGroupItem($receiver);
    get_positionRelative($receiver);
    get_p0($receiver);
    return Unit;
  }
  function recent$lambda$lambda$lambda$lambda$lambda($receiver) {
    get_positionAbsolute($receiver);
    get_leftRightTopBottom0($receiver);
    get_listGroupItemAction($receiver);
    return Unit;
  }
  function recent$lambda$lambda$lambda$lambda$lambda_0(closure$onClick, closure$task) {
    return function (it) {
      closure$onClick(closure$task);
      return Unit;
    };
  }
  function recent$lambda$lambda$lambda$lambda_1(closure$onClick, closure$task) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(recent$lambda$lambda$lambda$lambda$lambda);
      $receiver.href = '#';
      clickEvent($receiver, recent$lambda$lambda$lambda$lambda$lambda_0(closure$onClick, closure$task));
      return Unit;
    };
  }
  function recent$lambda$lambda$lambda$lambda$lambda_1($receiver) {
    get_p1($receiver);
    get_flexGrow1($receiver);
    get_dFlex($receiver);
    get_flexRow($receiver);
  ...
  function recent$lambda$lambda$lambda$lambda$lambda$lambda($receiver) {
    get_m1($receiver);
    get_flexGrow1($receiver);
    return Unit;
  }
  function recent$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$task) {
    return function () {
      return closure$task.title.initial.invoke();
    };
  }
  function recent$lambda$lambda$lambda$lambda$lambda_2(closure$task) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(recent$lambda$lambda$lambda$lambda$lambda$lambda);
      rxTextOrEmpty($receiver, recent$lambda$lambda$lambda$lambda$lambda$lambda_0(closure$task));
      return Unit;
    };
  }
  function recent$lambda$lambda$lambda$lambda$lambda$lambda_1($receiver) {
    get_btn($receiver);
    get_btnSecondary($receiver);
    get_p2($receiver);
    flexFixedSize($receiver);
  ...
  function recent$lambda$lambda$lambda$lambda$lambda$lambda$lambda($receiver) {
    get_fw($receiver);
    get_eyeSlash($receiver);
    return Unit;
  }
  function recent$lambda$lambda$lambda$lambda$lambda$lambda_2($receiver) {
    invoke_0(get_fa(get_cls($receiver)), recent$lambda$lambda$lambda$lambda$lambda$lambda$lambda);
    return Unit;
  }
  function recent$lambda$lambda$lambda$lambda$lambda$lambda_3(this$recent, closure$task) {
    return function (it) {
      var $receiver = withCollection(new HiddenTask(), this$recent.userHiddenTasks).props;
      $receiver.persistedFB_61zpoe$(closure$task.props.idOrFail);
      $receiver.save();
      return Unit;
    };
  }
  function recent$lambda$lambda$lambda$lambda$lambda_3(this$recent, closure$task) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(recent$lambda$lambda$lambda$lambda$lambda$lambda_1);
      invoke(get_span($receiver), recent$lambda$lambda$lambda$lambda$lambda$lambda_2);
      clickEvent($receiver, recent$lambda$lambda$lambda$lambda$lambda$lambda_3(this$recent, closure$task));
      return Unit;
    };
  }
  function recent$lambda$lambda$lambda$lambda_2(closure$task, this$recent) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(recent$lambda$lambda$lambda$lambda$lambda_1);
      invoke(get_span($receiver), recent$lambda$lambda$lambda$lambda$lambda_2(closure$task));
      invoke(get_button($receiver), recent$lambda$lambda$lambda$lambda$lambda_3(this$recent, closure$task));
      return Unit;
    };
  }
  function recent$lambda$lambda$lambda_2(closure$onClick, closure$task, this$recent) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(recent$lambda$lambda$lambda$lambda_0);
      invoke(get_a($receiver), recent$lambda$lambda$lambda$lambda_1(closure$onClick, closure$task));
      invoke(get_div($receiver), recent$lambda$lambda$lambda$lambda_2(closure$task, this$recent));
      return Unit;
    };
  }
  function recent$lambda$lambda_3(closure$onClick, this$recent) {
    return function (task) {
      return invoke(get_div(document), recent$lambda$lambda$lambda_2(closure$onClick, task, this$recent));
    };
  }
  function recent$lambda_0(closure$panel, this$recent, closure$killables, closure$filter) {
    return function (onClick) {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$ = new Var(query(this$recent.userTasks, this$recent.db, recent$lambda$lambda));
      tmp$_0 = this$recent.userTasks;
      tmp$_1 = recent$lambda$lambda_2(closure$killables, closure$filter);
      tmp$_2 = recent$lambda$lambda_3(onClick, this$recent);
      return new ListUIConfig(closure$panel, tmp$, tmp$_0, recent$lambda$lambda_0, tmp$_1, void 0, void 0, void 0, recent$lambda$lambda_1, tmp$_2);
    };
  }
  function recent($receiver, killables, panel, filter, redisplay) {
    showClosableList(killables, redisplay, recent$lambda($receiver), recent$lambda_0(panel, $receiver, killables, filter));
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda($receiver) {
    get_btnGroup($receiver);
    get_m1($receiver);
    return Unit;
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda(this$, closure$notesWrap, this$viewTask) {
    return function (it) {
      editNote(this$viewTask, this$.state.killables, this$.state.panel.sub(), withCollection(new Note(), closure$notesWrap), this$.state.redisplay);
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_0(this$, closure$notesWrap, this$viewTask) {
    return function ($receiver) {
      get_btnPrimary(get_cls($receiver));
      clickEvent($receiver, viewTask$lambda$lambda$lambda$lambda$lambda$lambda(this$, closure$notesWrap, this$viewTask));
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_1(closure$task) {
    return function () {
      return !closure$task.completed.initial.invoke().getOrDefault_11rb$(false);
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_2(closure$canComplete) {
    return function ($receiver) {
      get_btnPrimary(get_cls($receiver));
      rxDisplayed($receiver, closure$canComplete);
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_0($receiver) {
    get_dropdownMenu($receiver);
    get_dropdownMenuRight($receiver);
    return Unit;
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda$lambda(closure$task, closure$close) {
    return function (it) {
      closure$task.props.rollback();
      set(closure$task.status.current, TaskStatus.Completed);
      closure$task.props.save();
      closure$close();
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$task, closure$close, this$) {
    return function ($receiver) {
      get_clipboardCheck(get_fa(get_cls($receiver.icon)));
      $receiver.text.innerText = 'Mark as Completed';
      clickEvent(this$, viewTask$lambda$lambda$lambda$lambda$lambda$lambda$lambda(closure$task, closure$close));
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_3(closure$canComplete, closure$task, closure$close) {
    return function ($receiver) {
      rxDisplayed($receiver, closure$canComplete);
      get_cls($receiver).invoke_cr52h1$(viewTask$lambda$lambda$lambda$lambda$lambda$lambda_0);
      dropdownItemAnchor($receiver, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$task, closure$close, $receiver));
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda(this$, closure$notesWrap, this$viewTask, closure$task, closure$close) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(viewTask$lambda$lambda$lambda$lambda$lambda);
      faButton($receiver, get_comment(Fa.Companion), viewTask$lambda$lambda$lambda$lambda$lambda_0(this$, closure$notesWrap, this$viewTask));
      ViewScreenConfig.Companion.editButton_rqaarp$($receiver, this$viewTask.killables, this$.edit);
      var canComplete = addedTo(Rx_init(viewTask$lambda$lambda$lambda$lambda$lambda_1(closure$task)), this$viewTask.killables);
      invoke(get_dropdownSplit($receiver), viewTask$lambda$lambda$lambda$lambda$lambda_2(canComplete));
      invoke(get_div($receiver), viewTask$lambda$lambda$lambda$lambda$lambda_3(canComplete, closure$task, closure$close));
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda(this$, closure$notesWrap, this$viewTask, closure$task, closure$close) {
    return function ($receiver) {
      invoke(get_div($receiver), viewTask$lambda$lambda$lambda$lambda(this$, closure$notesWrap, this$viewTask, closure$task, closure$close));
      return Unit;
    };
  }
  function viewTask$lambda(closure$close, closure$notesWrap, this$viewTask, closure$task) {
    return function ($receiver, cfg) {
      var closure$close_0 = closure$close;
      var closure$notesWrap_0 = closure$notesWrap;
      var this$viewTask_0 = this$viewTask;
      var closure$task_0 = closure$task;
      ViewScreenConfig.Companion.leftMiddle_exslxk$($receiver, cfg.title, closure$close_0);
      $receiver.right.invoke_gk6m2q$(viewTask$lambda$lambda$lambda(cfg, closure$notesWrap_0, this$viewTask_0, closure$task_0, closure$close_0));
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda_0($receiver) {
    get_bgLight($receiver);
    return Unit;
  }
  function viewTask$lambda$lambda$lambda$lambda_0($receiver) {
    get_dFlex($receiver);
    get_flexColumn($receiver);
    get_bgWhite($receiver);
    get_borderBottom($receiver);
    return Unit;
  }
  function viewTask$lambda$lambda$lambda$lambda_1(closure$item) {
    return function () {
      return closure$item.title.initial.invoke();
    };
  }
  function viewTask$lambda$lambda$lambda$lambda_2(closure$item) {
    return function () {
      return closure$item.text.initial.invoke();
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_4(it) {
    return it.name;
  }
  function viewTask$lambda$lambda$lambda$lambda_3(closure$item) {
    return function () {
      return closure$item.status.initial.invoke().map_2o04qz$(viewTask$lambda$lambda$lambda$lambda$lambda_4);
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_5(closure$notesList) {
    return function () {
      return closure$notesList.isEmptyRx.invoke();
    };
  }
  function viewTask$lambda$lambda$lambda$lambda_4(closure$notesList) {
    return function ($receiver) {
      rxDisplayed_0($receiver, viewTask$lambda$lambda$lambda$lambda$lambda_5(closure$notesList));
      get_m1(get_cls($receiver));
      $receiver.innerText = '<none>';
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_6(closure$notesList) {
    return function () {
      return !closure$notesList.isEmptyRx.invoke();
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_7(closure$notesList) {
    return function (diff) {
      ...
      while (tmp$.hasNext()) {
        var element = tmp$.next();
        closure$notesList.remove_11rb$(element);
      }
      ...
      while (tmp$_0.hasNext()) {
        ...
        closure$notesList.add_11rb$(element_0);
      }
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_2(closure$ks, closure$id, this$viewTask) {
    return function ($receiver) {
      tagBadge($receiver, closure$ks, closure$id, this$viewTask.tagSource);
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_8(this$, this$viewTask) {
    return function (id, ks) {
      return invoke(get_span(this$), viewTask$lambda$lambda$lambda$lambda$lambda$lambda_2(ks, id, this$viewTask));
    };
  }
  function viewTask$lambda$lambda$lambda$lambda_5(closure$notesList, this$, closure$item, this$viewTask) {
    return function ($receiver) {
      rxDisplayed_0($receiver, viewTask$lambda$lambda$lambda$lambda$lambda_6(closure$notesList));
      this$.killables.plusAssign_wii6vi$(diffs(closure$item.tags.initial, viewTask$lambda$lambda$lambda$lambda$lambda_7(closure$notesList)));
      listenableList($receiver, closure$notesList, this$.killables, viewTask$lambda$lambda$lambda$lambda$lambda_8($receiver, this$viewTask));
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_9(closure$st, this$viewTask) {
    return function (ks, item, close) {
      editNote(this$viewTask, ks, closure$st.panel.sub(), item, close);
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_3($receiver) {
    $receiver.desc_tixzdw$(Note.Companion.ts);
    return Unit;
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_4() {
    return new Note();
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_5($receiver) {
    get_m1(get_cls($receiver));
    $receiver.innerText = '<none>';
    return Unit;
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda$lambda_6(it) {
    return orEmpty(it.text.initial.invoke());
  }
  function viewTask$lambda$lambda$lambda$lambda$lambda_10(closure$notesRoot, closure$notesWrap, this$viewTask) {
    return function (show) {
      return new ListUIConfig(closure$notesRoot, new Var(query(closure$notesWrap, this$viewTask.db, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_3)), closure$notesWrap, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_4, void 0, void 0, viewTask$lambda$lambda$lambda$lambda$lambda$lambda_5, void 0, void 0, stringListClick(viewTask$lambda$lambda$lambda$lambda$lambda$lambda_6, show));
    };
  }
  function viewTask$lambda$lambda$lambda$lambda_6(this$, closure$st, this$viewTask, closure$notesWrap) {
    return function ($receiver) {
      var notesRoot = new RootPanel($receiver);
      showClosableList(this$.killables, this$.redisplay, viewTask$lambda$lambda$lambda$lambda$lambda_9(closure$st, this$viewTask), viewTask$lambda$lambda$lambda$lambda$lambda_10(notesRoot, closure$notesWrap, this$viewTask));
      return Unit;
    };
  }
  function viewTask$lambda$lambda$lambda_1(this$, closure$item, this$viewTask, closure$st, closure$notesWrap) {
    return function ($receiver) {
      get_cls($receiver).invoke_cr52h1$(viewTask$lambda$lambda$lambda$lambda_0);
      this$.killables.plusAssign_wii6vi$(viewTextField($receiver, 'Title', viewTask$lambda$lambda$lambda$lambda_1(closure$item)));
      this$.killables.plusAssign_wii6vi$(viewTextField($receiver, 'Text', viewTask$lambda$lambda$lambda$lambda_2(closure$item)));
      this$.killables.plusAssign_wii6vi$(viewTextField($receiver, 'Status', viewTask$lambda$lambda$lambda$lambda_3(closure$item)));
      viewFieldLabel($receiver, 'Tags');
      var notesList = new ListenableMutableList();
      invoke(get_div($receiver), viewTask$lambda$lambda$lambda$lambda_4(notesList));
      invoke(get_div($receiver), viewTask$lambda$lambda$lambda$lambda_5(notesList, this$, closure$item, this$viewTask));
      viewFieldLabel($receiver, 'Notes');
      invoke(get_div($receiver), viewTask$lambda$lambda$lambda$lambda_6(this$, closure$st, this$viewTask, closure$notesWrap));
      return Unit;
    };
  }
  function viewTask$lambda_0(this$viewTask, closure$notesWrap) {
    return function ($receiver, st, item) {
      var this$viewTask_0 = this$viewTask;
      var closure$notesWrap_0 = closure$notesWrap;
      get_cls($receiver).invoke_cr52h1$(viewTask$lambda$lambda$lambda_0);
      scrollPanel($receiver, viewTask$lambda$lambda$lambda_1(st, item, this$viewTask_0, st, closure$notesWrap_0));
      return Unit;
    };
  }
  function viewTask($receiver, ks, panel, task, close) {
    var notesWrap = get_notes(task.props.docWrapOrFail);
    build_1(new ViewScreenConfig('Task', getCallableRef('editTask', function ($receiver, killables, panel, task, close) {
      return editTask($receiver, killables, panel, task, close), Unit;
    }.bind(null, $receiver)), viewTask$lambda(close, notesWrap, $receiver, task), viewTask$lambda_0($receiver, notesWrap)), ks, panel, task, close);
  }
  ...
  package$tasks.editNote_15aopw$ = editNote;
