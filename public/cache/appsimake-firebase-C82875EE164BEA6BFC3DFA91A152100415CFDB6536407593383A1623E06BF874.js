...
this['appsimake-firebase'] = function (_, Kotlin, $module$appsimake_commonshr, $module$kotlinx_coroutines_core) {
  ...
  var HasLib = $module$appsimake_commonshr.commonshr.HasLib;
  ...
  var inboxOf = $module$appsimake_commonshr.commonshr.inboxOf_rzp46g$;
  ...
  var Success_init = $module$appsimake_commonshr.common.Success;
  var Failure_init = $module$appsimake_commonshr.common.Failure;
  ...
  var editableOf = $module$appsimake_commonshr.commonshr.editableOf_9d8gjq$;
  var toFsEditable = $module$appsimake_commonshr.commonshr.toFsEditable_s8vq45$;
  var EditableDoc = $module$appsimake_commonshr.commonshr.EditableDoc;
  ...
  var DocWrapImpl = $module$appsimake_commonshr.commonshr.DocWrapImpl;
  ...
  DbApi.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return randomDoc_0($receiver, this);
  };
  ...
  DbApi.prototype.getOrDefault_bo0woj$$default = function ($receiver, source, fn, continuation) {
    return getOrDefault($receiver, this, source, fn, continuation);
  };
  DbApi.prototype.getOrDefault_bo0woj$ = function ($receiver, source, fn, continuation, callback$default) {
    if (source === void 0) {
      source = 'default';
    }
    return callback$default ? callback$default($receiver, source, fn, continuation) : this.getOrDefault_bo0woj$$default($receiver, source, fn, continuation);
  };
  DbApi.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return toFsDoc_0($receiver, this, source, default_0, continuation);
  };
  DbApi.prototype.toFsDoc_bo0woj$ = function ($receiver, source, default_0, continuation, callback$default) {
    if (source === void 0) {
      source = 'default';
    }
    return callback$default ? callback$default($receiver, source, default_0, continuation) : this.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  DbApi.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return set($receiver, this, data, options);
  };
  DbApi.prototype.set_o9yh22$ = function ($receiver, data, options, callback$default) {
    if (options === void 0) {
      options = {};
    }
    return callback$default ? callback$default($receiver, data, options) : this.set_o9yh22$$default($receiver, data, options);
  };
  DbApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'DbApi',
  ...
  CsDbKillsApi.prototype.documentChanges_pujjsl$$default = function ($receiver, query) {
    return documentChanges_0($receiver, this, query);
  };
  function CsDbKillsApi$documentChanges$lambda($receiver) {
    return Unit;
  }
  CsDbKillsApi.prototype.documentChanges_pujjsl$ = function ($receiver, query, callback$default) {
    if (query === void 0)
      query = CsDbKillsApi$documentChanges$lambda;
    return callback$default ? callback$default($receiver, query) : this.documentChanges_pujjsl$$default($receiver, query);
  };
  CsDbKillsApi.prototype.docs_prxdpg$ = function ($receiver) {
    return docs($receiver, this);
  };
  CsDbKillsApi.prototype.get_docsOrNull_g2zw3r$ = function ($receiver) {
    return docsOrNull($receiver, this);
  };
  ...
  TxApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'TxApi',
    interfaces: [HasTx, Api]
  };
  function DbTxApi() {
  }
  DbTxApi.prototype.getOrFail_prxdpg$ = function ($receiver, continuation) {
    return getOrFail($receiver, this, continuation);
  };
  DbTxApi.prototype.getOrDefault_we3fe6$ = function ($receiver, fn, continuation) {
    return getOrDefault_0($receiver, this, fn, continuation);
  };
  DbTxApi.prototype.txSet_y1t3au$ = function ($receiver, data) {
    return txSet($receiver, this, data);
  };
  DbTxApi.prototype.delete_prxdpg$ = function ($receiver) {
    return delete_3($receiver, this);
  };
  DbTxApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'DbTxApi',
    interfaces: [HasDbTx, DbApi, TxApi]
  };
  function DbTxWrap(db, tx) {
    this.db_5drfwh$_0 = db;
    this.tx_5drsaj$_0 = tx;
  }
  Object.defineProperty(DbTxWrap.prototype, 'db', {
    get: function () {
      return this.db_5drfwh$_0;
    }
  });
  Object.defineProperty(DbTxWrap.prototype, 'tx', {
    get: function () {
      return this.tx_5drsaj$_0;
    }
  });
  DbTxWrap.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function get_uid($receiver) {
    return $receiver.user.uid;
  }
  function HasDb() {
  }
  HasDb.$metadata$ = {
  ...
  HasDbUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasDbUser',
    interfaces: [HasUser, HasDb]
  };
  function HasCsDbUser() {
  }
  HasCsDbUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasCsDbUser',
    interfaces: [HasDbUser, HasCsDb]
  };
  function HasDbKillsUser() {
  }
  HasDbKillsUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasDbKillsUser',
    interfaces: [HasCsDbUser, HasDbKills]
  };
  function HasDbFcmKillsUser() {
  }
  HasDbFcmKillsUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasDbFcmKillsUser',
    interfaces: [HasDbFcmUser, HasFcm, HasDbKillsUser]
  };
  function HasDbFcmUser() {
  }
  HasDbFcmUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasDbFcmUser',
    interfaces: [HasFcm, HasDbUser]
  };
  function HasDbFcmKillsLibUser() {
  }
  HasDbFcmKillsLibUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasDbFcmKillsLibUser',
    interfaces: [HasDbFcmLibUser, HasDbFcmKillsUser]
  };
  function HasDbKillsLibUser() {
  }
  HasDbKillsLibUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasDbKillsLibUser',
    interfaces: [HasDbLibUser, HasDbKillsUser]
  };
  function HasDbLibUser() {
  }
  HasDbLibUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasDbLibUser',
    interfaces: [HasLibUser, HasDbUser]
  };
  function HasLibUser() {
  }
  HasLibUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasLibUser',
    interfaces: [HasLib, HasUser]
  };
  function HasDbFcmLibUser() {
  }
  HasDbFcmLibUser.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'HasDbFcmLibUser',
    interfaces: [HasDbLibUser, HasDbFcmUser]
  };
  var MaxBatchSize;
  ...
  function inboxOf_0($receiver, user) {
    return inboxOf($receiver, user.uid);
  }
  ...
  function Coroutine$txTry($receiver_0, fn_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
  ...
  Coroutine$txTry.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$txTry.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$txTry.prototype.constructor = Coroutine$txTry;
  Coroutine$txTry.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 1;
            this.result_0 = tx(this.local$$receiver, this.local$fn, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            this.local$tmp$ = new Success_init(this.result_0);
            this.exceptionState_0 = 4;
            this.state_0 = 3;
            continue;
          case 2:
            ...
            if (Kotlin.isType(e_0, Exception)) {
              this.local$tmp$ = new Failure_init(e_0);
            }
             else
              throw e_0;
            this.state_0 = 3;
  ...
  function txTry($receiver_0, fn_0, continuation_0, suspended) {
    var instance = new Coroutine$txTry($receiver_0, fn_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  var onSuccess = defineInlineFunction('appsimake-firebase.firebase.firestore.onSuccess_vxkwep$', wrapFunction(function () {
    var Success = _.$$importsForInline$$['appsimake-commonshr'].common.Success;
    var Failure = _.$$importsForInline$$['appsimake-commonshr'].common.Failure;
    var throwCCE = Kotlin.throwCCE;
    var Exception = Kotlin.kotlin.Exception;
    return function ($receiver, fn) {
      var tmp$, tmp$_0;
      if (Kotlin.isType($receiver, Success)) {
        var tmp$_1;
        try {
          var t = $receiver.value;
          fn(t);
          tmp$_1 = new Success(t);
        }
         catch (e) {
       ...
       else if (Kotlin.isType($receiver, Failure))
        tmp$_0 = Kotlin.isType(tmp$ = $receiver, Failure) ? tmp$ : throwCCE();
      else
        tmp$_0 = Kotlin.noWhenBranchMatched();
      return tmp$_0;
    };
  }));
  function RollbackException(msg) {
    if (msg === void 0)
      msg = null;
  ...
  function get_privateDoc($receiver) {
    return privateOf_0($receiver.lib, $receiver.user);
  }
  function get_privateSingletons($receiver) {
    return get_singletons(get_privateDoc($receiver));
  }
  function get_fcmTokensColl($receiver) {
    return get_fcmTokens(get_privateDoc($receiver));
  }
  ...
  function Coroutine$docsOrNull$lambda(this$docsOrNull_0, it_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$docsOrNull = this$docsOrNull_0;
    this.local$it = it_0;
  }
  Coroutine$docsOrNull$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$docsOrNull$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$docsOrNull$lambda.prototype.constructor = Coroutine$docsOrNull$lambda;
  Coroutine$docsOrNull$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return read(this.local$this$docsOrNull, this.local$it);
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function docsOrNull$lambda(this$docsOrNull_0) {
    return function (it_0, continuation_0, suspended) {
      var instance = new Coroutine$docsOrNull$lambda(this$docsOrNull_0, it_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function docsOrNull($receiver, deps) {
    return map(snapshots_0($receiver, deps), void 0, docsOrNull$lambda($receiver));
  }
  ...
  function editableOf_0($receiver, d, exists) {
    if (d === void 0) {
      d = {};
    }
    if (exists === void 0)
      exists = true;
    return editableOf($receiver, d, exists, FsDynamicOps_getInstance());
  }
  ...
  function Coroutine$getOrDefault($receiver_0, deps_0, source_0, fn_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
    this.local$deps = deps_0;
  ...
  Coroutine$getOrDefault.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$getOrDefault.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$getOrDefault.prototype.constructor = Coroutine$getOrDefault;
  Coroutine$getOrDefault.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            ...
            var tmp$ = docRef(this.local$$receiver, this.local$deps.db);
            var $receiver = {};
            $receiver.source = this.local$source;
            this.state_0 = 2;
            this.result_0 = await_0(tmp$.get($receiver), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            return extractOrDefault(this.local$$receiver, this.result_0, this.local$fn);
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function getOrDefault($receiver_0, deps_0, source_0, fn_0, continuation_0, suspended) {
    var instance = new Coroutine$getOrDefault($receiver_0, deps_0, source_0, fn_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function extractOrDefault($receiver, ds, fn) {
    if (ds.exists) {
      return new EditableDoc($receiver, $receiver.factory(ds.data(), FsDynamicOps_getInstance()), true);
    }
     else {
      return new EditableDoc($receiver, fn(), false);
    }
  }
  function extractOrFail($receiver, ds) {
    if (!ds.exists) {
      var message = 'Document does not exist: ' + $receiver.path;
      throw IllegalArgumentException_init(message.toString());
    }
    return new EditableDoc($receiver, $receiver.factory(ds.data(), FsDynamicOps_getInstance()), true);
  }
  function Coroutine$toFsDoc($receiver_0, deps_0, source_0, default_1, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
    this.local$deps = deps_0;
  ...
  Coroutine$toFsDoc.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$toFsDoc.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$toFsDoc.prototype.constructor = Coroutine$toFsDoc;
  Coroutine$toFsDoc.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 2;
            this.result_0 = getOrNull(this.local$$receiver, this.local$deps, this.local$source, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            var loaded = this.result_0;
            var block$result;
            if (loaded == null) {
              block$result = new RefDoc(toFsId(this.local$$receiver, false), this.local$default());
            }
             else {
              block$result = toFsDoc(loaded, toFsId(this.local$$receiver, true));
            }
  ...
  function toFsDoc_0($receiver_0, deps_0, source_0, default_1, continuation_0, suspended) {
    var instance = new Coroutine$toFsDoc($receiver_0, deps_0, source_0, default_1, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function wrapFsDoc($receiver, doc) {
    return new RefDoc(toFsId($receiver, false), doc);
  }
  function set($receiver, deps, data, options) {
    if (options === void 0) {
      options = {};
    }
    return docRef_0($receiver, deps).set(writeDynamic(data, FsDynamicOps_getInstance()), options);
  }
  function wrap($receiver) {
    var tmp$;
    return new CollectionWrap($receiver.id, (tmp$ = $receiver.parent) != null ? wrap_0(tmp$) : null);
  }
  function wrap_0($receiver) {
    return new DocWrapImpl($receiver.id, wrap($receiver.parent));
  }
  ...
  QuerySettingsBuilder.prototype.eq_n266k$ = function ($receiver, v) {
  ...
  QuerySettingsBuilder.prototype.get_asc_9i4614$ = function ($receiver) {
    this.settings = this.settings.asc_61zpoe$($receiver.name);
  };
  QuerySettingsBuilder.prototype.get_desc_9i4614$ = function ($receiver) {
  ...
  function documentChanges$lambda_0($receiver) {
    return Unit;
  }
  function documentChanges_0($receiver, deps, query_0) {
    if (query_0 === void 0)
      query_0 = documentChanges$lambda_0;
    return documentChanges(query($receiver, deps, query_0), deps);
  }
  ...
  function Coroutine$tx$lambda(this$tx_0, closure$fn_0, it_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$tx = this$tx_0;
    this.local$closure$fn = closure$fn_0;
    this.local$it = it_0;
  }
  Coroutine$tx$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$tx$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$tx$lambda.prototype.constructor = Coroutine$tx$lambda;
  Coroutine$tx$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$closure$fn(new DbTxWrap(this.local$this$tx.db, this.local$it), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function tx$lambda(this$tx_0, closure$fn_0) {
    return function (it_0, continuation_0, suspended) {
      var instance = new Coroutine$tx$lambda(this$tx_0, closure$fn_0, it_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function tx_0($receiver, fn, continuation) {
    return tx($receiver.db, tx$lambda($receiver, fn), continuation);
  }
  function Coroutine$txTry$lambda(this$txTry_0, closure$fn_0, it_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$closure$fn(new DbTxWrap(this.local$this$txTry.db, this.local$it), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function txTry$lambda(this$txTry_0, closure$fn_0) {
    return function (it_0, continuation_0, suspended) {
      var instance = new Coroutine$txTry$lambda(this$txTry_0, closure$fn_0, it_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function txTry_0($receiver, fn, continuation) {
    return txTry($receiver.db, txTry$lambda($receiver, fn), continuation);
  }
  function Coroutine$getOrDefault_0($receiver_0, deps_0, fn_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
    this.local$deps = deps_0;
  ...
  Coroutine$getOrDefault_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$getOrDefault_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$getOrDefault_0.prototype.constructor = Coroutine$getOrDefault_0;
  Coroutine$getOrDefault_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = await_0(this.local$deps.tx.get(docRef(this.local$$receiver, this.local$deps.db)), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function getOrDefault_0($receiver_0, deps_0, fn_0, continuation_0, suspended) {
    var instance = new Coroutine$getOrDefault_0($receiver_0, deps_0, fn_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$getOrFail($receiver_0, deps_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
    this.local$deps = deps_0;
  }
  Coroutine$getOrFail.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$getOrFail.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$getOrFail.prototype.constructor = Coroutine$getOrFail;
  Coroutine$getOrFail.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
          ...
          case 1:
            throw this.exception_0;
          case 2:
            return extractOrFail(this.local$$receiver, this.result_0);
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function getOrFail($receiver_0, deps_0, continuation_0, suspended) {
    var instance = new Coroutine$getOrFail($receiver_0, deps_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function txSet($receiver, deps, data) {
    return deps.tx.set(docRef($receiver, deps.db), writeDynamic(data, FsDynamicOps_getInstance()));
  }
  function delete_4($receiver, deps) {
    return deps.tx.delete(docRef($receiver, deps.db));
  }
  ...
  package$firebase.TxApi = TxApi;
  package$firebase.DbTxApi = DbTxApi;
  package$firebase.DbTxWrap = DbTxWrap;
  var package$auth = package$firebase.auth || (package$firebase.auth = {});
  package$auth.get_uid_32ydu7$ = get_uid;
  package$firebase.HasDb = HasDb;
  package$firebase.HasFcm = HasFcm;
  ...
  package$firebase.HasTx = HasTx;
  package$firebase.HasDbTx = HasDbTx;
  package$firebase.HasUser = HasUser;
  package$firebase.HasDbUser = HasDbUser;
  package$firebase.HasCsDbUser = HasCsDbUser;
  package$firebase.HasDbKillsUser = HasDbKillsUser;
  package$firebase.HasDbFcmKillsUser = HasDbFcmKillsUser;
  package$firebase.HasDbFcmUser = HasDbFcmUser;
  package$firebase.HasDbFcmKillsLibUser = HasDbFcmKillsLibUser;
  package$firebase.HasDbKillsLibUser = HasDbKillsLibUser;
  package$firebase.HasDbLibUser = HasDbLibUser;
  package$firebase.HasLibUser = HasLibUser;
  package$firebase.HasDbFcmLibUser = HasDbFcmLibUser;
  ...
  package$firestore.inboxOf_30ab3o$ = inboxOf_0;
  ...
  package$firestore.onSuccess_vxkwep$ = onSuccess;
  package$firestore.RollbackException = RollbackException;
  package$firestore.rollback_pdl1vj$ = rollback;
  ...
  package$firestore.get_privateDoc_sc9572$ = get_privateDoc;
  package$firestore.get_privateSingletons_sc9572$ = get_privateSingletons;
  package$firestore.get_fcmTokensColl_sc9572$ = get_fcmTokensColl;
  ...
  package$firestore.docsOrNull_ou9x2h$ = docsOrNull;
  ...
  package$firestore.editableOf_xlcbwg$ = editableOf_0;
  package$firestore.getCachedOrServer_1uroz$ = getCachedOrServer;
  package$firestore.getOrNull_uu0hce$ = getOrNull;
  package$firestore.getOrDefault_hvg3gk$ = getOrDefault;
  package$firestore.extractOrDefault_a46kpb$ = extractOrDefault;
  package$firestore.extractOrFail_bt13gf$ = extractOrFail;
  package$firestore.toFsDoc_hvg3gk$ = toFsDoc_0;
  package$firestore.wrapFsDoc_fuxh7m$ = wrapFsDoc;
  package$firestore.set_xmixsl$ = set;
  package$firestore.wrap_n7ghai$ = wrap;
  package$firestore.wrap_ty25rn$ = wrap_0;
  ...
  package$firestore.documentChanges_wamwi5$ = documentChanges_0;
  package$firestore.listEvents_wamwi5$ = listEvents_0;
  package$firestore.toList_wamwi5$ = toList;
  package$firestore.tx_4q5zrj$ = tx_0;
  package$firestore.txTry_4q5zrj$ = txTry_0;
  package$firestore.getOrDefault_z9h41t$ = getOrDefault_0;
  package$firestore.getOrFail_3pp9v5$ = getOrFail;
  package$firestore.txSet_g1afr1$ = txSet;
  package$firestore.delete_l1qlqh$ = delete_4;
  ...
  KillsApiFirebase.prototype.anyRx_tnde95$ = KillsApi.prototype.anyRx_tnde95$;
  ...
  KillsApiFirebase.prototype.forEachNonNull_cjboeh$ = KillsApi.prototype.forEachNonNull_cjboeh$;
  KillsApiFirebase.prototype.forEachTrue_aq5y71$ = KillsApi.prototype.forEachTrue_aq5y71$;
  ...
  KillsApiFirebase.prototype.register_3ijkb1$ = KillsApi.prototype.register_3ijkb1$;
  ...
  KillsApiFirebase.prototype.toChannel_z5dyp2$ = KillsApi.prototype.toChannel_z5dyp2$;
  ...
  DbKillsApi.prototype.get_randomDoc_lsue4w$ = DbApi.prototype.get_randomDoc_lsue4w$;
  ...
  DbKillsApi.prototype.getOrDefault_bo0woj$$default = DbApi.prototype.getOrDefault_bo0woj$$default;
  DbKillsApi.prototype.toFsDoc_bo0woj$$default = DbApi.prototype.toFsDoc_bo0woj$$default;
  DbKillsApi.prototype.set_o9yh22$$default = DbApi.prototype.set_o9yh22$$default;
  ...
  DbKillsApi.prototype.anyRx_tnde95$ = KillsApiFirebase.prototype.anyRx_tnde95$;
  ...
  DbKillsApi.prototype.forEachNonNull_cjboeh$ = KillsApiFirebase.prototype.forEachNonNull_cjboeh$;
  DbKillsApi.prototype.forEachTrue_aq5y71$ = KillsApiFirebase.prototype.forEachTrue_aq5y71$;
  ...
  DbKillsApi.prototype.register_3ijkb1$ = KillsApiFirebase.prototype.register_3ijkb1$;
  ...
  DbKillsApi.prototype.toChannel_z5dyp2$ = KillsApiFirebase.prototype.toChannel_z5dyp2$;
  ...
  DbKillsApi.prototype.getOrDefault_bo0woj$ = DbApi.prototype.getOrDefault_bo0woj$;
  DbKillsApi.prototype.toFsDoc_bo0woj$ = DbApi.prototype.toFsDoc_bo0woj$;
  DbKillsApi.prototype.set_o9yh22$ = DbApi.prototype.set_o9yh22$;
  CsApiFirebase.prototype.toRx_on0lyu$ = CsApi.prototype.toRx_on0lyu$;
  CsApiFirebase.prototype.toRxSet_vzwksx$ = CsApi.prototype.toRxSet_vzwksx$;
  ...
  CsKillsApiFirebase.prototype.anyRx_tnde95$ = CsKillsApi.prototype.anyRx_tnde95$;
  ...
  CsKillsApiFirebase.prototype.forEachNonNull_cjboeh$ = CsKillsApi.prototype.forEachNonNull_cjboeh$;
  CsKillsApiFirebase.prototype.forEachTrue_aq5y71$ = CsKillsApi.prototype.forEachTrue_aq5y71$;
  ...
  CsKillsApiFirebase.prototype.register_3ijkb1$ = CsKillsApi.prototype.register_3ijkb1$;
  ...
  CsKillsApiFirebase.prototype.toChannel_z5dyp2$ = CsKillsApi.prototype.toChannel_z5dyp2$;
  ...
  CsKillsApiFirebase.prototype.toRxSet_vzwksx$ = CsKillsApi.prototype.toRxSet_vzwksx$;
  ...
  CsDbKillsApi.prototype.anyRx_tnde95$ = CsKillsApiFirebase.prototype.anyRx_tnde95$;
  ...
  CsDbKillsApi.prototype.forEachNonNull_cjboeh$ = CsKillsApiFirebase.prototype.forEachNonNull_cjboeh$;
  CsDbKillsApi.prototype.forEachTrue_aq5y71$ = CsKillsApiFirebase.prototype.forEachTrue_aq5y71$;
  ...
  CsDbKillsApi.prototype.register_3ijkb1$ = CsKillsApiFirebase.prototype.register_3ijkb1$;
  ...
  CsDbKillsApi.prototype.toChannel_z5dyp2$ = CsKillsApiFirebase.prototype.toChannel_z5dyp2$;
  ...
  CsDbKillsApi.prototype.toRxSet_vzwksx$ = CsKillsApiFirebase.prototype.toRxSet_vzwksx$;
  ...
  CsDbKillsApi.prototype.get_randomDoc_lsue4w$ = DbApi.prototype.get_randomDoc_lsue4w$;
  ...
  CsDbKillsApi.prototype.getOrDefault_bo0woj$$default = DbApi.prototype.getOrDefault_bo0woj$$default;
  CsDbKillsApi.prototype.toFsDoc_bo0woj$$default = DbApi.prototype.toFsDoc_bo0woj$$default;
  CsDbKillsApi.prototype.set_o9yh22$$default = DbApi.prototype.set_o9yh22$$default;
  ...
  CsDbKillsApi.prototype.getOrDefault_bo0woj$ = DbApi.prototype.getOrDefault_bo0woj$;
  CsDbKillsApi.prototype.toFsDoc_bo0woj$ = DbApi.prototype.toFsDoc_bo0woj$;
  CsDbKillsApi.prototype.set_o9yh22$ = DbApi.prototype.set_o9yh22$;
  DbTxApi.prototype.getOrDefault_bo0woj$$default = DbApi.prototype.getOrDefault_bo0woj$$default;
  DbTxApi.prototype.delete_73z9b6$ = DbApi.prototype.delete_73z9b6$;
  DbTxApi.prototype.delete_ihdkly$ = DbApi.prototype.delete_ihdkly$;
  DbTxApi.prototype.get_ref_sj9vaa$ = DbApi.prototype.get_ref_sj9vaa$;
  DbTxApi.prototype.get_ref_aqty80$ = DbApi.prototype.get_ref_aqty80$;
  DbTxApi.prototype.get_randomDoc_sj9vaa$ = DbApi.prototype.get_randomDoc_sj9vaa$;
  DbTxApi.prototype.get_randomDoc_lsue4w$ = DbApi.prototype.get_randomDoc_lsue4w$;
  DbTxApi.prototype.toRandomFsDoc_xc7wmg$ = DbApi.prototype.toRandomFsDoc_xc7wmg$;
  DbTxApi.prototype.randomEditable_mx4g9l$$default = DbApi.prototype.randomEditable_mx4g9l$$default;
  DbTxApi.prototype.save_73z9b6$ = DbApi.prototype.save_73z9b6$;
  DbTxApi.prototype.save_biv66q$ = DbApi.prototype.save_biv66q$;
  DbTxApi.prototype.query_wzkv1r$$default = DbApi.prototype.query_wzkv1r$$default;
  DbTxApi.prototype.getCachedOrServer_prxdpg$ = DbApi.prototype.getCachedOrServer_prxdpg$;
  DbTxApi.prototype.getOrNull_m1hph$$default = DbApi.prototype.getOrNull_m1hph$$default;
  DbTxApi.prototype.toFsDoc_bo0woj$$default = DbApi.prototype.toFsDoc_bo0woj$$default;
  DbTxApi.prototype.set_o9yh22$$default = DbApi.prototype.set_o9yh22$$default;
  DbTxApi.prototype.getOrDefault_bo0woj$ = DbApi.prototype.getOrDefault_bo0woj$;
  DbTxApi.prototype.randomEditable_mx4g9l$ = DbApi.prototype.randomEditable_mx4g9l$;
  DbTxApi.prototype.query_wzkv1r$ = DbApi.prototype.query_wzkv1r$;
  DbTxApi.prototype.getOrNull_m1hph$ = DbApi.prototype.getOrNull_m1hph$;
  DbTxApi.prototype.toFsDoc_bo0woj$ = DbApi.prototype.toFsDoc_bo0woj$;
  DbTxApi.prototype.set_o9yh22$ = DbApi.prototype.set_o9yh22$;
  DbTxWrap.prototype.getOrFail_prxdpg$ = DbTxApi.prototype.getOrFail_prxdpg$;
  DbTxWrap.prototype.getOrDefault_we3fe6$ = DbTxApi.prototype.getOrDefault_we3fe6$;
  DbTxWrap.prototype.getOrDefault_bo0woj$$default = DbTxApi.prototype.getOrDefault_bo0woj$$default;
  DbTxWrap.prototype.txSet_y1t3au$ = DbTxApi.prototype.txSet_y1t3au$;
  DbTxWrap.prototype.delete_prxdpg$ = DbTxApi.prototype.delete_prxdpg$;
  DbTxWrap.prototype.delete_73z9b6$ = DbTxApi.prototype.delete_73z9b6$;
  DbTxWrap.prototype.delete_ihdkly$ = DbTxApi.prototype.delete_ihdkly$;
  DbTxWrap.prototype.get_ref_sj9vaa$ = DbTxApi.prototype.get_ref_sj9vaa$;
  DbTxWrap.prototype.get_ref_aqty80$ = DbTxApi.prototype.get_ref_aqty80$;
  DbTxWrap.prototype.get_randomDoc_sj9vaa$ = DbTxApi.prototype.get_randomDoc_sj9vaa$;
  DbTxWrap.prototype.get_randomDoc_lsue4w$ = DbTxApi.prototype.get_randomDoc_lsue4w$;
  DbTxWrap.prototype.toRandomFsDoc_xc7wmg$ = DbTxApi.prototype.toRandomFsDoc_xc7wmg$;
  DbTxWrap.prototype.randomEditable_mx4g9l$$default = DbTxApi.prototype.randomEditable_mx4g9l$$default;
  DbTxWrap.prototype.save_73z9b6$ = DbTxApi.prototype.save_73z9b6$;
  DbTxWrap.prototype.save_biv66q$ = DbTxApi.prototype.save_biv66q$;
  DbTxWrap.prototype.query_wzkv1r$$default = DbTxApi.prototype.query_wzkv1r$$default;
  DbTxWrap.prototype.getCachedOrServer_prxdpg$ = DbTxApi.prototype.getCachedOrServer_prxdpg$;
  DbTxWrap.prototype.getOrNull_m1hph$$default = DbTxApi.prototype.getOrNull_m1hph$$default;
  DbTxWrap.prototype.toFsDoc_bo0woj$$default = DbTxApi.prototype.toFsDoc_bo0woj$$default;
  DbTxWrap.prototype.set_o9yh22$$default = DbTxApi.prototype.set_o9yh22$$default;
  DbTxWrap.prototype.getOrDefault_bo0woj$ = DbTxApi.prototype.getOrDefault_bo0woj$;
  DbTxWrap.prototype.randomEditable_mx4g9l$ = DbTxApi.prototype.randomEditable_mx4g9l$;
  DbTxWrap.prototype.query_wzkv1r$ = DbTxApi.prototype.query_wzkv1r$;
  DbTxWrap.prototype.getOrNull_m1hph$ = DbTxApi.prototype.getOrNull_m1hph$;
  DbTxWrap.prototype.toFsDoc_bo0woj$ = DbTxApi.prototype.toFsDoc_bo0woj$;
  DbTxWrap.prototype.set_o9yh22$ = DbTxApi.prototype.set_o9yh22$;
  querySettings$ObjectLiteral.prototype.arrayContains_s44rpz$ = QuerySettingsBuilder.prototype.arrayContains_s44rpz$;
  querySettings$ObjectLiteral.prototype.eq_n266k$ = QuerySettingsBuilder.prototype.eq_n266k$;
  querySettings$ObjectLiteral.prototype.limit_za3lpa$ = QuerySettingsBuilder.prototype.limit_za3lpa$;
  querySettings$ObjectLiteral.prototype.get_asc_9i4614$ = QuerySettingsBuilder.prototype.get_asc_9i4614$;
  querySettings$ObjectLiteral.prototype.get_desc_9i4614$ = QuerySettingsBuilder.prototype.get_desc_9i4614$;
  MaxBatchSize = 500;
