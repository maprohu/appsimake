...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_fontawesome, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_commonshr, $module$appsimake_indexeddb, $module$appsimake_musiclib, $module$appsimake_common, $module$appsimake_commonfb, $module$appsimake_firebase, $module$appsimake_commonlib) {
    ...
    do
      try {
        switch (this.state_0) {
          ...
          case 2:
            return this.local$this$database.dbStatus.reset(), Unit;
  ...
  function Coroutine$main$lambda$ObjectLiteral$loggedIn$lambda(closure$ctx_0, closure$idb_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$closure$ctx.userSongsDB.queryCache.getAll(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 2:
            this.state_0 = 3;
            this.result_0 = this.local$closure$ctx.tagDB.queryCache.getAll(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
            this.state_0 = 4;
            this.result_0 = this.local$closure$ctx.songStoreDB.queryCache.getAll(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
  ...
  function main$lambda$ObjectLiteral$loggedIn$lambda(closure$ctx_0, closure$idb_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$main$lambda$ObjectLiteral$loggedIn$lambda(closure$ctx_0, closure$idb_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  main$lambda$ObjectLiteral.prototype.loggedIn_v1eir6$ = function (user) {
    ...
    launch(coroutines.GlobalScope, void 0, void 0, main$lambda$ObjectLiteral$loggedIn$lambda(ctx, this.closure$idb));
  ...
  function MusicCtx(fbCtx, user, idb) {
    ...
    this.dbStatus = new DBStatus(this.idb, this.tagDB, this.killables);
  ...
  function DBStatus(idb, tagDB, killables) {
    this.idb = idb;
    this.tagDB = tagDB;
    this.recordObject = new Var(new DBStatus$RecordObject());
    ...
    killables.plusAssign_wii6vi$(LocalSongs_getInstance().emitter.add_qlkmfe$(DBStatus_init$lambda(this)));
  }
  function DBStatus$RecordObject(size, count, duration) {
    if (size === void 0)
      size = L0;
    if (count === void 0)
      count = 0;
  ...
  DBStatus$RecordObject.prototype.component1 = function () {
    return this.size;
  };
  DBStatus$RecordObject.prototype.component2 = function () {
    return this.count;
  };
  DBStatus$RecordObject.prototype.component3 = function () {
    return this.duration;
  };
  DBStatus$RecordObject.prototype.copy_qu4meh$ = function (size, count, duration) {
    return new DBStatus$RecordObject(size === void 0 ? this.size : size, count === void 0 ? this.count : count, duration === void 0 ? this.duration : duration);
  };
  DBStatus$RecordObject.prototype.toString = function () {
    return 'RecordObject(size=' + Kotlin.toString(this.size) + (', count=' + Kotlin.toString(this.count)) + (', duration=' + Kotlin.toString(this.duration)) + ')';
  };
  DBStatus$RecordObject.prototype.hashCode = function () {
    var result = 0;
  ...
  DBStatus$RecordObject.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.size, other.size) && Kotlin.equals(this.count, other.count) && Kotlin.equals(this.duration, other.duration)))));
  };
  DBStatus.prototype.reset = function () {
    this.recordObject.now = new DBStatus$RecordObject();
  };
  function DBStatus$size$lambda(this$DBStatus) {
    return function () {
      return this$DBStatus.recordObject.invoke().size;
    };
  }
  function DBStatus$count$lambda(this$DBStatus) {
    return function () {
      return this$DBStatus.recordObject.invoke().count;
    };
  }
  function DBStatus$duration$lambda(this$DBStatus) {
    return function () {
      return this$DBStatus.recordObject.invoke().duration;
    };
  }
  function Coroutine$DBStatus_init$lambda$lambda$lambda(this$DBStatus_0, closure$id_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
  ...
  Coroutine$DBStatus_init$lambda$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$DBStatus_init$lambda$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$DBStatus_init$lambda$lambda$lambda.prototype.constructor = Coroutine$DBStatus_init$lambda$lambda$lambda;
  Coroutine$DBStatus_init$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function DBStatus_init$lambda$lambda$lambda(this$DBStatus_0, closure$id_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$DBStatus_init$lambda$lambda$lambda(this$DBStatus_0, closure$id_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function DBStatus_init$lambda$lambda$lambda_0(closure$tag) {
    return function (o) {
      return o.copy_qu4meh$(o.size.add(Kotlin.Long.fromInt(closure$tag.bytes.iv)), o.count + 1 | 0, o.duration + closure$tag.secs.iv);
    };
  }
  function DBStatus_init$lambda$lambda$lambda_1(closure$tag) {
    return function (o) {
      return o.copy_qu4meh$(o.size.subtract(Kotlin.Long.fromInt(closure$tag.bytes.iv)), o.count - 1 | 0, o.duration - closure$tag.secs.iv);
    };
  }
  function Coroutine$DBStatus_init$lambda$lambda(this$DBStatus_0, closure$id_0, closure$m_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$DBStatus = this$DBStatus_0;
  ...
  Coroutine$DBStatus_init$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$DBStatus_init$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$DBStatus_init$lambda$lambda.prototype.constructor = Coroutine$DBStatus_init$lambda$lambda;
  Coroutine$DBStatus_init$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            this.state_0 = 2;
            this.result_0 = this.local$this$DBStatus.tagDB.get_46owy4$(this.local$closure$id, DBStatus_init$lambda$lambda$lambda(this.local$this$DBStatus, this.local$closure$id), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 2:
            ...
            tmp$ = this.local$closure$m;
            if (Kotlin.isType(tmp$, SetAdded)) {
              return this.local$this$DBStatus.recordObject.transform_ru8m0w$(DBStatus_init$lambda$lambda$lambda_0(tag)), Unit;
            }
             else {
              if (Kotlin.isType(tmp$, SetRemoved)) {
                return this.local$this$DBStatus.recordObject.transform_ru8m0w$(DBStatus_init$lambda$lambda$lambda_1(tag)), Unit;
              }
               else {
                this.state_0 = 3;
                continue;
  ...
  function DBStatus_init$lambda$lambda(this$DBStatus_0, closure$id_0, closure$m_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$DBStatus_init$lambda$lambda(this$DBStatus_0, closure$id_0, closure$m_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function DBStatus_init$lambda(this$DBStatus) {
    return function (m) {
      var id = m.value;
      launch(coroutines.GlobalScope, void 0, void 0, DBStatus_init$lambda$lambda(this$DBStatus, id, m));
      return Unit;
    };
  }
  DBStatus.$metadata$ = {
