...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_commonshr, $module$appsimake_indexeddb, $module$appsimake_musiclib, $module$appsimake_common, $module$appsimake_firebase, $module$appsimake_commonlib, $module$appsimake_commonfb) {
  ...
  var get_ids = $module$appsimake_firebase.firebase.get_ids_5nqag1$;
  var combineAnd = $module$appsimake_commonshr.common.combineAnd_6vwu35$;
  ...
  var toRx = $module$appsimake_commonlib.commonlib.toRx_txiss2$;
  ...
  var feedTo_2 = $module$appsimake_commonshr.common.feedTo_cenaja$;
  ...
  function home$lambda$lambda$lambda$lambda_1(this$home, closure$killables) {
    return function ($receiver) {
      onlineStatusButton($receiver, this$home.onlineTasks, closure$killables, home$lambda$lambda$lambda$lambda$lambda_1);
      return Unit;
    };
  }
  ...
  function startMaintenance(ks, idb, userSongsDB) {
    var channel = toChannel(combineAnd(ks, get_ids(userSongsDB.dontLike), LocalSongs_getInstance().emitter), ks);
      ...
      try {
        switch (this.state_0) {
          ...
          case 1:
            throw this.exception_0;
          case 2:
            var ctx = new MusicCtx(this.local$closure$fbCtx, this.local$closure$user, this.local$closure$idb, this.local$dbLinks);
            ...
            home(ctx, playerFrame(ctx, ctx.appCtx.root).innerPanel, ctx.killables);
            return ctx;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
  ...
  function OnlineTasks$OnlineLoop($outer) {
    ...
    var emitter = addedTo(toAsync([map(this.$outer.transferSongs_0.upload, OnlineTasks$OnlineTasks$OnlineLoop_init$lambda), map(this.$outer.transferSongs_0.download, OnlineTasks$OnlineTasks$OnlineLoop_init$lambda_0)]), this.ks);
  ...
  function playerFrame($receiver, panel) {
    return new PlayerFrame(panel, $receiver.killables, randomSongSource($receiver.idb, $receiver.tagDB, $receiver.userSongsDB));
  }
  ...
  function DBStatus(idb, tagDB, storageDB, userSongsDB, transferSongs, killables) {
    ...
    this.connect_24qngr$(LocalSongs_getInstance().emitter, 'Local Database');
    this.connect_24qngr$(get_ids(filtered(storageDB.queryCache.emitter, this.ks, DBStatus_init$lambda)), 'Cloud');
    this.connect_24qngr$(get_ids(userSongsDB.like), 'Like');
    this.connect_24qngr$(get_ids(userSongsDB.new), 'New');
    this.connect_24qngr$(get_ids(userSongsDB.dontLike), "Don't Like");
    this.connect_24qngr$(transferSongs.upload, 'Upload');
    this.connect_24qngr$(transferSongs.download, 'Download');
  }
  ...
  DBStatus.prototype.connect_24qngr$ = function (emitter, title) {
  ...
  function songList$lambda$lambda$lambda$lambda_1(closure$tagDB, closure$userSongsDB) {
    return function (id, ks) {
      var tagRx = toRx(closure$tagDB.queryCache.placeholder_61zpoe$(id));
  ...
  function UserSongsDB$ids$lambda(this$UserSongsDB, closure$e) {
    return function () {
      ...
      this$UserSongsDB.killables_0.plusAssign_wii6vi$(feedTo_2(get_ids(closure$e), s));
      return s;
    };
  }
  ...
  return _;
}(typeof this['appsimake-music'] === 'undefined' ? {} : this['appsimake-music'], kotlin, this['appsimake-domx'], this['appsimake-bootstrap'], this['appsimake-fontawesome'], this['appsimake-commonui'], this['kotlinx-coroutines-core'], this['appsimake-commonshr'], this['appsimake-indexeddb'], this['appsimake-musiclib'], this['appsimake-common'], this['appsimake-firebase'], this['appsimake-commonlib'], this['appsimake-commonfb']);
