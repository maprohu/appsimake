...
this['appsimake-tasks'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_commonfb, $module$appsimake_taskslib, $module$appsimake_firebase, $module$appsimake_commonshr, $module$appsimake_fontawesome, $module$kotlinx_coroutines_core, $module$appsimake_common, $module$appsimake_commonui, $module$appsimake_commonlib) {
  ...
  function listTasks$lambda$lambda($receiver) {
    get_dGrid($receiver);
  ...
  function listTasks$lambda$lambda$lambda($receiver) {
    get_m1($receiver);
    get_justifySelfEnd($receiver);
    return Unit;
  }
  function listTasks$lambda$lambda_0($receiver) {
    get_cls($receiver).invoke_cr52h1$(listTasks$lambda$lambda$lambda);
  ...
  function listTasks$lambda$lambda$lambda_1($receiver) {
    $receiver.innerText = 'All';
    return Unit;
  }
  function listTasks$lambda$lambda$lambda$lambda(closure$s) {
    return function ($receiver) {
      $receiver.innerText = closure$s.name;
      return Unit;
    };
  }
  function listTasks$lambda$lambda$lambda$item$lambda$lambda(s) {
    return s.name;
  }
  function listTasks$lambda$lambda$lambda$item$lambda(closure$label, closure$m, closure$v) {
    return function ($receiver) {
      $receiver.innerText = closure$label + ' (' + joinToString(getValue(closure$m, closure$v), ', ', void 0, void 0, void 0, void 0, listTasks$lambda$lambda$lambda$item$lambda$lambda) + ')';
      return Unit;
    };
  }
  function listTasks$lambda$lambda$lambda$item(this$, closure$m) {
    return function (v, label) {
      invoke(get_option(this$), listTasks$lambda$lambda$lambda$item$lambda(label, closure$m, v));
    };
  }
  var ArrayList_init_0 = Kotlin.kotlin.collections.ArrayList_init_287e2$;
  function listTasks$lambda$lambda_1($receiver) {
    get_cls($receiver).invoke_cr52h1$(listTasks$lambda$lambda$lambda_0);
    invoke(get_option($receiver), listTasks$lambda$lambda$lambda_1);
    var $receiver_0 = TaskStatus$values();
    var tmp$;
    for (tmp$ = 0; tmp$ !== $receiver_0.length; ++tmp$) {
      var element = $receiver_0[tmp$];
      invoke(get_option($receiver), listTasks$lambda$lambda$lambda$lambda(element));
    }
    var $receiver_1 = TaskStatus$values();
    var destination = LinkedHashMap_init();
    var tmp$_0;
    for (tmp$_0 = 0; tmp$_0 !== $receiver_1.length; ++tmp$_0) {
      var element_0 = $receiver_1[tmp$_0];
      var key = element_0.completed;
      var tmp$_0_0;
    ...
    var item = listTasks$lambda$lambda$lambda$item($receiver, destination);
    item(false, 'Not Finished');
    item(true, 'Finished');
    return Unit;
  }
  function listTasks$lambda$lambda$lambda_2($receiver) {
    get_m1($receiver);
    get_justifySelfEnd($receiver);
    return Unit;
  }
  function listTasks$lambda$lambda_2($receiver) {
    get_cls($receiver).invoke_cr52h1$(listTasks$lambda$lambda$lambda_2);
  ...
  function listTasks$lambda$lambda$lambda$lambda$lambda$lambda($receiver) {
    get_fw($receiver);
    get_tags($receiver);
    return Unit;
  }
  function listTasks$lambda$lambda$lambda$lambda$lambda($receiver) {
    invoke_0(get_fa($receiver), listTasks$lambda$lambda$lambda$lambda$lambda$lambda);
    return Unit;
  }
  ...
  function listTasks$lambda$lambda$lambda_4($receiver) {
    get_cls($receiver).invoke_cr52h1$(listTasks$lambda$lambda$lambda$lambda_0);
    invoke(get_span($receiver), listTasks$lambda$lambda$lambda$lambda_1);
    return Unit;
  }
  function listTasks$lambda$lambda_3($receiver) {
    get_cls($receiver).invoke_cr52h1$(listTasks$lambda$lambda$lambda_3);
    invoke(get_button($receiver), listTasks$lambda$lambda$lambda_4);
    return Unit;
  }
  function listTasks$lambda_2($receiver) {
    get_cls($receiver).invoke_cr52h1$(listTasks$lambda$lambda);
    $receiver.style.cssText = trimIndent('\n                grid-template-columns: auto auto;\n            ');
    invoke(get_div($receiver), listTasks$lambda$lambda_0);
    invoke(get_select($receiver), listTasks$lambda$lambda_1);
    invoke(get_div($receiver), listTasks$lambda$lambda_2);
    invoke(get_div($receiver), listTasks$lambda$lambda_3);
    return Unit;
  }
  function listTasks($receiver, panel, after) {
    ...
    }.bind(null, $receiver)), query($receiver.userTasks, $receiver.db, listTasks$lambda_0), listTasks$lambda_1, new FilterConfig(listTasks$lambda_2)), panel, after);
  }
  ...
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_4(closure$recentSeq, closure$showHome, closure$root, this$LoggedIn) {
    return function (ha) {
      if (ha) {
  ...
  function LoggedIn$main$lambda$lambda$lambda$lambda$lambda_1(this$LoggedIn, closure$homeActive, closure$showHome) {
    return function ($receiver) {
      ...
      closure$homeActive.forEach_qlkmfe$(LoggedIn$main$lambda$lambda$lambda$lambda$lambda$lambda_4(recentSeq, closure$showHome, root, this$LoggedIn));
      return Unit;
    };
  }
