...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_commonfb, $module$appsimake_firebase, $module$appsimake_common, $module$appsimake_indexeddb, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_musiclib, $module$appsimake_fontawesome, $module$appsimake_firebaseshr, $module$appsimake_commonlib) {
  'use strict';
  ...
  var runUserState = $module$appsimake_commonfb.commonfb.runUserState_201dsr$;
  ...
  var FirebaseApi = $module$appsimake_firebase.firebase.FirebaseApi;
  var HasKillSetAndUIX = $module$appsimake_commonui.commonui.widget.HasKillSetAndUIX;
  var common = $module$appsimake_common.common;
  var UsageAndQuota = $module$appsimake_common.common.UsageAndQuota;
  var await_1 = $module$appsimake_indexeddb.indexeddb.await_cgxnqj$;
  var toSet = Kotlin.kotlin.collections.toSet_us0mfu$;
  var queryUsageAndQuota = $module$appsimake_common.common.queryUsageAndQuota_qs12is$;
  var getDirectory = $module$appsimake_common.common.getDirectory_lzt4nx$;
  var getFile = $module$appsimake_common.common.getFile_lzt4nx$;
  var file = $module$appsimake_common.common.file_sqof09$;
  var writeFile = $module$appsimake_common.common.writeFile_7y1pu9$;
  var remove = $module$appsimake_common.common.remove_sqof09$;
  var readAllEntries = $module$appsimake_common.common.readAllEntries_70fqbg$;
  ...
  var UiKillsApi = $module$appsimake_commonui.commonui.UiKillsApi;
  ...
  var requestPersistentFileSystem = $module$appsimake_common.common.requestPersistentFileSystem_cjjapg$;
  ...
  var get_checkDouble = $module$appsimake_fontawesome.fontawesome.get_checkDouble_xml72e$;
  ...
  var get_tachometerAlt = $module$appsimake_fontawesome.fontawesome.get_tachometerAlt_xml72e$;
  ...
  Details.prototype = Object.create(ForwardBase.prototype);
  Details.prototype.constructor = Details;
  Usage.prototype = Object.create(UIBase.prototype);
  ...
  function Boot(parent, from, localSongs) {
    ...
    this.$delegate_ffarcr$_0 = from;
    this.boot_uwv3j5$_0 = this;
    this.path = this;
    this.tasks = get_withCounter(discardExecutor(this));
    this.customTokenReady = CompletableDeferred(Unit);
    ...
    this.statusMessage = commonui.globalStatus;
    this.fbRefsDeferred_te042e$_0 = lazy(Boot$fbRefsDeferred$lambda(this));
    launch(this, void 0, void 0, Boot_init$lambda(this));
    this.songProcessMap_0 = LinkedHashMap_init();
  }
  Object.defineProperty(Boot.prototype, 'boot', {
    get: function () {
      return this.boot_uwv3j5$_0;
    }
  });
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = setupFileStorage(this);
          ...
          case 2:
            ...
            this.state_0 = 3;
            this.result_0 = LocalSongs$Companion_getInstance().invoke_vc7px7$(this.local$$receiver, storage, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
            var localSongs = this.result_0;
            this.local$$receiver_0 = new Boot(this.local$$receiver, this.local$closure$body, localSongs);
            this.state_0 = 4;
  ...
  Boot$Companion.prototype.create_bufp83$ = function (target, continuation) {
  ...
  function Boot$FBRefs(app, db, functions, storage) {
    this.app = app;
    this.db = db;
    this.functions = functions;
    this.storage = storage;
  }
  Boot$FBRefs.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FBRefs',
    interfaces: []
  };
  Object.defineProperty(Boot.prototype, 'fbRefsDeferred_0', {
    get: function () {
      return this.fbRefsDeferred_te042e$_0.value;
    }
  });
  Boot.prototype.fbRefs = function (continuation) {
    return this.fbRefsDeferred_0.await(continuation);
  };
  ...
  function Boot$SongProcess() {
    ...
    this.checkingStorage = new Var(false);
  }
  ...
  Object.defineProperty(Boot.prototype, 'body', {
    get: function () {
      return this.$delegate_ffarcr$_0.body;
    }
  });
  ...
  function Coroutine$Boot$fbRefsDeferred$lambda$lambda(this$Boot_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
  ...
  Coroutine$Boot$fbRefsDeferred$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot$fbRefsDeferred$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot$fbRefsDeferred$lambda$lambda.prototype.constructor = Coroutine$Boot$fbRefsDeferred$lambda$lambda;
  Coroutine$Boot$fbRefsDeferred$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$this$Boot.statusMessage.remAssign_11rb$('Initializing Firebase...');
            this.local$tmp$ = commonfb.FB.app;
            this.local$tmp$_0 = commonfb.FB.db;
            this.state_0 = 2;
          ...
          case 1:
            throw this.exception_0;
          case 2:
            return new Boot$FBRefs(this.local$tmp$, this.local$tmp$_0, this.result_0, commonfb.FB.storage);
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function Boot$fbRefsDeferred$lambda$lambda(this$Boot_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot$fbRefsDeferred$lambda$lambda(this$Boot_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Boot$fbRefsDeferred$lambda(this$Boot) {
    return function () {
      return async(this$Boot, void 0, void 0, Boot$fbRefsDeferred$lambda$lambda(this$Boot));
    };
  }
  function Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda(this$Boot_0, closure$st_0, this$_1, this$_2, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
  ...
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda.prototype.constructor = Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda;
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.local$tmp$_0 = this.local$this$.app;
            this.local$tmp$_1 = this.local$this$.db;
            this.local$tmp$_2 = this.local$this$.functions;
            this.local$tmp$_3 = this.local$this$.storage;
            this.local$tmp$_4 = cloudSongInfoSource(this.local$this$_0, this.local$this$.db);
            this.state_0 = 2;
            this.result_0 = userSongs(this.local$this$_0.kills, this.local$closure$st.user.uid, this.local$this$.db, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 2:
            tmp$ = this.result_0;
            return new LoggedIn(this.local$this$Boot, this.local$tmp$, this.local$tmp$_0, this.local$tmp$_1, this.local$tmp$_2, this.local$tmp$_3, this.local$tmp$_4, tmp$);
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function Boot_init$lambda$lambda$lambda$lambda$lambda(this$Boot_0, closure$st_0, this$_1, this$_2) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda(this$Boot_0, closure$st_0, this$_1, this$_2, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_0(this$Boot_0, this$_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
    this.local$this$ = this$_0;
  }
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_0.prototype.constructor = Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_0;
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return new NotLoggedIn(this.local$this$Boot, this.local$this$.app);
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function Boot_init$lambda$lambda$lambda$lambda$lambda_0(this$Boot_0, this$_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_0(this$Boot_0, this$_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_1(this$Boot_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
  }
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_1.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_1.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_1.prototype.constructor = Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_1;
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_1.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function Boot_init$lambda$lambda$lambda$lambda$lambda_1(this$Boot_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda_1(this$Boot_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot_init$lambda$lambda$lambda$lambda(closure$st_0, this$Boot_0, this$_1, this$_2, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$closure$st = closure$st_0;
    this.local$this$Boot = this$Boot_0;
        ...
        switch (this.state_0) {
          case 0:
            ...
            if (Kotlin.isType(tmp$, UserState$LoggedIn)) {
              this.local$this$Boot.statusMessage.remAssign_11rb$('Logging in...');
              this.state_0 = 5;
              this.result_0 = switchToView_0(this.local$this$Boot.content, Boot_init$lambda$lambda$lambda$lambda$lambda(this.local$this$Boot, this.local$closure$st, this.local$this$, this.local$this$_0), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
              ...
              if (Kotlin.isType(tmp$, Object.getPrototypeOf(UserState.NotLoggedIn).constructor)) {
                this.local$this$Boot.statusMessage.remAssign_11rb$('Logging out...');
                this.state_0 = 3;
                this.result_0 = switchToView_0(this.local$this$Boot.content, Boot_init$lambda$lambda$lambda$lambda$lambda_0(this.local$this$Boot, this.local$this$), this);
                if (this.result_0 === COROUTINE_SUSPENDED)
                  return COROUTINE_SUSPENDED;
                continue;
              }
                ...
                this.state_0 = 2;
                this.result_0 = switchToView_0(this.local$this$Boot.content, Boot_init$lambda$lambda$lambda$lambda$lambda_1(this.local$this$Boot), this);
                if (this.result_0 === COROUTINE_SUSPENDED)
                  return COROUTINE_SUSPENDED;
                continue;
              }
  ...
  function Boot_init$lambda$lambda$lambda$lambda(closure$st_0, this$Boot_0, this$_1, this$_2) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda$lambda(closure$st_0, this$Boot_0, this$_1, this$_2, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Boot_init$lambda$lambda$lambda(this$Boot, this$) {
    return function ($receiver, st) {
      this$Boot.exec(Boot_init$lambda$lambda$lambda$lambda(st, this$Boot, this$, $receiver));
      return Unit;
    };
  }
  function Boot_init$lambda$lambda$lambda_0(closure$d) {
    return function ($receiver) {
      $receiver.danger_61zpoe$(closure$d.toString());
      return Unit;
    };
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 1;
            this.result_0 = this.local$this$Boot.fbRefs(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            this.local$tmp$ = this.result_0;
            this.local$this$Boot_0 = this.local$this$Boot;
            this.exceptionState_0 = 5;
            this.local$this$Boot_0.statusMessage.remAssign_11rb$('Enabling persistence...');
            var tmp$ = this.local$tmp$.db;
            var $receiver = {};
            $receiver.experimentalTabSynchronization = true;
            this.state_0 = 2;
            this.result_0 = await_0(tmp$.enablePersistence($receiver), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 2:
            this.local$this$Boot_0.statusMessage.remAssign_11rb$('Switching to offline data...');
            this.state_0 = 3;
            this.result_0 = await_0(this.local$tmp$.db.disableNetwork(), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
            this.local$this$Boot_0.statusMessage.remAssign_11rb$('Checking user...');
            this.state_0 = 4;
            this.result_0 = runUserState(this.local$this$Boot_0, this.local$tmp$.app, void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
            this.local$this$Boot_0.forEach_5mel8p$(this.result_0, Boot_init$lambda$lambda$lambda(this.local$this$Boot_0, this.local$tmp$));
            this.exceptionState_0 = 7;
            this.state_0 = 6;
            continue;
          case 5:
            this.exceptionState_0 = 7;
            var d = this.exception_0;
            commonui.globalStatus.remAssign_11rb$('Error: ' + d.toString());
            this.local$this$Boot_0.slots.toasts(Boot_init$lambda$lambda$lambda_0(d));
            this.state_0 = 6;
            continue;
          case 6:
            return Unit;
  ...
  Boot.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Boot',
    interfaces: [BootPath, BodyPath, ViewImpl]
  };
  ...
  MusicApi.prototype.tasksUi_tdhe4g$ = function ($receiver) {
    return tasksUi(this, $receiver, this.boot);
  };
  MusicApi.prototype.tasksUi_55raw2$ = function ($receiver, fn) {
    return tasksUi_0(this, $receiver, fn);
  };
  MusicApi.prototype.syncUi_e1rmy3$ = function ($receiver) {
    syncUi(this, $receiver, this.loggedIn);
  };
  MusicApi.prototype.status_b5mdq1$ = function (items) {
    return new Database$Status(items, this, this.kills);
  };
  MusicApi.prototype.status_um4tjc$ = function (set) {
    return this.status_b5mdq1$(toMoves(set.diffsAll));
  };
  MusicApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'MusicApi',
    interfaces: [LoggedInPath, HasKillSetAndUIX, FirebaseApi]
  };
  ...
  function LocalSongStorage() {
  }
  LocalSongStorage.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'LocalSongStorage',
    interfaces: []
  };
  function IDBLocalSongStorage(idb) {
    this.idb = idb;
    this.name_uw0sx5$_0 = 'IndexedDB';
  }
  Object.defineProperty(IDBLocalSongStorage.prototype, 'name', {
    get: function () {
      return this.name_uw0sx5$_0;
    }
  });
  function Coroutine$usageInfo($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$tmp$ = void 0;
  }
  Coroutine$usageInfo.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$usageInfo.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$usageInfo.prototype.constructor = Coroutine$usageInfo;
  Coroutine$usageInfo.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (common.isStorageManagerSupported) {
              this.state_0 = 2;
              this.result_0 = await_0(window.navigator.storage.estimate(), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
          ...
          case 2:
            ...
            this.local$tmp$ = new UsageAndQuota(e_0.usage, e_0.quota);
            this.state_0 = 3;
            continue;
          case 3:
  ...
  IDBLocalSongStorage.prototype.usageInfo = function (continuation_0, suspended) {
    var instance = new Coroutine$usageInfo(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  IDBLocalSongStorage.prototype.readMp3_61zpoe$ = function (id, continuation) {
    return readMp3(this.idb, id, continuation);
  };
  IDBLocalSongStorage.prototype.writeMp3_tdb4ml$ = function (id, blob, continuation) {
    return await_1(writeMp3Store(this.idb).put(blob, id), continuation);
  };
  IDBLocalSongStorage.prototype.deleteMp3_61zpoe$ = function (id, continuation) {
    return await_1(writeMp3Store(this.idb).delete(id), continuation);
  };
  function Coroutine$listMp3s($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$listMp3s.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$listMp3s.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$listMp3s.prototype.constructor = Coroutine$listMp3s;
  Coroutine$listMp3s.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = await_1(readMp3Store(this.$this.idb).getAllKeys(), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  IDBLocalSongStorage.prototype.listMp3s = function (continuation_0, suspended) {
    var instance = new Coroutine$listMp3s(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  IDBLocalSongStorage.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'IDBLocalSongStorage',
    interfaces: [LocalSongStorage]
  };
  function FileSystemLocalSongStorage(dir) {
    FileSystemLocalSongStorage$Companion_getInstance();
    this.dir = dir;
    this.name_bsv60x$_0 = 'FileSystem';
  }
  Object.defineProperty(FileSystemLocalSongStorage.prototype, 'name', {
    get: function () {
      return this.name_bsv60x$_0;
    }
  });
  FileSystemLocalSongStorage.prototype.usageInfo = function (continuation) {
    return queryUsageAndQuota(window.navigator.webkitPersistentStorage, continuation);
  };
  function FileSystemLocalSongStorage$Companion() {
    FileSystemLocalSongStorage$Companion_instance = this;
  }
  function Coroutine$create_eu89pu$($this, fs_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$fs = fs_0;
  }
  Coroutine$create_eu89pu$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$create_eu89pu$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$create_eu89pu$.prototype.constructor = Coroutine$create_eu89pu$;
  Coroutine$create_eu89pu$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = getDirectory(this.local$fs.root, 'mp3s', void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            return new FileSystemLocalSongStorage(this.result_0);
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  FileSystemLocalSongStorage$Companion.prototype.create_eu89pu$ = function (fs_0, continuation_0, suspended) {
    var instance = new Coroutine$create_eu89pu$(this, fs_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  FileSystemLocalSongStorage$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var FileSystemLocalSongStorage$Companion_instance = null;
  function FileSystemLocalSongStorage$Companion_getInstance() {
    if (FileSystemLocalSongStorage$Companion_instance === null) {
      new FileSystemLocalSongStorage$Companion();
    }
    return FileSystemLocalSongStorage$Companion_instance;
  }
  function Coroutine$readMp3_61zpoe$($this, id_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 5;
    this.$this = $this;
    this.local$tmp$ = void 0;
  ...
  Coroutine$readMp3_61zpoe$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$readMp3_61zpoe$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$readMp3_61zpoe$.prototype.constructor = Coroutine$readMp3_61zpoe$;
  Coroutine$readMp3_61zpoe$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 2;
            var tmp$ = this.$this.dir;
            var $receiver = {};
            $receiver.create = false;
            this.state_0 = 1;
            this.result_0 = getFile(tmp$, this.local$id, $receiver, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 3:
            this.state_0 = 4;
            this.result_0 = file(this.local$tmp$, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
  ...
  FileSystemLocalSongStorage.prototype.readMp3_61zpoe$ = function (id_0, continuation_0, suspended) {
    var instance = new Coroutine$readMp3_61zpoe$(this, id_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$writeMp3_tdb4ml$($this, id_0, blob_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$id = id_0;
  ...
  Coroutine$writeMp3_tdb4ml$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$writeMp3_tdb4ml$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$writeMp3_tdb4ml$.prototype.constructor = Coroutine$writeMp3_tdb4ml$;
  Coroutine$writeMp3_tdb4ml$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = writeFile(this.$this.dir, this.local$id, this.local$blob, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  FileSystemLocalSongStorage.prototype.writeMp3_tdb4ml$ = function (id_0, blob_0, continuation_0, suspended) {
    var instance = new Coroutine$writeMp3_tdb4ml$(this, id_0, blob_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$deleteMp3_61zpoe$($this, id_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$id = id_0;
  }
  Coroutine$deleteMp3_61zpoe$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$deleteMp3_61zpoe$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$deleteMp3_61zpoe$.prototype.constructor = Coroutine$deleteMp3_61zpoe$;
  Coroutine$deleteMp3_61zpoe$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
          ...
          case 2:
            this.state_0 = 3;
            this.result_0 = remove(this.result_0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
  ...
  FileSystemLocalSongStorage.prototype.deleteMp3_61zpoe$ = function (id_0, continuation_0, suspended) {
    var instance = new Coroutine$deleteMp3_61zpoe$(this, id_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  function Coroutine$FileSystemLocalSongStorage$listMp3s$lambda(this$FileSystemLocalSongStorage_0, closure$ids_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$FileSystemLocalSongStorage = this$FileSystemLocalSongStorage_0;
    this.local$closure$ids = closure$ids_0;
    this.local$tmp$ = void 0;
    this.local$$receiver = $receiver_0;
  }
  Coroutine$FileSystemLocalSongStorage$listMp3s$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$FileSystemLocalSongStorage$listMp3s$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$FileSystemLocalSongStorage$listMp3s$lambda.prototype.constructor = Coroutine$FileSystemLocalSongStorage$listMp3s$lambda;
  Coroutine$FileSystemLocalSongStorage$listMp3s$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$tmp$ = readAllEntries(this.local$$receiver, this.local$this$FileSystemLocalSongStorage.dir).iterator();
            this.state_0 = 2;
            continue;
          case 1:
            throw this.exception_0;
          ...
          case 5:
            var e_0 = this.result_0;
            var tmp$ = this.local$closure$ids;
            var destination = ArrayList_init();
            var tmp$_0;
            for (tmp$_0 = 0; tmp$_0 !== e_0.length; ++tmp$_0) {
              var element = e_0[tmp$_0];
              if (element.isFile)
            ...
            addAll(tmp$, toSet_0(destination_0));
            this.state_0 = 2;
            continue;
          case 6:
            return Unit;
  ...
  function FileSystemLocalSongStorage$listMp3s$lambda(this$FileSystemLocalSongStorage_0, closure$ids_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$FileSystemLocalSongStorage$listMp3s$lambda(this$FileSystemLocalSongStorage_0, closure$ids_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$listMp3s_0($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$ids = void 0;
  }
  Coroutine$listMp3s_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$listMp3s_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$listMp3s_0.prototype.constructor = Coroutine$listMp3s_0;
  Coroutine$listMp3s_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$ids = LinkedHashSet_init();
            this.state_0 = 2;
            this.result_0 = coroutineScope(FileSystemLocalSongStorage$listMp3s$lambda(this.$this, this.local$ids), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  FileSystemLocalSongStorage.prototype.listMp3s = function (continuation_0, suspended) {
    var instance = new Coroutine$listMp3s_0(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  FileSystemLocalSongStorage.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FileSystemLocalSongStorage',
    interfaces: [LocalSongStorage]
  };
  function LocalSongs(parent, storage, initial) {
  ...
  function Coroutine$invoke_vc7px7$($this, parent_0, str_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  ...
  Coroutine$invoke_vc7px7$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$invoke_vc7px7$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$invoke_vc7px7$.prototype.constructor = Coroutine$invoke_vc7px7$;
  Coroutine$invoke_vc7px7$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$str.listMp3s(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            return new LocalSongs(this.local$parent, this.local$str, this.result_0);
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  LocalSongs$Companion.prototype.invoke_vc7px7$ = function (parent_0, str_0, continuation_0, suspended) {
    var instance = new Coroutine$invoke_vc7px7$(this, parent_0, str_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.storage.readMp3_61zpoe$(this.local$id, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.storage.writeMp3_tdb4ml$(this.local$id, this.local$blob, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.storage.deleteMp3_61zpoe$(this.local$id, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function songUi$lambda(closure$loggedIn, closure$id, closure$blob, this$songUi, closure$fileName, closure$bgfn) {
    return function ($receiver) {
      var boot = closure$loggedIn.boot;
  ...
  function tasksUi$lambda(closure$boot) {
    return function () {
      return closure$boot.tasks.pending.invoke();
    };
  }
  function tasksUi($receiver, factory, boot) {
    return tasksUi_0($receiver, factory, tasksUi$lambda(boot));
  }
  function tasksUi$lambda$lambda(closure$fn) {
    return function ($receiver) {
      return closure$fn() !== 0;
    };
  }
  function tasksUi$lambda$lambda_0(closure$fn) {
    return function () {
      return closure$fn().toString();
    };
  }
  function tasksUi_0($receiver, factory, fn) {
    var $receiver_0 = factory.badge;
    $receiver_0.visible_metn8w$($receiver, tasksUi$lambda$lambda(fn));
    get_m1($receiver_0.cls);
    $receiver_0.pill;
    $receiver_0.warning;
    $receiver.remAssign_7fncnf$($receiver_0.node, tasksUi$lambda$lambda_0(fn));
    return $receiver_0;
  }
  function Content() {
  }
  ...
  function UserUnknown(boot) {
    ...
    this.songInfoSource_xbu0tt$_0 = this.boot.localSongInfoSource;
    this.rawView_rbh9ba$_0 = ui_0(this);
  }
  ...
  UserUnknown.$metadata$ = {
    ...
    interfaces: [Content, ViewImpl, UiKillsApi]
  };
  ...
  function ui$lambda$lambda($receiver) {
    ...
    invoke(get_div($receiver), ui$lambda$lambda$lambda);
    return Unit;
  }
  function ui$lambda(this$ui) {
    return function ($receiver) {
      ...
      get_flexColumn($receiver_0);
      flexCenter($receiver_0);
      invoke(get_div($receiver), ui$lambda$lambda);
      var $receiver_1 = get_insert_0($receiver).status;
      var this$ui_0 = this$ui;
      flexFixedSize($receiver_1.cls);
      $receiver_1.get_global_mighe9$(this$ui_0);
      return Unit;
    };
  }
  function ui_0($receiver) {
    return new TopAndContent(null, widget.factory.wraps.div_iw61es$(ui$lambda($receiver)).node);
  }
  ...
  function localDatabase(continuation) {
    var $receiver = get_indexedDB(window).open('appsimake-music', L3);
    $receiver.addEventListener('upgradeneeded', localDatabase$lambda$lambda);
    return await_1($receiver, continuation);
  }
  var Math_0 = Math;
  function Coroutine$setupFileStorage(continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$tmp$ = void 0;
    this.local$MinQuota = void 0;
    this.local$ilss = void 0;
    this.local$tmp$_0 = void 0;
  ...
  Coroutine$setupFileStorage.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$setupFileStorage.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$setupFileStorage.prototype.constructor = Coroutine$setupFileStorage;
  Coroutine$setupFileStorage.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$MinQuota = 1073741824;
            this.state_0 = 2;
          ...
          case 1:
            throw this.exception_0;
          case 2:
            var ldb = this.result_0;
            this.local$ilss = new IDBLocalSongStorage(ldb);
            if (common.isFileSystemSupported) {
              commonui.globalStatus.remAssign_11rb$('Calculating IDB size...');
              this.state_0 = 3;
              this.result_0 = this.local$ilss.listMp3s(this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
             else {
              commonui.globalStatus.remAssign_11rb$('Using IDB.');
              this.local$tmp$ = this.local$ilss;
              this.state_0 = 16;
              continue;
            }
          ...
          case 4:
            ...
            var tmp$, tmp$_0;
            this.state_0 = 5;
            this.result_0 = this.local$ilss.readMp3_61zpoe$(element, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 5:
            this.local$sum += (tmp$_0 = (tmp$ = this.result_0) != null ? tmp$.size : null) != null ? tmp$_0 : 0;
            this.state_0 = 4;
            continue;
          case 6:
            var currentSize = this.local$sum;
            var b = currentSize * 2;
            var requestSize = Math_0.max(this.local$MinQuota, b);
            commonui.globalStatus.remAssign_11rb$('Requesting FileSystem storage: ' + get_groupThousands_0(Kotlin.Long.fromNumber(requestSize)) + ' bytes...');
            this.state_0 = 7;
            this.result_0 = requestPersistentFileSystem(window, requestSize, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 7:
            var fs = this.result_0;
            this.state_0 = 8;
            this.result_0 = FileSystemLocalSongStorage$Companion_getInstance().create_eu89pu$(fs, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 8:
            this.local$$receiver = this.result_0;
            commonui.globalStatus.remAssign_11rb$('Moving files to FileSystem...');
            this.state_0 = 9;
            this.result_0 = this.local$ilss.listMp3s(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 9:
            this.local$tmp$_1 = this.result_0.iterator();
            this.state_0 = 10;
            continue;
          case 10:
            ...
            var tmp$_1;
            this.state_0 = 11;
            this.result_0 = this.local$ilss.readMp3_61zpoe$(this.local$element, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 11:
            if ((tmp$_1 = this.result_0) != null) {
              this.state_0 = 12;
              this.result_0 = this.local$$receiver.writeMp3_tdb4ml$(this.local$element, tmp$_1, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
          ...
          case 12:
            this.state_0 = 13;
            this.result_0 = this.local$ilss.deleteMp3_61zpoe$(this.local$element, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 13:
          ...
          case 14:
            ...
            continue;
          case 15:
            commonui.globalStatus.remAssign_11rb$('FileSystem created.');
  ...
  function setupFileStorage(continuation_0, suspended) {
    var instance = new Coroutine$setupFileStorage(continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            var audioLoaded = CompletableDeferred_0();
  ...
  function Database(from) {
    ...
    this.from = from;
    this.database_xrdx92$_0 = this;
    this.toBeDownloaded = this.status_um4tjc$(this.filtered_49l5s4$(this.get_ids_wjz35z$(this.loggedIn.uploadedSet), Database$toBeDownloaded$lambda(this)));
    this.toBeUploaded = this.status_um4tjc$(this.filtered_49l5s4$(this.boot.localSongs.set, Database$toBeUploaded$lambda(this)));
    this.toBeDeleted = this.status_um4tjc$(this.filtered_49l5s4$(this.boot.localSongs.set, Database$toBeDeleted$lambda(this)));
    this.newInCloud = this.status_um4tjc$(this.filtered_49l5s4$(this.get_ids_wjz35z$(this.filtered_49l5s4$(this.loggedIn.storageSet.set, Database$newInCloud$lambda)), Database$newInCloud$lambda_0(this)));
    this.rawView_vrycfe$_0 = ui_2(this);
  }
  Object.defineProperty(Database.prototype, 'database', {
    get: function () {
      return this.database_xrdx92$_0;
    }
  });
  ...
  function Coroutine$details($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$details.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$details.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$details.prototype.constructor = Coroutine$details;
  Coroutine$details.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.forward.remAssign_11rb$(new Details(this.$this), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Database.prototype.details = function (continuation_0, suspended) {
    var instance = new Coroutine$details(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$usage($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$usage.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$usage.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$usage.prototype.constructor = Coroutine$usage;
  Coroutine$usage.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.forward.remAssign_11rb$(new Usage(this.$this), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Database.prototype.usage = function (continuation_0, suspended) {
    var instance = new Coroutine$usage(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Database$Status(items, path, kills) {
    this.items = items;
    this.path = path;
    this.kills_h7e34o$_0 = kills;
    this.set = this.toRxSet_jr4bl4$(this.items);
    this.count = new Var(0);
    this.size = new Var(L0);
    this.duration = new Var(0.0);
    process(this.items, this.kills, Database$Database$Status_init$lambda(this));
  }
  Object.defineProperty(Database$Status.prototype, 'kills', {
    get: function () {
      return this.kills_h7e34o$_0;
    }
  });
  function Coroutine$Database$Database$Status_init$lambda$lambda(this$Status_0, closure$id_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$Status = this$Status_0;
    this.local$closure$id = closure$id_0;
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$Status.path.boot.localSongs.load_61zpoe$(this.local$closure$id, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function Database$Database$Status_init$lambda$lambda(this$Status_0, closure$id_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Database$Database$Status_init$lambda$lambda(this$Status_0, closure$id_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Database$Database$Status_init$lambda(this$Status) {
    return function ($receiver, id) {
      var tag = this$Status.path.loggedIn.songInfoSource(id, Database$Database$Status_init$lambda$lambda(this$Status, id));
  ...
  Object.defineProperty(Database.prototype, 'body', {
    get: function () {
      return this.from.body;
    }
  });
  Object.defineProperty(Database.prototype, 'boot', {
    get: function () {
      return this.from.boot;
    }
  });
  Object.defineProperty(Database.prototype, 'loggedIn', {
    get: function () {
  ...
  function Database$toBeDownloaded$lambda(this$Database) {
    return function ($receiver, id) {
      return this$Database.loggedIn.userSongs.get(id).invoke() === UserSongState.Like && !$receiver.containsRx_1w65cx$(this$Database.boot.localSongs.set, id).invoke();
    };
  }
  function Database$toBeUploaded$lambda(this$Database) {
    return function ($receiver, id) {
      return this$Database.loggedIn.userSongs.get(id).invoke() === UserSongState.Like && !$receiver.containsRx_1w65cx$(this$Database.loggedIn.storageIds, id).invoke();
    };
  }
  function Database$toBeDeleted$lambda(this$Database) {
    return function ($receiver, id) {
      return this$Database.loggedIn.userSongs.get(id).invoke() === UserSongState.DontLike;
    };
  }
  ...
  function Database$newInCloud$lambda_0(this$Database) {
    return function ($receiver, id) {
      return !$receiver.containsRx_1w65cx$(this$Database.boot.localSongs.set, id).invoke() && this$Database.loggedIn.userSongs.get(id).invoke() === UserSongState.New;
    };
  }
  Database.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Database',
    interfaces: [DatabasePath, MusicApi, LoggedInPath, ForwardBase]
  };
  function DetailsPath() {
  }
  DetailsPath.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'DetailsPath',
    interfaces: [DatabasePath]
  };
  function Details(from) {
    ForwardBase_init(from, this);
    this.from = from;
    this.details_eae2fa$_0 = this;
    this.localSongIds = this.status_um4tjc$(this.boot.localSongs.set);
    this.new = this.status_um4tjc$(this.filtered_49l5s4$(this.boot.localSongs.set, Details$new$lambda(this)));
    this.like = this.status_um4tjc$(this.get_ids_wjz35z$(this.filtered_49l5s4$(this.loggedIn.userSongSet.set, Details$like$lambda)));
    this.dontLike = this.status_um4tjc$(this.get_ids_wjz35z$(this.filtered_49l5s4$(this.loggedIn.userSongSet.set, Details$dontLike$lambda)));
    this.cloud = this.status_um4tjc$(this.get_ids_wjz35z$(this.filtered_49l5s4$(this.loggedIn.storageSet.set, Details$cloud$lambda)));
    this.uploading = this.status_um4tjc$(this.loggedIn.uploadingIds);
    this.rawView_ndpus1$_0 = ui_1(this);
  }
  Object.defineProperty(Details.prototype, 'details', {
    get: function () {
      return this.details_eae2fa$_0;
    }
  });
  Object.defineProperty(Details.prototype, 'rawView', {
    get: function () {
      return this.rawView_ndpus1$_0;
    }
  });
  Object.defineProperty(Details.prototype, 'body', {
    get: function () {
      return this.from.body;
    }
  });
  Object.defineProperty(Details.prototype, 'boot', {
    get: function () {
      return this.from.boot;
    }
  });
  Object.defineProperty(Details.prototype, 'database', {
    get: function () {
      return this.from.database;
    }
  });
  Object.defineProperty(Details.prototype, 'loggedIn', {
    get: function () {
      return this.from.loggedIn;
    }
  });
  function Details$new$lambda(this$Details) {
    return function ($receiver, id) {
      return this$Details.loggedIn.userSongs.get(id).invoke() === UserSongState.New;
    };
  }
  function Details$like$lambda($receiver, us) {
    return equals(us.state.initial.invoke(), new Some(UserSongState.Like));
  }
  function Details$dontLike$lambda($receiver, us) {
    return equals(us.state.initial.invoke(), new Some(UserSongState.DontLike));
  }
  function Details$cloud$lambda($receiver, us) {
    return us.uploaded.initial.invoke().getOrDefault_11rb$(false);
  }
  Details.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Details',
    interfaces: [DetailsPath, DatabasePath, MusicApi, ForwardBase]
  };
  ...
  Coroutine$ui$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$ui.database.back();
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui$lambda$lambda$statusPanel(this$, this$ui) {
    return function (st, title, bgfn) {
      ...
      statusPanel(this$ui, get_insert_0(this$), this$ui.database, st, title, bgfn);
    };
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            tmp$ = this.local$this$ui.cloud.set.iterator();
            while (tmp$.hasNext()) {
              var element = tmp$.next();
              checkStorage(this.local$this$ui.loggedIn, element);
            }
  ...
  function ui$lambda$lambda$lambda_1(this$ui) {
    return function ($receiver, bg) {
      ...
      var this$ui_0 = this$ui;
      $receiver_0.p2;
      get_checkDouble($receiver_0.fa);
      $receiver_0.secondary;
      $receiver.click_3xepc3$($receiver_0, ui$lambda$lambda$lambda$lambda$lambda_0(this$ui_0));
      return Unit;
    };
  }
  function ui$lambda$lambda_0(this$ui) {
    return function ($receiver) {
      ...
      statusPanel(this$ui.cloud, 'Cloud', ui$lambda$lambda$lambda_1(this$ui));
  ...
  function ui_1($receiver) {
    ...
    remAssign($receiver_0.title, 'Database Details');
    ...
    invoke($receiver_2.pane, ui$lambda$lambda_0($receiver));
  ...
  Coroutine$ui$lambda$lambda$lambda_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$ui.loggedIn.back();
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_2.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$ui.loggedIn.sync.sync(), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_2(this$ui_0) {
    return function (continuation_0, suspended) {
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$ui.details(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$ui.usage(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_4(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda$statusPanel$lambda_0($receiver, it) {
    return Unit;
  }
  function ui$lambda$lambda$statusPanel_0(this$, this$ui) {
    return function (status, title, bgfn) {
      if (bgfn === void 0)
        bgfn = ui$lambda$lambda$statusPanel$lambda_0;
      statusPanel(this$ui, get_insert_0(this$), this$ui, status, title, bgfn);
    };
  }
  function ui$lambda$lambda$lambda$lambda$lambda_5(this$ui) {
    return function () {
      ...
      any$break: do {
        ...
        while (tmp$.hasNext()) {
          var element = tmp$.next();
          if (!this$ui.boot.processOf_61zpoe$(element).downloading.invoke()) {
            any$result = true;
            break any$break;
          }
        }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            while (tmp$.hasNext()) {
              var element = tmp$.next();
              download(this.local$this$ui.loggedIn, element);
            }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_6(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda$lambda_3(this$ui) {
    return function ($receiver, bg) {
      ...
      this$ui_0.rxEnabled_y5ufnr$($receiver_0, ui$lambda$lambda$lambda$lambda$lambda_5(this$ui_0));
      $receiver.click_3xepc3$($receiver_0, ui$lambda$lambda$lambda$lambda$lambda_6(this$ui_0));
      return Unit;
    };
  }
  function ui$lambda$lambda$lambda$lambda$lambda_7(this$ui) {
    return function () {
      ...
      any$break: do {
        ...
        while (tmp$.hasNext()) {
          var element = tmp$.next();
          if (!this$ui.boot.processOf_61zpoe$(element).uploading.invoke()) {
            any$result = true;
            break any$break;
          }
        }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            while (tmp$.hasNext()) {
              var element = tmp$.next();
              upload(this.local$this$ui.loggedIn, element);
            }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_8(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda$lambda_4(this$ui) {
    return function ($receiver, bg) {
      ...
      this$ui_0.rxEnabled_y5ufnr$($receiver_0, ui$lambda$lambda$lambda$lambda$lambda_7(this$ui_0));
      $receiver.click_3xepc3$($receiver_0, ui$lambda$lambda$lambda$lambda$lambda_8(this$ui_0));
      return Unit;
    };
  }
  function ui$lambda$lambda$lambda$lambda$lambda_9(this$ui) {
    return function () {
      ...
      any$break: do {
        ...
        while (tmp$.hasNext()) {
          var element = tmp$.next();
          if (!this$ui.boot.processOf_61zpoe$(element).deletingFromLocal.invoke()) {
            any$result = true;
            break any$break;
          }
        }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            while (tmp$.hasNext()) {
              var element = tmp$.next();
              deleteFromLocal(this.local$this$ui.loggedIn, element);
            }
  ...
  function ui$lambda$lambda$lambda_5(this$ui) {
    return function ($receiver, bg) {
      ...
      this$ui_0.rxEnabled_y5ufnr$($receiver_0, ui$lambda$lambda$lambda$lambda$lambda_9(this$ui_0));
      $receiver.click_3xepc3$($receiver_0, ui$lambda$lambda$lambda$lambda$lambda_10(this$ui_0));
      return Unit;
    };
  }
  function ui$lambda$lambda_1(this$ui) {
    return function ($receiver) {
      get_p1(get_cls($receiver));
      var statusPanel = ui$lambda$lambda$statusPanel_0($receiver, this$ui);
      statusPanel(this$ui.toBeDownloaded, 'To Be Downloaded', ui$lambda$lambda$lambda_3(this$ui));
      statusPanel(this$ui.toBeUploaded, 'To Be Uploaded', ui$lambda$lambda$lambda_4(this$ui));
      statusPanel(this$ui.toBeDeleted, 'To Be Deleted', ui$lambda$lambda$lambda_5(this$ui));
  ...
  function ui_2($receiver) {
    ...
    var $receiver_1 = $receiver_0.left.button;
    $receiver_1.back;
    $receiver.click_3xepc3$($receiver_1, ui$lambda$lambda$lambda_2($receiver));
    ...
    $receiver.click_ka8ib0$($receiver_4, ui$lambda$lambda$lambda$lambda$lambda_1($receiver));
    var $receiver_5 = $receiver_3.item;
    get_syncAlt($receiver_5.fa);
    $receiver_5.text.remAssign_61zpoe$('Synchronize');
    $receiver.click_ka8ib0$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_2($receiver));
    var $receiver_6 = $receiver_3.item;
    get_list($receiver_6.fa);
    $receiver_6.text.remAssign_61zpoe$('Details');
    $receiver.click_ka8ib0$($receiver_6, ui$lambda$lambda$lambda$lambda$lambda_3($receiver));
    var $receiver_7 = $receiver_3.item;
    get_tachometerAlt($receiver_7.fa);
    $receiver_7.text.remAssign_61zpoe$('Usage');
    $receiver.click_ka8ib0$($receiver_7, ui$lambda$lambda$lambda$lambda$lambda_4($receiver));
    var tmp$ = $receiver_0.node;
  ...
  function Coroutine$showStatus($receiver_0, database_0, st_0, title_0, bgfn_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
    this.local$database = database_0;
    this.local$st = st_0;
    this.local$title = title_0;
    this.local$bgfn = bgfn_0;
  }
  Coroutine$showStatus.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$showStatus.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$showStatus.prototype.constructor = Coroutine$showStatus;
  Coroutine$showStatus.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$$receiver.forward.remAssign_11rb$(new Status(this.local$$receiver, this.local$database, this.local$st, this.local$title, this.local$bgfn), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function showStatus($receiver_0, database_0, st_0, title_0, bgfn_0, continuation_0, suspended) {
    var instance = new Coroutine$showStatus($receiver_0, database_0, st_0, title_0, bgfn_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function statusPanel$lambda($receiver, it) {
    return Unit;
  }
  function statusPanel$lambda$lambda(closure$title) {
    return function ($receiver) {
      get_m1(get_cls($receiver));
  ...
  function statusPanel$lambda$lambda$lambda(closure$st) {
    return function () {
      return get_groupThousands(closure$st.count.invoke());
    };
  }
  function statusPanel$lambda$lambda$lambda_0(closure$st) {
    return function () {
      return get_groupThousands_0(closure$st.size.invoke());
    };
  }
  function statusPanel$lambda$lambda$lambda_1(closure$st) {
    return function () {
      return get_formatSecs(numberToInt(closure$st.duration.invoke()));
    };
  }
  function statusPanel$lambda$lambda_0(closure$st, this$statusPanel) {
    return function ($receiver) {
      get_m1(get_cls($receiver));
      remAssign(get_dt($receiver), 'Songs');
      this$statusPanel.remAssign_7fncnf$(get_dd($receiver), statusPanel$lambda$lambda$lambda(closure$st));
      remAssign(get_dt($receiver), 'Bytes');
      this$statusPanel.remAssign_7fncnf$(get_dd($receiver), statusPanel$lambda$lambda$lambda_0(closure$st));
      remAssign(get_dt($receiver), 'Duration');
      this$statusPanel.remAssign_7fncnf$(get_dd($receiver), statusPanel$lambda$lambda$lambda_1(closure$st));
      return Unit;
    };
  }
  function Coroutine$statusPanel$lambda$lambda$lambda$lambda$lambda(closure$database_0, closure$st_0, closure$title_0, closure$bgfn_0, this$statusPanel_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    ...
    this.local$this$statusPanel = this$statusPanel_0;
  }
  Coroutine$statusPanel$lambda$lambda$lambda$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$statusPanel$lambda$lambda$lambda$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$statusPanel$lambda$lambda$lambda$lambda$lambda.prototype.constructor = Coroutine$statusPanel$lambda$lambda$lambda$lambda$lambda;
  Coroutine$statusPanel$lambda$lambda$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = showStatus(this.local$this$statusPanel, this.local$closure$database, this.local$closure$st, this.local$closure$title, this.local$closure$bgfn, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function statusPanel$lambda$lambda$lambda$lambda$lambda(closure$database_0, closure$st_0, closure$title_0, closure$bgfn_0, this$statusPanel_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$statusPanel$lambda$lambda$lambda$lambda$lambda(closure$database_0, closure$st_0, closure$title_0, closure$bgfn_0, this$statusPanel_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function statusPanel$lambda$lambda_1(closure$bgfn, this$statusPanel, closure$database, closure$st, closure$title) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      row($receiver_0);
      get_justifyContentEnd($receiver_0);
      ...
      var closure$bgfn_0 = closure$bgfn;
      var this$statusPanel_0 = this$statusPanel;
      var closure$database_0 = closure$database;
      var closure$st_0 = closure$st;
      var closure$title_0 = closure$title;
      get_m1($receiver_1.cls);
      closure$bgfn_0(this$statusPanel_0, $receiver_1);
      var $receiver_2 = $receiver_1.button;
      $receiver_2.p2;
      $receiver_2.secondary;
      get_list($receiver_2.fa);
      this$statusPanel_0.click_3xepc3$($receiver_2, statusPanel$lambda$lambda$lambda$lambda$lambda(closure$database_0, closure$st_0, closure$title_0, closure$bgfn_0, this$statusPanel_0));
      return Unit;
    };
  }
  function statusPanel$lambda_0(closure$title, closure$st, this$statusPanel, closure$bgfn, closure$database) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_m1($receiver_0);
      get_p1($receiver_0);
      ...
      get_rounded($receiver_0);
      column($receiver_0);
      invoke(get_h6($receiver), statusPanel$lambda$lambda(closure$title));
      invoke(get_dl($receiver), statusPanel$lambda$lambda_0(closure$st, this$statusPanel));
      invoke(get_div($receiver), statusPanel$lambda$lambda_1(closure$bgfn, this$statusPanel, closure$database, closure$st, closure$title));
      return Unit;
    };
  }
  function statusPanel($receiver, factory, database, st, title, bgfn) {
    if (bgfn === void 0)
      bgfn = statusPanel$lambda;
    factory.wraps.div_iw61es$(statusPanel$lambda_0(title, st, $receiver, bgfn, database));
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$ui.refresh(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_11(this$ui) {
    return function () {
      var tmp$, tmp$_0;
      return (tmp$_0 = (tmp$ = this$ui.usageInfoVar.invoke()) != null ? get_groupThousands_0(numberToLong(tmp$.usage)) : null) != null ? tmp$_0 : '<unknown>';
    };
  }
  function ui$lambda$lambda$lambda$lambda$lambda_12(this$ui) {
    return function () {
      var tmp$, tmp$_0;
      return (tmp$_0 = (tmp$ = this$ui.usageInfoVar.invoke()) != null ? get_groupThousands_0(numberToLong(tmp$.quota)) : null) != null ? tmp$_0 : '<unknown>';
    };
  }
  function ui$lambda$lambda$lambda$lambda$lambda_13(this$ui) {
    return function () {
      var tmp$, tmp$_0;
      return (tmp$_0 = (tmp$ = this$ui.usageInfoVar.invoke()) != null ? roundToInt(numberToDouble(tmp$.usage) / numberToDouble(tmp$.quota) * 100).toString() + ' %' : null) != null ? tmp$_0 : '<unknown>';
    };
  }
  function ui$lambda$lambda$lambda$lambda_0(this$, this$ui) {
    return function ($receiver) {
      get_m1(get_cls($receiver));
      remAssign(get_dt($receiver), 'Type');
      remAssign(get_dd($receiver), this$.name);
      remAssign(get_dt($receiver), 'Usage');
      this$ui.remAssign_7fncnf$(get_dd($receiver), ui$lambda$lambda$lambda$lambda$lambda_11(this$ui));
      remAssign(get_dt($receiver), 'Quota');
      this$ui.remAssign_7fncnf$(get_dd($receiver), ui$lambda$lambda$lambda$lambda$lambda_12(this$ui));
      remAssign(get_dt($receiver), 'Percent');
  ...
  function ui$lambda$lambda_2(this$ui) {
    return function ($receiver) {
      get_p1(get_cls($receiver));
      var receiver = this$ui.boot.localSongs.storage;
      var this$ui_0 = this$ui;
      invoke(get_dl($receiver), ui$lambda$lambda$lambda$lambda_0(receiver, this$ui_0));
      return Unit;
    };
  }
  function ui_3($receiver) {
    ...
    var $receiver_1 = $receiver_0.left.button;
    $receiver_1.back;
    $receiver.click_3xepc3$($receiver_1, ui$lambda$lambda$lambda_6($receiver));
    var $receiver_2 = $receiver_0.right.button;
    $receiver_2.m1p2;
    $receiver_2.secondary;
    get_redoAlt($receiver_2.fa);
    $receiver.click_3xepc3$($receiver_2, ui$lambda$lambda$lambda_7($receiver));
    var tmp$ = $receiver_0.node;
    var $receiver_3 = widget.factory.scrollPane;
    invoke($receiver_3.pane, ui$lambda$lambda_2($receiver));
  ...
  UsagePath.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'UsagePath',
    interfaces: [DatabasePath]
  };
  function Usage(from) {
    UIBase_init(from, this);
    this.$delegate_xgevje$_0 = from;
    this.usage_eqghdp$_0 = this;
    this.usageInfoVar = new Var(null);
    launch(this, void 0, void 0, Usage_init$lambda(this));
    this.rawView_v98ki7$_0 = ui_3(this);
  }
  Object.defineProperty(Usage.prototype, 'usage', {
    get: function () {
      return this.usage_eqghdp$_0;
    }
  });
  function Coroutine$refresh($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$tmp$ = void 0;
  }
  Coroutine$refresh.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$refresh.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$refresh.prototype.constructor = Coroutine$refresh;
  Coroutine$refresh.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$tmp$ = this.$this.usageInfoVar;
            this.state_0 = 2;
            this.result_0 = this.$this.boot.localSongs.storage.usageInfo(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            this.local$tmp$.remAssign_11rb$(this.result_0);
            return;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
  ...
  Usage.prototype.refresh = function (continuation_0, suspended) {
    var instance = new Coroutine$refresh(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  Object.defineProperty(Usage.prototype, 'rawView', {
    get: function () {
      return this.rawView_v98ki7$_0;
    }
  });
  Object.defineProperty(Usage.prototype, 'body', {
    get: function () {
      return this.$delegate_xgevje$_0.body;
    }
  });
  Object.defineProperty(Usage.prototype, 'boot', {
    get: function () {
      return this.$delegate_xgevje$_0.boot;
    }
  });
  Object.defineProperty(Usage.prototype, 'database', {
    get: function () {
      return this.$delegate_xgevje$_0.database;
    }
  });
  Object.defineProperty(Usage.prototype, 'loggedIn', {
    get: function () {
      return this.$delegate_xgevje$_0.loggedIn;
    }
  });
  function Coroutine$Usage_init$lambda(this$Usage_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$Usage = this$Usage_0;
  }
  Coroutine$Usage_init$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Usage_init$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Usage_init$lambda.prototype.constructor = Coroutine$Usage_init$lambda;
  Coroutine$Usage_init$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$Usage.refresh(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function Usage_init$lambda(this$Usage_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$Usage_init$lambda(this$Usage_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  Usage.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Usage',
    interfaces: [UsagePath, DatabasePath, UIBase]
  };
  function ImportPath() {
  }
  ImportPath.$metadata$ = {
  ...
  function Import(from) {
    ...
    this.loader = get_withCounter(discardExecutor(this));
    this.rawView_xbdjti$_0 = ui_4(this);
  }
  Object.defineProperty(Import.prototype, 'import', {
    get: function () {
      return this.import_7gj8mk$_0;
    }
  });
  ...
  Import.prototype.load_c4p07t$ = function (list, continuation) {
    ...
    while (tmp$_0.hasNext()) {
      ...
      this.loader.exec(Import$load$lambda$lambda(element_0, this));
    }
  };
  ...
  Object.defineProperty(Import.prototype, 'body', {
    get: function () {
      return this.from.body;
    }
  });
  Object.defineProperty(Import.prototype, 'boot', {
    get: function () {
      return this.from.boot;
    }
  });
  Object.defineProperty(Import.prototype, 'database', {
    get: function () {
      return this.from.database;
    }
  });
  Object.defineProperty(Import.prototype, 'loggedIn', {
    get: function () {
      return this.from.loggedIn;
    }
  });
  ...
  Import.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Import',
    interfaces: [ImportPath, DatabasePath, MusicApi, UIBase]
  };
  function ImportFile(import_0, file, playable) {
    UIBase_init(import_0, this);
    this.file = file;
    this.playable = playable;
    this.$delegate_quogu9$_0 = import_0;
    var $receiver = new Var(false);
    this.forEach_5mel8p$($receiver, ImportFile$importing$lambda$lambda(import_0, this));
    this.importing = $receiver;
    var $receiver_0 = this.loggedIn.userSongs.get(this.playable.id);
    this.forEach_5mel8p$($receiver_0, ImportFile$state$lambda$lambda(this));
    this.state = $receiver_0;
    this.tag = this.loggedIn.songInfoSource(this.playable.id, ImportFile$tag$lambda(this));
    this.rawView_2r18my$_0 = ui_5(this);
    this.forEach_5mel8p$(this.containsRx_1w65cx$(this.boot.localSongs.set, this.playable.id), ImportFile_init$lambda(this));
  }
  ...
  Object.defineProperty(ImportFile.prototype, 'body', {
    get: function () {
      return this.$delegate_quogu9$_0.body;
    }
  });
  Object.defineProperty(ImportFile.prototype, 'boot', {
    get: function () {
      return this.$delegate_quogu9$_0.boot;
    }
  });
  Object.defineProperty(ImportFile.prototype, 'database', {
    get: function () {
      return this.$delegate_quogu9$_0.database;
    }
  });
  Object.defineProperty(ImportFile.prototype, 'import', {
    get: function () {
      return this.$delegate_quogu9$_0.import;
    }
  });
  Object.defineProperty(ImportFile.prototype, 'loggedIn', {
    get: function () {
      return this.$delegate_quogu9$_0.loggedIn;
    }
  });
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$ImportFile.boot.localSongs.addMp3_izzmmv$(this.local$this$ImportFile.playable, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function ImportFile$importing$lambda$lambda(closure$import, this$ImportFile) {
    return function ($receiver, i) {
      var $receiver_0 = closure$import.loadable;
      var this$ImportFile_0 = this$ImportFile;
      if (i) {
        $receiver_0.remove_11rb$(this$ImportFile_0);
        this$ImportFile_0.boot.tasks.exec(ImportFile$importing$lambda$lambda$lambda$lambda(this$ImportFile_0));
      }
       else {
  ...
  function ui$lambda$lambda_3(this$ui) {
    return function () {
      return this$ui.boot.tasks.pending.invoke() + this$ui.loader.pending.invoke() | 0;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda_1(this$, this$ui) {
    return function (it) {
      var tmp$;
  ...
  function ui$lambda$lambda$lambda_9(this$ui) {
    return function ($receiver) {
      ...
      $receiver.onchange = ui$lambda$lambda$lambda$lambda_1($receiver, this$ui);
      return Unit;
    };
  }
  function ui$lambda$lambda$lambda$lambda$lambda_14($receiver) {
    get_folderOpen(get_fa(get_cls($receiver)));
    return Unit;
  }
  function ui$lambda$lambda$lambda$lambda_2(closure$inp) {
    return function ($receiver) {
      $receiver.htmlFor = get_ref(closure$inp);
      faButtonSpan($receiver, void 0, ui$lambda$lambda$lambda$lambda$lambda_14);
      var $receiver_0 = get_cls($receiver);
      get_btn($receiver_0);
  ...
  function ui$lambda$lambda$lambda$lambda_3(this$, this$ui) {
    return function (it) {
      var tmp$;
      if ((tmp$ = this$.files) != null) {
        var this$ui_0 = this$ui;
  ...
  function ui$lambda$lambda$lambda_10(this$ui) {
    return function ($receiver) {
      ...
      $receiver.multiple = true;
      $receiver.accept = 'audio/mpeg';
      $receiver.onchange = ui$lambda$lambda$lambda$lambda_3($receiver, this$ui);
      return Unit;
    };
  }
  function ui$lambda$lambda$lambda$lambda$lambda_15($receiver) {
    get_file(get_fa(get_cls($receiver)));
    return Unit;
  }
  function ui$lambda$lambda$lambda$lambda_4(closure$inp) {
    return function ($receiver) {
      $receiver.htmlFor = get_ref(closure$inp);
      faButtonSpan($receiver, void 0, ui$lambda$lambda$lambda$lambda$lambda_15);
      var $receiver_0 = get_cls($receiver);
      get_btn($receiver_0);
      get_btnPrimary($receiver_0);
      get_m0($receiver_0);
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_16(this$ui) {
    return function ($receiver) {
  ...
  function ui_4($receiver) {
    ...
    var $receiver_1 = $receiver_0.left.button;
    $receiver_1.back;
    $receiver.click_3xepc3$($receiver_1, ui$lambda$lambda$lambda_8($receiver));
    remAssign($receiver_0.title, 'Import MP3s');
    var inputContainer = $receiver_0.node;
    $receiver.tasksUi_55raw2$($receiver_0.right, ui$lambda$lambda_3($receiver));
    var $receiver_2 = $receiver_0.right.buttonGroup;
    $receiver_2.m1;
    if (commonui.webkitdirectorySupported) {
      var $receiver_3 = invoke(get_input(inputContainer), ui$lambda$lambda$lambda_9($receiver));
      invoke(get_label($receiver_2.node), ui$lambda$lambda$lambda$lambda_2($receiver_3));
    }
    var $receiver_4 = invoke(get_input(inputContainer), ui$lambda$lambda$lambda_10($receiver));
    invoke(get_label($receiver_2.node), ui$lambda$lambda$lambda$lambda_4($receiver_4));
    var $receiver_5 = $receiver_0.right.dropdown;
    $receiver_5.bars;
    $receiver_5.right;
    var $receiver_6 = $receiver_5.menu;
    var $receiver_7 = $receiver_6.item;
    $receiver.rxClass_mjd6u9$($receiver_7.node, get_disabled(Cls.Companion), ui$lambda$lambda$lambda$lambda$lambda_16($receiver));
    get_fileImport($receiver_7.fa);
    $receiver_7.text.remAssign_61zpoe$('Start Importing');
    $receiver.click_ka8ib0$($receiver_7, ui$lambda$lambda$lambda$lambda$lambda_17($receiver));
    var $receiver_8 = $receiver_6.item;
    $receiver.rxClass_mjd6u9$($receiver_8.node, get_disabled(Cls.Companion), ui$lambda$lambda$lambda$lambda$lambda_18($receiver));
    get_trashAlt($receiver_8.fa);
    $receiver_8.text.remAssign_61zpoe$('Clear List');
    $receiver.click_ka8ib0$($receiver_8, ui$lambda$lambda$lambda$lambda$lambda_19($receiver));
    var tmp$ = $receiver_0.node;
    var $receiver_9 = widget.factory.scrollPane;
    var $receiver_10 = $receiver_9.cls;
    get_p1($receiver_10);
    get_flexColumn($receiver_10);
    listenableList($receiver_9.pane, $receiver.kills, $receiver.loadList, ui$lambda$lambda_4);
    return new TopAndContent(tmp$, $receiver_9.node);
  }
  function ui$lambda$lambda$lambda_11(this$ui) {
    return function () {
  ...
  function ui$lambda$lambda$lambda$lambda_5(it) {
    return get_formatSecs(roundToInt(it));
  }
  function ui$lambda$lambda$lambda_13(this$ui) {
    return function () {
      return this$ui.tag.secs.initial.invoke().map_2o04qz$(ui$lambda$lambda$lambda$lambda_5).getOrDefault_11rb$('<unknown>');
    };
  }
  function ui$lambda$lambda_5(this$ui) {
    return function ($receiver) {
      ...
      remAssign(get_dt($receiver), 'Artist');
      this$ui.remAssign_7fncnf$(get_dd($receiver), ui$lambda$lambda$lambda_11(this$ui));
      remAssign(get_dt($receiver), 'Title');
      this$ui.remAssign_7fncnf$(get_dd($receiver), ui$lambda$lambda$lambda_12(this$ui));
      remAssign(get_dt($receiver), 'Size');
      remAssign(get_dd($receiver), get_groupThousands(this$ui.file.size) + ' bytes');
      remAssign(get_dt($receiver), 'Duration');
      this$ui.remAssign_7fncnf$(get_dd($receiver), ui$lambda$lambda$lambda_13(this$ui));
      return Unit;
    };
  }
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_10.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$ui.boot.play_izzmmv$(this.local$this$ui.playable), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_21(this$ui) {
    return function ($receiver) {
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_11.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$ui.boot.like_61zpoe$(this.local$this$ui.playable.id), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_12.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$ui.boot.dontLike_61zpoe$(this.local$this$ui.playable.id), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_24(this$ui) {
    return function () {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_25(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_26(this$ui_0) {
    return function (continuation_0, suspended) {
  ...
  function ui$lambda$lambda_6(this$ui) {
    return function ($receiver) {
      ...
      $receiver_2.secondary;
      get_play($receiver_2.fa);
      this$ui_0.click_3xepc3$($receiver_2, ui$lambda$lambda$lambda$lambda$lambda_20(this$ui_0));
      var $receiver_3 = $receiver_1.button;
      $receiver_3.p2;
      get_thumbsUp($receiver_3.fa);
      this$ui_0.rxClass_wqb4ha$($receiver_3.node, ui$lambda$lambda$lambda$lambda$lambda_21(this$ui_0));
      this$ui_0.click_3xepc3$($receiver_3, ui$lambda$lambda$lambda$lambda$lambda_22(this$ui_0));
      var $receiver_4 = $receiver_1.button;
      $receiver_4.p2;
      $receiver_4.secondary;
      get_thumbsDown($receiver_4.fa);
      this$ui_0.click_3xepc3$($receiver_4, ui$lambda$lambda$lambda$lambda$lambda_23(this$ui_0));
      var $receiver_5 = $receiver_1.button;
      $receiver_5.p2;
      $receiver_5.secondary;
      get_fileImport($receiver_5.fa);
      this$ui_0.rxEnabled_y5ufnr$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_24(this$ui_0));
      this$ui_0.click_3xepc3$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_25(this$ui_0));
      var $receiver_6 = $receiver_1.button;
      $receiver_6.p2;
      $receiver_6.secondary;
      get_ban($receiver_6.fa);
      this$ui_0.click_3xepc3$($receiver_6, ui$lambda$lambda$lambda$lambda$lambda_26(this$ui_0));
      return Unit;
    };
  }
  function ui$lambda_0(this$ui) {
    return function ($receiver) {
      ...
      get_dFlex($receiver_0);
      get_flexColumn($receiver_0);
      invoke(get_dl($receiver), ui$lambda$lambda_5(this$ui));
      invoke(get_div($receiver), ui$lambda$lambda_6(this$ui));
      return Unit;
    };
  }
  function ui_5($receiver) {
    return invoke(get_div(document), ui$lambda_0($receiver));
  }
  function task($receiver, id, pr, fn) {
    $receiver.boot.task_1lt98f$(pr($receiver.boot.processOf_61zpoe$(id)), fn);
  }
  function upload$lambda($receiver) {
    return $receiver.uploading;
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$upload.boot.localSongs.load_61zpoe$(this.local$closure$id, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 2:
            ...
            if (file != null) {
              ...
              save($receiver, this$upload.loggedIn.db);
              $receiver.props.clearDirty();
              this.local$store = $receiver;
              var ref = this.local$this$upload.loggedIn.storageRef.child(this.local$closure$id);
              this.state_0 = 3;
          ...
          case 3:
            ...
            save(this.local$store, this$upload_0.loggedIn.db);
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$upload.loggedIn.privileged_lnyleu$(upload$lambda$lambda(this.local$this$upload, this.local$closure$id), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function upload$lambda_0(this$upload_0, closure$id_0) {
    return function (continuation_0, suspended) {
  ...
  function upload($receiver, id) {
    task($receiver, id, upload$lambda, upload$lambda_0($receiver, id));
  }
  function download$lambda($receiver) {
      ...
      try {
        switch (this.state_0) {
          ...
          case 3:
            var file = this.result_0;
            this.state_0 = 4;
            this.result_0 = this.local$this$download.boot.localSongs.addMp3_tdb4ml$(this.local$closure$id, file, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$download.loggedIn.privileged_lnyleu$(download$lambda$lambda(this.local$this$download, this.local$closure$id), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function download$lambda_0(this$download_0, closure$id_0) {
    return function (continuation_0, suspended) {
  ...
  function download($receiver, id) {
    task($receiver, id, download$lambda, download$lambda_0($receiver, id));
  }
  function deleteFromLocal$lambda($receiver) {
    return $receiver.deletingFromLocal;
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$deleteFromLocal.boot.localSongs.removeMp3_61zpoe$(this.local$closure$id, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function deleteFromLocal$lambda_0(this$deleteFromLocal_0, closure$id_0) {
    return function (continuation_0, suspended) {
  ...
  function deleteFromLocal($receiver, id) {
    task($receiver, id, deleteFromLocal$lambda, deleteFromLocal$lambda_0($receiver, id));
  }
  function deleteFromCloud$lambda($receiver) {
    return $receiver.deletingFromCloud;
  }
  ...
  Coroutine$deleteFromCloud$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            docRef(get_storage(musiclib.musicLib.app).doc_61zpoe$(this.local$closure$id), this.local$this$deleteFromCloud.loggedIn.db).delete();
            this.state_0 = 2;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$deleteFromCloud.loggedIn.privileged_lnyleu$(deleteFromCloud$lambda$lambda(this.local$closure$id, this.local$this$deleteFromCloud), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function deleteFromCloud$lambda_0(this$deleteFromCloud_0, closure$id_0) {
    return function (continuation_0, suspended) {
  ...
  function deleteFromCloud($receiver, id) {
    task($receiver, id, deleteFromCloud$lambda, deleteFromCloud$lambda_0($receiver, id));
  }
  function checkStorage$lambda($receiver) {
    return $receiver.checkingStorage;
  }
  function Coroutine$checkStorage$lambda$lambda$lambda(this$checkStorage_0, closure$id_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$checkStorage = this$checkStorage_0;
    this.local$closure$id = closure$id_0;
  }
  Coroutine$checkStorage$lambda$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$checkStorage$lambda$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$checkStorage$lambda$lambda$lambda.prototype.constructor = Coroutine$checkStorage$lambda$lambda$lambda;
  Coroutine$checkStorage$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$checkStorage.boot.localSongs.load_61zpoe$(this.local$closure$id, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function checkStorage$lambda$lambda$lambda(this$checkStorage_0, closure$id_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$checkStorage$lambda$lambda$lambda(this$checkStorage_0, closure$id_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function checkStorage$lambda$lambda$lambda_0(closure$e) {
    return function ($receiver) {
      throw IllegalStateException_init(closure$e.message.toString());
    };
  }
  function Coroutine$checkStorage$lambda$lambda(this$checkStorage_0, closure$id_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 6;
    this.local$this$checkStorage = this$checkStorage_0;
    this.local$closure$id = closure$id_0;
    this.local$tag = void 0;
    this.local$localSize = void 0;
  }
  Coroutine$checkStorage$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$checkStorage$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$checkStorage$lambda$lambda.prototype.constructor = Coroutine$checkStorage$lambda$lambda;
  Coroutine$checkStorage$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 4;
            this.local$tag = this.local$this$checkStorage.songInfoSource(this.local$closure$id, checkStorage$lambda$lambda$lambda(this.local$this$checkStorage, this.local$closure$id));
            this.state_0 = 1;
            this.result_0 = waitExtracted(this.local$tag, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            var localSizeOpt = this.local$tag.bytes.initial.now;
            if (Kotlin.isType(localSizeOpt, Some)) {
              this.local$localSize = localSizeOpt.value;
              this.state_0 = 2;
              this.result_0 = await_0(this.local$this$checkStorage.storageRef.child(this.local$closure$id).getMetadata(), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
          ...
          case 2:
            var meta = this.result_0;
            var cloudSize = meta.size;
            if (!equals(this.local$localSize, cloudSize)) {
              var message = 'Cloud storage size does not match local file. id: ' + this.local$closure$id + ' cloud: ' + cloudSize.toString() + ' local: ' + this.local$localSize;
              throw IllegalArgumentException_init(message.toString());
            }
          ...
          case 4:
            ...
            console.dir(e.unsafeCast < new Any());
            return this.local$this$checkStorage.boot.slots.toasts(checkStorage$lambda$lambda$lambda_0(e));
          case 5:
            return Unit;
          case 6:
            throw this.exception_0;
  ...
  function checkStorage$lambda$lambda(this$checkStorage_0, closure$id_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$checkStorage$lambda$lambda(this$checkStorage_0, closure$id_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$checkStorage$lambda(this$checkStorage_0, closure$id_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$checkStorage = this$checkStorage_0;
    this.local$closure$id = closure$id_0;
  }
  Coroutine$checkStorage$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$checkStorage$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$checkStorage$lambda.prototype.constructor = Coroutine$checkStorage$lambda;
  Coroutine$checkStorage$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$checkStorage.loggedIn.privileged_lnyleu$(checkStorage$lambda$lambda(this.local$this$checkStorage, this.local$closure$id), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function checkStorage$lambda_0(this$checkStorage_0, closure$id_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$checkStorage$lambda(this$checkStorage_0, closure$id_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function checkStorage($receiver, id) {
    task($receiver, id, checkStorage$lambda, checkStorage$lambda_0($receiver, id));
  }
  ...
  function LoggedIn(from, user, app, db, functions, storage, songInfoSource, userSongs) {
    ...
    this.rawView_mrgtfa$_0 = ui_6(this);
  ...
  Object.defineProperty(LoggedIn.prototype, 'loggedIn', {
    get: function () {
      return this.loggedIn_3smexi$_0;
    }
  });
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.boot.customTokenReady.await(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Object.defineProperty(LoggedIn.prototype, 'boot', {
    get: function () {
      return this.from.boot;
    }
  });
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$LoggedIn.boot.customTokenReady.await(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            return commonui.globalStatus.remAssign_11rb$('Logged in.'), Unit;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  LoggedIn.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LoggedIn',
    interfaces: [MusicApi, LoggedInPath, BootPath, Content, ForwardBase]
  };
  ...
  Coroutine$Sync_init$lambda$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            commonui.globalStatus.remAssign_11rb$('Going online...');
            this.state_0 = 1;
          ...
          case 1:
            this.exceptionState_0 = 5;
            commonui.globalStatus.remAssign_11rb$('Flushing data...');
            this.state_0 = 2;
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            continue;
          case 1:
            commonui.globalStatus.remAssign_11rb$('Syncing complete.');
            this.exceptionState_0 = 4;
            this.state_0 = 3;
            continue;
          case 2:
            this.exceptionState_0 = 4;
            var e = this.exception_0;
            this.local$this$.boot.slots.toasts(Sync_init$lambda$lambda$lambda$lambda_0(e));
            commonui.globalStatus.remAssign_11rb$('Syncing failed: ' + e.message.toString());
            this.state_0 = 3;
            continue;
          case 3:
  ...
  function Coroutine$ui$lambda$lambda$lambda$lambda$lambda_15(this$ui_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$ui = this$ui_0;
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_27(this$ui_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$ui$lambda$lambda$lambda$lambda$lambda_15(this$ui_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$ui$lambda$lambda$lambda$lambda$lambda_16(this$ui_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$ui = this$ui_0;
  }
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_16.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_16.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_16.prototype.constructor = Coroutine$ui$lambda$lambda$lambda$lambda$lambda_16;
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_16.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_28(this$ui_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$ui$lambda$lambda$lambda$lambda$lambda_16(this$ui_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function ui$lambda$lambda$lambda_14(this$) {
    return function ($receiver) {
      get_m1(this$.cls);
      return Unit;
    };
  ...
  function ui_6($receiver) {
    ...
    $receiver.click_ka8ib0$($receiver_4, ui$lambda$lambda$lambda$lambda$lambda_27($receiver));
    $receiver_3.divider;
    var $receiver_5 = $receiver_3.item;
    get_signOutAlt($receiver_5.fa);
    $receiver_5.text.remAssign_61zpoe$('Sign Out');
    $receiver.click_ka8ib0$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_28($receiver));
    remAssign($receiver_0.title, 'Music');
    $receiver.syncUi_e1rmy3$($receiver_0.slots.right.slots);
    var $receiver_6 = userIcon($receiver_0.right, $receiver.kills, $receiver.boot.userIcon);
    invoke($receiver_6.node, ui$lambda$lambda$lambda_14($receiver_6));
    var tmp$ = $receiver_0.node;
    var $receiver_7 = widget.factory.status;
    get_flexGrow1($receiver_7.cls);
    $receiver_7.get_global_mighe9$($receiver);
  ...
  function Coroutine$main$lambda(closure$loading_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = Boot$Companion_getInstance().create_bufp83$(this.local$closure$loading.target, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function main$lambda(closure$loading_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$main$lambda(closure$loading_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function main() {
    ...
    launchGlobal(main$lambda(loading));
  }
  ...
  function NotLoggedIn(boot, app) {
    ...
    this.rawView_sonhr6$_0 = ui_7(this);
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$NotLoggedIn.forward.switchTo_11rb$(new HourglassView(this.local$this$NotLoggedIn), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function NotLoggedIn$signIn$lambda$lambda$lambda(closure$it) {
    return function ($receiver) {
      $receiver.danger_61zpoe$('Sign in failed: ' + (closure$it != null ? closure$it.message : null).toString());
      return Unit;
    };
  }
  ...
  function Coroutine$NotLoggedIn$signIn$lambda$lambda_1(this$NotLoggedIn_0, closure$customTokenReady_0, it_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$NotLoggedIn = this$NotLoggedIn_0;
    this.local$closure$customTokenReady = closure$customTokenReady_0;
  }
  Coroutine$NotLoggedIn$signIn$lambda$lambda_1.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$NotLoggedIn$signIn$lambda$lambda_1.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$NotLoggedIn$signIn$lambda$lambda_1.prototype.constructor = Coroutine$NotLoggedIn$signIn$lambda$lambda_1;
  Coroutine$NotLoggedIn$signIn$lambda$lambda_1.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            this.state_0 = 2;
            this.result_0 = this.local$this$NotLoggedIn.boot.fbRefs(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            var functions = this.result_0.functions;
            commonui.globalStatus.remAssign_11rb$('Requesting online token...');
            this.state_0 = 3;
            this.result_0 = callable(commonlib.customToken, functions).call_11rb$(Unit, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
            if ((tmp$ = this.result_0) != null) {
              var this$NotLoggedIn = this.local$this$NotLoggedIn;
              commonui.globalStatus.remAssign_11rb$('Signing in with online token...');
              this.state_0 = 4;
              this.result_0 = await_0(this$NotLoggedIn.app.auth().signInWithCustomToken(tmp$), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
          ...
          case 4:
            ...
            continue;
          case 5:
            commonui.globalStatus.remAssign_11rb$('Signed in with online token.');
            return this.local$closure$customTokenReady.complete_11rb$(Unit);
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function NotLoggedIn$signIn$lambda$lambda_1(this$NotLoggedIn_0, closure$customTokenReady_0) {
    return function (it_0, continuation_0, suspended) {
      var instance = new Coroutine$NotLoggedIn$signIn$lambda$lambda_1(this$NotLoggedIn_0, closure$customTokenReady_0, it_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$NotLoggedIn$signIn$lambda(this$NotLoggedIn_0, closure$customTokenReady_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$NotLoggedIn = this$NotLoggedIn_0;
    this.local$closure$customTokenReady = closure$customTokenReady_0;
  ...
  Coroutine$NotLoggedIn$signIn$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return new Login(this.local$this$NotLoggedIn, this.local$this$NotLoggedIn.boot, this.local$this$NotLoggedIn.app, this.local$this$NotLoggedIn.back, NotLoggedIn$signIn$lambda$lambda(this.local$this$NotLoggedIn), NotLoggedIn$signIn$lambda$lambda_0(this.local$this$NotLoggedIn), NotLoggedIn$signIn$lambda$lambda_1(this.local$this$NotLoggedIn, this.local$closure$customTokenReady));
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function NotLoggedIn$signIn$lambda(this$NotLoggedIn_0, closure$customTokenReady_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$NotLoggedIn$signIn$lambda(this$NotLoggedIn_0, closure$customTokenReady_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  Coroutine$signIn.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var $receiver = CompletableDeferred_0();
            this.$this.boot.customTokenReady = $receiver;
            var customTokenReady = $receiver;
            this.state_0 = 2;
            this.result_0 = this.$this.forward.switchTo_cbny1b$(NotLoggedIn$signIn$lambda(this.$this, customTokenReady), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function Coroutine$ui$lambda$lambda$lambda$lambda$lambda_17(this$ui_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$ui = this$ui_0;
  }
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_17.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_17.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_17.prototype.constructor = Coroutine$ui$lambda$lambda$lambda$lambda$lambda_17;
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_17.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_29(this$ui_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$ui$lambda$lambda$lambda$lambda$lambda_17(this$ui_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function ui$lambda$lambda$lambda_15(this$) {
    return function ($receiver) {
      get_m1(this$.cls);
      return Unit;
    };
  ...
  function ui_7($receiver) {
    ...
    $receiver.click_ka8ib0$($receiver_3, ui$lambda$lambda$lambda$lambda$lambda_29($receiver));
    remAssign($receiver_0.title, 'Music');
    var $receiver_4 = userIcon($receiver_0.right, $receiver.kills, $receiver.path.boot.userIcon);
    invoke($receiver_4.node, ui$lambda$lambda$lambda_15($receiver_4));
  ...
  function ui$lambda$lambda_8(closure$totalDurationText) {
    return function ($receiver) {
      return closure$totalDurationText.invoke().length;
    };
  }
  function ui$lambda$lambda_9(this$ui, closure$totalDurationTextLength) {
    return function ($receiver) {
      return padStart(get_formatSecs(this$ui.currentPosition.invoke()), closure$totalDurationTextLength.invoke(), 32);
    };
  }
  function ui$lambda$lambda_10(this$ui) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda_12(closure$artistTitle) {
    return function ($receiver) {
      return closure$artistTitle.invoke().artist;
    };
  }
  function ui$lambda$lambda_13(closure$artistTitle) {
    return function ($receiver) {
      return closure$artistTitle.invoke().title;
    };
  }
  function ui$lambda$lambda$lambda_16(this$) {
  ...
  function ui$lambda$lambda$lambda_18(this$ui) {
    return function () {
  ...
  function ui$lambda$lambda$lambda_19(this$ui) {
    return function () {
  ...
  function ui$lambda$lambda$lambda_20(this$ui) {
    return function () {
  ...
  function ui$lambda$lambda$lambda_21(this$ui) {
    return function () {
  ...
  function ui$lambda$lambda$lambda_22(this$ui) {
    return function () {
      this$ui.uix(ui$lambda$lambda$lambda$lambda_11(this$ui));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_30(this$ui, closure$artist, closure$title) {
    return function ($receiver) {
      rxText($receiver, this$ui.kills, ui$lambda$lambda$lambda$lambda$lambda$lambda_1(closure$artist, closure$title));
      return Unit;
    };
  }
  function ui$lambda$lambda$lambda$lambda_12(this$ui, closure$artist, closure$title) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_m1($receiver_0);
      get_p1($receiver_0);
      ...
      invoke(get_span($receiver), ui$lambda$lambda$lambda$lambda$lambda_30(this$ui, closure$artist, closure$title));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_31(this$ui, closure$currentPositionText, closure$totalDurationText) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_m0($receiver_0);
      get_textPrimary($receiver_0);
  ...
  function ui$lambda$lambda$lambda$lambda_13(this$ui, closure$currentPositionText, closure$totalDurationText) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_border($receiver_0);
      get_borderPrimary($receiver_0);
      ...
      get_p2($receiver_0);
      flexCenter($receiver_0);
      invoke(get_pre($receiver), ui$lambda$lambda$lambda$lambda$lambda_31(this$ui, closure$currentPositionText, closure$totalDurationText));
      return Unit;
    };
  }
  function ui$lambda$lambda$lambda_23(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText) {
    return function ($receiver) {
      get_justifyContentCenter(get_cls($receiver));
      invoke(get_div($receiver), ui$lambda$lambda$lambda$lambda_12(this$ui, closure$artist, closure$title));
      invoke(get_div($receiver), ui$lambda$lambda$lambda$lambda_13(this$ui, closure$currentPositionText, closure$totalDurationText));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_32(this$ui) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_btn($receiver_0);
  ...
  function ui$lambda$lambda$lambda$lambda_14(this$ui) {
    return function ($receiver) {
      ...
      invoke(get_button($receiver), ui$lambda$lambda$lambda$lambda$lambda_32(this$ui));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_33(this$ui) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_34(this$ui) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_35(this$ui) {
    return function ($receiver) {
      get_btnOutlinePrimary(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_36(this$ui) {
    return function ($receiver) {
      get_btnOutlinePrimary(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda_15(this$ui, closure$mediaButton) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_m1($receiver_0);
      get_btnGroup($receiver_0);
      closure$mediaButton($receiver, get_stepBackward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_33(this$ui));
      closure$mediaButton($receiver, get_backward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_34(this$ui));
      closure$mediaButton($receiver, get_forward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_35(this$ui));
      closure$mediaButton($receiver, get_stepForward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_36(this$ui));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_37(closure$likeButtonsDisabled, this$ui, closure$state) {
    return function ($receiver) {
      get_btn(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_38(closure$likeButtonsDisabled, this$ui, closure$state) {
    return function ($receiver) {
      get_btn(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda_16(closure$likeButtonsDisabled, this$ui, closure$state) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_m1($receiver_0);
      get_btnGroup($receiver_0);
      invoke(get_button($receiver), ui$lambda$lambda$lambda$lambda$lambda_37(closure$likeButtonsDisabled, this$ui, closure$state));
      invoke(get_button($receiver), ui$lambda$lambda$lambda$lambda$lambda_38(closure$likeButtonsDisabled, this$ui, closure$state));
      return Unit;
    };
  }
  function ui$lambda$lambda$lambda_24(this$ui, closure$mediaButton, closure$likeButtonsDisabled, closure$state) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_flexWrap($receiver_0);
      get_justifyContentCenter($receiver_0);
      invoke(get_div($receiver), ui$lambda$lambda$lambda$lambda_14(this$ui));
      invoke(get_div($receiver), ui$lambda$lambda$lambda$lambda_15(this$ui, closure$mediaButton));
      invoke(get_div($receiver), ui$lambda$lambda$lambda$lambda_16(closure$likeButtonsDisabled, this$ui, closure$state));
      return Unit;
    };
  }
  function ui$lambda$lambda_14(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText, closure$likeButtonsDisabled, closure$state) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      ...
      row_0($receiver, ui$lambda$lambda$lambda_23(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText));
      row_0($receiver, ui$lambda$lambda$lambda_24(this$ui, mediaButton, closure$likeButtonsDisabled, closure$state));
      return Unit;
    };
  }
  function ui_8($receiver) {
    var $receiver_0 = new Factory();
    var totalDurationText = $receiver.rx_pn7ch0$(ui$lambda$lambda_7($receiver));
    var totalDurationTextLength = $receiver.rx_pn7ch0$(ui$lambda$lambda_8(totalDurationText));
    var currentPositionText = $receiver.rx_pn7ch0$(ui$lambda$lambda_9($receiver, totalDurationTextLength));
    var likeButtonsDisabled = $receiver.rx_pn7ch0$(ui$lambda$lambda_10($receiver));
    var state = $receiver.userSong;
    var artistTitle = $receiver.rx_pn7ch0$(ui$lambda$lambda_11($receiver));
    var artist = $receiver.rx_pn7ch0$(ui$lambda$lambda_12(artistTitle));
    var title = $receiver.rx_pn7ch0$(ui$lambda$lambda_13(artistTitle));
    if (mediasession.mediaSessionSupported) {
      var $receiver_1 = window.navigator.mediaSession;
      $receiver.forEach_5mel8p$(artistTitle, ui$lambda$lambda$lambda_16($receiver_1));
      $receiver_1.setActionHandler('play', ui$lambda$lambda$lambda_17($receiver));
      $receiver_1.setActionHandler('pause', ui$lambda$lambda$lambda_18($receiver));
      $receiver_1.setActionHandler('seekbackward', ui$lambda$lambda$lambda_19($receiver));
      $receiver_1.setActionHandler('seekforward', ui$lambda$lambda$lambda_20($receiver));
      $receiver_1.setActionHandler('previoustrack', ui$lambda$lambda$lambda_21($receiver));
      $receiver_1.setActionHandler('nexttrack', ui$lambda$lambda$lambda_22($receiver));
    }
    return $receiver_0.wraps.div_iw61es$(ui$lambda$lambda_14($receiver, artist, title, currentPositionText, totalDurationText, likeButtonsDisabled, state)).node;
  }
  var SeekSeconds;
  function VisiblePath(visible) {
    this.visible = visible;
    this.$delegate_uqedmb$_0 = visible.boot;
  }
  Object.defineProperty(VisiblePath.prototype, 'body', {
    get: function () {
      return this.$delegate_uqedmb$_0.body;
    }
  });
  Object.defineProperty(VisiblePath.prototype, 'boot', {
    get: function () {
      return this.$delegate_uqedmb$_0.boot;
    }
  });
  ...
  function Visible(boot) {
    ...
    this.rawView_13lnzh$_0 = ui_8(this);
  }
  ...
  function Status(from, database, stat, title, bgfn) {
    UIBase_init(from, this);
    this.from = from;
    this.stat = stat;
    this.title = title;
    this.bgfn = bgfn;
    this.$delegate_hxtta3$_0 = database;
    this.status_1i1ech$_0 = this;
    this.rawView_avgzzq$_0 = ui_9(this);
  }
  Object.defineProperty(Status.prototype, 'status', {
    get: function () {
      return this.status_1i1ech$_0;
    }
  });
  ...
  Object.defineProperty(Status.prototype, 'body', {
    get: function () {
      return this.$delegate_hxtta3$_0.body;
    }
  });
  Object.defineProperty(Status.prototype, 'boot', {
    get: function () {
      return this.$delegate_hxtta3$_0.boot;
    }
  });
  Object.defineProperty(Status.prototype, 'database', {
    get: function () {
      return this.$delegate_hxtta3$_0.database;
    }
  });
  Object.defineProperty(Status.prototype, 'loggedIn', {
    get: function () {
      return this.$delegate_hxtta3$_0.loggedIn;
    }
  });
  Status.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Status',
    interfaces: [StatusPath, DatabasePath, MusicApi, CommonFbApi, UIBase]
  };
  ...
  function ui$lambda$lambda$lambda_25(this$ui_0) {
    return function (continuation_0, suspended) {
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$ui.boot.localSongs.load_61zpoe$(this.local$closure$id, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function ui$lambda$lambda$lambda$lambda$lambda$lambda_19(this$ui, closure$id) {
    return function ($receiver) {
      if ($receiver.containsRx_1w65cx$(this$ui.boot.localSongs.set, closure$id).invoke()) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda(this$ui, closure$id) {
    return function ($receiver) {
      return !$receiver.containsRx_1w65cx$(this$ui.boot.localSongs.set, closure$id).invoke() && $receiver.containsRx_1w65cx$(this$ui.loggedIn.storageIds, closure$id).invoke();
    };
  }
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return download(this.local$this$ui.loggedIn, this.local$closure$id), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return upload(this.local$this$ui.loggedIn, this.local$closure$id), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_5(this$ui, closure$id) {
    return function ($receiver) {
      return $receiver.containsRx_1w65cx$(this$ui.boot.localSongs.set, closure$id).invoke();
    };
  }
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_1.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return deleteFromLocal(this.local$this$ui.loggedIn, this.local$closure$id), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_8(this$ui, closure$id) {
    return function ($receiver) {
      return $receiver.containsRx_1w65cx$(this$ui.loggedIn.storageIds, closure$id).invoke();
    };
  }
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_2.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return deleteFromCloud(this.local$this$ui.loggedIn, this.local$closure$id), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui$lambda$lambda$lambda$lambda$lambda$lambda_20(this$ui, closure$id, this$) {
    return function ($receiver) {
      var process = this$ui.boot.processOf_61zpoe$(closure$id);
  ...
  function Coroutine$ui$lambda$lambda$lambda$lambda$lambda_18(this$ui_0, this$_1, closure$id_0, this$_2, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$ui = this$ui_0;
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_18.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_18.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_18.prototype.constructor = Coroutine$ui$lambda$lambda$lambda$lambda$lambda_18;
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_18.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var api = get_fbapi(plus_0(this.local$this$ui, this.local$this$));
            var node = songUi(api, this.local$closure$id, null, ui$lambda$lambda$lambda$lambda$lambda$lambda_19(this.local$this$ui, this.local$closure$id), this.local$this$ui.loggedIn, ui$lambda$lambda$lambda$lambda$lambda$lambda_20(this.local$this$ui, this.local$closure$id, this.local$this$));
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_39(this$ui_0, this$_1, closure$id_0, this$_2) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$ui$lambda$lambda$lambda$lambda$lambda_18(this$ui_0, this$_1, closure$id_0, this$_2, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function ui$lambda$lambda$lambda$lambda_17(this$ui, this$, this$_0) {
    return function ($receiver, id) {
      launch(this$_0, this$ui.coroutineContext, void 0, ui$lambda$lambda$lambda$lambda$lambda_39(this$ui, $receiver, id, this$));
      return Unit;
    };
  }
  function Coroutine$ui$lambda$lambda$lambda_5(this$ui_0, this$_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$ui = this$ui_0;
  ...
  Coroutine$ui$lambda$lambda$lambda_5.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$ui$lambda$lambda$lambda_5.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$ui$lambda$lambda$lambda_5.prototype.constructor = Coroutine$ui$lambda$lambda$lambda_5;
  Coroutine$ui$lambda$lambda$lambda_5.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return process(this.local$this$ui.stat.items, this.local$this$ui.kills, ui$lambda$lambda$lambda$lambda_17(this.local$this$ui, this.local$this$, this.local$$receiver)), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui$lambda$lambda$lambda_26(this$ui_0, this$_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$ui$lambda$lambda$lambda_5(this$ui_0, this$_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function ui$lambda$lambda_15(this$ui) {
    return function ($receiver) {
      get_p1(get_cls($receiver));
      launch(this$ui, void 0, void 0, ui$lambda$lambda$lambda_26(this$ui, $receiver));
      return Unit;
    };
  }
  function ui_9($receiver) {
    ...
    var $receiver_1 = $receiver_0.left.button;
    $receiver_1.back;
    $receiver.click_3xepc3$($receiver_1, ui$lambda$lambda$lambda_25($receiver));
    $receiver.tasksUi_tdhe4g$($receiver_0.right);
    $receiver.syncUi_e1rmy3$($receiver_0.slots.right.slots);
    var $receiver_2 = $receiver_0.right.buttonGroup;
    $receiver_2.m1;
    ...
    var tmp$ = $receiver_0.node;
    var $receiver_3 = widget.factory.scrollPane;
    invoke($receiver_3.pane, ui$lambda$lambda_15($receiver));
    return new TopAndContent(tmp$, $receiver_3.node);
  }
  function Bind() {
  ...
  package$common.LocalSongStorage = LocalSongStorage;
  $$importsForInline$$['appsimake-common'] = $module$appsimake_common;
  package$common.IDBLocalSongStorage = IDBLocalSongStorage;
  Object.defineProperty(FileSystemLocalSongStorage, 'Companion', {
    get: FileSystemLocalSongStorage$Companion_getInstance
  });
  package$common.FileSystemLocalSongStorage = FileSystemLocalSongStorage;
  ...
  package$common.tasksUi_qasi2y$ = tasksUi_0;
  ...
  package$content.ui_zd33o2$ = ui_0;
  ...
  package$data.setupFileStorage = setupFileStorage;
  ...
  package$data.Mp3Tag = Mp3Tag;
  package$data.extractMp3Tag_qfdq9h$ = extractMp3Tag;
  ...
  var package$details = package$database.details || (package$database.details = {});
  package$details.DetailsPath = DetailsPath;
  package$details.Details = Details;
  package$details.ui_nf38ql$ = ui_1;
  package$database.ui_ihgqlm$ = ui_2;
  package$database.showStatus_nv1cm7$ = showStatus;
  package$database.statusPanel_av1go2$ = statusPanel;
  var package$usage = package$database.usage || (package$database.usage = {});
  package$usage.ui_sbvnwb$ = ui_3;
  package$usage.UsagePath = UsagePath;
  package$usage.Usage = Usage;
  ...
  package$import.ui_1redzq$ = ui_4;
  package$import.ui_jya5ma$ = ui_5;
  var package$loggedin = package$music.loggedin || (package$music.loggedin = {});
  package$loggedin.task_5g4192$ = task;
  ...
  package$notloggedin.ui_njwtce$ = ui_7;
  ...
  package$status.ui_c4885m$ = ui_9;
  var package$template = package$music.template || (package$music.template = {});
  package$template.Bind = Bind;
  MusicApi.prototype.get_ids_wjz35z$ = FirebaseApi.prototype.get_ids_wjz35z$;
  MusicApi.prototype.rx_pn7ch0$ = FirebaseApi.prototype.rx_pn7ch0$;
  MusicApi.prototype.rx_rf89m5$ = FirebaseApi.prototype.rx_rf89m5$;
  MusicApi.prototype.containsRx_1w65cx$ = FirebaseApi.prototype.containsRx_1w65cx$;
  MusicApi.prototype.filtered_49l5s4$ = FirebaseApi.prototype.filtered_49l5s4$;
  MusicApi.prototype.forEach_5mel8p$ = FirebaseApi.prototype.forEach_5mel8p$;
  MusicApi.prototype.forEach_igkruk$ = FirebaseApi.prototype.forEach_igkruk$;
  MusicApi.prototype.map_i8ud5a$ = FirebaseApi.prototype.map_i8ud5a$;
  MusicApi.prototype.onChange_ocsf2x$ = FirebaseApi.prototype.onChange_ocsf2x$;
  MusicApi.prototype.process_ttzep4$ = FirebaseApi.prototype.process_ttzep4$;
  MusicApi.prototype.remAssign_7fncnf$ = FirebaseApi.prototype.remAssign_7fncnf$;
  MusicApi.prototype.rxClass_wqb4ha$ = FirebaseApi.prototype.rxClass_wqb4ha$;
  MusicApi.prototype.rxClass_mjd6u9$ = FirebaseApi.prototype.rxClass_mjd6u9$;
  MusicApi.prototype.toChannelLater_z5dyp2$ = FirebaseApi.prototype.toChannelLater_z5dyp2$;
  MusicApi.prototype.toRxSet_jr4bl4$ = FirebaseApi.prototype.toRxSet_jr4bl4$;
  ...
  Content.prototype.get_childUIWrap_irb06o$ = JobScopeWithView.prototype.get_childUIWrap_irb06o$;
  ...
  Database$Status.prototype.rx_pn7ch0$ = HasKillSet.prototype.rx_pn7ch0$;
  Database$Status.prototype.rx_rf89m5$ = HasKillSet.prototype.rx_rf89m5$;
  Database$Status.prototype.containsRx_1w65cx$ = HasKillSet.prototype.containsRx_1w65cx$;
  Database$Status.prototype.filtered_49l5s4$ = HasKillSet.prototype.filtered_49l5s4$;
  Database$Status.prototype.forEach_5mel8p$ = HasKillSet.prototype.forEach_5mel8p$;
  Database$Status.prototype.forEach_igkruk$ = HasKillSet.prototype.forEach_igkruk$;
  Database$Status.prototype.map_i8ud5a$ = HasKillSet.prototype.map_i8ud5a$;
  Database$Status.prototype.onChange_ocsf2x$ = HasKillSet.prototype.onChange_ocsf2x$;
  Database$Status.prototype.process_ttzep4$ = HasKillSet.prototype.process_ttzep4$;
  Database$Status.prototype.remAssign_7fncnf$ = HasKillSet.prototype.remAssign_7fncnf$;
  Database$Status.prototype.rxClass_wqb4ha$ = HasKillSet.prototype.rxClass_wqb4ha$;
  Database$Status.prototype.rxClass_mjd6u9$ = HasKillSet.prototype.rxClass_mjd6u9$;
  Database$Status.prototype.toChannelLater_z5dyp2$ = HasKillSet.prototype.toChannelLater_z5dyp2$;
  Database$Status.prototype.toRxSet_jr4bl4$ = HasKillSet.prototype.toRxSet_jr4bl4$;
  Database.prototype.tasksUi_tdhe4g$ = MusicApi.prototype.tasksUi_tdhe4g$;
  Database.prototype.tasksUi_55raw2$ = MusicApi.prototype.tasksUi_55raw2$;
  Database.prototype.syncUi_e1rmy3$ = MusicApi.prototype.syncUi_e1rmy3$;
  Database.prototype.status_b5mdq1$ = MusicApi.prototype.status_b5mdq1$;
  Database.prototype.status_um4tjc$ = MusicApi.prototype.status_um4tjc$;
  Database.prototype.get_ids_wjz35z$ = MusicApi.prototype.get_ids_wjz35z$;
  Details.prototype.tasksUi_tdhe4g$ = MusicApi.prototype.tasksUi_tdhe4g$;
  Details.prototype.tasksUi_55raw2$ = MusicApi.prototype.tasksUi_55raw2$;
  Details.prototype.syncUi_e1rmy3$ = MusicApi.prototype.syncUi_e1rmy3$;
  Details.prototype.status_b5mdq1$ = MusicApi.prototype.status_b5mdq1$;
  Details.prototype.status_um4tjc$ = MusicApi.prototype.status_um4tjc$;
  Details.prototype.get_ids_wjz35z$ = MusicApi.prototype.get_ids_wjz35z$;
  Import.prototype.tasksUi_tdhe4g$ = MusicApi.prototype.tasksUi_tdhe4g$;
  Import.prototype.tasksUi_55raw2$ = MusicApi.prototype.tasksUi_55raw2$;
  Import.prototype.syncUi_e1rmy3$ = MusicApi.prototype.syncUi_e1rmy3$;
  Import.prototype.status_b5mdq1$ = MusicApi.prototype.status_b5mdq1$;
  Import.prototype.status_um4tjc$ = MusicApi.prototype.status_um4tjc$;
  ...
  LoggedIn.prototype.tasksUi_55raw2$ = MusicApi.prototype.tasksUi_55raw2$;
  LoggedIn.prototype.syncUi_e1rmy3$ = MusicApi.prototype.syncUi_e1rmy3$;
  LoggedIn.prototype.status_b5mdq1$ = MusicApi.prototype.status_b5mdq1$;
  LoggedIn.prototype.status_um4tjc$ = MusicApi.prototype.status_um4tjc$;
  ...
  Status.prototype.tasksUi_55raw2$ = MusicApi.prototype.tasksUi_55raw2$;
  Status.prototype.syncUi_e1rmy3$ = MusicApi.prototype.syncUi_e1rmy3$;
  Status.prototype.status_b5mdq1$ = MusicApi.prototype.status_b5mdq1$;
  Status.prototype.status_um4tjc$ = MusicApi.prototype.status_um4tjc$;
  Mp3Store = named(Mp3Store$lambda).provideDelegate_n5byny$(this, Mp3Store_metadata);
  SeekSeconds = 15.0;
  main();
  Kotlin.defineModule('appsimake-music', _);
  return _;
}(typeof this['appsimake-music'] === 'undefined' ? {} : this['appsimake-music'], kotlin, this['appsimake-commonui'], this['appsimake-commonshr'], this['kotlinx-coroutines-core'], this['appsimake-commonfb'], this['appsimake-firebase'], this['appsimake-common'], this['appsimake-indexeddb'], this['appsimake-domx'], this['appsimake-bootstrap'], this['appsimake-musiclib'], this['appsimake-fontawesome'], this['appsimake-firebaseshr'], this['appsimake-commonlib']);
