...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_commonfb, $module$appsimake_firebase, $module$appsimake_indexeddb, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_musiclib, $module$appsimake_fontawesome, $module$appsimake_common, $module$appsimake_commonlib, $module$appsimake_firebaseshr) {
  ...
  var HasUIXApi = $module$appsimake_commonui.commonui.widget.HasUIXApi;
  ...
  function Boot(parent, from, localSongs) {
    ...
    this.tasks = get_withCounter(Boot$tasks$lambda(this));
  ...
  function Coroutine$Boot$tasks$lambda$lambda(closure$t_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$t = closure$t_0;
  }
  Coroutine$Boot$tasks$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot$tasks$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot$tasks$lambda$lambda.prototype.constructor = Coroutine$Boot$tasks$lambda$lambda;
  Coroutine$Boot$tasks$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$closure$t(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function Boot$tasks$lambda$lambda(closure$t_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot$tasks$lambda$lambda(closure$t_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Boot$tasks$lambda(this$Boot) {
    return function (t) {
      launch(this$Boot, void 0, void 0, Boot$tasks$lambda$lambda(t));
      return Unit;
    };
  }
  ...
  MusicApi.prototype.tasksUi_ebzpz9$ = function ($receiver, boot) {
    return tasksUi(this, $receiver, boot);
  };
  MusicApi.prototype.syncUi_ibtow$ = function ($receiver, loggedIn) {
    syncUi(this, $receiver, loggedIn);
  };
  MusicApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'MusicApi',
    interfaces: [HasUIXApi, FBApi]
  };
  ...
  function Database(from) {
    ...
    this.like = new Database$Status(this, map(toMoves(this.filtered_49l5s4$(this.path.loggedIn.userSongSet.set, Database$like$lambda).diffsAll), Database$like$lambda_0));
    this.dontLike = new Database$Status(this, map(toMoves(this.filtered_49l5s4$(this.path.loggedIn.userSongSet.set, Database$dontLike$lambda).diffsAll), Database$dontLike$lambda_0));
    this.cloud = new Database$Status(this, map(toMoves(this.filtered_49l5s4$(this.path.loggedIn.storageSet.set, Database$cloud$lambda).diffsAll), Database$cloud$lambda_0));
    this.newInCloud = new Database$Status(this, map(toMoves(this.filtered_49l5s4$(this.path.loggedIn.storageSet.set, Database$newInCloud$lambda(this)).diffsAll), Database$newInCloud$lambda_0));
  ...
  function Coroutine$showStatus_a7ayit$($this, st_0, title_0, bgfn_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$st = st_0;
  ...
  Coroutine$showStatus_a7ayit$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$showStatus_a7ayit$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$showStatus_a7ayit$.prototype.constructor = Coroutine$showStatus_a7ayit$;
  Coroutine$showStatus_a7ayit$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  Database.prototype.showStatus_a7ayit$ = function (st_0, title_0, bgfn_0, continuation_0, suspended) {
    var instance = new Coroutine$showStatus_a7ayit$(this, st_0, title_0, bgfn_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  function Database$like$lambda$lambda(s) {
    return s.props.idOrFail;
  }
  function Database$like$lambda_0(m) {
    return m.map_2o04qz$(Database$like$lambda$lambda);
  }
  function Database$dontLike$lambda($receiver, us) {
    return equals(us.state.initial.invoke(), new Some(UserSongState.DontLike));
  }
  function Database$dontLike$lambda$lambda(s) {
    return s.props.idOrFail;
  }
  function Database$dontLike$lambda_0(m) {
    return m.map_2o04qz$(Database$dontLike$lambda$lambda);
  }
  function Database$cloud$lambda($receiver, us) {
    return us.uploaded.initial.invoke().getOrDefault_11rb$(false);
  }
  function Database$cloud$lambda$lambda(s) {
    return s.props.idOrFail;
  }
  function Database$cloud$lambda_0(m) {
    return m.map_2o04qz$(Database$cloud$lambda$lambda);
  }
  function Database$newInCloud$lambda(this$Database) {
    return function ($receiver, us) {
      var id = us.props.idOrFail;
      return us.uploaded.initial.invoke().getOrDefault_11rb$(false) && !$receiver.containsRx_1w65cx$(this$Database.path.boot.localSongs.set, id).invoke() && this$Database.path.loggedIn.userSongs.get(id).invoke() === UserSongState.New;
    };
  }
  function Database$newInCloud$lambda$lambda(s) {
    return s.props.idOrFail;
  }
  function Database$newInCloud$lambda_0(m) {
    return m.map_2o04qz$(Database$newInCloud$lambda$lambda);
  }
  Database.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Database',
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$ui.showStatus_a7ayit$(this.local$closure$st, this.local$closure$title, this.local$closure$bgfn, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function ui_0($receiver) {
    ...
    $receiver.tasksUi_ebzpz9$($receiver_0.right, $receiver.path.boot);
    $receiver.syncUi_ibtow$($receiver_0.slots.right.slots, $receiver.path.loggedIn);
  ...
  function ui_3($receiver) {
    ...
    $receiver.syncUi_ibtow$($receiver_0.slots.right.slots, $receiver);
  ...
  function ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral(this$ui, this$) {
    this.this$ui = this$ui;
    this.$delegate_vffo9h$_0 = this$ui;
    this.kills_r9gpku$_0 = this$.kills;
  }
  Object.defineProperty(ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype, 'kills', {
    get: function () {
      return this.kills_r9gpku$_0;
    }
  });
  Object.defineProperty(ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype, 'uix', {
    get: function () {
      return this.$delegate_vffo9h$_0.uix;
    }
  });
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.get_ids_wjz35z$ = function ($receiver) {
    return this.$delegate_vffo9h$_0.get_ids_wjz35z$($receiver);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.rx_pn7ch0$ = function (fn) {
    return this.$delegate_vffo9h$_0.rx_pn7ch0$(fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.rx_rf89m5$ = function (killFirst, fn) {
    return this.$delegate_vffo9h$_0.rx_rf89m5$(killFirst, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.click_3xepc3$ = function ($receiver, action) {
    return this.$delegate_vffo9h$_0.click_3xepc3$($receiver, action);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.click_ka8ib0$ = function ($receiver, action) {
    return this.$delegate_vffo9h$_0.click_ka8ib0$($receiver, action);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.click_htd9kn$ = function ($receiver, action) {
    return this.$delegate_vffo9h$_0.click_htd9kn$($receiver, action);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.containsRx_1w65cx$ = function ($receiver, value) {
    return this.$delegate_vffo9h$_0.containsRx_1w65cx$($receiver, value);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.filtered_49l5s4$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.filtered_49l5s4$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.forEach_5mel8p$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.forEach_5mel8p$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.forEach_igkruk$ = function ($receiver, killOrder, fn) {
    return this.$delegate_vffo9h$_0.forEach_igkruk$($receiver, killOrder, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.map_i8ud5a$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.map_i8ud5a$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.onChange_ocsf2x$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.onChange_ocsf2x$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.process_ttzep4$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.process_ttzep4$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.remAssign_ah7wag$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.remAssign_ah7wag$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.remAssign_7fncnf$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.remAssign_7fncnf$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.rxClass_wqb4ha$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.rxClass_wqb4ha$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.rxClass_mjd6u9$ = function ($receiver, stl, fn) {
    return this.$delegate_vffo9h$_0.rxClass_mjd6u9$($receiver, stl, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.rxEnabled_y5ufnr$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.rxEnabled_y5ufnr$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.toRxSet_jr4bl4$ = function ($receiver) {
    return this.$delegate_vffo9h$_0.toRxSet_jr4bl4$($receiver);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.prototype.visibility_dakdiv$ = function ($receiver, fn) {
    return this.$delegate_vffo9h$_0.visibility_dakdiv$($receiver, fn);
  };
  ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [CommonFbApi]
  };
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_15.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var api = new ui$lambda$lambda$lambda$lambda$lambda$ObjectLiteral(this.local$this$ui, this.local$this$);
  ...
  package$loggedin.syncUi_snujax$ = syncUi;
  ...
  MusicApi.prototype.click_3xepc3$ = HasUIXApi.prototype.click_3xepc3$;
  MusicApi.prototype.click_ka8ib0$ = HasUIXApi.prototype.click_ka8ib0$;
  MusicApi.prototype.click_htd9kn$ = HasUIXApi.prototype.click_htd9kn$;
  ...
  Database.prototype.tasksUi_ebzpz9$ = MusicApi.prototype.tasksUi_ebzpz9$;
  Database.prototype.syncUi_ibtow$ = MusicApi.prototype.syncUi_ibtow$;
  Database.prototype.get_ids_wjz35z$ = MusicApi.prototype.get_ids_wjz35z$;
  Import.prototype.tasksUi_ebzpz9$ = MusicApi.prototype.tasksUi_ebzpz9$;
  Import.prototype.syncUi_ibtow$ = MusicApi.prototype.syncUi_ibtow$;
  Import.prototype.get_ids_wjz35z$ = MusicApi.prototype.get_ids_wjz35z$;
  LoggedIn.prototype.tasksUi_ebzpz9$ = MusicApi.prototype.tasksUi_ebzpz9$;
  LoggedIn.prototype.syncUi_ibtow$ = MusicApi.prototype.syncUi_ibtow$;
  ...
  Status.prototype.tasksUi_ebzpz9$ = MusicApi.prototype.tasksUi_ebzpz9$;
  Status.prototype.syncUi_ibtow$ = MusicApi.prototype.syncUi_ibtow$;
