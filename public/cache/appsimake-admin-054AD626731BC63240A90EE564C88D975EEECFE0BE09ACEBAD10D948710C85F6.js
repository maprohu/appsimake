...
this['appsimake-admin'] = function (_, Kotlin, $module$appsimake_commonfb, $module$appsimake_adminlib, $module$appsimake_commonui, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_indexlib, $module$appsimake_firebase, $module$appsimake_commonlib, $module$kotlinx_coroutines_core) {
  ...
  var get_border0 = $module$appsimake_bootstrap.bootstrap.get_border0_kre7dp$;
  var invoke = $module$appsimake_domx.domx.invoke_inodcj$;
  var get_height0 = $module$appsimake_domx.styles.get_height0_kre7dp$;
  var get_hAuto = $module$appsimake_bootstrap.bootstrap.get_hAuto_kre7dp$;
  ...
  function ui$lambda$lambda$lambda_0($receiver) {
    var $receiver_0 = get_cls($receiver);
    get_hAuto($receiver_0);
    get_scrollVertical($receiver_0);
    get_flexGrow1($receiver_0);
    return Unit;
  }
  function ui$lambda$lambda$lambda_1(this$) {
    return function (html) {
  ...
  function ui$lambda_0(closure$pellChange, this$ui, closure$codeChange) {
    return function ($receiver) {
      ...
      $receiver_1.element = $receiver;
      $receiver_1.onChange = ui$lambda$lambda$lambda(closure$pellChange_0);
      $receiver_1.styleWithCSS = true;
      var $receiver_2 = {};
      $receiver_2.name = 'heading3';
      $receiver_2.icon = '<b>H<sub>3<\/sub><\/b>';
      $receiver_2.title = 'Heading 3';
      $receiver_2.result = ui$lambda$lambda$lambda$lambda;
      $receiver_1.actions = ['bold', 'italic', 'underline', 'strikethrough', 'heading1', 'heading2', $receiver_2, 'paragraph', 'quote', 'olist', 'ulist', 'code', 'line', 'link', 'image'];
      var $receiver_3 = tmp$.init($receiver_1);
      var this$ui_0 = this$ui;
      var closure$codeChange_0 = closure$codeChange;
      invoke($receiver_3.content, ui$lambda$lambda$lambda_0);
      $receiver_3.content.innerHTML = this$ui_0.editing.current.html.now;
      closure$codeChange_0.plusAssign_qlkmfe$(ui$lambda$lambda$lambda_1($receiver_3));
      return Unit;
    };
  }
  ...
  function ui($receiver) {
    ...
    var editorNode = column(document, ui$lambda_0(pellChange, $receiver, codeChange));
  ...
  function ui_1($receiver) {
    ...
    $receiver.signOut_tstgz9$($receiver_2, ui$lambda$lambda$lambda$lambda_2($receiver));
    $receiver.get_reload_rp0x24$($receiver_2);
  ...
  function ui_2($receiver) {
    ...
    $receiver_1.bars;
    var $receiver_2 = $receiver_1.menu;
    $receiver.signOut_tstgz9$($receiver_2, ui$lambda$lambda$lambda$lambda_3($receiver));
    $receiver.get_reload_rp0x24$($receiver_2);
    var tmp$ = $receiver_0.node;
  ...
  Index.prototype.get_reload_rp0x24$ = FBBackApi.prototype.get_reload_rp0x24$;
