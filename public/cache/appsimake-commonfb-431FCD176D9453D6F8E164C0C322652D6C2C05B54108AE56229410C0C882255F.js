...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_fontawesome, $module$appsimake_domx, $module$appsimake_bootstrap) {
  ...
  function libMessages$lambda(this$libMessages, closure$ch) {
    return function (e) {
      var msgData = e.data;
  ...
  function libMessages($receiver) {
    var ch = Channel(2147483647);
    on(window.navigator.serviceWorker, $receiver, 'message', libMessages$lambda($receiver, ch));
    return ch;
  }
  ...
  package$messaging.libMessages_2xd7w5$ = libMessages;
