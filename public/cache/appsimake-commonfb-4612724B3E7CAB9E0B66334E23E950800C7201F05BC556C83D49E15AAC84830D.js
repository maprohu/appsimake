...
this['appsimake-commonfb'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_firebase, $module$appsimake_commonui, $module$kotlinx_coroutines_core, $module$appsimake_fontawesome, $module$appsimake_domx, $module$appsimake_bootstrap) {
  ...
  var HasKillsLib = $module$appsimake_commonshr.commonshr.HasKillsLib;
  ...
  HasCsDbKillsLibToast.$metadata$ = {
    ...
    interfaces: [HasKillsLib, HasCsDbKillsToast]
  };
  function HasLogin() {
  }
  HasLogin.$metadata$ = {
  ...
  function libMessages$lambda$lambda(this$libMessages, closure$ch) {
    return function (e) {
      var msgData = e.data;
  ...
  function libMessages($receiver, fcmOpt) {
    ...
    if (fcmOpt != null) {
      on(window.navigator.serviceWorker, $receiver, 'message', libMessages$lambda$lambda($receiver, ch));
  ...
  package$messaging.libMessages_t77b5h$ = libMessages;
