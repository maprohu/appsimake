...
this['appsimake-music'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonfb, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_indexeddb, $module$appsimake_musiclib, $module$appsimake_domx, $module$appsimake_firebase, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_common, $module$appsimake_commonlib, $module$appsimake_firebaseshr) {
  'use strict';
  ...
  var runUserState = $module$appsimake_commonfb.commonfb.runUserState_g2eoyy$;
  var fwd = $module$appsimake_commonui.commonui.widget.fwd_kg9inz$;
  ...
  var lazy = $module$appsimake_commonfb.commonfb.lazy_muuc72$;
  ...
  var process = $module$appsimake_commonshr.rx.process_w2h46r$;
  ...
  var toRxSetWithLookup = $module$appsimake_firebase.firebase.firestore.toRxSetWithLookup_muuc72$;
  var merge = $module$appsimake_commonfb.commonfb.merge_t7bci5$;
  ...
  var fwdc = $module$appsimake_commonui.commonui.widget.fwdc_8pwk8e$;
  ...
  function Boot(parent, from, idb, localSongs) {
    ...
    this.content = this.viewsAny_ce24rb$(new UserUnknown(this), this.contentHole);
    this.userSongs = this.wrap_mh5how$(null);
    this.songInclude_0 = songInclude(this.kills, this.localSongs, this.rx_pn7ch0$(Boot$songInclude$lambda(this)));
    this.songSource = songSource(this, this.songInclude_0, this.localSongs);
    this.player = this.viewFromRx_ahf225$(this.viewsAny_lqv1tx$(this.slots.player), this.songSource, Boot$player$lambda(this));
    this.songInfoSource = this.wrap_mh5how$(localSongInfoSource());
    this.signOut = new Var(Boot$signOut$lambda(this));
    launch(coroutines.GlobalScope, void 0, void 0, Boot_init$lambda(this, idb));
  }
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            this.state_0 = 3;
            this.result_0 = LocalSongs$Companion_getInstance().invoke_u10xpl$(this.local$$receiver, this.local$idb, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
            var localSongs = this.result_0;
            this.local$$receiver_0 = new Boot(this.local$$receiver, new BodyPath(this.local$closure$body), this.local$idb, localSongs);
            this.state_0 = 4;
  ...
  Boot.prototype.like_61zpoe$ = function (id) {
    var tmp$;
    if ((tmp$ = this.userSongs.now.item) != null) {
      tmp$.like_61zpoe$(id);
    }
  };
  ...
  function Coroutine$Boot$play$lambda$lambda$lambda$lambda(this$_0, closure$playable_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$ = this$_0;
    this.local$closure$playable = closure$playable_0;
  }
  Coroutine$Boot$play$lambda$lambda$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot$play$lambda$lambda$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot$play$lambda$lambda$lambda$lambda.prototype.constructor = Coroutine$Boot$play$lambda$lambda$lambda$lambda;
  Coroutine$Boot$play$lambda$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function Boot$play$lambda$lambda$lambda$lambda(this$_0, closure$playable_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot$play$lambda$lambda$lambda$lambda(this$_0, closure$playable_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot$play$lambda$lambda(this$Boot_0, closure$playable_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            $receiver.exec(Boot$play$lambda$lambda$lambda$lambda($receiver, closure$playable));
            return $receiver;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
  ...
  function Boot$play$lambda$lambda(this$Boot_0, closure$playable_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot$play$lambda$lambda(this$Boot_0, closure$playable_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = switchToView(this.local$this$Boot.player, Boot$play$lambda$lambda(this.local$this$Boot, this.local$closure$playable), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function Boot$songInclude$lambda(this$Boot) {
    return function ($receiver) {
      var tmp$;
      return (tmp$ = this$Boot.userSongs.invoke().item) != null ? tmp$.get : null;
    };
  }
  function Coroutine$Boot$player$lambda(this$Boot_0, s_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
  ...
  Coroutine$Boot$player$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (this.local$s != null) {
              this.state_0 = 2;
              this.result_0 = this.local$s(this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
          ...
          case 3:
            if (this.result_0 != null) {
              this.local$$receiver = new Visible(this.local$this$Boot);
              this.state_0 = 4;
              this.result_0 = this.local$$receiver.loadNextSong_6taknv$(false, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  function Boot$player$lambda(this$Boot_0) {
    return function (s_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot$player$lambda(this$Boot_0, s_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot$signOut$lambda(this$Boot_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
  }
  Coroutine$Boot$signOut$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot$signOut$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot$signOut$lambda.prototype.constructor = Coroutine$Boot$signOut$lambda;
  Coroutine$Boot$signOut$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$Boot.userState.now = UserState.Unknown, Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function Boot$signOut$lambda(this$Boot_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot$signOut$lambda(this$Boot_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Boot_init$lambda$lambda(this$Boot) {
    return function ($receiver, st) {
      this$Boot.userState.now = st;
      return Unit;
    };
  }
  function Coroutine$Boot_init$lambda$lambda$lambda(closure$app_0, this$Boot_0, $receiver_0, it_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
  ...
  Coroutine$Boot_init$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return new NotLoggedIn(this.local$$receiver, this.local$closure$app, this.local$this$Boot.path);
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function Boot_init$lambda$lambda$lambda(closure$app_0, this$Boot_0) {
    return function ($receiver_0, it_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda(closure$app_0, this$Boot_0, $receiver_0, it_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot_init$lambda$lambda$lambda_0(this$Boot_0, closure$u_0, closure$app_0, closure$db_0, closure$functions_0, $receiver_0, it_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
  ...
  Coroutine$Boot_init$lambda$lambda$lambda_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot_init$lambda$lambda$lambda_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot_init$lambda$lambda$lambda_0.prototype.constructor = Coroutine$Boot_init$lambda$lambda$lambda_0;
  Coroutine$Boot_init$lambda$lambda$lambda_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return new LoggedIn(this.local$$receiver, this.local$this$Boot.path, this.local$closure$u.user, this.local$closure$app, this.local$closure$db, this.local$closure$functions);
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function Boot_init$lambda$lambda$lambda_0(this$Boot_0, closure$u_0, closure$app_0, closure$db_0, closure$functions_0) {
    return function ($receiver_0, it_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda_0(this$Boot_0, closure$u_0, closure$app_0, closure$db_0, closure$functions_0, $receiver_0, it_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot_init$lambda$lambda(closure$app_0, this$Boot_0, closure$db_0, closure$functions_0, u_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$closure$app = closure$app_0;
    this.local$this$Boot = this$Boot_0;
  ...
  Coroutine$Boot_init$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot_init$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot_init$lambda$lambda.prototype.constructor = Coroutine$Boot_init$lambda$lambda;
  Coroutine$Boot_init$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (Kotlin.isType(this.local$u, Object.getPrototypeOf(UserState.NotLoggedIn).constructor)) {
              this.state_0 = 4;
              this.result_0 = fwd(this.local$this$Boot, Boot_init$lambda$lambda$lambda(this.local$closure$app, this.local$this$Boot), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
             else {
              if (Kotlin.isType(this.local$u, UserState$LoggedIn)) {
                this.state_0 = 2;
                this.result_0 = fwd(this.local$this$Boot, Boot_init$lambda$lambda$lambda_0(this.local$this$Boot, this.local$u, this.local$closure$app, this.local$closure$db, this.local$closure$functions), this);
                if (this.result_0 === COROUTINE_SUSPENDED)
                  return COROUTINE_SUSPENDED;
                continue;
              }
  ...
  function Boot_init$lambda$lambda_0(closure$app_0, this$Boot_0, closure$db_0, closure$functions_0) {
    return function (u_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda(closure$app_0, this$Boot_0, closure$db_0, closure$functions_0, u_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda(closure$uid_0, closure$db_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
  ...
  Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (this.local$closure$uid != null) {
              var $receiver = this.local$closure$uid;
              var closure$db = this.local$closure$db;
              this.state_0 = 2;
              this.result_0 = userSongs(this.local$$receiver.kills, $receiver, closure$db, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  function Boot_init$lambda$lambda$lambda$lambda$lambda(closure$uid_0, closure$db_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda$lambda$lambda(closure$uid_0, closure$db_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot_init$lambda$lambda$lambda$lambda(this$Boot_0, closure$uid_0, closure$db_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
    this.local$closure$uid = closure$uid_0;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$Boot.switchToWrap_t6rg6d$(this.local$this$Boot.userSongs, Boot_init$lambda$lambda$lambda$lambda$lambda(this.local$closure$uid, this.local$closure$db), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function Boot_init$lambda$lambda$lambda$lambda(this$Boot_0, closure$uid_0, closure$db_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda$lambda(this$Boot_0, closure$uid_0, closure$db_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Boot_init$lambda$lambda$lambda_1(this$Boot, closure$db) {
    return function ($receiver, uid) {
      this$Boot.exec(Boot_init$lambda$lambda$lambda$lambda(this$Boot, uid, closure$db));
      return Unit;
    };
  }
  function Coroutine$Boot_init$lambda$lambda$lambda_1(this$Boot_0, this$_0, closure$app_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
    this.local$this$ = this$_0;
  ...
  Coroutine$Boot_init$lambda$lambda$lambda_1.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot_init$lambda$lambda$lambda_1.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot_init$lambda$lambda$lambda_1.prototype.constructor = Coroutine$Boot_init$lambda$lambda$lambda_1;
  Coroutine$Boot_init$lambda$lambda$lambda_1.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$this$Boot.userState.now = UserState.Unknown;
            this.local$this$.clear();
            return this.local$closure$app.auth().signOut();
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function Boot_init$lambda$lambda$lambda_2(this$Boot_0, this$_0, closure$app_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda$lambda_1(this$Boot_0, this$_0, closure$app_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot_init$lambda$lambda_0(closure$db_0, $receiver_0, it_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$db = closure$db_0;
  ...
  Coroutine$Boot_init$lambda$lambda_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Boot_init$lambda$lambda_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Boot_init$lambda$lambda_0.prototype.constructor = Coroutine$Boot_init$lambda$lambda_0;
  Coroutine$Boot_init$lambda$lambda_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (this.local$it == null) {
              return localSongInfoSource();
            }
             else {
              return cloudSongInfoSource(this.local$$receiver, this.local$closure$db);
            }
  ...
  function Boot_init$lambda$lambda_1(closure$db_0) {
    return function ($receiver_0, it_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda$lambda_0(closure$db_0, $receiver_0, it_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Coroutine$Boot_init$lambda(this$Boot_0, closure$idb_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$Boot = this$Boot_0;
      ...
      try {
        switch (this.state_0) {
          ...
          case 3:
            ...
            continue;
          case 4:
            this.local$this$Boot.forEach_5mel8p$(runUserState(this.local$this$Boot, this.local$app), Boot_init$lambda$lambda(this.local$this$Boot));
            this.local$this$Boot.viewFromRx_ahf225$(this.local$this$Boot.content, this.local$this$Boot.userState, Boot_init$lambda$lambda_0(this.local$app, this.local$this$Boot, this.local$db, this.local$functions));
            this.state_0 = 5;
            this.result_0 = toLatestUid(this.local$this$Boot.user_0, this.local$this$Boot.kills, this.local$closure$idb, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 5:
            var $receiver_0 = this.result_0;
            var this$Boot = this.local$this$Boot;
            this$Boot.forEach_5mel8p$($receiver_0.rxv, Boot_init$lambda$lambda$lambda_1(this$Boot, this.local$db));
            this$Boot.signOut.now = Boot_init$lambda$lambda$lambda_2(this$Boot, $receiver_0, this.local$app);
            return this.local$this$Boot.wrapFromRx_m95o2z$(this.local$this$Boot.songInfoSource, this.local$this$Boot.user_0, Boot_init$lambda$lambda_1(this.local$db));
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function Boot_init$lambda(this$Boot_0, closure$idb_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$Boot_init$lambda(this$Boot_0, closure$idb_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  LocalSongs.prototype.emit_0 = function (m) {
    m.applyTo_wgjnv3$(this.mutableSet_0);
  };
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            if (blob == null) {
              this.$this.emit_0(new SetRemoved(this.local$id));
            }
  ...
  function Coroutine$localSongInfoSource$lambda(closure$map_0, f_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
  ...
  Coroutine$localSongInfoSource$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$localSongInfoSource$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$localSongInfoSource$lambda.prototype.constructor = Coroutine$localSongInfoSource$lambda;
  Coroutine$localSongInfoSource$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$id = this.local$f.component1(), this.local$blob = this.local$f.component2();
            var blob = this.local$f.component2();
            this.local$$receiver = this.local$closure$map;
            var value = this.local$$receiver.get_11rb$(this.local$id);
            if (value == null) {
              this.local$$receiver_0 = new Mp3File();
              this.state_0 = 2;
              this.result_0 = initFrom(this.local$$receiver_0, blob, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
          ...
          case 1:
            throw this.exception_0;
          case 2:
            this.local$$receiver_0.props.clearDirty();
            var answer = this.local$$receiver_0;
            this.local$$receiver.put_xwzc9p$(this.local$id, answer);
            this.local$tmp$ = answer;
            this.state_0 = 3;
            continue;
          case 3:
            return new Var(new Some(this.local$tmp$));
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function localSongInfoSource$lambda(closure$map_0) {
    return function (f_0, continuation_0, suspended) {
      var instance = new Coroutine$localSongInfoSource$lambda(closure$map_0, f_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function cloudSongInfoSource$lambda() {
    return new Mp3File();
  }
  function Coroutine$cloudSongInfoSource$lambda(closure$cache_0, f_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
  ...
  Coroutine$cloudSongInfoSource$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$cloudSongInfoSource$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$cloudSongInfoSource$lambda.prototype.constructor = Coroutine$cloudSongInfoSource$lambda;
  Coroutine$cloudSongInfoSource$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$id = this.local$f.component1(), this.local$blob = this.local$f.component2();
            this.state_0 = 2;
            this.result_0 = this.local$closure$cache(this.local$id, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            throw this.exception_0;
          case 2:
            this.local$tag = this.result_0;
            if (this.local$tag.now.isEmpty()) {
              this.local$$receiver = new Mp3File();
              this.state_0 = 3;
              this.result_0 = initFrom(this.local$$receiver, this.local$blob, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
          ...
          case 3:
            var $receiver = this.local$$receiver.props;
            $receiver.persisted_11rd$(get_songs(musiclib.musicLib.app).doc_61zpoe$(this.local$id));
            $receiver.save();
            this.state_0 = 4;
            continue;
          case 4:
  ...
  function cloudSongInfoSource$lambda_0(closure$cache_0) {
    return function (f_0, continuation_0, suspended) {
      var instance = new Coroutine$cloudSongInfoSource$lambda(closure$cache_0, f_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function cloudSongInfoSource($receiver, db) {
    if (db === void 0)
      db = commonfb.FB.db;
    var cache = lazy(get_songs(musiclib.musicLib.app), $receiver.kills, db, cloudSongInfoSource$lambda);
    return cloudSongInfoSource$lambda_0(cache);
  }
  ...
  function songSource$lambda$lambda(closure$inc, closure$incset) {
    return function (id, idks) {
      closure$inc(id).forEach_yk5nc8$(idks, songSource$lambda$lambda$lambda(closure$incset, id));
      plusAssign(idks, songSource$lambda$lambda$lambda_0(closure$incset, id));
      return Unit;
    };
  }
  function songSource$lambda(closure$includeSong, closure$localSongs) {
    return function ($receiver) {
      var inc = closure$includeSong.invoke();
      var incset = new RxMutableSet();
      var iks = new Killables();
      process(closure$localSongs, iks.killSet, songSource$lambda$lambda(inc, incset));
      return to(incset, iks.kill);
    };
  }
  function songSource$lambda_0(closure$included, closure$incSeq) {
    return function ($receiver, f) {
      var inc = f.component1()
      , kill = f.component2();
      closure$included.now = inc;
      closure$incSeq.remAssign_o14v8n$(kill);
      return Unit;
    };
  }
  ...
  function songSource$lambda_1(closure$songRing) {
    return function (id, lks) {
      closure$songRing.insertItem_h6hr7q$(id);
      plusAssign(lks, songSource$lambda$lambda_0(closure$songRing, id));
      return Unit;
    };
  }
      ...
      try {
        switch (this.state_0) {
          ...
          case 1:
            throw this.exception_0;
          case 2:
            if (this.local$closure$included.now.isEmpty()) {
              this.state_0 = 6;
              continue;
            }

            this.local$id = this.local$closure$songRing.next;
            if (this.local$closure$included.now.contains_11rb$(this.local$id)) {
              this.state_0 = 3;
  ...
  function songSource$lambda_2(closure$next_0) {
    return function (continuation_0, suspended) {
  ...
  function songSource$lambda_3(closure$included, closure$nextFn) {
    return function ($receiver) {
      if (closure$included.invoke().isEmptyRx.invoke()) {
        return null;
      }
       else {
  ...
  function songSource($receiver, includeSong, localSongsDB) {
    ...
    var included = new Var(new RxMutableSet());
    var incSeq = seq($receiver.kills);
    $receiver.forEach_5mel8p$($receiver.rx_pn7ch0$(songSource$lambda(includeSong, localSongs)), songSource$lambda_0(included, incSeq));
    process(localSongsDB.set, $receiver.kills, songSource$lambda_1(songRing));
    songRing.moveHead_gney3$();
    var next = songSource$next(included, songRing, localSongsDB);
    var nextFn = songSource$lambda_2(next);
    return $receiver.rx_pn7ch0$(songSource$lambda_3(included, nextFn));
  }
  ...
  function getInclude$lambda(closure$map, closure$ks, closure$states, closure$state) {
    return function (id) {
      var $receiver = closure$map;
      var tmp$;
      var value = $receiver.get_11rb$(id);
      if (value == null) {
        var answer = Rx_init(closure$ks, getInclude$lambda$lambda$lambda(closure$states, id, closure$state));
  ...
  function getInclude(ks, states, state) {
    var map = LinkedHashMap_init();
    return getInclude$lambda(map, ks, states, state);
  }
  function songInclude$lambda$lambda(it) {
    return new Var(true);
  }
  function songInclude$lambda$getIncludeState(closure$uks, closure$songState) {
    return function (state) {
      return getInclude(closure$uks, closure$songState, state);
    };
  }
  var Collection = Kotlin.kotlin.collections.Collection;
  function songInclude$lambda(closure$kseq, closure$userSongs, closure$localSongs) {
    return function ($receiver) {
      var uks = closure$kseq.killSet();
      var songState = closure$userSongs.invoke();
      if (songState == null) {
        return songInclude$lambda$lambda;
      }
       else {
        var $receiver_0 = closure$localSongs.set;
        var any$result;
        any$break: do {
          var tmp$;
          ...
          while (tmp$.hasNext()) {
            ...
            if (songState(element).invoke() === UserSongState.New) {
              any$result = true;
              break any$break;
            }
          }
        ...
        var getIncludeState = songInclude$lambda$getIncludeState(uks, songState);
        if (hasNew) {
          return getIncludeState(UserSongState.New);
        }
         else {
          return getIncludeState(UserSongState.Like);
        }
      }
    };
  }
  function songInclude(ks, localSongs, userSongs) {
    var kseq = seq(ks);
    return Rx_init(ks, songInclude$lambda(kseq, userSongs, localSongs));
  }
  ...
  function userSongs$rxv(closure$map) {
    return function (id) {
      var $receiver = closure$map;
      var tmp$;
      var value = $receiver.get_11rb$(id);
      if (value == null) {
        var answer = new Var(UserSongState.New);
        $receiver.put_xwzc9p$(id, answer);
        tmp$ = answer;
      }
       else {
  ...
  function userSongs$lambda$lambda(closure$rxv) {
    return function ($receiver, st) {
      closure$rxv.now = st.getOrDefault_11rb$(UserSongState.New);
      return Unit;
    };
  }
  function userSongs$lambda_0(closure$rxv) {
    return function (item, ks) {
      var rxv = closure$rxv(item.props.idOrFail);
      item.state.initial.forEach_yk5nc8$(ks, userSongs$lambda$lambda(rxv));
      return Unit;
    };
  }
  function userSongs$lambda_1(closure$rxv) {
    return function (it) {
      return closure$rxv(it);
    };
  }
  function userSongs$lambda_2(closure$rxv, closure$cw, closure$db) {
    return function (id, state) {
      closure$rxv(id).now = state;
      var $receiver = new UserSong();
      var closure$cw_0 = closure$cw;
      var closure$db_0 = closure$db;
      $receiver.props.persisted_11rd$(closure$cw_0.doc_61zpoe$(id));
      $receiver.state.cv = state;
      merge($receiver, closure$db_0);
      return Unit;
    };
  }
  function Coroutine$userSongs(uks_0, uid_0, db_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$cw = void 0;
    this.local$uks = uks_0;
    this.local$uid = uid_0;
    this.local$db = db_0;
  }
  Coroutine$userSongs.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$userSongs.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$userSongs.prototype.constructor = Coroutine$userSongs;
  Coroutine$userSongs.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (this.local$db === void 0)
              this.local$db = commonfb.FB.db;
            this.local$cw = get_usersongs(get_private(musiclib.musicLib.app).doc_61zpoe$(this.local$uid));
            this.state_0 = 2;
            this.result_0 = toRxSetWithLookup(this.local$cw, this.local$uks, this.local$db, userSongs$lambda, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 2:
            ...
            var map = LinkedHashMap_init();
            var rxv = userSongs$rxv(map);
            process(source.set, this.local$uks, userSongs$lambda_0(rxv));
            return new UserSongs(userSongs$lambda_1(rxv), userSongs$lambda_2(rxv, this.local$cw, this.local$db));
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function userSongs(uks_0, uid_0, db_0, continuation_0, suspended) {
    var instance = new Coroutine$userSongs(uks_0, uid_0, db_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  function Database(factory, from) {
    ForwardBase.call(this, factory);
    this.from = from;
    this.path = new DatabasePath(this);
  ...
  function ui$lambda$lambda$lambda_0(this$ui) {
    return function () {
      return this$ui.path.loggedIn.syncing.invoke();
    };
  }
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_1.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$ui.path.loggedIn.sync(), Unit;
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function ui_0($receiver) {
    ...
    var $receiver_2 = $receiver_0.right.wraps.span;
    $receiver_2.visible_cskrne$($receiver, ui$lambda$lambda$lambda_0($receiver));
    var $receiver_3 = $receiver_2.cls;
    get_m1($receiver_3);
    var $receiver_4 = get_fa($receiver_3);
    get_fw($receiver_4);
    get_syncAlt($receiver_4);
    get_spin($receiver_4);
    ...
    $receiver_7.text.remAssign_61zpoe$('Import MP3s');
    $receiver.click_ka8ib0$($receiver_7, ui$lambda$lambda$lambda$lambda$lambda_0($receiver));
    var $receiver_8 = $receiver_6.item;
    get_syncAlt($receiver_8.fa);
    $receiver_8.text.remAssign_61zpoe$('Synchronize');
    $receiver.click_ka8ib0$($receiver_8, ui$lambda$lambda$lambda$lambda$lambda_1($receiver));
  ...
  function Import(from) {
    ...
    this.from = from;
    this.path = new ImportPath(this);
    this.work = get_withCounter(executor(this));
  ...
  Import.prototype.load_c4p07t$ = function (list, continuation) {
    ...
    while (tmp$_0.hasNext()) {
      ...
      this.work.exec(Import$load$lambda$lambda(element_0, this));
    }
  };
  ...
  function ImportFile(import_0, file, playable) {
    ...
    var $receiver_0 = this.map_i8ud5a$(this.path.boot.userSongs, ImportFile$state$lambda(this));
    this.forEach_5mel8p$($receiver_0, ImportFile$state$lambda$lambda(this));
    this.state = $receiver_0;
    this.tag = this.map_i8ud5a$(this.mapAsync_m547eu$(this.path.boot.songInfoSource, new Var(common.None), ImportFile$tag$lambda(this)), ImportFile$tag$lambda_0);
    this.rawView_2r18my$_0 = ui_2(this);
    this.forEach_5mel8p$(this.containsRx_t3ffic$(this.path.boot.localSongs.set, this.playable.id), ImportFile_init$lambda(this));
  }
  ...
  function ImportFile$importing$lambda$lambda(this$ImportFile) {
    return function ($receiver, i) {
      ...
      if (i) {
        ...
        this$ImportFile_0.path.import.work.exec(ImportFile$importing$lambda$lambda$lambda$lambda(this$ImportFile_0));
      }
       else {
  ...
  function ImportFile$state$lambda(this$ImportFile) {
    return function ($receiver, usi) {
      var tmp$, tmp$_0;
      var tmp$_1;
      tmp$_1 = (tmp$ = usi.item) != null ? tmp$.get(this$ImportFile.playable.id).invoke() : null;
      return (tmp$_0 = tmp$_1) != null ? tmp$_0 : UserSongState.New;
    };
  }
  ...
  function Coroutine$ImportFile$tag$lambda(this$ImportFile_0, $receiver_0, it_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$ImportFile = this$ImportFile_0;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$it.item(this.local$this$ImportFile.playable, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function ImportFile$tag$lambda(this$ImportFile_0) {
    return function ($receiver_0, it_0, continuation_0, suspended) {
      var instance = new Coroutine$ImportFile$tag$lambda(this$ImportFile_0, $receiver_0, it_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function ImportFile$tag$lambda$lambda() {
    return new Mp3File();
  }
  function ImportFile$tag$lambda_0($receiver, it) {
    return it.invoke().getOrElse_skz6lt$(ImportFile$tag$lambda$lambda);
  }
  ...
  function ui$lambda$lambda$lambda_2(this$ui) {
    return function () {
      return this$ui.work.pending.invoke() !== 0;
    };
  }
  function ui$lambda$lambda$lambda_3(this$ui) {
    return function () {
      return this$ui.work.pending.invoke().toString();
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda_1(closure$inp) {
    return function ($receiver) {
      ...
      faButtonSpan($receiver, void 0, ui$lambda$lambda$lambda$lambda$lambda_2);
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_3($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda_3(closure$inp) {
    return function ($receiver) {
      $receiver.htmlFor = get_ref(closure$inp);
      faButtonSpan($receiver, void 0, ui$lambda$lambda$lambda$lambda$lambda_3);
      var $receiver_0 = get_cls($receiver);
      get_btn($receiver_0);
      get_btnPrimary($receiver_0);
      get_m0($receiver_0);
  ...
  function ui_1($receiver) {
    ...
    var $receiver_2 = $receiver_0.right.badge;
    $receiver_2.visible_cskrne$($receiver, ui$lambda$lambda$lambda_2($receiver));
    get_p1($receiver_2.cls);
    $receiver_2.pill;
    $receiver_2.warning;
    $receiver.remAssign_7fncnf$($receiver_2.node, ui$lambda$lambda$lambda_3($receiver));
    var $receiver_3 = $receiver_0.right.buttonGroup;
    $receiver_3.m1;
    if (commonui.webkitdirectorySupported) {
      var $receiver_4 = invoke(get_input(inputContainer), ui$lambda$lambda$lambda_4($receiver));
      invoke(get_label($receiver_3.node), ui$lambda$lambda$lambda$lambda_1($receiver_4));
    }
    var $receiver_5 = invoke(get_input(inputContainer), ui$lambda$lambda$lambda_5($receiver));
    invoke(get_label($receiver_3.node), ui$lambda$lambda$lambda$lambda_3($receiver_5));
    var $receiver_6 = $receiver_0.right.dropdown;
    $receiver_6.bars;
    $receiver_6.right;
    var $receiver_7 = $receiver_6.menu;
    var $receiver_8 = $receiver_7.item;
    $receiver.rxClass_mjd6u9$($receiver_8.node, get_disabled(Cls.Companion), ui$lambda$lambda$lambda$lambda$lambda_4($receiver));
    get_fileImport($receiver_8.fa);
    $receiver_8.text.remAssign_61zpoe$('Start Importing');
    $receiver.click_ka8ib0$($receiver_8, ui$lambda$lambda$lambda$lambda$lambda_5($receiver));
    var $receiver_9 = $receiver_7.item;
    $receiver.rxClass_mjd6u9$($receiver_9.node, get_disabled(Cls.Companion), ui$lambda$lambda$lambda$lambda$lambda_6($receiver));
    get_trashAlt($receiver_9.fa);
    $receiver_9.text.remAssign_61zpoe$('Clear List');
    $receiver.click_ka8ib0$($receiver_9, ui$lambda$lambda$lambda$lambda$lambda_7($receiver));
    var tmp$ = $receiver_0.node;
    var $receiver_10 = widget.factory.scrollPane;
    var $receiver_11 = $receiver_10.cls;
    get_p1($receiver_11);
    get_flexColumn($receiver_11);
    listenableList($receiver_10.pane, $receiver.kills, $receiver.loadList, ui$lambda$lambda);
    return new TopAndContent(tmp$, $receiver_10.node);
  }
  function ui$lambda$lambda$lambda_6(this$ui) {
    return function () {
      return fixedArtist(this$ui.tag.invoke()).getOrDefault_11rb$('<unknown>');
    };
  }
  function ui$lambda$lambda$lambda_7(this$ui) {
    return function () {
      return fixedTitle(this$ui.tag.invoke()).getOrDefault_11rb$('<unknown>');
    };
  }
  ...
  function ui$lambda$lambda$lambda_8(this$ui) {
    return function () {
      return this$ui.tag.invoke().secs.initial.invoke().map_2o04qz$(ui$lambda$lambda$lambda$lambda_4).getOrDefault_11rb$('<unknown>');
    };
  }
  ...
  Coroutine$ui$lambda$lambda$lambda$lambda$lambda_8.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var $receiver = this.local$this$ui;
            var tmp$;
            var tmp$_0;
  ...
  function ui$lambda$lambda_1(this$ui) {
    return function ($receiver) {
      ...
      this$ui_0.click_3xepc3$($receiver_2, ui$lambda$lambda$lambda$lambda$lambda_8(this$ui_0));
      var $receiver_3 = $receiver_1.button;
      $receiver_3.p2;
      get_thumbsUp($receiver_3.fa);
      this$ui_0.rxClass_wqb4ha$($receiver_3.node, ui$lambda$lambda$lambda$lambda$lambda_9(this$ui_0));
      this$ui_0.click_3xepc3$($receiver_3, ui$lambda$lambda$lambda$lambda$lambda_10(this$ui_0));
      var $receiver_4 = $receiver_1.button;
      $receiver_4.p2;
      $receiver_4.secondary;
      get_thumbsDown($receiver_4.fa);
      this$ui_0.click_3xepc3$($receiver_4, ui$lambda$lambda$lambda$lambda$lambda_11(this$ui_0));
      var $receiver_5 = $receiver_1.button;
      $receiver_5.p2;
      $receiver_5.secondary;
      get_fileImport($receiver_5.fa);
      this$ui_0.rxEnabled_y5ufnr$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_12(this$ui_0));
      this$ui_0.click_3xepc3$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_13(this$ui_0));
      var $receiver_6 = $receiver_1.button;
      $receiver_6.p2;
      $receiver_6.secondary;
      get_ban($receiver_6.fa);
      this$ui_0.click_3xepc3$($receiver_6, ui$lambda$lambda$lambda$lambda$lambda_14(this$ui_0));
      return Unit;
    };
  }
  function ui$lambda(this$ui) {
    return function ($receiver) {
      ...
      invoke(get_dl($receiver), ui$lambda$lambda_0(this$ui));
      invoke(get_div($receiver), ui$lambda$lambda_1(this$ui));
      return Unit;
    };
  }
  ...
  function LoggedInPath(loggedIn) {
    BootPath.call(this, loggedIn.boot);
  ...
  function LoggedIn(factory, from, user, app, db, functions) {
    ForwardBase.call(this, factory);
    this.boot = from.boot;
    this.path = new LoggedInPath(this);
    this.rawView_mrgtfa$_0 = ui_3(this);
    this.syncing = new Var(false);
    var log = LoggedIn_init$log;
    var customToken = lazy_0(LoggedIn_init$lambda(functions, app));
    this.forEach_5mel8p$(this.syncing, LoggedIn_init$lambda_0(customToken, db, user, this));
  }
  ...
  Coroutine$database.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$tmp$ = this.$this.forward;
            this.state_0 = 2;
            this.result_0 = fwdc(this.$this, getCallableRef('Database', function (factory, from) {
              return new Database(factory, from);
            }), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          ...
          case 2:
            this.state_0 = 3;
            this.result_0 = this.local$tmp$.remAssign_11rb$(this.result_0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
  ...
  LoggedIn.prototype.sync = function () {
  ...
  function Coroutine$LoggedIn_init$lambda$lambda(closure$functions_0, closure$app_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$functions = closure$functions_0;
  ...
  Coroutine$LoggedIn_init$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$LoggedIn_init$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$LoggedIn_init$lambda$lambda.prototype.constructor = Coroutine$LoggedIn_init$lambda$lambda;
  Coroutine$LoggedIn_init$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
          ...
          case 1:
            throw this.exception_0;
          case 2:
            var custTokenCall = this.result_0;
            this.state_0 = 3;
            this.result_0 = custTokenCall.call_11rb$(Unit, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
            if ((tmp$ = this.result_0) != null) {
              this.state_0 = 4;
              this.result_0 = await_0(this.local$closure$app.auth().signInWithCustomToken(tmp$), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  function LoggedIn_init$lambda$lambda(closure$functions_0, closure$app_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$LoggedIn_init$lambda$lambda(closure$functions_0, closure$app_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function LoggedIn_init$lambda(closure$functions, closure$app) {
    return function () {
      return async(coroutines.GlobalScope, void 0, void 0, LoggedIn_init$lambda$lambda(closure$functions, closure$app));
    };
  }
  function LoggedIn_init$lambda$lambda$lambda(closure$e) {
    return function ($receiver) {
      $receiver.danger_61zpoe$('Synchronizing failed: ' + closure$e.message.toString());
      return Unit;
    };
  }
  function Coroutine$LoggedIn_init$lambda$lambda_0(closure$customToken_0, closure$db_0, closure$user_0, this$LoggedIn_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 6;
    this.local$closure$customToken = closure$customToken_0;
    this.local$closure$db = closure$db_0;
    this.local$closure$user = closure$user_0;
    this.local$this$LoggedIn = this$LoggedIn_0;
    this.local$$receiver = $receiver_0;
  }
  Coroutine$LoggedIn_init$lambda$lambda_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$LoggedIn_init$lambda$lambda_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$LoggedIn_init$lambda$lambda_0.prototype.constructor = Coroutine$LoggedIn_init$lambda$lambda_0;
  Coroutine$LoggedIn_init$lambda$lambda_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 1;
            this.result_0 = this.local$closure$customToken.value.await(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            this.state_0 = 2;
            this.result_0 = await_0(this.local$closure$db.enableNetwork(), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 2:
            this.state_0 = 3;
            this.result_0 = flushQueries(this.local$$receiver, [collectionRef(get_usersongs(get_private(musiclib.musicLib.app).doc_61zpoe$(this.local$closure$user.uid)), this.local$closure$db)], this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
          ...
          case 4:
            ...
            this.local$this$LoggedIn.path.boot.slots.toasts(LoggedIn_init$lambda$lambda$lambda(e));
            this.state_0 = 5;
            continue;
          case 5:
            return this.local$this$LoggedIn.syncing.now = false, Unit;
          case 6:
            throw this.exception_0;
  ...
  function LoggedIn_init$lambda$lambda_0(closure$customToken_0, closure$db_0, closure$user_0, this$LoggedIn_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$LoggedIn_init$lambda$lambda_0(closure$customToken_0, closure$db_0, closure$user_0, this$LoggedIn_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function LoggedIn_init$lambda_0(closure$customToken, closure$db, closure$user, this$LoggedIn) {
    return function ($receiver, s) {
      if (s) {
        launch(this$LoggedIn, void 0, void 0, LoggedIn_init$lambda$lambda_0(closure$customToken, closure$db, closure$user, this$LoggedIn));
      }
      return Unit;
    };
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$ui.path.boot.signOut.now(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function ui_3($receiver) {
    ...
    $receiver.click_ka8ib0$($receiver_4, ui$lambda$lambda$lambda$lambda$lambda_15($receiver));
    $receiver_3.divider;
    var $receiver_5 = $receiver_3.item;
    get_signOutAlt($receiver_5.fa);
    $receiver_5.text.remAssign_61zpoe$('Sign Out');
    $receiver.click_ka8ib0$($receiver_5, ui$lambda$lambda$lambda$lambda$lambda_16($receiver));
  ...
  function NotLoggedIn(factory, app, path) {
    ForwardBase.call(this, factory);
    this.app = app;
    this.path = path;
  ...
  function ui_4($receiver) {
    ...
    $receiver.click_ka8ib0$($receiver_3, ui$lambda$lambda$lambda$lambda$lambda_17($receiver));
    remAssign($receiver_0.title, 'Music');
  ...
  function Coroutine$nextTrack($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$nextTrack.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$nextTrack.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$nextTrack.prototype.constructor = Coroutine$nextTrack;
  Coroutine$nextTrack.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.next(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Player.prototype.nextTrack = function (continuation_0, suspended) {
    var instance = new Coroutine$nextTrack(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.path.visible.loadNextSong_6taknv$(this.$this.isPlaying, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Player.prototype.next = function (continuation_0, suspended) {
  ...
  function Coroutine$dontLike($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$dontLike.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$dontLike.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$dontLike.prototype.constructor = Coroutine$dontLike;
  Coroutine$dontLike.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.$this.path.boot.dontLike_61zpoe$(this.$this.playable.id);
            this.state_0 = 2;
            this.result_0 = this.$this.next(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
  ...
  Player.prototype.dontLike = function (continuation_0, suspended) {
    var instance = new Coroutine$dontLike(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  function Coroutine$forward($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$forward.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$forward.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$forward.prototype.constructor = Coroutine$forward;
  Coroutine$forward.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var newPos = this.$this.audio.currentTime + SeekSeconds;
  ...
  Player.prototype.forward = function (continuation_0, suspended) {
    var instance = new Coroutine$forward(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  Player.prototype.like = function () {
    var tmp$;
    if ((tmp$ = this.path.boot.userSongs.now.item) != null) {
  ...
  function Player$state$lambda(this$Player) {
    return function ($receiver, usi) {
      var tmp$, tmp$_0;
      var tmp$_1;
      tmp$_1 = (tmp$ = usi.item) != null ? tmp$.get(this$Player.playable.id).invoke() : null;
      return (tmp$_0 = tmp$_1) != null ? tmp$_0 : UserSongState.New;
    };
  }
  Player.$metadata$ = {
  ...
  function Playing(player) {
    ...
    player.audio.play();
    plusAssign(player.kills, Playing_init$lambda$lambda(player));
    player.readCounterNow();
    plusAssign(player.kills, onInterval(window, 250, Playing_init$lambda$lambda_0(player)));
    plusAssign(player.kills, listen(player.audio, 'ended', Playing_init$lambda$lambda_1(player)));
  }
  ...
  function Coroutine$Playing_init$lambda$lambda$lambda(this$_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$ = this$_0;
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$.next(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function Playing_init$lambda$lambda$lambda(this$_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Playing_init$lambda$lambda$lambda(this$_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function Playing_init$lambda$lambda_1(this$) {
    return function (it) {
      this$.exec(Playing_init$lambda$lambda$lambda(this$));
      return Unit;
    };
  }
  Playing.$metadata$ = {
  ...
  function ui$lambda$lambda_3(closure$totalDurationText) {
    return function ($receiver) {
      return closure$totalDurationText.invoke().length;
    };
  }
  function ui$lambda$lambda_4(this$ui, closure$totalDurationTextLength) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda_7(closure$artistTitle) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_18(this$ui, closure$artist, closure$title) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda_11(this$ui, closure$artist, closure$title) {
    return function ($receiver) {
      ...
      invoke(get_span($receiver), ui$lambda$lambda$lambda$lambda$lambda_18(this$ui, closure$artist, closure$title));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_19(this$ui, closure$currentPositionText, closure$totalDurationText) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      get_m0($receiver_0);
      get_textPrimary($receiver_0);
  ...
  function ui$lambda$lambda$lambda$lambda_12(this$ui, closure$currentPositionText, closure$totalDurationText) {
    return function ($receiver) {
      ...
      invoke(get_pre($receiver), ui$lambda$lambda$lambda$lambda$lambda_19(this$ui, closure$currentPositionText, closure$totalDurationText));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda_13(this$ui) {
    return function ($receiver) {
      ...
      invoke(get_button($receiver), ui$lambda$lambda$lambda$lambda$lambda_20(this$ui));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_22(this$ui) {
    return function ($receiver) {
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_23(this$ui) {
    return function ($receiver) {
      get_btnOutlinePrimary(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda_14(this$ui, closure$mediaButton) {
    return function ($receiver) {
      ...
      get_m1($receiver_0);
      get_btnGroup($receiver_0);
      closure$mediaButton($receiver, get_stepBackward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_21(this$ui));
      closure$mediaButton($receiver, get_backward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_22(this$ui));
      closure$mediaButton($receiver, get_forward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_23(this$ui));
      closure$mediaButton($receiver, get_stepForward(Fa.Companion), void 0, ui$lambda$lambda$lambda$lambda$lambda_24(this$ui));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda$lambda_12(closure$state) {
    return function ($receiver) {
      return equals(closure$state.invoke(), UserSongState.Like) ? get_btnPrimary(Cls.Companion) : get_btnSecondary(Cls.Companion);
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_25(closure$likeButtonsDisabled, this$ui, closure$state) {
    return function ($receiver) {
      get_btn(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda$lambda$lambda_16(closure$state) {
    return function ($receiver) {
      return equals(closure$state.invoke(), UserSongState.DontLike) ? get_btnPrimary(Cls.Companion) : get_btnSecondary(Cls.Companion);
    };
  }
  ...
  function ui$lambda$lambda$lambda$lambda$lambda_26(closure$likeButtonsDisabled, this$ui, closure$state) {
    return function ($receiver) {
      get_btn(get_cls($receiver));
  ...
  function ui$lambda$lambda$lambda$lambda_15(closure$likeButtonsDisabled, this$ui, closure$state) {
    return function ($receiver) {
      ...
      get_m1($receiver_0);
      get_btnGroup($receiver_0);
      invoke(get_button($receiver), ui$lambda$lambda$lambda$lambda$lambda_25(closure$likeButtonsDisabled, this$ui, closure$state));
      invoke(get_button($receiver), ui$lambda$lambda$lambda$lambda$lambda_26(closure$likeButtonsDisabled, this$ui, closure$state));
      return Unit;
    };
  }
  ...
  function ui$lambda$lambda_9(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText, closure$likeButtonsDisabled, closure$state) {
    return function ($receiver) {
      var $receiver_0 = get_cls($receiver);
      ...
      row($receiver, ui$lambda$lambda$lambda_18(this$ui, closure$artist, closure$title, closure$currentPositionText, closure$totalDurationText));
      row($receiver, ui$lambda$lambda$lambda_19(this$ui, mediaButton, closure$likeButtonsDisabled, closure$state));
      return Unit;
    };
  }
  function ui_5($receiver) {
    var $receiver_0 = new Factory();
    var totalDurationText = $receiver.rx_pn7ch0$(ui$lambda$lambda_2($receiver));
    var totalDurationTextLength = $receiver.rx_pn7ch0$(ui$lambda$lambda_3(totalDurationText));
    var currentPositionText = $receiver.rx_pn7ch0$(ui$lambda$lambda_4($receiver, totalDurationTextLength));
    var likeButtonsDisabled = $receiver.rx_pn7ch0$(ui$lambda$lambda_5($receiver));
    var state = $receiver.userSong;
    var artistTitle = $receiver.rx_pn7ch0$(ui$lambda$lambda_6($receiver));
    var artist = $receiver.rx_pn7ch0$(ui$lambda$lambda_7(artistTitle));
    var title = $receiver.rx_pn7ch0$(ui$lambda$lambda_8(artistTitle));
    ...
    return $receiver_0.wraps.div_iw61es$(ui$lambda$lambda_9($receiver, artist, title, currentPositionText, totalDurationText, likeButtonsDisabled, state)).node;
  }
  var SeekSeconds;
  ...
  function Visible(boot) {
    ...
    var $receiver = new Var(new Mp3File());
    this.forEach_5mel8p$(this.mapAsync_m547eu$(this.rx_pn7ch0$(Visible$tag$lambda$lambda(this)), new Var(common.None), Visible$tag$lambda$lambda_0), Visible$tag$lambda$lambda_1($receiver));
    this.tag = $receiver;
  ...
  function Coroutine$loadNextSong_6taknv$($this, startPlaying_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$tmp$_1 = void 0;
    this.local$startPlaying = startPlaying_0;
  }
  Coroutine$loadNextSong_6taknv$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$loadNextSong_6taknv$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$loadNextSong_6taknv$.prototype.constructor = Coroutine$loadNextSong_6taknv$;
  Coroutine$loadNextSong_6taknv$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$, tmp$_0;
            this.local$tmp$_1 = this.$this.player;
            if ((tmp$ = this.$this.path.boot.songSource.now) != null) {
              this.state_0 = 2;
          ...
          case 3:
            this.state_0 = 4;
            this.result_0 = this.local$tmp$_1.switchTo_11rb$((tmp$_0 = this.result_0) != null ? new Player(this.$this, tmp$_0, this.local$startPlaying) : null, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
  ...
  Visible.prototype.loadNextSong_6taknv$ = function (startPlaying_0, continuation_0, suspended) {
    var instance = new Coroutine$loadNextSong_6taknv$(this, startPlaying_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  function Visible$tag$lambda$lambda(this$Visible) {
    return function ($receiver) {
      var tmp$;
      return to(this$Visible.path.boot.songInfoSource.invoke().item, (tmp$ = this$Visible.player.invoke()) != null ? tmp$.playable : null);
    };
  }
  function Coroutine$Visible$tag$lambda$lambda($receiver_0, f_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$tmp$ = void 0;
  ...
  Coroutine$Visible$tag$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$Visible$tag$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$Visible$tag$lambda$lambda.prototype.constructor = Coroutine$Visible$tag$lambda$lambda;
  Coroutine$Visible$tag$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var s = this.local$f.component1()
            , p = this.local$f.component2();
            if (p != null) {
              this.state_0 = 2;
              this.result_0 = s(p, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  function Visible$tag$lambda$lambda_0($receiver_0, f_0, continuation_0, suspended) {
    var instance = new Coroutine$Visible$tag$lambda$lambda($receiver_0, f_0, this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Visible$tag$lambda$lambda$lambda$lambda(it) {
    return it.invoke();
  }
  function Visible$tag$lambda$lambda$lambda$lambda_0() {
    return new Mp3File();
  }
  function Visible$tag$lambda$lambda$lambda(closure$t) {
    return function ($receiver) {
      return toOptional(closure$t).flatMap_30i4av$(Visible$tag$lambda$lambda$lambda$lambda).getOrElse_skz6lt$(Visible$tag$lambda$lambda$lambda$lambda_0);
    };
  }
  function Visible$tag$lambda$lambda$lambda_0(this$) {
    return function ($receiver, it) {
      this$.now = it;
      return Unit;
    };
  }
  function Visible$tag$lambda$lambda_1(this$) {
    return function ($receiver, t) {
      $receiver.forEach_5mel8p$($receiver.rx_pn7ch0$(Visible$tag$lambda$lambda$lambda(t)), Visible$tag$lambda$lambda$lambda_0(this$));
      return Unit;
    };
  }
  ...
  function SongStorageDB(source, killables) {
    this.source = source;
    this.uploaded_putbmv$_0 = lazy_0(SongStorageDB$uploaded$lambda(this, killables));
  }
  ...
  package$data.songInclude_cmhzhn$ = songInclude;
  ...
  return _;
}(typeof this['appsimake-music'] === 'undefined' ? {} : this['appsimake-music'], kotlin, this['appsimake-commonui'], this['appsimake-commonfb'], this['appsimake-commonshr'], this['kotlinx-coroutines-core'], this['appsimake-indexeddb'], this['appsimake-musiclib'], this['appsimake-domx'], this['appsimake-firebase'], this['appsimake-bootstrap'], this['appsimake-fontawesome'], this['appsimake-common'], this['appsimake-commonlib'], this['appsimake-firebaseshr']);
