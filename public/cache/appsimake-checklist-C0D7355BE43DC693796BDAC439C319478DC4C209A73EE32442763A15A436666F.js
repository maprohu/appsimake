...
this['appsimake-checklist'] = function (_, Kotlin, $module$appsimake_commonfb, $module$appsimake_checklistlib, $module$appsimake_commonshr, $module$appsimake_commonui, $module$appsimake_domx, $module$appsimake_bootstrap, $module$appsimake_fontawesome, $module$appsimake_firebase, $module$kotlinx_coroutines_core) {
  ...
  function main() {
    FbLinksFactory.Companion.start_gwo7fm$(checklist.checklistLib, void 0, void 0, main$lambda);
  }
  ...
  EditChecklist.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_d3by9q$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  EditChecklist.prototype.getCachedOrServer_prxdpg$ = function ($receiver, continuation) {
    return this.$delegate_d3by9q$_0.getCachedOrServer_prxdpg$($receiver, continuation);
  };
  EditChecklist.prototype.getOrNull_m1hph$$default = function ($receiver, source, continuation) {
    return this.$delegate_d3by9q$_0.getOrNull_m1hph$$default($receiver, source, continuation);
  };
  ...
  EditChecklist.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_d3by9q$_0.set_o9yh22$$default($receiver, data, options);
  };
  EditChecklist.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_d3by9q$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            get_btnOutlineSecondary($receiver_0.cls);
  ...
  function editChecklistUi$lambda$lambda(closure$item, this$editChecklistUi, closure$control) {
    return function ($receiver) {
      ...
      $receiver_7.submit;
      get_btnOutlineSecondary($receiver_7.cls);
      get_plus($receiver_7.fa);
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$Links.getCachedOrServer_prxdpg$(this.local$parent.checklists.doc_61zpoe$(this.local$id), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$Links.getCachedOrServer_prxdpg$(this.local$parent.loggedIn.checklists.doc_61zpoe$(this.local$id), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  LoggedIn.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_b157uu$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  LoggedIn.prototype.getCachedOrServer_prxdpg$ = function ($receiver, continuation) {
    return this.$delegate_b157uu$_0.getCachedOrServer_prxdpg$($receiver, continuation);
  };
  LoggedIn.prototype.getOrNull_m1hph$$default = function ($receiver, source, continuation) {
    return this.$delegate_b157uu$_0.getOrNull_m1hph$$default($receiver, source, continuation);
  };
  ...
  LoggedIn.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_b157uu$_0.set_o9yh22$$default($receiver, data, options);
  };
  LoggedIn.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_b157uu$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  function ui$lambda$lambda$lambda$lambda_0($receiver) {
    $receiver.get_desc_9i4614$(Checklist.Companion.ts);
    return Unit;
  }
  ...
  NewChecklist.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_qnotay$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  NewChecklist.prototype.getCachedOrServer_prxdpg$ = function ($receiver, continuation) {
    return this.$delegate_qnotay$_0.getCachedOrServer_prxdpg$($receiver, continuation);
  };
  NewChecklist.prototype.getOrNull_m1hph$$default = function ($receiver, source, continuation) {
    return this.$delegate_qnotay$_0.getOrNull_m1hph$$default($receiver, source, continuation);
  };
  ...
  NewChecklist.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_qnotay$_0.set_o9yh22$$default($receiver, data, options);
  };
  NewChecklist.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_qnotay$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            var $receiver_1 = get_insert_0($receiver.left).icon;
            get_m1($receiver_1.cls);
            get_check($receiver_1.fa);
            $receiver_1.fw;
            this$ui.visible_od9jl4$($receiver_1.svg, ui$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0(this.local$i));
  ...
  ViewChecklist.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_cqpqsg$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  ViewChecklist.prototype.getCachedOrServer_prxdpg$ = function ($receiver, continuation) {
    return this.$delegate_cqpqsg$_0.getCachedOrServer_prxdpg$($receiver, continuation);
  };
  ViewChecklist.prototype.getOrNull_m1hph$$default = function ($receiver, source, continuation) {
    return this.$delegate_cqpqsg$_0.getOrNull_m1hph$$default($receiver, source, continuation);
  };
  ...
  ViewChecklist.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_cqpqsg$_0.set_o9yh22$$default($receiver, data, options);
  };
  ViewChecklist.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_cqpqsg$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  EditChecklistPath.prototype.get_randomDoc_lsue4w$ = LoggedInPath.prototype.get_randomDoc_lsue4w$;
  ...
  EditChecklistPath.prototype.getCachedOrServer_prxdpg$ = LoggedInPath.prototype.getCachedOrServer_prxdpg$;
  EditChecklistPath.prototype.getOrNull_m1hph$$default = LoggedInPath.prototype.getOrNull_m1hph$$default;
  ...
  EditChecklistPath.prototype.set_o9yh22$$default = LoggedInPath.prototype.set_o9yh22$$default;
  EditChecklistPath.prototype.toFsDoc_bo0woj$$default = LoggedInPath.prototype.toFsDoc_bo0woj$$default;
  EditChecklistPath.prototype.toRandomFsDoc_xc7wmg$ = LoggedInPath.prototype.toRandomFsDoc_xc7wmg$;
  EditChecklistPath.prototype.getOrNull_m1hph$ = LoggedInPath.prototype.getOrNull_m1hph$;
  ...
  EditChecklistPath.prototype.set_o9yh22$ = LoggedInPath.prototype.set_o9yh22$;
  EditChecklistPath.prototype.toFsDoc_bo0woj$ = LoggedInPath.prototype.toFsDoc_bo0woj$;
  ...
  EditChecklistLike.prototype.anyRx_tnde95$ = BindKillsApi.prototype.anyRx_tnde95$;
  EditChecklistLike.prototype.attached_ux9tev$ = BindKillsApi.prototype.attached_ux9tev$;
  ...
  EditChecklistLike.prototype.forEachNonNull_cjboeh$ = BindKillsApi.prototype.forEachNonNull_cjboeh$;
  EditChecklistLike.prototype.forEachTrue_aq5y71$ = BindKillsApi.prototype.forEachTrue_aq5y71$;
  ...
  EditChecklistLike.prototype.register_3ijkb1$ = BindKillsApi.prototype.register_3ijkb1$;
  ...
  EditChecklistLike.prototype.runView_n76bhm$ = BindKillsApi.prototype.runView_n76bhm$;
  ...
  EditChecklistLike.prototype.toChannel_z5dyp2$ = BindKillsApi.prototype.toChannel_z5dyp2$;
  ...
  EditChecklistLike.prototype.toRxSet_vzwksx$ = CsApiCommonui.prototype.toRxSet_vzwksx$;
  ...
  EditChecklistLike.prototype.signIn_tstgz9$ = KillsUixApi.prototype.signIn_tstgz9$;
  ...
  EditChecklist.prototype.get_docsOrNull_g2zw3r$ = FBBackApi.prototype.get_docsOrNull_g2zw3r$;
  ...
  EditChecklist.prototype.documentChanges_pujjsl$$default = FBBackApi.prototype.documentChanges_pujjsl$$default;
  ...
  EditChecklist.prototype.getOrNull_m1hph$ = EditChecklistPath.prototype.getOrNull_m1hph$;
  ...
  EditChecklist.prototype.set_o9yh22$ = EditChecklistPath.prototype.set_o9yh22$;
  EditChecklist.prototype.toFsDoc_bo0woj$ = EditChecklistPath.prototype.toFsDoc_bo0woj$;
  ...
  EditChecklist.prototype.documentChanges_pujjsl$ = FBBackApi.prototype.documentChanges_pujjsl$;
  ...
  NewChecklistPath.prototype.get_randomDoc_lsue4w$ = LoggedInPath.prototype.get_randomDoc_lsue4w$;
  ...
  NewChecklistPath.prototype.getCachedOrServer_prxdpg$ = LoggedInPath.prototype.getCachedOrServer_prxdpg$;
  NewChecklistPath.prototype.getOrNull_m1hph$$default = LoggedInPath.prototype.getOrNull_m1hph$$default;
  ...
  NewChecklistPath.prototype.set_o9yh22$$default = LoggedInPath.prototype.set_o9yh22$$default;
  NewChecklistPath.prototype.toFsDoc_bo0woj$$default = LoggedInPath.prototype.toFsDoc_bo0woj$$default;
  NewChecklistPath.prototype.toRandomFsDoc_xc7wmg$ = LoggedInPath.prototype.toRandomFsDoc_xc7wmg$;
  NewChecklistPath.prototype.getOrNull_m1hph$ = LoggedInPath.prototype.getOrNull_m1hph$;
  ...
  NewChecklistPath.prototype.set_o9yh22$ = LoggedInPath.prototype.set_o9yh22$;
  NewChecklistPath.prototype.toFsDoc_bo0woj$ = LoggedInPath.prototype.toFsDoc_bo0woj$;
  ...
  NewChecklist.prototype.get_docsOrNull_g2zw3r$ = FBBackApi.prototype.get_docsOrNull_g2zw3r$;
  ...
  NewChecklist.prototype.documentChanges_pujjsl$$default = FBBackApi.prototype.documentChanges_pujjsl$$default;
  ...
  NewChecklist.prototype.getOrNull_m1hph$ = NewChecklistPath.prototype.getOrNull_m1hph$;
  ...
  NewChecklist.prototype.set_o9yh22$ = NewChecklistPath.prototype.set_o9yh22$;
  NewChecklist.prototype.toFsDoc_bo0woj$ = NewChecklistPath.prototype.toFsDoc_bo0woj$;
  ...
  NewChecklist.prototype.documentChanges_pujjsl$ = FBBackApi.prototype.documentChanges_pujjsl$;
  ...
  ViewPath.prototype.get_randomDoc_lsue4w$ = LoggedInPath.prototype.get_randomDoc_lsue4w$;
  ...
  ViewPath.prototype.getCachedOrServer_prxdpg$ = LoggedInPath.prototype.getCachedOrServer_prxdpg$;
  ViewPath.prototype.getOrNull_m1hph$$default = LoggedInPath.prototype.getOrNull_m1hph$$default;
  ...
  ViewPath.prototype.set_o9yh22$$default = LoggedInPath.prototype.set_o9yh22$$default;
  ViewPath.prototype.toFsDoc_bo0woj$$default = LoggedInPath.prototype.toFsDoc_bo0woj$$default;
  ViewPath.prototype.toRandomFsDoc_xc7wmg$ = LoggedInPath.prototype.toRandomFsDoc_xc7wmg$;
  ViewPath.prototype.getOrNull_m1hph$ = LoggedInPath.prototype.getOrNull_m1hph$;
  ...
  ViewPath.prototype.set_o9yh22$ = LoggedInPath.prototype.set_o9yh22$;
  ViewPath.prototype.toFsDoc_bo0woj$ = LoggedInPath.prototype.toFsDoc_bo0woj$;
  ...
  ViewChecklist.prototype.get_clickActivate_tvm2vp$ = FBBackApi.prototype.get_clickActivate_tvm2vp$;
  ViewChecklist.prototype.get_clickToggle_tvm2vp$ = FBBackApi.prototype.get_clickToggle_tvm2vp$;
  ViewChecklist.prototype.get_docsOrNull_g2zw3r$ = FBBackApi.prototype.get_docsOrNull_g2zw3r$;
  ...
  ViewChecklist.prototype.click_4eku4n$ = FBBackApi.prototype.click_4eku4n$;
  ViewChecklist.prototype.click_9375ex$ = FBBackApi.prototype.click_9375ex$;
  ViewChecklist.prototype.click_512jbc$ = FBBackApi.prototype.click_512jbc$;
  ViewChecklist.prototype.click_3zaxtq$ = FBBackApi.prototype.click_3zaxtq$;
  ViewChecklist.prototype.click_ts68bh$ = FBBackApi.prototype.click_ts68bh$;
  ViewChecklist.prototype.docs_prxdpg$ = FBBackApi.prototype.docs_prxdpg$;
  ViewChecklist.prototype.documentChanges_pujjsl$$default = FBBackApi.prototype.documentChanges_pujjsl$$default;
  ...
  ViewChecklist.prototype.signIn_tstgz9$ = FBBackApi.prototype.signIn_tstgz9$;
  ViewChecklist.prototype.signOut_tstgz9$ = FBBackApi.prototype.signOut_tstgz9$;
  ...
  ViewChecklist.prototype.getOrNull_m1hph$ = LoggedInTC.prototype.getOrNull_m1hph$;
  ...
  ViewChecklist.prototype.set_o9yh22$ = LoggedInTC.prototype.set_o9yh22$;
  ViewChecklist.prototype.toFsDoc_bo0woj$ = LoggedInTC.prototype.toFsDoc_bo0woj$;
  ...
  ViewChecklist.prototype.documentChanges_pujjsl$ = FBBackApi.prototype.documentChanges_pujjsl$;
