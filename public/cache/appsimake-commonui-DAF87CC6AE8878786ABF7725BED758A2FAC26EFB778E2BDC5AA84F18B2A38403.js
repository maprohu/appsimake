...
this['appsimake-commonui'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_domx, $module$appsimake_common, $module$kotlinx_coroutines_core, $module$appsimake_buildenv, $module$appsimake_fontawesome, $module$appsimake_bootstrap) {
  ...
  function ProgressBackTC(parent, back) {
    CsKillsView.call(this, parent);
    this.back_s87j76$_0 = back;
    var $receiver = factory.topbar;
    this.get_backButton_tdhe4g$($receiver.left);
  ...
  function Coroutine$Icon$FaImpl$of$lambda(this$Icon_0, this$FaImpl_0, closure$cssName_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
      ...
      try {
        switch (this.state_0) {
          ...
          case 1:
            throw this.exception_0;
          case 2:
            return this.local$tmp$.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', '#' + this.result_0.icon_61zpoe$(this.local$closure$cssName)), Unit;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function Icon$FaImpl$of$lambda(this$Icon_0, this$FaImpl_0, closure$cssName_0) {
    return function (continuation_0, suspended) {
      var instance = new Coroutine$Icon$FaImpl$of$lambda(this$Icon_0, this$FaImpl_0, closure$cssName_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  Icon$FaImpl.prototype.of_aoddxy$ = function (cssName, cs) {
    launchReport(cs, Icon$FaImpl$of$lambda(this.$outer, this, cssName));
  };
