  ...
  Coroutine$main$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$$receiver = new Body(this.local$closure$loading.target);
          ...
          case 2:
            this.state_0 = 3;
            this.result_0 = switchToView(this.local$$receiver.content, new Home(this.local$$receiver, this.local$app, this.local$db), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
