...
this['appsimake-firebase'] = function (_, Kotlin, $module$appsimake_commonshr, $module$appsimake_common, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  DbApi.prototype.get_prxdpg$ = function ($receiver, continuation) {
    return get_0($receiver, this, continuation);
  };
  DbApi.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'DbApi',
  ...
  Coroutine$live$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$tmp$ = snapshots(this.local$this$, this.local$closure$deps).iterator();
            this.state_0 = 2;
            continue;
          case 1:
            throw this.exception_0;
  ...
  function Coroutine$get($receiver_0, deps_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = await_0(docRef_0(this.local$$receiver, this.local$deps).get(), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
          ...
          case 2:
            ...
            return toFsDoc(this.local$$receiver.parent.factory(ds.data(), FsDynamicOps_getInstance()), toFsId(this.local$$receiver, true));
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  function get_0($receiver_0, deps_0, continuation_0, suspended) {
    var instance = new Coroutine$get($receiver_0, deps_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  package$firestore.get_1uroz$ = get_0;
  ...
  DbKillsApi.prototype.get_prxdpg$ = DbApi.prototype.get_prxdpg$;
  ...
  CsKillsApiFirebase.prototype.get_oldKilled_vsdo34$ = CsKillsApiCommon.prototype.get_oldKilled_vsdo34$;
  CsKillsApiFirebase.prototype.get_oldKilledOpt_vsdo34$ = CsKillsApiCommon.prototype.get_oldKilledOpt_vsdo34$;
  ...
  CsDbKillsApi.prototype.get_prxdpg$ = DbApi.prototype.get_prxdpg$;
  ...
  return _;
}(typeof this['appsimake-firebase'] === 'undefined' ? {} : this['appsimake-firebase'], kotlin, this['appsimake-commonshr'], this['appsimake-common'], this['kotlinx-coroutines-core']);
