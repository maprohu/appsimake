...
this['appsimake-fbmessagingsw'] = function (_, Kotlin, $module$appsimake_commonshr, $module$kotlinx_coroutines_core, $module$appsimake_firebaseshr) {
  ...
  var createLibMessage = $module$appsimake_firebaseshr.firebaseshr.createLibMessage_ycvucz$;
  ...
  function Coroutine$messageToClient(data_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$data = data_0;
  }
  Coroutine$messageToClient.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$messageToClient.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$messageToClient.prototype.constructor = Coroutine$messageToClient;
  Coroutine$messageToClient.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
          ...
          case 1:
            throw this.exception_0;
          case 2:
            var fc = this.result_0;
            if (fc != null) {
              this.state_0 = 4;
              this.result_0 = await_0(fc.focus(), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
              ...
              this.state_0 = 3;
              this.result_0 = await_0(self.clients.openWindow(self.registration.scope + '?' + commonshr.MessageUrlParameter + '=' + encodeURIComponent(JSON.stringify(this.local$data))), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
          ...
          case 3:
            ...
            continue;
          case 4:
            this.result_0.postMessage(this.local$data);
            this.state_0 = 5;
            continue;
          case 5:
            return;
  ...
  function messageToClient(data_0, continuation_0, suspended) {
    var instance = new Coroutine$messageToClient(data_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function libMessageToClient(lib, data, continuation) {
    return messageToClient(createLibMessage(lib, data), continuation);
  }
          ...
          case 2:
            ...
            firstOrNull$break: do {
              ...
              while (tmp$.hasNext()) {
                ...
                if (element.visibilityState == 'visible') {
  ...
  function Coroutine$initMessaging$lambda$lambda_0(closure$e_0, closure$click_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
  ...
  Coroutine$initMessaging$lambda$lambda_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$closure$e.notification.close();
            this.state_0 = 2;
  ...
  function initMessaging$lambda$lambda_0(closure$e_0, closure$click_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$initMessaging$lambda$lambda_0(closure$e_0, closure$click_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function initMessaging$lambda_2(closure$click) {
    return function (e) {
      ...
      e.waitUntil(asPromise(async(coroutines.GlobalScope, void 0, void 0, initMessaging$lambda$lambda_0(e, closure$click))));
      return Unit;
    };
  }
  ...
  package$fbmessagingsw.messageToClient_s8jyv4$ = messageToClient;
  package$fbmessagingsw.libMessageToClient_ycvucz$ = libMessageToClient;
