...
this['appsimake-eventlog'] = function (_, Kotlin, $module$appsimake_commonui, $module$appsimake_commonfb, $module$appsimake_domx, $module$appsimake_commonshr, $module$appsimake_bootstrap, $module$appsimake_eventloglib, $module$appsimake_firebase, $module$kotlinx_coroutines_core, $module$appsimake_fontawesome) {
  'use strict';
  ...
  EditEventType.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_nwiveq$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  EditEventType.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_nwiveq$_0.set_o9yh22$$default($receiver, data, options);
  };
  EditEventType.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_nwiveq$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  function main() {
    FbLinksFactory.Companion.start_gwo7fm$(eventlog.eventlogLib, void 0, void 0, main$lambda);
  }
  function LinksPath() {
  }
  LinksPath.$metadata$ = {
  ...
  LoggedIn.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_9135me$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  LoggedIn.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_9135me$_0.set_o9yh22$$default($receiver, data, options);
  };
  LoggedIn.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_9135me$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  function ui$lambda$lambda$lambda_0($receiver) {
    $receiver.get_desc_9i4614$(EventType.Companion.ts);
    return Unit;
  }
  ...
  NewEventType.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_q1ybt6$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  NewEventType.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_q1ybt6$_0.set_o9yh22$$default($receiver, data, options);
  };
  NewEventType.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_q1ybt6$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  RecordOccurrence.prototype.get_randomDoc_lsue4w$ = function ($receiver) {
    return this.$delegate_3hq59m$_0.get_randomDoc_lsue4w$($receiver);
  };
  ...
  RecordOccurrence.prototype.set_o9yh22$$default = function ($receiver, data, options) {
    return this.$delegate_3hq59m$_0.set_o9yh22$$default($receiver, data, options);
  };
  RecordOccurrence.prototype.toFsDoc_bo0woj$$default = function ($receiver, source, default_0, continuation) {
    return this.$delegate_3hq59m$_0.toFsDoc_bo0woj$$default($receiver, source, default_0, continuation);
  };
  ...
  function RecordOccurrence_init$lambda$lambda_1($receiver) {
    $receiver.get_desc_9i4614$(Occurrence.Companion.ts);
  ...
  EditEventTypePath.prototype.get_randomDoc_lsue4w$ = LoggedInPath.prototype.get_randomDoc_lsue4w$;
  ...
  EditEventTypePath.prototype.set_o9yh22$$default = LoggedInPath.prototype.set_o9yh22$$default;
  EditEventTypePath.prototype.toFsDoc_bo0woj$$default = LoggedInPath.prototype.toFsDoc_bo0woj$$default;
  ...
  EditEventTypePath.prototype.set_o9yh22$ = LoggedInPath.prototype.set_o9yh22$;
  EditEventTypePath.prototype.toFsDoc_bo0woj$ = LoggedInPath.prototype.toFsDoc_bo0woj$;
  ...
  EditEventType.prototype.get_docsOrNull_g2zw3r$ = FBBackApi.prototype.get_docsOrNull_g2zw3r$;
  ...
  EditEventType.prototype.documentChanges_pujjsl$$default = FBBackApi.prototype.documentChanges_pujjsl$$default;
  ...
  EditEventType.prototype.set_o9yh22$ = EditEventTypePath.prototype.set_o9yh22$;
  EditEventType.prototype.toFsDoc_bo0woj$ = EditEventTypePath.prototype.toFsDoc_bo0woj$;
  ...
  EditEventType.prototype.documentChanges_pujjsl$ = FBBackApi.prototype.documentChanges_pujjsl$;
  ...
  NewEventTypePath.prototype.get_randomDoc_lsue4w$ = LoggedInPath.prototype.get_randomDoc_lsue4w$;
  ...
  NewEventTypePath.prototype.set_o9yh22$$default = LoggedInPath.prototype.set_o9yh22$$default;
  NewEventTypePath.prototype.toFsDoc_bo0woj$$default = LoggedInPath.prototype.toFsDoc_bo0woj$$default;
  ...
  NewEventTypePath.prototype.set_o9yh22$ = LoggedInPath.prototype.set_o9yh22$;
  NewEventTypePath.prototype.toFsDoc_bo0woj$ = LoggedInPath.prototype.toFsDoc_bo0woj$;
  ...
  NewEventType.prototype.get_docsOrNull_g2zw3r$ = FBBackApi.prototype.get_docsOrNull_g2zw3r$;
  ...
  NewEventType.prototype.documentChanges_pujjsl$$default = FBBackApi.prototype.documentChanges_pujjsl$$default;
  ...
  NewEventType.prototype.set_o9yh22$ = NewEventTypePath.prototype.set_o9yh22$;
  NewEventType.prototype.toFsDoc_bo0woj$ = NewEventTypePath.prototype.toFsDoc_bo0woj$;
  ...
  NewEventType.prototype.documentChanges_pujjsl$ = FBBackApi.prototype.documentChanges_pujjsl$;
  ...
  RecordOccurrencePath.prototype.get_randomDoc_lsue4w$ = LoggedInPath.prototype.get_randomDoc_lsue4w$;
  ...
  RecordOccurrencePath.prototype.set_o9yh22$$default = LoggedInPath.prototype.set_o9yh22$$default;
  RecordOccurrencePath.prototype.toFsDoc_bo0woj$$default = LoggedInPath.prototype.toFsDoc_bo0woj$$default;
  ...
  RecordOccurrencePath.prototype.set_o9yh22$ = LoggedInPath.prototype.set_o9yh22$;
  RecordOccurrencePath.prototype.toFsDoc_bo0woj$ = LoggedInPath.prototype.toFsDoc_bo0woj$;
  ...
  RecordOccurrence.prototype.get_docsOrNull_g2zw3r$ = FBBackApi.prototype.get_docsOrNull_g2zw3r$;
  ...
  RecordOccurrence.prototype.documentChanges_pujjsl$$default = FBBackApi.prototype.documentChanges_pujjsl$$default;
  ...
  RecordOccurrence.prototype.set_o9yh22$ = RecordOccurrencePath.prototype.set_o9yh22$;
  RecordOccurrence.prototype.toFsDoc_bo0woj$ = RecordOccurrencePath.prototype.toFsDoc_bo0woj$;
  ...
  RecordOccurrence.prototype.documentChanges_pujjsl$ = FBBackApi.prototype.documentChanges_pujjsl$;
  ...
  return _;
}(typeof this['appsimake-eventlog'] === 'undefined' ? {} : this['appsimake-eventlog'], kotlin, this['appsimake-commonui'], this['appsimake-commonfb'], this['appsimake-domx'], this['appsimake-commonshr'], this['appsimake-bootstrap'], this['appsimake-eventloglib'], this['appsimake-firebase'], this['kotlinx-coroutines-core'], this['appsimake-fontawesome']);
