...
this['appsimake-bootstrap'] = function (_, Kotlin, $module$appsimake_domx, $module$appsimake_commonshr, $module$appsimake_common) {
  ...
  var rxClassOpt = $module$appsimake_commonshr.rx.rxClassOpt_jabexw$;
  ...
  function DropdownItemAnchor$anchor$lambda($receiver) {
    get_dropdownItem(get_cls($receiver));
    $receiver.href = '#';
    return Unit;
  }
  function DropdownItemAnchor$icon$lambda$lambda($receiver) {
    get_mr2(get_cls($receiver));
    return Unit;
  }
  ...
  function rxDisplay($receiver, ks, rxVal) {
    var rxv = Rx_init(ks, rxDisplay$lambda(rxVal));
    rxDisplay_0($receiver, ks, rxv);
  }
  ...
  function rxDisplay_0($receiver, ks, rxVal) {
    rxVal.forEach_yk5nc8$(ks, rxDisplay$lambda_0($receiver));
  }
  ...
  function rxAnchorEnabled($receiver, ks, rxVal) {
    var stl = Rx_init(ks, rxAnchorEnabled$lambda(rxVal));
    rxClassOpt($receiver, ks, stl);
  }
  ...
  function rxAnchorClick($receiver, ks, rxVal, fn) {
    rxAnchorEnabled($receiver, ks, rxVal);
  ...
  function rxText($receiver, ks, rxVal) {
    rxVal.forEach_yk5nc8$(ks, rxText$lambda($receiver));
  }
  function rxText_0($receiver, ks, fn) {
  ...
  function rxTextOrEmpty($receiver, ks, fn) {
    rxText_0($receiver, ks, rxTextOrEmpty$lambda(fn));
  }
  ...
  function get_alert($receiver) {
    return alert_0.getValue_lrcp0p$($receiver, alert_metadata);
  }
  var alertWarning_metadata = new PropertyMetadata('alertWarning');
  var alertWarning_0;
  function get_alertWarning($receiver) {
    return alertWarning_0.getValue_lrcp0p$($receiver, alertWarning_metadata);
  }
  ...
  package$bootstrap.rxDisplay_z6arxy$ = rxDisplay;
  package$bootstrap.rxDisplay_rlaqb$ = rxDisplay_0;
  package$bootstrap.rxAnchorEnabled_fsnrwe$ = rxAnchorEnabled;
  package$bootstrap.rxAnchorClick_6ml6df$ = rxAnchorClick;
  package$bootstrap.rxText_krbx0q$ = rxText;
  package$bootstrap.rxText_jae58v$ = rxText_0;
  ...
  alert_0 = css().provideDelegate_d6mtq7$(this, alert_metadata);
  alertWarning_0 = css().provideDelegate_d6mtq7$(this, alertWarning_metadata);
