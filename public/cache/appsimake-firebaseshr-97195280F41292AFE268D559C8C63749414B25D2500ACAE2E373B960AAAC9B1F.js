...
this['appsimake-firebaseshr'] = function (_, Kotlin, $module$appsimake_commonshr) {
  ...
  function PropOps(delete_0, serverTimestamp, deleteCollection) {
  ...
  PropOps.prototype.copy_vco7bp$ = function (delete_0, serverTimestamp, deleteCollection) {
    return new PropOps(delete_0 === void 0 ? this.delete : delete_0, serverTimestamp === void 0 ? this.serverTimestamp : serverTimestamp, deleteCollection === void 0 ? this.deleteCollection : deleteCollection);
  };
  PropOps.prototype.toString = function () {
    return 'PropOps(delete=' + Kotlin.toString(this.delete) + (', serverTimestamp=' + Kotlin.toString(this.serverTimestamp)) + (', deleteCollection=' + Kotlin.toString(this.deleteCollection)) + ')';
  };
  ...
  PropOps.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.delete, other.delete) && Kotlin.equals(this.serverTimestamp, other.serverTimestamp) && Kotlin.equals(this.deleteCollection, other.deleteCollection)))));
  };
  var propOps;
  function get_ops() {
    return propOps;
